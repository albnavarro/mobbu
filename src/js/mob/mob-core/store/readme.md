...
Proxi must be create after store is binded, as the following example:
...
**proposal** creare un proxi con look-up dinamico sullo store propietario e suglio store collegati:
```js
