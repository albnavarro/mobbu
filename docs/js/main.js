(() => {
  ...
  var getChildrenInsideElement = ({
    ...
    return [...children].filter((id2) => {
      const child2 = getElementById({ id: id2 }) ?? null;
...
`;
  ...
  function getSubmenu({ children, staticProps: staticProps2, callback: callback2 }) {
    return children.map((child2) => {
      const { label, url, scrollToSection } = child2;
      return renderHtml`
  ...
  var animatedPatternN0v2 = () => {
    return renderHtml`<div class="l-padding">
        <animation-title
            ${staticProps({ title: "Animated pattern N.0 v1" })}
        ></animation-title>
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  var animatedPatternN0v4 = () => {
    return renderHtml`<div class="l-padding">
        <animation-title
            ${staticProps({ title: "Animated pattern N.0 v4" })}
        ></animation-title>
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  var animatedPatternN0v5 = () => {
    return renderHtml`<div class="l-padding">
        <animation-title
            ${staticProps({ title: "Animated pattern N.0 v5" })}
        ></animation-title>
        <animatedpattern-n0
            ${staticProps({
      fill: [
      ...
      reorder: false
        ...
        <quick-nav
            ${staticProps({
      prevRoute: "#animatedPatternN0v4",
      nextRoute: "#animatedPatternN0v6"
    })}
        ></quick-nav>
    </div>`;
  };
  ...
  var animatedPatternN0v6 = () => {
    return renderHtml`<div class="l-padding">
        <animation-title
            ${staticProps({ title: "Animated pattern N.0 v6" })}
        ></animation-title>
        <animatedpattern-n0
            ${staticProps({
      fill: [
      ...
      reorder: false
        ...
        <quick-nav
            ${staticProps({
      prevRoute: "#animatedPatternN0v5",
      nextRoute: "#animatedPatternN0v7"
    })}
        ></quick-nav>
    </div>`;
  };
