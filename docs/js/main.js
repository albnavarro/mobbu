    ...
    `,t=g`<div class="dragger-child">
        ...
        <li class="l-rosa__controls__item">
            <span for="numerators" class="l-rosa__controls__label">
                ${r`numerators: <strong>${()=>e.numerators}</strong>`}
            </span>
            <div class="l-rosa__controls__range">
                <input
                    ...
                    value="${e.numerators}"
                    step="1"
                    ${t({change:o=>{let{target:n}=o;if(!n)return;let s=n.value;e.numerators=Number(s)}})}
                />
            </div>
        </li>
        <li class="l-rosa__controls__item">
            <span for="denominator" class="l-rosa__controls__label">
                ${r`denominator: <strong>${()=>e.denominator}</strong>`}
            </span>
            <div class="l-rosa__controls__range">
                <input
                    type="range"
                    ...
                    value="${e.denominator}"
                    step="1"
                    ${t({change:o=>{let{target:n}=o;if(!n)return;let s=n.value;e.denominator=Number(s)}})}
                />
            </div>
        </li>
