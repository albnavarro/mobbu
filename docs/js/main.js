...
`;var kf=({getState:e})=>{let{rawContent:t}=e();navigator.clipboard.writeText(t)};function Rf({sync:e,bindProps:t,setState:r,delegateEvents:o}){return g`
    ...
    `}var Pf=async({setState:e,getState:t,codeEl:r,currentKey:o,updateScroller:s,goToTop:n,syncParent:i})=>{let{urls:a}=t(),p=a.find(({label:m})=>m===o)?.source;if(!p?.length)return;let u=g`<html-content
        ...
        ${i}
    ></html-content>`;r.insertAdjacentHTML("afterbegin",u),await po(r),e("rawContent",r.textContent),s(),n()},Pp=({codeEl:e,removeDOM:t})=>{e.textContent="";let r=e.firstElementChild;r&&t(r)},Ap=({onMount:e,setState:t,getState:r,repeat:o,html:s,bindProps:n,delegateEvents:i,staticProps:a,computed:l,watch:p,removeDOM:u,syncParent:m})=>(e(({element:d,refs:f})=>{let{screenEl:T,scrollerEl:b,codeEl:w,scrollbar:x}=f,{updateScroller:C,move:_,goToTop:W}=kp({screen:T,scroller:b,scrollbar:x});x.addEventListener("input",()=>{_(x.value)}),A.watch("beforeRouteLeave",()=>{t("urls",[])}),l("currentButtonState",["urls","activeContent"],(k,$)=>(k.length>0?(d.classList.add("active"),document.body.style.overflow="hidden"):(d.classList.remove("active"),document.body.style.overflow="",Pp({codeEl:w,removeDOM:u}),t("activeContent",""),W()),$));let M=p("activeContent",k=>{Pp({codeEl:w,removeDOM:u}),Pf({setState:t,getState:r,codeEl:w,currentKey:k,updateScroller:C,goToTop:W,staticProps:a,syncParent:m})});return()=>{M()}}),s`
...
Loading snippet ...</pre
    ...
    </div>`};var Dg=E({name:"mob-snippet",component:bh,exportState:["source","isFull","hasOverflow","hasBorder","numLines","loadOnMount"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number}),loadOnMount:()=>({value:!1,type:Boolean})}});function Vg({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var yh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${Vg({id:s,label:n})}
        class="spacer spacer--${r} ${i}"
    ></div>`};var $g=E({name:"mob-spacer",component:yh,exportState:["style","line","id","label"],state:{style:()=>({value:"medium",type:String,validate:e=>["small","medium","big"].includes(e),strict:!0}),line:()=>({value:!1,type:Boolean}),id:()=>({value:"",type:String}),label:()=>({value:"",type:String})}});var Wg=g`
    <div class="only-desktop">
        <h3>This content is available only on desktop</h3>
        <h4>Need page reload on a screen size up to 1024px</h4>
    </div>
`,vh=({element:e})=>{e.textContent="",!oe.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Wg))},Sh=({html:e,onMount:t})=>(t(({element:r})=>{vh({element:r}),c.useResize(()=>{vh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var Bg=E({name:"only-desktop",component:Sh,state:{}});var wh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=Z.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
        <div class="c-loader ${n}">
            <span class="c-loader__inner"></span>
        </div>
    `};var jg=E({name:"mob-loader",component:wh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var zg=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},Th=({html:e,onMount:t})=>(t(({element:r})=>{if(oe.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{zg({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var Hg=E({name:"doc-scroll",component:Th});var xh=({html:e,delegateEvents:t})=>e`
        <div
            class="c-doc-top"
            ${t({click:()=>At.to(0,{duration:2e3})})}
        ></div>
    `;var Ug=E({name:"doc-top",component:xh});function qg({targets:e,delegateEvents:t,syncParent:r,staticProps:o,setState:s,bindProps:n}){return e.map((i,a)=>{let{label:l,scroll:p}=i.dataset;return g`<li>
                <scroll-to-button
    ...
    </div>`};var Rh=({html:e,getState:t})=>{let{label:r,url:o}=t(),{activeRoute:s}=A.get();return e`<a href="./#${o}" class="${s===o?"current":""}">${r}</a>`};var Kg=E({name:"links-mobjs",component:kh,exportState:["section"],state:{section:()=>({value:"",type:String})}}),Zg=E({name:"links-mobjs-button",component:Rh,exportState:["label","url"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String})}});var Ph=({html:e,onMount:t})=>(t(({element:r})=>{r.classList.add("disable");let o=Z.createTween({data:{opacity:1,scale:1},duration:500});return o.subscribe(({opacity:s,scale:n})=>{r.style.opacity=s,r.style.transform=`scale(${n})`}),A.watch("beforeRouteChange",()=>{r.classList.remove("disable"),o.goTo({opacity:1,scale:1})}),A.watch("atfterRouteChange",async()=>{await o.goTo({opacity:0,scale:.9}),r.classList.add("disable")}),()=>{o.destroy(),o=null}}),e`
        <div class="c-loader center-viewport">
            <span class="c-loader__inner"></span>
        </div>
    `);var Qg=E({name:"route-loader",component:Ph,state:{isLoading:()=>({value:!1,type:Boolean})}});var Ah=({html:e})=>e`
    ...
    `;var sb=E({name:"footer-nav",component:Oh}),nb=E({name:"footer-nav-button",component:_h,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function ib({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function ab({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function lb(){let e=qe("page-transition");_e(e,"url","#home"),D.set("navigationIsOpen",!1),D.emit("closeNavigation"),D.emit("closeAllAccordion"),D.emit("goToTop")}var Nh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return D.watch("openNavigation",()=>ib({navInfo:s})),D.watch("closeNavigation",()=>ab({navInfo:s})),A.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Lh={},Fh={},Xs=()=>Lh,ve=()=>Fh,Dh=async()=>{Lh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Fh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Vh={github:Mh},ub=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=qe("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=D.get();s&&(D.set("navigationIsOpen",!1),D.emit("closeNavigation"))};function pb({delegateEvents:e}){let{header:t}=Xs(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
    ...
    `;var hb=()=>{let{navigationIsOpen:e}=D.get("navigationIsOpen");if(D.set("navigationIsOpen",t=>!t),e){D.emit("closeNavigation");return}D.emit("openNavigation")},Wh=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{D.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),D.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var db=E({name:"mob-header",component:Nh}),mb=E({name:"mob-header-nav",component:$h}),fb=E({name:"mob-header-toggle",component:Wh});var Ii=0,Bh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ut({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=D.get();a&&(Ii=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ii})`)}});n.init(),D.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=Se(r),u=Se(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),D.watch("refreshScroller",()=>n.refresh()),D.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),D.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ii})`}),D.watch("goToTop",()=>{setTimeout(()=>{n.set(0),D.set("activeSection","no-section")},s)})};function gb({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function bb({element:e,main:t}){D.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function yb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=D.get();r&&(D.set("navigationIsOpen",!1),D.emit("closeNavigation"))}),t.addEventListener("click",()=>{D.emit("closeAllAccordion"),D.emit("goToTop");let{navigationIsOpen:r}=D.get();r||At.to(0)})}var jh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return D.watch("openNavigation",()=>bb({element:r,main:s})),D.watch("closeNavigation",()=>gb({element:r,main:s})),c.useResize(()=>{let p=oe.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),yb({main:s,toTopBtn:i}),Bh({root:r}),()=>{}}),e`
    ...
    `);function vb({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?g`
    ...
    `};function Sb({children:e,staticProps:t,callback:r}){return e.map(o=>{let{label:s,url:n,scrollToSection:i}=o;return g`
            ...
            `}).join("")}var qh=({onMount:e,html:t,getState:r,setState:o,staticProps:s,bindProps:n,watch:i})=>{let{children:a,headerButton:l,callback:p}=r(),{label:u,url:m}=l;return e(({refs:d})=>{let{content:f}=d;return Io.subscribe(f),Io.reset(f),i("isOpen",async T=>{if(await Io[T?"down":"up"](f),D.emit("refreshScroller"),!T){let w=qe("main_navigation");_e(w,"currentAccordionId",-1,!1)}}),()=>{}}),t`
    ...
    `};var wb=E({name:"mob-navigation-container",component:jh,isolateOnMount:!0,isolateCreation:!0}),Tb=E({name:"mob-navigation",component:zh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),xb=E({name:"mob-navigation-submenu",component:qh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),Cb=E({name:"mob-navigation-button",type:"button",component:Hh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),Ib=E({name:"mob-navigation-label",component:Uh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var Gh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var Eb=E({name:"doc-container",component:Gh});var Jh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var kb=E({name:"doc-title",component:Jh,state:{}});var Yh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Rb=E({name:"doc-title-small",component:Yh,state:{}});var Xh=`<?xml version="1.0" encoding="UTF-8"?>
...
`;var Qh=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
    ...
    `);var _b=E({name:"shape-right",component:Qh}),Ob=E({name:"shape-left",component:Kh});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},ze=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},He=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},yt=e=>"roundRect"in e,ed=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Zr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:pr({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:hr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),pr=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,hr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var td=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],T=[],b={},w={},x=e.getContext(m,{alpha:!1}),C="#000",_="#fff",{activeRoute:W}=A.get(),{offscreen:M,offScreenCtx:k}=ze({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Zr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,T=p?f.map((L,J)=>({...L,scale:1,rotate:0,hasFill:i.includes(J)})).sort(L=>L.hasFill?-1:1).reverse():f.map((L,J)=>{let ne=i.includes(J);return{...L,scale:1,rotate:0,hasFill:ne}}),b=Z.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),T.forEach(L=>{b.subscribeCache(L,({scale:J,rotate:ne})=>{L.rotate=ne,L.scale=J})});let $=()=>{if(!x)return;u&&(M.width=e.width,M.height=e.height);let L=u?k:x;L.fillStyle="#1a1b26",L.fillRect(0,0,e.width,e.height),T.forEach(({x:J,y:ne,centerX:j,centerY:O,width:y,height:v,rotate:R,scale:P,hasFill:V,offsetXCenter:G,offsetYCenter:Q})=>{let Ie=Math.PI/180*R,ae=Math.cos(Ie)*P,de=Math.sin(Ie)*P;L.setTransform(ae,de,-de,ae,Math.round(j+G),Math.round(O+Q)),L.beginPath(),L.rect(Math.round(-j+J),Math.round(-O+ne),y,v),L.fillStyle=V?_:C,L.fill(),L.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:M,ctx:x})};w=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(b,{scale:1.5,rotate:90},{duration:1e3}).goTo(b,{scale:.5},{duration:500}).goTo(b,{rotate:180,scale:1.2},{duration:500}).goTo(b,{scale:1.3},{duration:500}).goTo(b,{scale:1},{duration:1200}),w.onLoopEnd(({direction:L,loop:J})=>{console.log(`loop end: ${L}, ${J}`)}),w.play();let U=()=>{$(),d&&c.useNextFrame(()=>U())};c.useFrame(({time:L})=>{U({time:L})});let B=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,T.forEach(L=>{let{width:J,height:ne,gutter:j,numberOfColumn:O}=L;L.offsetXCenter=pr({canvasWidth:e.width,width:J,gutter:j,numberOfColumn:O}),L.offsetYCenter=hr({canvasHeight:e.height,height:ne,gutter:j,numberOfRow:t})}),c.useFrame(()=>$())}),K=D.watch("openNavigation",()=>{w?.stop(),d=!1}),F=D.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:L}=A.get();L===W&&(w?.play(),c.useFrame(()=>U()))},500));return()=>{b.destroy(),w.destroy(),B(),F(),K(),b=null,w=null,x=null,M=null,k=null,f=[],T=[],d=!1}};var rd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=td({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN0:s}=ve(),{source:n}=s;return t`
        <div>
    ...
    `};var Nb=E({name:"animatedpattern-n0",component:rd,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[16,27,38,49,60,71,82,93],type:Array}),stagger:()=>({value:{each:5,grid:{col:11,row:11,direction:"row"},waitComplete:!1},type:"any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||se())}});var od=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a})=>{let{useOffscreen:l,context:p}=je({disableOffcanvas:a}),u=!0,m=[],d=[],f={},T={},b={},{top:w,left:x}=ie(e),C=e.getContext(p,{alpha:!1}),_="#000",W="#fff",{activeRoute:M}=A.get(),{offscreen:k,offScreenCtx:$}=ze({useOffscreen:l,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,m=Zr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,d=m.map((O,y)=>({...O,scale:0,mouseX:0,mouseY:0,hasFill:i.includes(y)})).sort(O=>O.hasFill?-1:1),f=Z.createLerp({data:{mouseX:0,mouseY:0}}),d.forEach(O=>{f.subscribeCache(O,({mouseX:y,mouseY:v})=>{O.mouseX=y,O.mouseY=v})}),T=Z.createTween({ease:"easeInOutSine",stagger:{each:5,from:"center",waitComplete:!1},data:{scale:0}}),d.forEach(O=>{T.subscribeCache(O,({scale:y})=>{O.scale=y})});let U=()=>{if(!C)return;l&&(k.width=e.width,k.height=e.height);let O=l?$:C;O.fillStyle="#1a1b26",O.fillRect(0,0,e.width,e.height),d.forEach(({x:y,y:v,centerX:R,centerY:P,width:V,height:G,mouseX:Q,mouseY:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Q-(e.width-(V+n)*r)/2,Ge=Ie-(e.height-(G+n)*t)/2,Je=(y-Le)/250,vt=(v-Ge)/250,St=Math.sqrt(Math.pow(Math.abs(Je),2)+Math.pow(Math.abs(vt),2)),Yt=Oe(Math.abs(St),0,2),eo=0,Ue=Math.cos(eo)*(Yt+ae),Lo=Math.sin(eo)*(Yt+ae);O.setTransform(Ue,Lo,-Lo,Ue,Math.round(R+Me),Math.round(P+De)),O.beginPath(),O.rect(Math.round(-R+y),Math.round(-P+v),V,G),O.fillStyle=de?W:_,O.fill(),O.setTransform(1,0,0,1,0,0)}),He({useOffscreen:l,offscreen:k,ctx:C})};b=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).goTo(T,{scale:.3},{duration:1e3}),b.play();let B=({x:O,y})=>{f.goTo({mouseX:O-x,mouseY:y-w})},K=c.useMouseMove(({client:O})=>{let{x:y,y:v}=O;B({x:y,y:v})}),F=c.useTouchMove(({client:O})=>{let{x:y,y:v}=O;B({x:y,y:v})}),L=()=>{U(),u&&c.useNextFrame(()=>L())};c.useFrame(({time:O})=>{L({time:O})});let J=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,w=ie(e).top,x=ie(e).left,d.forEach(O=>{let{width:y,height:v,gutter:R,numberOfColumn:P}=O;O.offsetXCenter=pr({canvasWidth:e.width,width:y,gutter:R,numberOfColumn:P}),O.offsetYCenter=hr({canvasHeight:e.height,height:v,gutter:R,numberOfRow:t})}),c.useFrame(()=>U())}),ne=D.watch("openNavigation",()=>{b?.stop(),u=!1}),j=D.watch("closeNavigation",()=>setTimeout(async()=>{u=!0;let{activeRoute:O}=A.get();O===M&&(b?.play(),c.useFrame(()=>L()))},500));return()=>{T.destroy(),b.destroy(),f.destroy(),J(),K(),F(),j(),ne(),T=null,b=null,f=null,C=null,k=null,$=null,m=[],d=[],u=!1}};var sd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=od({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN1:s}=ve(),{source:n}=s;return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Mb=E({name:"animatedpattern-n1",component:sd,isolateCreation:!0,isolateOnMount:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","disableOffcanvas"],state:{numberOfRow:7,numberOfColumn:15,cellWidth:70,cellHeight:70,gutter:10,fill:[21,22,23,24,25,25,26,37,42,53,58,69,74,85,86,87,88,89,90,44,60,65,66],disableOffcanvas:!!(Re()||se())}});function Lb({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function Fb({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var nd=({canvas:e,amountOfPath:t,width:r,height:o,fill:s,stroke:n,opacity:i,spacerY:a,intialRotation:l,perpetualRatio:p,mouseMoveRatio:u,disableOffcanvas:m})=>{let{useOffscreen:d,context:f}=je({disableOffcanvas:m}),T=!0,b=e.getContext(f,{alpha:!1}),w=[],x=[],C={},{left:_}=ie(e),{activeRoute:W}=A.get(),{offscreen:M,offScreenCtx:k}=ze({useOffscreen:d,canvas:e}),$=d?k:b,U=yt($)&&!se();$=null,e.width=e.clientWidth,e.height=e.clientHeight,w=[...new Array(t).keys()].map((y,v)=>{let R=v,P=R<t/2?t-R:R,V=P-(t-P);return{width:Math.floor(Lb({width:r,relativeIndex:V,amountOfPath:t})),height:Math.floor(Fb({height:o,relativeIndex:V,amountOfPath:t})),fill:s,stroke:n,opacity:V*i,rotate:0,y:0,relativeIndex:V,index:v}}),x=w.splice(0,w.length/2).concat(w.reverse()),C=Z.createSpring({data:{rotate:0,y:0},stagger:{each:5,from:"center"}}),[...x].forEach(y=>{C.subscribeCache(y,({rotate:v})=>{y.rotate=v})});let B=({time:y=0})=>{if(!b)return;d&&(M.width=e.width,M.height=e.height);let v=d?k:b,R=e.width/2,P=e.height/2;v.fillStyle="#1a1b26",v.fillRect(0,0,e.width,e.height),x.forEach(({width:V,height:G,opacity:Q,rotate:Ie,relativeIndex:ae,index:de})=>{let Me=Math.sin(y/1e3)*p*ae,De=de<t/2?Me+15*ae/2:-Me-15*ae/2,Le=de<t/2?-1:1,Ge=1,Je=Math.PI/180*(Ie-l),vt=Math.cos(Je)*Ge,St=Math.sin(Je)*Ge;v.setTransform(vt,St,-St,vt,R,P+G/2),U?(v.beginPath(),v.roundRect(-(V*Le)/2,-G/2+De+a(de<t/2),V,G,[200,0])):(v.beginPath(),v.rect(-(V*Le)/2,-G/2+De+a(de<t/2),V,G)),v.strokeStyle=`rgba(255, 255, 255, ${Q})`,v.fillStyle=`rgba(26, 27, 38, ${Q})`,v.stroke(),v.fill(),v.setTransform(1,0,0,1,0,0)}),He({useOffscreen:d,offscreen:M,ctx:b})},K=({time:y=0})=>{B({time:y}),T&&c.useNextFrame(({time:v})=>K({time:v}))};c.useFrame(({time:y})=>{K({time:y})});let F=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,_=ie(e).left,c.useFrame(({time:y})=>{B({time:y})})}),L=({x:y})=>{let v=y-e.width/2-_;C.goTo({rotate:v/u})},J=c.useMouseMove(({client:y})=>{let{x:v}=y;L({x:v})}),ne=c.useTouchMove(({client:y})=>{let{x:v}=y;L({x:v})}),j=D.watch("openNavigation",()=>{T=!1}),O=D.watch("closeNavigation",()=>{setTimeout(()=>{T=!0;let{activeRoute:y}=A.get();y===W&&c.useFrame(({time:v})=>K({time:v}))},500)});return()=>{C.destroy(),F(),J(),ne(),O(),j(),b=null,M=null,k=null,C=null,x=[],w=[],T=!1}};var id=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(oe.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=nd({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN0:s}=ve(),{source:n}=s,i=se()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Db=E({name:"caterpillar-n0",component:id,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","fill","stroke","opacity","spacerY","intialRotation","perpetualRatio","mouseMoveRatio","disableOffcanvas"],state:{amountOfPath:17,width:Re()||se()?30:40,height:Re()||se()?30:40,radius:0,fill:"",stroke:"#fff",opacity:.05,spacerY:e=>e?300:-400,intialRotation:33,perpetualRatio:6,mouseMoveRatio:10,disableOffcanvas:!!(Re()||se())}});var ad=({canvas:e,numItems:t,width:r,height:o,fill:s,opacity:n,radius:i,rotationDuration:a,rotationEach:l,centerEach:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=e.getContext(d,{alpha:!1}),b=[],w={},x={},C={},{top:_,left:W}=ie(e),{activeRoute:M}=A.get(),{offscreen:k,offScreenCtx:$}=ze({useOffscreen:m,canvas:e}),U=m?$:T,B=yt(U)&&!se();U=null,e.width=e.clientWidth,e.height=e.clientHeight,b=[...new Array(t).keys()].map((v,R)=>{let P=R>=t/2?t/2+(t/2-R):R,V=s.includes(R)?1:P*n;return{width:P*r,height:P*o,x:0,y:0,hasFill:s.includes(R),opacity:V,radius:i,rotate:0,relativeIndex:P}}),w=Z.createTween({data:{rotate:0},stagger:{each:l,from:"center"},ease:"easeLinear",relative:!0}),[...b].forEach(v=>{w.subscribeCache(v,({rotate:R})=>{v.rotate=R})}),x=Z.createSpring({data:{x:0,y:0},stagger:{each:p,from:"end"}}),[...b].forEach(v=>{x.subscribeCache(v,({x:R,y:P})=>{v.x=R,v.y=P})});let K=()=>{if(!T)return;m&&(k.width=e.width,k.height=e.height);let v=m?$:T;v.fillStyle="#1a1b26",v.fillRect(0,0,e.width,e.height),b.forEach(({width:R,height:P,x:V,y:G,opacity:Q,rotate:Ie,hasFill:ae},de)=>{let Me=b.length-de,De=e.width/2,Le=e.height/2,Ge=1,Je=Math.PI/180*Ie,vt=Math.cos(Je)*Ge,St=Math.sin(Je)*Ge;v.setTransform(vt,St,-St,vt,De+V+Me*V/20,Le+G+Me*G/20),B?(v.beginPath(),v.roundRect(Number.parseInt(-R/2),Number.parseInt(-P/2),R,P,[200,0])):(v.beginPath(),v.rect(Number.parseInt(-R/2),Number.parseInt(-P/2),R,P)),ae?v.fillStyle="rgba(255, 255, 255, 1)":(v.fillStyle=`rgba(26, 27, 38, ${Q})`,v.strokeStyle=`rgba(255, 255, 255, ${Q})`,v.stroke()),v.fill(),v.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:k,ctx:T})};C=Ne.createAsyncTimeline({repeat:-1,yoyo:!1}),C.goTo(w,{rotate:360},{duration:a}),C.play();let F=()=>{K(),f&&c.useNextFrame(()=>F())};c.useFrame(()=>F());let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,_=ie(e).top,W=ie(e).left,K()}),J=({x:v,y:R})=>{let P=window.innerWidth,V=window.innerHeight,G=v-e.width/2-W,Q=R-e.height/2-_;x.goTo({x:Oe(G,-P/2+400+W,P/2-400-W),y:Oe(Q,-V/2+200+_,V/2-200-_)})},ne=c.useMouseMove(({client:v})=>{let{x:R,y:P}=v;J({x:R,y:P})}),j=c.useTouchMove(({client:v})=>{let{x:R,y:P}=v;J({x:R,y:P})}),O=D.watch("openNavigation",()=>{f=!1,C?.pause()}),y=D.watch("closeNavigation",()=>setTimeout(()=>{f=!0;let{activeRoute:v}=A.get();v===M&&(C?.resume(),c.useFrame(()=>F()))},500));return()=>{w.destroy(),x.destroy(),C.destroy(),L(),ne(),j(),O(),y(),w=null,x=null,C=null,T=null,k=null,$=null,b=[],f=!1}};var ld=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(oe.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=ad({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN1:s}=ve(),{source:n}=s,i=se()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Vb=E({name:"caterpillar-n1",component:ld,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(Re()||se())}});var Ei=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},cd=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:T}=je({disableOffcanvas:d}),b=!0,w=e.getContext(T,{alpha:!1}),x=[],C=m,{activeRoute:_}=A.get(),{offscreen:W,offScreenCtx:M}=ze({useOffscreen:f,canvas:e}),k=f?M:w,$=yt(k)&&!se();k=null,x=[...new Array(t).keys()].map((j,O)=>{let y=O>=t/2?t/2+(t/2-O):O,v=r+r/3*y,R=o+o/3*y,P=n.includes(O)?1:(t-O)*i;return{width:v,height:R,x:0,y:0,hasFill:n.includes(O),opacity:P,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let U=Z.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:O})=>{Ei({isForced:j,direction:O,value:1})},1).add(({isForced:j,direction:O})=>{Ei({isForced:j,direction:O,value:5})},5).add(({isForced:j,direction:O})=>{Ei({isForced:j,direction:O,value:9})},9);x.forEach(j=>{U.subscribeCache(j,({x:O,rotate:y})=>{let v=O/u,R=2/(3-Math.cos(2*v)),P=R*Math.cos(v)*a,V=R*Math.sin(2*v)/2*l;j.x=P,j.y=V,j.rotate=y})});let B=Ne.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(U);B.onLoopEnd(({loop:j,direction:O})=>{console.log(`loop end: ${j} , ${O}`)});let K=()=>{if(!w)return;f&&(W.width=e.width,W.height=e.height);let j=f?M:w;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),x.forEach(({width:O,height:y,x:v,y:R,radius:P,rotate:V,hasFill:G,opacity:Q})=>{let Ie=e.width/2,ae=e.height/2,de=1,Me=Math.PI/180*V,De=Math.cos(Me)*de,Le=Math.sin(Me)*de;j.setTransform(De,Le,-Le,De,Ie+v,ae+R),$?(j.beginPath(),j.roundRect(Number.parseInt(-O/2),Number.parseInt(-y/2),O,y,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-O/2),Number.parseInt(-y/2),O,y,P)),G?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${Q})`,j.strokeStyle=`rgba(255, 255, 255, ${Q})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),He({useOffscreen:f,offscreen:W,ctx:w})},F=()=>{K(),b&&c.useNextFrame(()=>F())};c.useFrame(()=>F()),B.play();let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,K()}),J=D.watch("openNavigation",()=>{b=!1,B?.pause()}),ne=D.watch("closeNavigation",()=>setTimeout(()=>{b=!0;let{activeRoute:j}=A.get();j===_&&(B?.resume(),c.useFrame(()=>F()))},500));return{destroy:()=>{b=!1,L(),J(),ne(),U.destroy(),B.destroy(),w=null,W=null,M=null,x=[]},play:()=>{B.stop(),B.play()},playReverse:()=>{B.stop(),B.playReverse()},playUseCurrent:()=>B.play({useCurrent:!0}),playReverseUseCurrent:()=>B.playReverse({useCurrent:!0}),playFromLabel:()=>{B.stop(),B.playFrom("mylabel")},plaFromLabelReverse:()=>{B.stop(),B.playFromReverse("mylabel")},stop:()=>B.stop(),pause:()=>B.pause(),resume:()=>B.resume(),reverse:()=>B.reverse(),setRotation:j=>C=j}};function $b({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return g` <li class="c-canvas__controls__item">
                <button
                    type="button"
            ...
            </li>`}).join("")}var ud=({onMount:e,html:t,getState:r,staticProps:o})=>{let{buttons:s,rotationDefault:n}=r();e(({element:p,refs:u})=>{if(oe.mq("max","desktop"))return;let{wrap:m,canvas:d,rangeValue:f,rotationButton:T}=u,b=cd({canvas:d,...r()}),{destroy:w,setRotation:x}=b;return Object.entries(s).forEach(([C,_])=>{let{method:W}=_;p.querySelector(`.${C}`).addEventListener("click",()=>b?.[W]())}),T.addEventListener("change",()=>{let C=T.value;x(C),f.textContent=C}),c.useFrame(()=>{m.classList.add("active")}),()=>{w()}});let{caterpillarN2:i}=ve(),{source:a}=i,l=se()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
...
`;var hd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=Z.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=Z.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=Z.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=Z.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Ne.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{l.stop(),s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var dd=({refs:e})=>{let t=Z.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var Ub=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},md=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:b,M_left:w,M_right:x,around:C}=i,{playIntro:_,playSvg:W,destroySvg:M}=hd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:b},{M_left:w},{M_right:x}],around:C}),{playText:k,destroyText:$}=dd({refs:a});return Ub({playText:k,playIntro:_,playSvg:W}),()=>{M(),$()}});let{home:o}=ve(),{source:s}=o;return e`<div>
    ...
    `};var Qb=E({name:"horizontal-scroller-button",component:vd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var Sd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var e0=E({name:"horizontal-scroller-section",component:Sd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Ks=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var wd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],b=[],w=Z.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",_="#fff",{activeRoute:W}=A.get(),{offscreen:M,offScreenCtx:k}=ze({useOffscreen:m,canvas:e}),$=m?k:x,U=yt($);$=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Zr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)})).sort(y=>y.hasFill?-1:1):T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)}));let B=Z.createStaggers({items:b,stagger:l}),K=B.map(({item:y,start:v,end:R})=>{let P=y.hasFill?1.1:1,V=Z.createSequencer({data:{scale:0}}).goTo({scale:P},{start:v,end:R,ease:"easeOutBack"}),G=V.subscribe(({scale:Q})=>{y.scale=Q});return w.add(V),{sequencer:V,unsubscribe:G}}),F=()=>{if(!x)return;m&&(M.width=e.width,M.height=e.height);let y=m?k:x;y.fillStyle="#1a1b26",y.fillRect(0,0,e.width,e.height),b.forEach(({x:v,y:R,centerX:P,centerY:V,width:G,height:Q,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Math.PI/180*Ie,Ge=Math.cos(Le)*ae,Je=Math.sin(Le)*ae;y.setTransform(Ge,Je,-Je,Ge,Math.round(P+Me),Math.round(V+De)),ed(y,Math.round(-P+v),Math.round(-V+R),G,Q,5),U?(y.beginPath(),y.roundRect(Math.round(-P+v),Math.round(-V+R),G,Q,5)):(y.beginPath(),y.rect(Math.round(-P+v),Math.round(-V+R),G,Q)),y.fillStyle=de?_:C,y.fill(),y.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:M,ctx:x})},L=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:w,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"lerp"});L.init();let J=()=>{F(),f&&c.useNextFrame(()=>J())};c.useFrame(({time:y})=>{J({time:y})});let ne=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(y=>{let{width:v,height:R,gutter:P,numberOfColumn:V}=y;y.offsetXCenter=pr({canvasWidth:e.width,width:v,gutter:P,numberOfColumn:V}),y.offsetYCenter=hr({canvasHeight:e.height,height:R,gutter:P,numberOfRow:r})}),c.useFrame(()=>F())}),j=D.watch("openNavigation",()=>{f=!1}),O=D.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:y}=A.get();y===W&&c.useFrame(()=>J())},500));return()=>{ne(),O(),j(),K.forEach(({sequencer:y,unsubscribe:v})=>{y.destroy(),v()}),K=[],w.destroy(),w=null,B=[],L.destroy(),L=null,x=null,M=null,k=null,T=[],b=[],f=!1}};var Td=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=wd({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ve(),{source:n}=s;return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
    ...
    `};var r0=E({name:"scroller-n0",component:Td,isolateOnMount:!0,isolateCreation:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[36,37,38,39,40,47,51,58,62,69,73,80,81,82,83,84],type:Array}),stagger:()=>({value:{type:"equal",each:6,from:"random"},type:"Any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||se())}});function o0({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function s0({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var xd=({canvas:e,canvasScroller:t,amountOfPath:r,width:o,height:s,radius:n,opacity:i,intialRotation:a,endRotation:l,disableOffcanvas:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:p}),d=!0,f=e.getContext(m,{alpha:!1}),T=[],{activeRoute:b}=A.get(),{offscreen:w,offScreenCtx:x}=ze({useOffscreen:u,canvas:e}),C=u?x:f,_=yt(C)&&!se();C=null,e.width=e.clientWidth,e.height=e.clientHeight,T=[...new Array(r).keys()].map((F,L)=>{let J=L>=r/2?r/2+(r/2-L):L;return{width:Math.floor(o0({width:o,relativeIndex:J,amountOfPath:r})),height:Math.floor(s0({height:s,relativeIndex:J,amountOfPath:r})),opacity:J*i,rotate:0,relativeIndex:J,index:L}});let W=Z.createScrollerTween({from:{rotate:0},to:{rotate:l},stagger:{each:5,from:"center"}});[...T].forEach(F=>{W.subscribeCache(F,({rotate:L})=>{F.rotate=L})});let M=()=>{if(!f)return;u&&(w.width=e.width,w.height=e.height);let F=u?x:f,L=e.width/2,J=e.height/2;F.fillStyle="#1a1b26",F.fillRect(0,0,e.width,e.height),T.forEach(({width:ne,height:j,opacity:O,rotate:y,index:v})=>{let R=T.length/2-v,P=1,V=Math.PI/180*(y-a),G=Math.cos(V)*P,Q=Math.sin(V)*P;F.setTransform(G,Q,-Q,G,L,J+R*19),_?(F.beginPath(),F.roundRect(-ne/2,-j/2+R*19,ne,j,150)):(F.beginPath(),F.rect(Number.parseInt(-ne/2),Number.parseInt(-j/2),ne,j,n)),F.strokeStyle=`rgba(255, 255, 255, ${O})`,F.fillStyle=`rgba(26, 27, 38, ${O})`,F.stroke(),F.fill(),F.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:w,ctx:f})},k=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:W,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"spring"});k.init();let $=({time:F=0})=>{M({time:F}),d&&c.useNextFrame(({time:L})=>$({time:L}))};c.useFrame(({time:F})=>{$({time:F})});let U=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,c.useFrame(()=>{M()})}),B=D.watch("openNavigation",()=>{d=!1}),K=D.watch("closeNavigation",()=>{setTimeout(()=>{d=!0;let{activeRoute:F}=A.get();F===b&&c.useFrame(({time:L})=>$({time:L}))},500)});return()=>{W.destroy(),U(),K(),B(),W.destroy(),W=null,k.destroy(),k=null,f=null,w=null,x=null,W=null,T=[],d=!1}};var Cd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(oe.mq("max","desktop"))return;let{wrap:l,canvas:p,canvasScroller:u}=a,m=xd({canvas:p,canvasScroller:u,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{m()}});let{scrollerN1:s}=ve(),{source:n}=s,i=se()?"c-canvas__wrap--wrapped":"";return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
            <div class="c-canvas c-canvas--fixed ">
                <code-button
    ...
    `};var u0=E({name:"dynamic-list",component:Rd,state:{counter:()=>({value:0,type:Number}),data:()=>({value:Zs,type:Array}),activeSample:()=>({value:3,type:Number})}});function Qr(e,t){return`${e}: ${t}`}var Pd=async({getState:e,html:t,onMount:r,key:o,staticProps:s,bindProps:n,watch:i,id:a})=>{let{isFull:l,parentListId:p,index:u,label:m,counter:d}=e();return r(({element:T,refs:b})=>{let{indexEl:w,labelEl:x,counterEl:C}=b;T.addEventListener("click",()=>{T.classList.toggle("is-selected")}),i("index",_=>{w.textContent=Qr("index",_)}),i("label",_=>{x.textContent=Qr("label",_)}),i("counter",_=>{C.textContent=Qr("counter",_)}),c.useFrame(()=>{T.classList.add("active")})}),t`
    ...
    `};var h0=E({name:"dynamic-list-slot",component:_d,exportState:["staticFromSlot","staticFromComponent","parentParentState","parentState"],state:{staticFromSlot:()=>({value:"",type:"any"}),staticFromComponent:()=>({value:"",type:"any"}),parentParentState:()=>({value:"",type:"any"}),parentState:()=>({value:"",type:"any"})}});var Od=async({html:e})=>e`<div class="dynamic-list-empty">
        <p>empty comp</p>
        <mobjs-slot name="empty-slot"></mobjs-slot>
    </div>`;var d0=E({name:"dynamic-list-empty",component:Od});var Nd=async({watch:e,onMount:t,html:r,getState:o})=>{let{parentListId:s,counter:n}=o();return t(({refs:i})=>{let{counterValueEl:a}=i;e("counter",l=>{a.textContent=l})}),r`<div class="dynamic-counter">
    ...
    </div>`};var m0=E({name:"dynamic-list-counter",component:Nd,exportState:["counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});var Md=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button" class="dynamic-list-button">${s}</button>
    `};var f0=E({name:"dynamic-list-button",component:Md,exportState:["active","label"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});function g0({sync:e,staticProps:t,bindProps:r,listId:o,delegateEvents:s}){return g`
        <dynamic-list-card
            ${t({parentListId:o})}
    ...
    `;var C0=()=>g`<div class="l-padding">
    ...
    </div>`;var L0=()=>g`<div class="l-index">
        <home-component></home-component>
    </div>`;var F0=async()=>{let{success:e,data:t}=await I({source:"./data/about.json"});return e?g`<doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var D0=()=>g` <doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`;var V0=()=>g`<div>
        <horizontal-scroller></horizontal-scroller>
    </div>`;var $0=()=>g`<div>
        <horizontal-scroller
            ${S({animatePin:!0})}
        ></horizontal-scroller>
    </div>`;var W0=async()=>{let{success:e,data:t}=await I({source:"./data/canvas/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var B0=()=>g`<div>
        ...
        ></scroller-n0>
    </div>`;var q0=()=>g`<div class="l-padding">
        <caterpillar-n3></caterpillar-n3>
    </div>`;var G0=()=>g` <dynamic-list> </dynamic-list> `;var J0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Y0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/initialization.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var X0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/routing.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var K0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/component.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Z0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/html.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Q0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/onMount.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/setState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emit.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emitAsync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/computed.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watch.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchSync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/remove.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/removeDom.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getChildren.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var uy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/freezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var py=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unFreezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var hy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getParentId.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var my=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/staticProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var gy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unBind.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var by=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/syncParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var yy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/delegateEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/repeat.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var wy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/refs.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/slot.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var xy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/utils.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/webComponent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/debug.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/runtime.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ky=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/instanceName.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Py=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/events.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/store.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var _y=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/asyncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/createStagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var My=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/parallax.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/scrollTrigger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/sequencer.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/stagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var $y=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/syncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Wy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/tweenSpringLerp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var By=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Defaults</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var jy=async()=>{let{success:e,data:t}=await I({source:"./data/svg/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var zy=async()=>{let{success:e,data:t}=await Us({source:"./asset/svg/child.svg"});return e?g`<div>
