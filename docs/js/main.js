...
Loading snippet ...</pre
    ...
    </div>`};var Lg=E({name:"mob-snippet",component:gh,exportState:["source","isFull","hasOverflow","hasBorder","numLines"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number})}});function Fg({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var bh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${Fg({id:s,label:n})}
        class="spacer spacer--${r} ${i}"
    ></div>`};var Dg=E({name:"mob-spacer",component:bh,exportState:["style","line","id","label"],state:{style:()=>({value:"medium",type:String,validate:e=>["small","medium","big"].includes(e),strict:!0}),line:()=>({value:!1,type:Boolean}),id:()=>({value:"",type:String}),label:()=>({value:"",type:String})}});var Vg=g`
    <div class="only-desktop">
        <h3>This content is available only on desktop</h3>
        <h4>Need page reload on a screen size up to 1024px</h4>
    </div>
`,yh=({element:e})=>{e.textContent="",!oe.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Vg))},vh=({html:e,onMount:t})=>(t(({element:r})=>{yh({element:r}),c.useResize(()=>{yh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var $g=E({name:"only-desktop",component:vh,state:{}});var Sh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=re.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
        <div class="c-loader ${n}">
            <span class="c-loader__inner"></span>
        </div>
    `};var Wg=E({name:"mob-loader",component:Sh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var Bg=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},wh=({html:e,onMount:t})=>(t(({element:r})=>{if(oe.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{Bg({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var jg=E({name:"doc-scroll",component:wh});var Th=({html:e,delegateEvents:t})=>e`
        <div
            class="c-doc-top"
            ${t({click:()=>At.to(0,{duration:2e3})})}
        ></div>
    `;var zg=E({name:"doc-top",component:Th});function Hg({targets:e,delegateEvents:t,syncParent:r,staticProps:o,setState:s,bindProps:n}){return e.map((i,a)=>{let{label:l,scroll:p}=i.dataset;return g`<li>
                <scroll-to-button
    ...
    `;var rb=E({name:"footer-nav",component:_h}),ob=E({name:"footer-nav-button",component:Ah,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function sb({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function nb({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function ib(){let e=qe("page-transition");_e(e,"url","#home"),D.set("navigationIsOpen",!1),D.emit("closeNavigation"),D.emit("closeAllAccordion"),D.emit("goToTop")}var Oh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return D.watch("openNavigation",()=>sb({navInfo:s})),D.watch("closeNavigation",()=>nb({navInfo:s})),L.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Mh={},Lh={},Ys=()=>Mh,ve=()=>Lh,Fh=async()=>{Mh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Lh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Dh={github:Nh},lb=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=qe("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=D.get();s&&(D.set("navigationIsOpen",!1),D.emit("closeNavigation"))};function cb({delegateEvents:e}){let{header:t}=Ys(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
    ...
    `;var ub=()=>{let{navigationIsOpen:e}=D.get("navigationIsOpen");if(D.set("navigationIsOpen",t=>!t),e){D.emit("closeNavigation");return}D.emit("openNavigation")},$h=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{D.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),D.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `};var vb=E({name:"mob-navigation-container",component:Bh,isolateOnMount:!0,isolateCreation:!0}),Sb=E({name:"mob-navigation",component:jh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),wb=E({name:"mob-navigation-submenu",component:Uh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),Tb=E({name:"mob-navigation-button",type:"button",component:zh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),xb=E({name:"mob-navigation-label",component:Hh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var qh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var Cb=E({name:"doc-container",component:qh});var Gh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var Ib=E({name:"doc-title",component:Gh,state:{}});var Jh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Eb=E({name:"doc-title-small",component:Jh,state:{}});var Yh=`<?xml version="1.0" encoding="UTF-8"?>
...
`;var pd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=re.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=re.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=re.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=re.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Be.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Be.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var hd=({refs:e})=>{let t=re.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var zb=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},dd=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:b,M_left:w,M_right:x,around:C}=i,{playIntro:A,playSvg:W,destroySvg:N}=pd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:b},{M_left:w},{M_right:x}],around:C}),{playText:k,destroyText:$}=hd({refs:a});return zb({playText:k,playIntro:A,playSvg:W}),()=>{N(),$()}});let{home:o}=ve(),{source:s}=o;return e`<div>
    ...
    `};var Kb=E({name:"horizontal-scroller-button",component:yd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var vd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var Zb=E({name:"horizontal-scroller-section",component:vd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Xs=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Sd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],b=[],w=re.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",A="#fff",{activeRoute:W}=L.get(),{offscreen:N,offScreenCtx:k}=ze({useOffscreen:m,canvas:e}),$=m?k:x,U=yt($);$=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Zr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)})).sort(y=>y.hasFill?-1:1):T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)}));let B=re.createStaggers({items:b,stagger:l}),K=B.map(({item:y,start:v,end:R})=>{let P=y.hasFill?1.1:1,V=re.createSequencer({data:{scale:0}}).goTo({scale:P},{start:v,end:R,ease:"easeOutBack"}),G=V.subscribe(({scale:Z})=>{y.scale=Z});return w.add(V),{sequencer:V,unsubscribe:G}}),F=()=>{if(!x)return;m&&(N.width=e.width,N.height=e.height);let y=m?k:x;y.fillStyle="#1a1b26",y.fillRect(0,0,e.width,e.height),b.forEach(({x:v,y:R,centerX:P,centerY:V,width:G,height:Z,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Ne,offsetYCenter:Fe})=>{let Me=Math.PI/180*Ie,Ge=Math.cos(Me)*ae,Je=Math.sin(Me)*ae;y.setTransform(Ge,Je,-Je,Ge,Math.round(P+Ne),Math.round(V+Fe)),Qh(y,Math.round(-P+v),Math.round(-V+R),G,Z,5),U?(y.beginPath(),y.roundRect(Math.round(-P+v),Math.round(-V+R),G,Z,5)):(y.beginPath(),y.rect(Math.round(-P+v),Math.round(-V+R),G,Z)),y.fillStyle=de?A:C,y.fill(),y.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:N,ctx:x})},M=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:w,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"lerp"});M.init();let J=()=>{F(),f&&c.useNextFrame(()=>J())};c.useFrame(({time:y})=>{J({time:y})});let ne=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(y=>{let{width:v,height:R,gutter:P,numberOfColumn:V}=y;y.offsetXCenter=pr({canvasWidth:e.width,width:v,gutter:P,numberOfColumn:V}),y.offsetYCenter=hr({canvasHeight:e.height,height:R,gutter:P,numberOfRow:r})}),c.useFrame(()=>F())}),j=D.watch("openNavigation",()=>{f=!1}),_=D.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:y}=L.get();y===W&&c.useFrame(()=>J())},500));return()=>{ne(),_(),j(),K.forEach(({sequencer:y,unsubscribe:v})=>{y.destroy(),v()}),K=[],w.destroy(),w=null,B=[],M.destroy(),M=null,x=null,N=null,k=null,T=[],b=[],f=!1}};var wd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=Sd({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ve(),{source:n}=s;return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
    ...
    `};var o0=E({name:"caterpillar-n3",component:xd,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","opacity","intialRotation","endRotation","disableOffcanvas"],state:{amountOfPath:17,width:15,height:40,radius:0,opacity:.05,intialRotation:33,endRotation:720,disableOffcanvas:!!(Re()||se())}});var Ks=[{key:"a",label:"A"},{key:"b",label:"B"},{key:"c",label:"C"},{key:"d",label:"D"}],Cd=[{key:"f",label:"F"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"c",label:"C"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"d",label:"D"},{key:"b",label:"B"}],Id=[{key:"m",label:"M"},{key:"q",label:"Q"},{key:"z",label:"Z"},{key:"i",label:"I"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"n",label:"N"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"l",label:"L"},{key:"j",label:"J"},{key:"d",label:"D"}],Ed=[{key:"h",label:"H"},{key:"f",label:"F"},{key:"a",label:"A"},{key:"d",label:"D"}];var s0=[{buttonLabel:"sample1",data:Cd},{buttonLabel:"salmple2",data:Id},{buttonLabel:"sample3",data:Ed},{buttonLabel:"Initial",data:Ks}],n0=[{label:"dynamic list with key",key:"key",clean:!1},{label:"dynamic list without key",key:"",clean:!1},{label:"dynamic list clear",key:"",clean:!0}];function i0({setState:e,staticProps:t,delegateEvents:r,bindProps:o}){return s0.map((s,n)=>{let{data:i,buttonLabel:a}=s;return g`
                <dynamic-list-button
                    ${t({label:a})}
    ...
    `};var u0=E({name:"dynamic-list-slot",component:Ad,exportState:["staticFromSlot","staticFromComponent","parentParentState","parentState"],state:{staticFromSlot:()=>({value:"",type:"any"}),staticFromComponent:()=>({value:"",type:"any"}),parentParentState:()=>({value:"",type:"any"}),parentState:()=>({value:"",type:"any"})}});var _d=async({html:e})=>e`<div class="dynamic-list-empty">
        <p>empty comp</p>
        <mobjs-slot name="empty-slot"></mobjs-slot>
    </div>`;var p0=E({name:"dynamic-list-empty",component:_d});var Od=async({watch:e,onMount:t,html:r,getState:o})=>{let{parentListId:s,counter:n}=o();return t(({refs:i})=>{let{counterValueEl:a}=i;e("counter",l=>{a.textContent=l})}),r`<div class="dynamic-counter">
    ...
    </div>`};var h0=E({name:"dynamic-list-counter",component:Od,exportState:["counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});var Nd=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button" class="dynamic-list-button">${s}</button>
    `};var d0=E({name:"dynamic-list-button",component:Nd,exportState:["active","label"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});function m0({sync:e,staticProps:t,bindProps:r,listId:o,delegateEvents:s}){return g`
        <dynamic-list-card
            ${t({parentListId:o})}
    ...
    `;var S0=()=>g`<div class="l-padding">
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/plugin.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Plugin</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var Vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
