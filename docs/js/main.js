(() => {
  ...
  var SimpleStore = class {
    ...
    watch(prop, callback2 = () => {
      ...
      const id2 = getUnivoqueId();
      this.callBackWatcher.set(id2, { fn: callback2, prop });
      return () => this.callBackWatcher.delete(id2);
    }
    /**
     * @description
  ...
  function handleMouse(event) {
    ...
    const addCb6 = (cb) => {
      const id2 = getUnivoqueId();
      callbacks9.set(id2, cb);
      if (typeof window !== "undefined") {
        init7();
      }
      return () => callbacks9.delete(id2);
    };
    return addCb6;
  }
  ...
  var update = ({ id: id2, callBackObject, frame }) => {
    if (!subscriber[id2])
      return;
  ...
  var addCb = (cb) => {
    const id2 = getUnivoqueId();
    callbacks2.set(id2, cb);
    if (typeof window !== "undefined") {
      init2();
    }
    return () => callbacks2.delete(id2);
  };
  ...
  var indexCallbackObject = {};
  var amountOfFrameToFire = 0;
  var updateKeys = (currentFrameLimit2) => {
    Object.keys(indexCallbackObject).forEach((key) => {
      delete Object.assign(indexCallbackObject, {
        [`${Number.parseInt(key) - currentFrameLimit2}`]: indexCallbackObject[key]
      })[key];
    });
  };
  var fire3 = ({ currentFrame: currentFrame2, time: time2, fps: fps2, shouldRender: shouldRender2 }) => {
    const indexCallbackArray = indexCallbackObject[currentFrame2];
    if (!indexCallbackArray)
      return;
    indexCallbackArray.forEach((item) => item({ time: time2, fps: fps2, shouldRender: shouldRender2 }));
    indexCallbackObject[currentFrame2] = null;
    delete indexCallbackObject[currentFrame2];
  ...
  var add4 = (callback2, index) => {
    ...
    if (indexCallbackObject[frameIndex]) {
      indexCallbackObject[frameIndex].push(callback2);
    } else {
      indexCallbackObject[frameIndex] = [callback2];
      amountOfFrameToFire++;
    }
  ...
  var addCb2 = (cb) => {
    const id2 = getUnivoqueId();
    callbacks5.set(id2, cb);
    if (typeof window !== "undefined") {
      init3();
    }
    return () => callbacks5.delete(id2);
  };
  ...
  var addCb3 = (cb) => {
    const id2 = getUnivoqueId();
    callbacks6.set(id2, cb);
    if (typeof window !== "undefined") {
      init4();
    }
    return () => callbacks6.delete(id2);
  };
  ...
  var addCb4 = (cb) => {
    const id2 = getUnivoqueId();
    callbacks7.set(id2, cb);
    if (typeof window !== "undefined") {
      init5();
    }
    return () => callbacks7.delete(id2);
  };
  ...
  var addCb5 = (cb) => {
    const id2 = getUnivoqueId();
    callbacks8.set(id2, cb);
    if (typeof window !== "undefined") {
      init6();
    }
    return () => callbacks8.delete(id2);
  };
  ...
  var setElementById = ({
    ...
    if (!item)
      return;
    componentMap.set(id2, { ...item, element: newElement });
  };
  var getElementById = ({ id: id2 = "" }) => {
    if (!id2 || id2 === "")
      return;
    const item = componentMap.get(id2);
  ...
  // src/js/mobjs/mainStore/actions/root.js
  ...
  var setDelegateBindEvent = (eventsData = []) => {
    ...
    tempDelegateEventMap.set(id2, eventsDataParsed);
    return id2;
  };
  ...
  var applyDelegationBindEvent = (root) => {
    ...
    eventToAdd.forEach((eventKey) => {
      if (eventRegistered.includes(eventKey))
        return;
  ...
  var setStaticProps = (props = {}) => {
    const id2 = mobCore.getUnivoqueId();
    staticPropsMap.set(id2, props);
    return id2;
  };
  var getPropsFromParent = (id2 = "") => {
    const props = staticPropsMap.get(id2);
    staticPropsMap.delete(id2);
    return props ?? {};
  };
  ...
  var setBindEvents = (eventsData = []) => {
    const eventsDataParsed = checkType(Object, eventsData) ? [eventsData] : eventsData;
    const id2 = mobCore.getUnivoqueId();
    bindEventMap.set(id2, eventsDataParsed);
    return id2;
  };
  ...
  var updateChildrenArray = ({
    ...
    currentChild[componentName] = [...arr, id2];
    return currentChild;
  };
  ...
  var addSelfToParentComponent = ({ id: id2 = "" }) => {
    if (!id2 || id2 === "")
      return;
    const item = componentMap.get(id2);
    const parentId = item?.parentId;
  ...
  var addSelfIdToFutureComponent = ({ element, id: id2 }) => {
    const children = queryAllFutureComponent(element, false);
    children.forEach((child) => {
      child.setParentId(id2);
    });
  };

  // src/js/mobjs/componentStore/action/props.js
  var setDynamicPropsWatch = ({ id: id2 = "", unWatchArray = [] }) => {
    const item = componentMap.get(id2);
    if (!item)
      return;
  ...
  var freezePropById = ({ id: id2 = "", prop }) => {
    if (!id2 || id2 === "")
      return;
    const item = componentMap.get(id2);
    if (!item)
  ...
  var unFreezePropById = ({ id: id2 = "", prop }) => {
    if (!id2 || id2 === "")
      return;
    const item = componentMap.get(id2);
    if (!item)
  ...
  var getFreezePropStatus = ({ id: id2 = "", prop }) => {
    if (!id2 || id2 === "")
      return false;
    const item = componentMap.get(id2);
  ...
  var setStateById = (id2 = "", prop = "", value, fire4 = true) => {
    if ((!id2 || id2 === "") && (!prop || prop === "") && !value)
      return;
    const isFreezed = getFreezePropStatus({ id: id2, prop });
    if (isFreezed) {
      return;
    }
    const item = componentMap.get(id2);
  ...
  var watchById = (id2 = "", prop = "", cb = () => {
  }) => {
    if ((!id2 || id2 === "") && (!prop || prop === ""))
      return;
    const item = componentMap.get(id2);
    const state = item?.state;
  ...
  var setBindProps = (propsObj) => {
    ...
    const id2 = mobCore.getUnivoqueId();
    dynamicPropsMap.set(id2, { ...propsObj, componentId: "", propsId: id2 });
    return id2;
  };
  var setDynamicProp = ({
    componentId,
  ...
  var getRepeaterComponentTarget = ({ id: id2 }) => {
    const item = repeaterTargetComponentMap.get(id2);
    if (!item)
      return;
    return item?.targetComponent;
  };
  var removeRepeaterComponentTargetByParentId = ({ id: id2 }) => {
    for (const [key, value] of repeaterTargetComponentMap) {
      const { repeaterParentId } = value;
      if (repeaterParentId === id2) {
  ...
  var removeAndDestroyById = ({ id: id2 = "" }) => {
    if (!id2 || id2 === "")
      return;
    ...
    const parentInstance = instances.find(({ child: child2 }) => {
      const parentComponentArray = child2?.[componentName] ?? [];
      return parentComponentArray.includes(id2);
    });
  ...
  var removeCancellableComponent = () => {
    ...
    cancellableComponents2.forEach(({ id: id2 }) => removeAndDestroyById({ id: id2 }));
  };
  var removeOrphanComponent = () => {
    ...
    orphans.forEach(({ id: id2 }) => removeAndDestroyById({ id: id2 }));
  ...
  var setDestroyCallback = ({ cb = () => {
    ...
    if (!item)
      return;
    componentMap.set(id2, { ...item, destroy: cb });
  };
  ...
  function selectAll4(root, slotName) {
    for (const node of walkPreOrder(root)) {
  ...
  var getNewElement = ({ componentParsed, content: content2 }) => {
    if (componentParsed.parentNode) {
      componentParsed.insertAdjacentHTML("afterend", content2);
      return (
        /** @type {HTMLElement} */
        componentParsed.nextElementSibling
      );
    }
    return;
  };
  ...
  var addToSlot = ({ element }) => {
    ...
    const slots = [...componentWithSlot].map((component) => {
      ...
      if (!slot)
        return { slot: null, elementMoved: null };
  ...
  var executeConversion = ({ componentParsed, content: content2 }) => {
    const prevContent = componentParsed.innerHTML;
    const newElement = getNewElement({ componentParsed, content: content2 });
    if (newElement) {
      const id2 = componentParsed.getId();
      ...
      if (debug)
        newElement.setAttribute(ATTR_IS_COMPONENT, id2 ?? "");
    }
      ...
      customElements.define(
        ...
        class extends HTMLElement {
          ...
          constructor() {
            ...
            this.#isChildOfRepeatId = host.getAttribute(ATTR_CHILD_REPEATID);
            ...
            if (this.#isChildOfRepeatId && this.#isChildOfRepeatId !== "") {
          ...
          disconnectedCallback() {
            if (!this.shadowRoot || !this.active)
              return;
  ...
  // src/js/mobjs/mainStore/actions/componentList.js
  ...
  var addOnMoutCallback = ({ id: id2, cb = () => {
  } }) => {
    onMountCallbackMap.set(id2, cb);
  };
  var fireOnMountCallBack = async ({ id: id2, element, refsCollection }) => {
    const callback2 = onMountCallbackMap.get(id2);
    const destroyCallback = await callback2?.({
      element,
      refs: parseRefs(refsCollection)
    });
    setDestroyCallback({ cb: destroyCallback, id: id2 });
    onMountCallbackMap.delete(id2);
  };
  ...
  function selectAll6(root, repeatId) {
    for (const node of walkPreOrder(root)) {
  ...
  var querySecificRepeater = (node, repeatId) => {
    const root = node || document.body;
    for (const child of root.children) {
      const result = selectAll6(child, repeatId);
      if (result)
        return result;
    }
    return null;
  ...
  var addActiveRepeat = ({ id: id2, state, container }) => {
    activeRepeatMap.add({ id: id2, state, container });
  };
  var removeActiveRepeat = ({ id: id2, state, container }) => {
    activeRepeatMap.forEach((repeat) => {
      if (id2 === repeat.id && state === repeat.state && container === repeat.container) {
        activeRepeatMap.delete(repeat);
      }
    });
  };
  var getActiveRepeater = ({ id: id2 = "", state = "", container }) => {
    const repeatIsActive = [...activeRepeatMap].some((repeat) => {
      return id2 === repeat.id && state === repeat.state && container === repeat.container;
    });
    return repeatIsActive;
  };

  // src/js/mobjs/componentStore/action/children.js
  var getChildrenIdByName = ({ id: id2 = "", component = "" }) => {
    if (!id2 || id2 === "")
      return [];
    const item = componentMap.get(id2);
    const child = item?.child;
  ...
  var updateChildrenOrder = ({ id: id2, component, filterBy = [] }) => {
    const element = getElementById({ id: id2 });
    if (!element)
      return;
    const components = getChildrenIdByName({ id: id2, component });
    const componentsIdFiltered = components.map((id3) => {
      return { id: id3, element: getElementById({ id: id3 }) };
  ...
  // src/js/mobjs/updateList/utils.js
  ...
  var getChildrenInsideElement = ({
    ...
    if (!children || !element)
      return [];
    return [...children].filter((id2) => {
      const child = getElementById({ id: id2 }) ?? null;
  ...
  // src/js/mobjs/updateList/addWithKey.js
  ...
  function getPartialsComponentList({
    ...
    ${ATTR_CHILD_REPEATID}="${repeatId}" ${ATTR_PARENT_ID}="${id2}"`
    );
    return render2({
      sync,
  ...
  var addWithKey = ({
    ...
    if (!chunkedElementToAdd?.[0].length)
      chunkedElementToAdd.shift();
    ...
    elementToRemoveByKey.forEach((component) => {
      const id3 = getIdByElement({ element: component });
      if (!id3)
        return;
      removeAndDestroyById({ id: id3 });
    });
    return currentUnique;
  };

  // src/js/mobjs/updateList/addWithoutKey.js
  var addWithoutKey = ({
    current = [],
    previous = [],
    containerList = document.createElement("div"),
  ...
  var watchList = ({
    ...
    const mainComponent = getElementById({ id: id2 });
    ...
    watch(
      ...
      async (current, previous) => {
        ...
        [...childrenFiltered].forEach((id3, index) => {
  ...
  var inizializeRepeat = ({ repeatId, placeholderListObj }) => {
    if (!repeatId || !placeholderListObj || placeholderListObj.length === 0)
      return;
    const obj = repeatMap.get(repeatId);
    if (!obj)
      return;
    const containerList = placeholderListObj.find(({ id: id2 }) => {
      return id2 === repeatId;
    });
  ...
  // src/js/mobjs/componentStore/registerComponent.js
  ...
  // src/js/mobjs/creationStep/getComponentData.js
  ...
  var registerComponent = ({
    ...
    setParentsComponent({ componentId: id2 });
    ...
    return {
      ...
      repeatId,
      getChildren,
      watchSync: (state4, callback2) => {
        const unsubscribe3 = watch(state4, callback2);
        emit(state4);
        return unsubscribe3;
      },
      freezeProp: (prop) => freezePropById({ id: id2, prop }),
      unFreezeProp: (prop) => unFreezePropById({ id: id2, prop }),
      unBind: () => unBind({ id: id2 }),
      bindProps: (obj) => {
        return `${ATTR_DYNAMIC}="${setBindProps({
          ...obj,
          parentId: obj?.forceParent ? void 0 : id2
        })}" `;
      },
      staticProps: (obj) => ` ${ATTR_PROPS}="${setStaticProps(obj)}" `,
      syncParent: ` ${ATTR_PARENT_ID}="${id2}" `,
      remove: () => {
      ...
      getParentId: () => getParentIdById(id2),
      watchParent: (prop, cb) => {
        const unsubscribeParent = watchById(getParentIdById(id2), prop, cb);
        setDynamicPropsWatch({ id: id2, unWatchArray: [unsubscribeParent] });
      },
      html: (strings, ...values) => {
        return {
          id: id2,
      ...
      onMount: (cb) => addOnMoutCallback({ id: id2, cb }),
  ...
  var queryGenericRepeater = (node) => {
    ...
    const root = node || document.body;
    for (const child of root.children) {
      result = [...result, ...selectAll7(child)];
    }
    return result;
  };
  ...
  var parseComponentsRecursive = async ({
    ...
    const { content: content2, componentParsed, id: id2 } = await userFunctionComponent(
      componentData
    );
    ...
    addSelfIdToFutureComponent({ element: newElement, id: id2 });
    if (!newElement) {
      const activeParser = decrementParserCounter();
      if (!activeParser) {
      }
    ...
    setElementById({ id: id2, newElement });
    ...
    functionToFireAtTheEnd.push({
      ...
      fireDynamic: () => {
        applyDynamicProps({ componentId: id2, inizilizeWatcher: true });
      },
  ...
  var parseComponents = async ({ element, isCancellable = true }) => {
  ...
  var parseDom = async (element) => {
    await parseComponents({
      element
    });
  };

  // src/js/mobjs/mainStore/actions/routeList.js
  ...
  var sequencerRangeValidate = ({ start, end }) => {
    ...
    if (!startIsValid)
      sequencerRangeStartWarning(start);
    if (!endIsValid)
      sequencerRangeEndWarning(end);
    return startIsValid && endIsValid;
  };
  var durationIsValid = (duration2) => {
    const isValid = mobCore.checkType(Number, duration2);
    if (!isValid && duration2 !== void 0 && duration2 !== null)
      durationWarining(duration2);
  ...
  var initialDataPropValidate = (prop, value) => {
    ...
    if (!propIsValid)
      initialDataPropWarining(prop);
    if (!valueIsValid)
      initialDataValueWarining(value);
  ...
  var validateStaggerFrom = (from) => {
    ...
    if (!fromIsValid)
      staggerFromGenericWarning(from);
    return fromIsValid;
  };
  ...
  var relativeIsValid = (val2, tweenType) => {
    ...
    if (!isValid && val2 !== void 0 && val2 !== null)
      relativeWarining(val2, tweenType);
  ...
  var springConfigIsValidAndGetNew = (config) => {
    ...
    if (!isInConfig && config !== void 0 && config !== null)
  ...
  var springConfigIsValid = (config) => {
    ...
    if (!isValid && config !== void 0 && config !== null)
      springPresetWarning(config);
    return isValid;
  };
  var springConfigPropIsValid = (obj) => {
    ...
    if (!isValid && obj !== void 0 && obj !== null)
  ...
  var durationIsNumberOrFunctionIsValid = (duration2) => {
    ...
    if (!isValid && duration2 !== void 0 && duration2 !== null)
      durationNumberOrFunctionWarining(duration2);
  ...
  var domNodeIsValidAndReturnElOrWin = (element, returnWindow = false) => {
    ...
    const isValid = realEl && realEl !== void 0 && realEl !== null;
    if (returnWindow) {
  ...
  var directionIsValid = (direction2, component) => {
    ...
    if (!isValid && direction2 !== void 0 && direction2 !== null)
      parallaxDirectionWarining(direction2, component);
  ...
  var parallaxDynamicValueIsValid = (obj, label) => {
    ...
    if (!isValid)
      parallaxDynmicValueWarining(label);
  ...
  var parallaxTypeIsValid = (value) => {
    ...
    if (!isValid && valueParsed !== void 0 && valueParsed !== null)
  ...
  var breakpointIsValid = (mq2, label, component) => {
    ...
    if (!isValid && mq2 !== void 0 && mq2 !== null)
      breakpointWarning(mq2, choice, label, component);
  ...
  var breakpointTypeIsValid = (type, label, component) => {
    ...
    if (!isValid && type !== void 0 && type !== null)
  ...
  var parallaxPropiertiesIsValid = (value, type, tweenIsParallaxTween, tweenIsSequencer) => {
    ...
    if (notParallaxTweenInsideParallax)
  ...
  var parallaxEaseTypeIsValid = (value, isSequencer, isScrollTtrigger) => {
    ...
    const fallback = sequencerUseSpringInsideScrolltrigger ? parallaxConstant.EASE_LERP : fallbackIfIsValid;
  ...
  var getRandomChoice = (arr, each, index) => {
  ...
  var getItemsByRow = (arr, stagger, chunckSizeCol) => {
  ...
  var setCallBack = (currentCallback, arrayOfCallback) => {
    const { id: id2 } = callBackStore.get();
    const arrayOfCallbackUpdated = [
      ...arrayOfCallback,
      { cb: currentCallback, id: id2, index: -1, frame: -1 }
    ];
    const prevId = id2;
    callBackStore.quickSetProp("id", id2 + 1);
    return {
      arrayOfCallbackUpdated,
      unsubscribeCb: (arrayOfCallback2) => arrayOfCallback2.map(({ id: id3, cb, index, frame }) => {
        if (id3 === prevId)
          cb = () => {
          };
        return { id: id3, cb, index, frame };
      })
    };
  };
  var setCallBackCache = (item, currentCallback, arrayOfCallback, unsubscribeCacheArray) => {
    ...
    const arrayOfCallbackUpdated = [
      ...arrayOfCallback,
      { cb: cacheId, id: id2, index: -1, frame: -1 }
    ];
    ...
    return {
      ...
      unsubscribeCb: (arrayOfCallback2) => {
        unsubscribe3();
        return arrayOfCallback2.map(({ id: id3, cb, index, frame }) => {
          if (id3 === prevId)
            cb = -1;
          return { id: id3, cb, index, frame };
        });
    ...
    draw(_time, fps2, res = () => {
      ...
      this.values.forEach((item) => {
        ...
        item.currentValue = lerp(
          item.currentValue,
          item.toValue,
          this.velocity / fps2 * 60
        );
        item.currentValue = getRoundedValue(item.currentValue);
        item.settled = Number(Math.abs(item.toValue - item.currentValue).toFixed(4)) <= this.precision;
        if (item.settled) {
          item.currentValue = item.toValue;
        }
      });
  ...
  var SmoothScroller = class {
    ...
    onWhell({ target, spinY, preventDefault }) {
      ...
      if (!mq[this.queryType](this.breakpoint) || bodyIsOverflow)
        return;
      if (target === this.scroller || isDescendant(this.scroller, target)) {
        this.dragEnable = false;
        preventDefault();
  ...
  var ParallaxPin = class {
    ...
    init({ instance }) {
      ...
      this.collisionTranslateProp = this.orientation === parallaxConstant.DIRECTION_VERTICAL ? "Y" : "X";
      this.collisionStyleProp = this.orientation === parallaxConstant.DIRECTION_VERTICAL ? "top" : "left";
    ...
    setUpMotion() {
      ...
      this.unsubscribeSpring = this.spring.subscribe(
        ({ collision, verticalGap }) => {
          if (this.orientation === parallaxConstant.DIRECTION_VERTICAL && this.pin) {
    ...
    createPin() {
      ...
      if (parentNode)
        parentNode.insertBefore(wrapper2, this.item);
      ...
      const wrapperStyle = (() => {
        ...
        if (this.orientation === parallaxConstant.DIRECTION_VERTICAL) {
          return this.invertSide ? { borderBottom: borderStyle } : { borderTop: borderStyle };
        } else {
          return this.invertSide ? { borderRight: borderStyle } : { borderLeft: borderStyle };
        }
      })();
    ...
    refreshCollisionPoint() {
      ...
      if (this.screen !== window) {
        this.start -= this.parallaxInstance.direction === parallaxConstant.DIRECTION_VERTICAL ? position(this.screen).top : position(this.screen).left;
      }
    ...
    getGap() {
      if (!this.wrapper)
        return 0;
      return this.orientation === parallaxConstant.DIRECTION_VERTICAL ? position(this.wrapper).top - this.startFromTop : position(this.wrapper).left - this.startFromTop;
    }
    /**
     * @returns {void}
     */
    ...
    tween(gap) {
      const cb = () => {
        if (!this.pin || !this.collisionStyleProp)
          return;
    ...
    setFixedPosition() {
      if (!this.pin)
        return;
      const left = this.orientation === parallaxConstant.DIRECTION_VERTICAL ? position(this.pin).left : position(this.pin).top;
      const style = this.orientation === parallaxConstant.DIRECTION_VERTICAL ? "left" : "top";
      const cb = () => {
        if (!this.pin)
          return;
    ...
    deactivateTrasponder() {
      if (!this.shoulTranspond || !this.item || !this.wrapper)
        return;
      const cb = () => {
        if (!this.pin)
          return;
     ...
     */
    onScroll(scrollTop) {
      if (!this.isInizialized || !this.wrapper)
        return;
      ...
      const offsetTop = this.orientation === parallaxConstant.DIRECTION_VERTICAL ? position(this.wrapper).top : position(this.wrapper).left;
  ...
  var ParallaxClass = class {
    ...
    constructor(data3) {
      ...
      this.motion = (() => {
        ...
        return this.easeType === parallaxConstant.EASE_SPRING ? new HandleSpring() : new HandleLerp();
      })();
    }
    /**
     * @description
    ...
    move({ value, parentIsMoving = false }) {
      if (!mq[this.queryType](this.breakpoint) || !value)
        return;
    ...
    getScrollValueOnMove(value) {
      if (value === void 0)
        return;
      if (this.screen !== window)
        return value + this.screenPosition;
      return value;
    }
    /**
     * @description
    ...
    getFixedValue() {
      ...
      if (!this.fixedShouldRender && !this.firstTime)
    ...
    *
    ...
    constructor(data3 = {}) {
      ...
      this.onTouchMove = (e) => {
        ...
        if (this.shouldDragValue && e.cancelable)
          e.preventDefault();
      };
     ...
     */
    initScroller() {
      if (!this.trigger || !mq[this.queryType](this.breakpoint))
        return;
    ...
    draw({ partial, isLastDraw }) {
      const mainFn = () => {
        this.values.forEach((item) => {
          ...
          const fromValue = item.fromIsFn ? item.fromFn() : item.fromValue;
  ...
  var HandleSequencer = class {
    ...
    setStretchFactor(duration2 = 0) {
      ...
      this.labels.forEach(({ time: time2 }, i) => {
        this.labels[i].time = getRoundedValue(time2 * stretchFactor);
      });
      this.callbackAdd.forEach(({ time: time2 }, i) => {
        this.callbackAdd[i].time = getRoundedValue(time2 * stretchFactor);
      });
    }
    /**
     *
    ...
    mergeArray(newData, data3) {
      return data3.map((item) => {
        ...
        return itemToMerge ? { ...item, ...itemToMerge, active: true } : inactiveItem;
      });
    }
    /**
     * @private
    ...
    add(fn = () => {
      ...
      if (!fnIsValid)
        syncTimelineAddFnWarning(fn);
      if (!timeIsValid)
        syncTimelineAddTimeWarning(time2);
      if (!addIsValid)
        return this;
  ...
  // src/js/mobMotion/animation/sequencer/sequencerUtils.js
  ...
  var HandleAsyncTimeline = class {
    ...
    run() {
      ...
      const tweenPromises = currentTweelist.map((item) => {
        ...
        if (isImmediate)
          newTweenProps.immediate = true;
        if (tweenProps && "relative" in tweenProps && tweenProps.relative) {
          tweenProps.relative = false;
          relativePropInsideTimelineWarning();
        }
        this.currentAction.push({ id: id2, action });
        const prevActionIsCurrent = lastAction.find(
          ({ id: prevId, action: prevAction }) => {
            return prevId === id2 && prevAction === action;
          }
        );
        const fn = {
          set: () => {
            return tween2?.[action](valuesFrom, newTweenProps);
          },
          goTo: () => {
            return tween2?.[action](valuesTo, newTweenProps);
          },
          goFrom: () => {
            return tween2?.[action](valuesFrom, newTweenProps);
          },
          goFromTo: () => {
            return tween2?.[action](valuesFrom, valuesTo, newTweenProps);
          },
          sync: () => {
        ...
        return new Promise((res, reject) => {
          ...
          const sessionId = this.sessionId;
          const cb = () => {
            if (this.isStopped || this.startOnDelay || sessionId !== this.sessionId) {
              reject();
              return;
            }
            const unsubscribeActiveTween = this.addToActiveTween(tween2);
            const unsubscribeTweenStartInPause = tween2 && tween2?.onStartInPause ? tween2.onStartInPause(() => {
              return this.isInPause;
            }) : NOOP;
            fn[action]().then(() => res({ resolve: true })).catch(() => {
            }).finally(() => {
      ...
      Promise[promiseType](tweenPromises).then(() => {
        if (this.isInSuspension || this.isStopped)
          return;
        const {
    ...
    addToActiveTween(tween2) {
      ...
      return () => {
        this.currentTween = this.currentTween.filter(
          ({ id: id2 }) => id2 !== prevActiveTweenCounter
        );
      };
    }
    /**
    ...
    addTweenToStore(tween2) {
      ...
      const tweenIsStored = this.tweenStore.find(({ id: id2 }) => id2 === uniqueId);
      if (tweenIsStored)
        return;
    ...
    set(tween2, valuesSet = {}, tweenProps = {}) {
      if (!asyncTimelineTweenIsValid(tween2))
        return this;
    ...
    setTween(label = "", items2 = []) {
      ...
      const tweens = this.tweenStore.filter(({ id: id2 }) => {
        return itemsId.has(id2);
      });
  ...
  var HandleSyncTimeline = class {
    ...
    updateTime(time2, fps2) {
      if (this.isStopped || this.fpsIsInLoading)
        return;
    ...
    getTimeFromLabel(label) {
      ...
      if (!labelObj)
        syncTimelineLabelWarning(label);
     ...
     */
    pause() {
      if (this.isStopped || this.isInPause || this.fpsIsInLoading)
        return;
      this.isStopped = false;
      this.isInPause = true;
    }
  ...
  var titleContentDef = createComponent({
    ...
    state: {
      ...
      color: () => ({
        ...
        type: String,
        validate: (val2) => {
          return ["white", "green"].includes(val2);
        }
      }),
      isBold: () => ({
        value: false,
  ...
  var paragraphContentDef = createComponent({
    ...
    state: {
      ...
      color: () => ({
        ...
        type: String,
        validate: (val2) => {
          return ["white", "grey", "green"].includes(val2);
        }
      })
    }
  });
...
Loading snippet ...</pre
  ...
  // src/js/component/common/spacer/spacer.js
  function getId({ id: id2, label }) {
    return id2 && id2.length > 0 ? `data-scroll=${id2} data-label=${label}` : "";
  }
  var Spacer = async ({ html, getState }) => {
    const { style, line, id: id2, label } = getState();
  ...
  // src/js/component/common/spacer/definition.js
...
`;
  ...
  // src/js/component/common/docScroll/docScroll.js
  var setProperty = ({ scrollY, element }) => {
    mobCore.useNextTick(() => {
  ...
  // src/js/component/common/docScroll/definition.js
  var docScrollDef = createComponent({
    name: "doc-scroll",
    component: DocScroll
  });

  // src/js/component/common/docTop/docScroll.js
  var DocTop = ({ html, delegateEvents }) => {
    return html`
        <div
            class="c-doc-top"
            ${delegateEvents({
      click: () => bodyScroll.to(0, { duration: 2e3 })
    })}
        ></div>
    `;
  };

  // src/js/component/common/docTop/definition.js
  var docTopDef = createComponent({
    name: "doc-top",
    component: DocTop
  });
    ...
    return targets.map((target, index) => {
      ...
      return renderHtml`<li>
                <scroll-to-button
                    ${delegateEvents({
        click: () => {
          const offsetTop = scroll === "start" ? 0 : offset(target).top - 50;
  ...
  var initNavigationScoller = ({ root }) => {
  ...
  var footer_shape_left_default = '<?xml version="1.0" encoding="UTF-8"?>\n<!-- Created with Inkscape (http://www.inkscape.org/) -->\n<svg width="1200" height="980" version="1.1" viewBox="0 0 317.5 259.29" xmlns="http://www.w3.org/2000/svg">\n <path d="m84.648 204.79 0.04201-1.6119 65.328 35.861-3.9842 0.28156z" fill="#679138"/>\n <g>\n  <path d="m84.555 201.64-24.746 4.1152 50.205 48.047 80.357 18.064 0.58008-2.582-79.641-17.902-46.581-43.607 19.959-4.6029 121.13 66.812 1.2559-2.3281z" color="#000000" style="-inkscape-stroke:none"/>\n  <path d="m64.253 212.26-1.7754 15.152 36.959 39.379 80.752 2.918 0.0137 0.10156 0.68945-0.0977-0.13867-2.6309-80.133-2.8965-36.254-36.861 2.1874-9.4827 43.264 35.767 1.6914-2.0352z" color="#000000" style="-inkscape-stroke:none"/>\n  <path d="m172.79 231.52-4.0976 9.0078 1.4239 1.2379 3.8222-8.1363 36.371 6.6265 14.486 4.7988-4.4995-4.8896-8.6653-2.5226z" color="#000000" style="-inkscape-stroke:none"/>\n  <path d="m186.23 226.47-5.5636 6.4433 2.0584 0.6014 4.309-5.05 26.675 7.6553 13.745 17.417-6.3872 4.2907 1.2559 3.4121 1.8008-0.66407-0.68945-1.8691 6.3965-3.5586-13.723-21.125z" color="#000000" style="-inkscape-stroke:none"/>\n  <path d="m37.344 173.99-16.016 1.7363-39.809 45.324 28.905-39.173-11.879-0.18164-173.8 88.117 0.61914 2.502 193.58-2.9004-0.0059-0.37109c0.4768 0.42118 2.0535 1.8816 2.3105 2.0957l1.6934-2.0332c-1.4101-1.1744-8.5557-7.6939-15.211-13.807-6.2499-5.7405-11.438-10.535-12.135-11.178zm-6.0401 4.3716-39.079 66.251 0.78711 0.72656s6.269 5.7922 12.928 11.908c4.5809 4.2075 7.479 6.8074 10.531 9.5566l-185.43 2.7793 166.03-84.231 8.1675-0.90986-38.539 52.109 2.0469 1.6699 53.879-59.975z" color="#000000" style="-inkscape-stroke:none"/>\n  <path d="m28.958 213.48-17.999 1.2065-0.62774 1.5525 17.668-0.69577 18.445 34.536-28.138 16.842 1.2383 2.3379 31.598-16.74z" color="#000000" style="-inkscape-stroke:none"/>\n </g>\n <g>\n  <path d="m310.78 270.78c-3.7734-1.0583-92.499-32.951-92.499-32.951l-4.6535 4.0576-15.385 6.9598-4.4338 9.0258-29.328-20.186-66.174 5.0788 8.5106 7.0647-19.764 9.3302-24.362 11.195-16.604-16.262-49.121-5.8524-29.204-10.902s-9.6718-15.155-10.656-14.931c-0.98444 0.22427-83.131 16.984-83.131 16.984l-239.72 47.353z"/>\n  <path d="m134.74 240.24c0-0.78961-0.26303-10.354-0.26303-10.354s2.1229-0.93017 2.9631-0.41341c0.84026 0.51677 23.817 8.5085 23.817 8.5085z"/>\n </g>\n <path d="m81.803 190.43 26.155 25.549 0.92173 0.47251s10.969 6.2842 21.996 12.401c5.5134 3.0582 11.066 6.1546 15.316 8.5625 2.1251 1.2039 3.9264 2.237 5.2266 3.002 0.6501 0.38248 1.1759 0.69764 1.5469 0.92969 0.37094 0.23206 0.70552 0.52022 0.49414 0.31445l1.8438-1.8945c-0.37196-0.36208-0.52844-0.40742-0.93555-0.66211-0.4071-0.25468-0.94568-0.57942-1.6074-0.96875-1.3235-0.77864-3.1319-1.8157-5.2637-3.0234-4.2636-2.4155-9.8209-5.514-15.338-8.5742-10.952-6.0751-16.622-9.0847-16.782-9.1721l-28.05-24.481 7.9618 0.10454 57.161 31.361 36.805-1.7363 19.852 11.979 1.3515-0.99656-20.523-13.664-36.889 1.7422-58.549-30.875z" color="#000000" style="-inkscape-stroke:none"/>\n <path d="m76.112 240.23-21.461 10.672-3.3086 15.23 3.5332 1.14 1.5671-15.028 20.175-10.739z" color="#000000" style="-inkscape-stroke:none"/>\n <g>\n  <path d="m104.34 212.28-22.54-21.848 1.0543 4.6614 16.499 14.576z" fill="#9ece6a"/>\n  <path d="m87.327 192.88 7.9618 0.10454 0.09541 2.1548-5.8273-0.29963z" fill="#9ece6a"/>\n  <path d="m95.289 192.99 0.09541 2.1548 57.139 31.983-0.073-2.7773z" fill="#679138"/>\n  <path d="m152.45 224.35 36.805-1.7363-0.078 1.0962-36.654 3.4174z" fill="#9ece6a"/>\n  <path d="m189.18 223.71 0.078-1.0962 13.211 7.9707-4.1287-1.0313z" fill="#679138"/>\n  <path d="m170.24 241.54 3.7046-7.9083 0.0681 2.8506-2.8602 5.6838z" fill="#9ece6a"/>\n  <path d="m173.94 233.63 0.0681 2.8506 35.817 5.4851 0.48528-1.7091z" fill="#679138"/>\n  <path d="m209.83 241.96 0.48528-1.7091 4.3418 1.372-2.8874 1.1447z" fill="#557333"/>\n  <path d="m183.11 233.04 3.9256-4.5767-0.0899 1.8923-2.7391 2.851z" fill="#9ece6a"/>\n  <path d="m187.04 228.47-0.0899 1.8923 26.682 7.274 0.0821-1.511z" fill="#679138"/>\n  <path d="m213.63 237.63 0.0821-1.511 2.2345 2.7987-1.3019-0.39007z" fill="#557333"/>\n  <path d="m59.809 205.76 2.1895 7.5288 1.9224 2.1787 0.33146-3.2035 18.073 15.017z" fill="#9ece6a"/>\n  <path d="m64.731 207.78 19.959-4.6029-0.04201 1.6119-17.964 4.9099z" fill="#9ece6a"/>\n </g>\n</svg>\n';
  ...
  var HomeComponent = ({ html, onMount, staticProps: staticProps2 }) => {
    ...
    return html`<div>
      ...
      style: "legend"
        ...
        <div class="l-index__top-left">${piece_arrow_default}</div>
        <div class="l-index__logo">${logo_default}</div>
        <div class="l-index__top-right">${piece_arrow_default}</div>
    </div>`;
  };
    ...
    onMount(({ element }) => {
      ...
      watch("currentId", (id2) => {
        ...
        const shadowCenter = element.querySelector(
          `.shadowClass--section-${id2} .shadowClass--in-center`
        );
        ...
        const scrollValue = (
           ...
           * ( onLeaveBack issue )
           */
          Number.parseInt(id2) === 0 ? window.innerHeight + 1 : top + height - window.innerHeight
        );
  ...
  var horizontalScrollerSection = ({ html, getState }) => {
    const { id: id2, pinClass } = getState();
    return html`
        <section
            class="l-h-scroller__column js-column"
            data-shadow="section-${id2}"
        >
  ...
  var scrollerN0Animation = ({
    ...
    let sequencersInstances = staggers.map(({ item, start, end }) => {
      ...
      const sequencer = tween.createSequencer({ data: { scale: 0 } }).goTo({ scale }, { start, end, ease: "easeOutBack" });
  ...
  function updateNewElement(id2) {
    return `<strong>Current cards id:</strong> ${id2.join(",").replaceAll(",", " | ")}`;
  }
  ...
  __export(routeList_exports, {
    about: () => about,
    animatedPatternN0v1: () => animatedPatternN0v1,
    animatedPatternN0v2: () => animatedPatternN0v2,
    animatedPatternN0v3: () => animatedPatternN0v3,
    animatedPatternN0v4: () => animatedPatternN0v4,
    animatedPatternN0v5: () => animatedPatternN0v5,
    animatedPatternN0v6: () => animatedPatternN0v6,
    animatedPatternN0v7: () => animatedPatternN0v7,
    ...
    mobMotion_plugin: () => mobMotion_plugin,
  ...
  var animatedPatternN0v1 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0></animatedpattern-n0>
    </div>`;
  };

  // src/js/pages/canvas/animatedPattern/animatedPatternN0v2/index.js
  var animatedPatternN0v2 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN0v3/index.js
  var animatedPatternN0v3 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN0v4/index.js
  var animatedPatternN0v4 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN0v5/index.js
  var animatedPatternN0v5 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN0v6/index.js
  var animatedPatternN0v6 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN0v7/index.js
  var animatedPatternN0v7 = () => {
    return renderHtml`<div class="l-padding">
        <animatedpattern-n0
            ${staticProps({
      fill: [],
  ...
  // src/js/pages/canvas/animatedPattern/animatedPatternN1/index.js
