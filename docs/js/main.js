...
Loading snippet ...</pre
    ...
    </div>`};var Ig=E({name:"mob-snippet",component:mh,exportState:["source","isFull","hasOverflow","hasBorder","numLines"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number})}});function Eg({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var fh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${Eg({id:s,label:n})}
