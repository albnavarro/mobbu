...
`;var Pf=({getState:e})=>{let{rawContent:t}=e();navigator.clipboard.writeText(t)};function Af({sync:e,bindProps:t,setState:r,delegateEvents:o}){return b`
    ...
    `}var _f=async({setState:e,getState:t,codeEl:r,currentKey:o,updateScroller:s,goToTop:n,syncParent:i})=>{let{urls:a}=t(),p=a.find(({label:m})=>m===o)?.source;if(!p?.length)return;let u=b`<html-content
        ${y({source:p,useMinHeight:!0})}
        ${i}
    ></html-content>`;r.insertAdjacentHTML("afterbegin",u),await ho(r),e("rawContent",r.textContent),s(),n()},Pp=({codeEl:e,removeDOM:t})=>{e.textContent="";let r=e.firstElementChild;r&&t(r)},Ap=({onMount:e,setState:t,getState:r,repeat:o,html:s,bindProps:n,delegateEvents:i,staticProps:a,computed:l,watch:p,removeDOM:u,syncParent:m})=>(e(({element:d,refs:f})=>{let{screenEl:T,scrollerEl:g,codeEl:w,scrollbar:x}=f,{updateScroller:C,move:P,goToTop:M}=kp({screen:T,scroller:g,scrollbar:x});x.addEventListener("input",()=>{P(x.value)}),O.watch("beforeRouteLeave",()=>{t("urls",[])}),l("currentButtonState",["urls","activeContent"],(k,V)=>(k.length>0?(d.classList.add("active"),document.body.style.overflow="hidden"):(d.classList.remove("active"),document.body.style.overflow="",Pp({codeEl:w,removeDOM:u}),t("activeContent",""),M()),V));let _=p("activeContent",k=>{Pp({codeEl:w,removeDOM:u}),_f({setState:t,getState:r,codeEl:w,currentKey:k,updateScroller:C,goToTop:M,staticProps:a,syncParent:m})});return()=>{_()}}),s`
        <div class="code-overlay js-overlay">
            ...
            <div class="code-overlay__wrap js-overlay-wrap">
                ...
                <div class="code-overlay__header">
                    ${o({clean:!0,watch:"urls",render:({sync:d})=>Af({sync:d,bindProps:n,delegateEvents:i,setState:t})})}
                </div>
                <input
                    type="range"
                    id="test"
...
Loading snippet ...</pre
    ...
    </div>`};var $g=I({name:"mob-snippet",component:bh,exportState:["source","isFull","hasOverflow","hasBorder","numLines","loadOnMount"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number}),loadOnMount:()=>({value:!1,type:Boolean})}});function Wg({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var yh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${Wg({id:s,label:n})}
        class="spacer spacer--${r} ${i}"
    ></div>`};var Bg=I({name:"mob-spacer",component:yh,exportState:["style","line","id","label"],state:{style:()=>({value:"medium",type:String,validate:e=>["small","medium","big"].includes(e),strict:!0}),line:()=>({value:!1,type:Boolean}),id:()=>({value:"",type:String}),label:()=>({value:"",type:String})}});var jg=b`
    <div class="only-desktop">
        <h3>This content is available only on desktop</h3>
        <h4>Need page reload on a screen size up to 1024px</h4>
    </div>
`,vh=({element:e})=>{e.textContent="",!re.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",jg))},Sh=({html:e,onMount:t})=>(t(({element:r})=>{vh({element:r}),c.useResize(()=>{vh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var zg=I({name:"only-desktop",component:Sh,state:{}});var wh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=Z.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
        <div class="c-loader ${n}">
            <span class="c-loader__inner"></span>
        </div>
    `};var Hg=I({name:"mob-loader",component:wh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var qg=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},Th=({html:e,onMount:t})=>(t(({element:r})=>{if(re.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{qg({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var Ug=I({name:"doc-scroll",component:Th});function Gg({targets:e,delegateEvents:t,syncParent:r,staticProps:o,setState:s,bindProps:n}){return e.map((i,a)=>{let{label:l,scroll:p}=i.dataset;return b`<li>
                <scroll-to-button
...
`;var Ph=({getState:e,html:t})=>{let{prevRoute:r,nextRoute:o}=e();return t`<div>
        ...
        <a
            ...
            >${pr}</a
        >
    </div>`};var rb=I({name:"quick-nav",component:Ph,exportState:["prevRoute","nextRoute"],state:{prevRoute:()=>({value:"",type:String}),nextRoute:()=>({value:"",type:String})}});var Ah=({getState:e,html:t,onMount:r})=>{let{title:o}=e();return r(({refs:s})=>{let{titleEl:n}=s;c.useFrame(()=>{n.classList.add("visible")})}),t`<div class="c-animation-title">
        <h4 ref="titleEl">${o}</h4>
    </div>`};var ob=I({name:"animation-title",component:Ah,exportState:["title"],state:{title:()=>({value:"",type:String})}});var _h=({html:e})=>e`
    ...
    `;var lb=I({name:"footer-nav",component:Nh}),cb=I({name:"footer-nav-button",component:Oh,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function ub({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function pb({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function hb(){let e=Ue("page-transition");_e(e,"url","#home"),W.set("navigationIsOpen",!1),W.emit("closeNavigation"),W.emit("closeAllAccordion"),W.emit("goToTop")}var Mh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return W.watch("openNavigation",()=>ub({navInfo:s})),W.watch("closeNavigation",()=>pb({navInfo:s})),O.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Fh={},Dh={},Ks=()=>Fh,ye=()=>Dh,Vh=async()=>{Fh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Dh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var $h={github:Lh},mb=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=Ue("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=W.get();s&&(W.set("navigationIsOpen",!1),W.emit("closeNavigation"))};function fb({delegateEvents:e}){let{header:t}=Ks(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return b`<li class="l-header__sidenav__item">
    ...
    `;var gb=()=>{let{navigationIsOpen:e}=W.get("navigationIsOpen");if(W.set("navigationIsOpen",t=>!t),e){W.emit("closeNavigation");return}W.emit("openNavigation")},Bh=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{W.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),W.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var bb=I({name:"mob-header",component:Mh}),yb=I({name:"mob-header-nav",component:Wh}),vb=I({name:"mob-header-toggle",component:Bh});var Ii=0,jh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ht({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=W.get();a&&(Ii=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ii})`)}});n.init(),W.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=Se(r),u=Se(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),W.watch("refreshScroller",()=>n.refresh()),W.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),W.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ii})`}),W.watch("goToTop",()=>{setTimeout(()=>{n.move(0),W.set("activeSection","no-section")},s)})};function Sb({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function wb({element:e,main:t}){W.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function Tb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=W.get();r&&(W.set("navigationIsOpen",!1),W.emit("closeNavigation"))}),t.addEventListener("click",()=>{W.emit("closeAllAccordion"),W.emit("goToTop");let{navigationIsOpen:r}=W.get();r||lr.to(0)})}var zh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return W.watch("openNavigation",()=>wb({element:r,main:s})),W.watch("closeNavigation",()=>Sb({element:r,main:s})),c.useResize(()=>{let p=re.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),Tb({main:s,toTopBtn:i}),jh({root:r}),()=>{}}),e`
    ...
    `);function xb({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?b`
        ...
        <nav class="l-navigation">
            <ul class="l-navigation__list">
                ${xb({data:n,staticProps:t,setState:r,bindProps:o,bindEvents:s})}
            </ul>
        </nav>
    `};var qh=({getState:e,html:t,onMount:r,watch:o,delegateEvents:s})=>{let{label:n,url:i,arrowClass:a,subMenuClass:l,fireRoute:p,callback:u,scrollToSection:m}=e();return r(({element:d})=>(o("isOpen",f=>{c.useFrame(()=>{d.classList.toggle("active",f)})}),O.watch("activeRoute",f=>{c.useFrame(()=>{let T=f===i;d.classList.toggle("current",T),T&&p&&(u(),W.set("activeSection",m))})}),()=>{})),t`
        <button
            ...
            ${s({click:()=>{if(u(),!p)return;let d=Ue("page-transition");_e(d,"url",i),W.set("navigationIsOpen",!1),W.emit("closeNavigation")}})}
        >
            ${n}
        </button>
    ...
    `};function Cb({children:e,staticProps:t,callback:r}){return e.map(o=>{let{label:s,url:n,scrollToSection:i}=o;return b`
                <li class="l-navigation__submenu__item">
                    <mob-navigation-button
                        ${t({callback:r,label:s,url:n,subMenuClass:"l-navigation__link--submenu",scrollToSection:i})}
                    ></mob-navigation-button>
                </li>
            `}).join("")}var Gh=({onMount:e,html:t,getState:r,setState:o,staticProps:s,bindProps:n,watch:i})=>{let{children:a,headerButton:l,callback:p}=r(),{label:u,url:m}=l;return e(({refs:d})=>{let{content:f}=d;return Eo.subscribe(f),Eo.reset(f),i("isOpen",async T=>{if(await Eo[T?"down":"up"](f),W.emit("refreshScroller"),!T){let w=Ue("main_navigation");_e(w,"currentAccordionId",-1,!1)}}),()=>{}}),t`
        <li class="l-navigation__item has-child">
            ...
            <ul class="l-navigation__submenu" ref="content">
                ${Cb({children:a,staticProps:s,callback:p})}
            </ul>
        </li>
    `};var Ib=I({name:"mob-navigation-container",component:zh,isolateOnMount:!0,isolateCreation:!0}),Eb=I({name:"mob-navigation",component:Hh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),kb=I({name:"mob-navigation-submenu",component:Gh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),Rb=I({name:"mob-navigation-button",type:"button",component:qh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),Pb=I({name:"mob-navigation-label",component:Uh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var Jh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var Ab=I({name:"doc-container",component:Jh});var Yh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var _b=I({name:"doc-title",component:Yh,state:{}});var Xh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Ob=I({name:"doc-title-small",component:Xh,state:{}});var Kh=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Zh=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
        <div>
            <div class="shape shape-left" ref="shape">${Kh}</div>
        </div>
...
`;var ed=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
        <div>
            <div class="shape shape-right" ref="shape">${Qh}</div>
        </div>
    `);var Lb=I({name:"shape-right",component:ed}),Fb=I({name:"shape-left",component:Zh});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},ze=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},He=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},yt=e=>"roundRect"in e,td=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Qr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:hr({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:dr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),hr=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,dr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var rd=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],T=[],g={},w={},x=e.getContext(m,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:k}=ze({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Qr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,T=p?f.map((L,G)=>({...L,scale:1,rotate:0,hasFill:i.includes(G)})).sort(L=>L.hasFill?-1:1).reverse():f.map((L,G)=>{let se=i.includes(G);return{...L,scale:1,rotate:0,hasFill:se}}),g=Z.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),T.forEach(L=>{g.subscribeCache(L,({scale:G,rotate:se})=>{L.rotate=se,L.scale=G})});let V=()=>{if(!x)return;u&&(_.width=e.width,_.height=e.height);let L=u?k:x;L.fillStyle="#1a1b26",L.fillRect(0,0,e.width,e.height),T.forEach(({x:G,y:se,centerX:j,centerY:N,width:v,height:S,rotate:R,scale:A,hasFill:B,offsetXCenter:J,offsetYCenter:Q})=>{let Ie=Math.PI/180*R,ae=Math.cos(Ie)*A,de=Math.sin(Ie)*A;L.setTransform(ae,de,-de,ae,Math.round(j+J),Math.round(N+Q)),L.beginPath(),L.rect(Math.round(-j+G),Math.round(-N+se),v,S),L.fillStyle=B?P:C,L.fill(),L.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:_,ctx:x})};w=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(g,{scale:1.5,rotate:90},{duration:1e3}).goTo(g,{scale:.5},{duration:500}).goTo(g,{rotate:180,scale:1.2},{duration:500}).goTo(g,{scale:1.3},{duration:500}).goTo(g,{scale:1},{duration:1200}),w.onLoopEnd(({direction:L,loop:G})=>{console.log(`loop end: ${L}, ${G}`)}),w.play();let q=()=>{V(),d&&c.useNextFrame(()=>q())};c.useFrame(({time:L})=>{q({time:L})});let $=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,T.forEach(L=>{let{width:G,height:se,gutter:j,numberOfColumn:N}=L;L.offsetXCenter=hr({canvasWidth:e.width,width:G,gutter:j,numberOfColumn:N}),L.offsetYCenter=dr({canvasHeight:e.height,height:se,gutter:j,numberOfRow:t})}),c.useFrame(()=>V())}),Y=W.watch("openNavigation",()=>{w?.stop(),d=!1}),D=W.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:L}=O.get();L===M&&(w?.play(),c.useFrame(()=>q()))},500));return()=>{g.destroy(),w.destroy(),$(),D(),Y(),g=null,w=null,x=null,_=null,k=null,f=[],T=[],d=!1}};var od=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=rd({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN0:s}=ye(),{source:n}=s;return t`
        <div>
    ...
    `};var Db=I({name:"animatedpattern-n0",component:od,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[16,27,38,49,60,71,82,93],type:Array}),stagger:()=>({value:{each:5,grid:{col:11,row:11,direction:"row"},waitComplete:!1},type:"any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||ne())}});var sd=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a})=>{let{useOffscreen:l,context:p}=je({disableOffcanvas:a}),u=!0,m=[],d=[],f={},T={},g={},{top:w,left:x}=ie(e),C=e.getContext(p,{alpha:!1}),P="#000",M="#fff",{activeRoute:_}=O.get(),{offscreen:k,offScreenCtx:V}=ze({useOffscreen:l,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,m=Qr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,d=m.map((N,v)=>({...N,scale:0,mouseX:0,mouseY:0,hasFill:i.includes(v)})).sort(N=>N.hasFill?-1:1),f=Z.createLerp({data:{mouseX:0,mouseY:0}}),d.forEach(N=>{f.subscribeCache(N,({mouseX:v,mouseY:S})=>{N.mouseX=v,N.mouseY=S})}),T=Z.createTween({ease:"easeInOutSine",stagger:{each:5,from:"center",waitComplete:!1},data:{scale:0}}),d.forEach(N=>{T.subscribeCache(N,({scale:v})=>{N.scale=v})});let q=()=>{if(!C)return;l&&(k.width=e.width,k.height=e.height);let N=l?V:C;N.fillStyle="#1a1b26",N.fillRect(0,0,e.width,e.height),d.forEach(({x:v,y:S,centerX:R,centerY:A,width:B,height:J,mouseX:Q,mouseY:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Q-(e.width-(B+n)*r)/2,Ge=Ie-(e.height-(J+n)*t)/2,Je=(v-Le)/250,vt=(S-Ge)/250,St=Math.sqrt(Math.pow(Math.abs(Je),2)+Math.pow(Math.abs(vt),2)),Jt=Oe(Math.abs(St),0,2),to=0,qe=Math.cos(to)*(Jt+ae),Fo=Math.sin(to)*(Jt+ae);N.setTransform(qe,Fo,-Fo,qe,Math.round(R+Me),Math.round(A+De)),N.beginPath(),N.rect(Math.round(-R+v),Math.round(-A+S),B,J),N.fillStyle=de?M:P,N.fill(),N.setTransform(1,0,0,1,0,0)}),He({useOffscreen:l,offscreen:k,ctx:C})};g=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).goTo(T,{scale:.3},{duration:1e3}),g.play();let $=({x:N,y:v})=>{f.goTo({mouseX:N-x,mouseY:v-w})},Y=c.useMouseMove(({client:N})=>{let{x:v,y:S}=N;$({x:v,y:S})}),D=c.useTouchMove(({client:N})=>{let{x:v,y:S}=N;$({x:v,y:S})}),L=()=>{q(),u&&c.useNextFrame(()=>L())};c.useFrame(({time:N})=>{L({time:N})});let G=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,w=ie(e).top,x=ie(e).left,d.forEach(N=>{let{width:v,height:S,gutter:R,numberOfColumn:A}=N;N.offsetXCenter=hr({canvasWidth:e.width,width:v,gutter:R,numberOfColumn:A}),N.offsetYCenter=dr({canvasHeight:e.height,height:S,gutter:R,numberOfRow:t})}),c.useFrame(()=>q())}),se=W.watch("openNavigation",()=>{g?.stop(),u=!1}),j=W.watch("closeNavigation",()=>setTimeout(async()=>{u=!0;let{activeRoute:N}=O.get();N===_&&(g?.play(),c.useFrame(()=>L()))},500));return()=>{T.destroy(),g.destroy(),f.destroy(),G(),Y(),D(),j(),se(),T=null,g=null,f=null,C=null,k=null,V=null,m=[],d=[],u=!1}};var nd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=sd({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN1:s}=ye(),{source:n}=s;return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Vb=I({name:"animatedpattern-n1",component:nd,isolateCreation:!0,isolateOnMount:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","disableOffcanvas"],state:{numberOfRow:7,numberOfColumn:15,cellWidth:70,cellHeight:70,gutter:10,fill:[21,22,23,24,25,25,26,37,42,53,58,69,74,85,86,87,88,89,90,44,60,65,66],disableOffcanvas:!!(Re()||ne())}});function $b({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function Wb({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var id=({canvas:e,amountOfPath:t,width:r,height:o,fill:s,stroke:n,opacity:i,spacerY:a,intialRotation:l,perpetualRatio:p,mouseMoveRatio:u,disableOffcanvas:m})=>{let{useOffscreen:d,context:f}=je({disableOffcanvas:m}),T=!0,g=e.getContext(f,{alpha:!1}),w=[],x=[],C={},{left:P}=ie(e),{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:k}=ze({useOffscreen:d,canvas:e}),V=d?k:g,q=yt(V)&&!ne();V=null,e.width=e.clientWidth,e.height=e.clientHeight,w=[...new Array(t).keys()].map((v,S)=>{let R=S,A=R<t/2?t-R:R,B=A-(t-A);return{width:Math.floor($b({width:r,relativeIndex:B,amountOfPath:t})),height:Math.floor(Wb({height:o,relativeIndex:B,amountOfPath:t})),fill:s,stroke:n,opacity:B*i,rotate:0,y:0,relativeIndex:B,index:S}}),x=w.splice(0,w.length/2).concat(w.reverse()),C=Z.createSpring({data:{rotate:0,y:0},stagger:{each:5,from:"center"}}),[...x].forEach(v=>{C.subscribeCache(v,({rotate:S})=>{v.rotate=S})});let $=({time:v=0})=>{if(!g)return;d&&(_.width=e.width,_.height=e.height);let S=d?k:g,R=e.width/2,A=e.height/2;S.fillStyle="#1a1b26",S.fillRect(0,0,e.width,e.height),x.forEach(({width:B,height:J,opacity:Q,rotate:Ie,relativeIndex:ae,index:de})=>{let Me=Math.sin(v/1e3)*p*ae,De=de<t/2?Me+15*ae/2:-Me-15*ae/2,Le=de<t/2?-1:1,Ge=1,Je=Math.PI/180*(Ie-l),vt=Math.cos(Je)*Ge,St=Math.sin(Je)*Ge;S.setTransform(vt,St,-St,vt,R,A+J/2),q?(S.beginPath(),S.roundRect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J,[200,0])):(S.beginPath(),S.rect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J)),S.strokeStyle=`rgba(255, 255, 255, ${Q})`,S.fillStyle=`rgba(26, 27, 38, ${Q})`,S.stroke(),S.fill(),S.setTransform(1,0,0,1,0,0)}),He({useOffscreen:d,offscreen:_,ctx:g})},Y=({time:v=0})=>{$({time:v}),T&&c.useNextFrame(({time:S})=>Y({time:S}))};c.useFrame(({time:v})=>{Y({time:v})});let D=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=ie(e).left,c.useFrame(({time:v})=>{$({time:v})})}),L=({x:v})=>{let S=v-e.width/2-P;C.goTo({rotate:S/u})},G=c.useMouseMove(({client:v})=>{let{x:S}=v;L({x:S})}),se=c.useTouchMove(({client:v})=>{let{x:S}=v;L({x:S})}),j=W.watch("openNavigation",()=>{T=!1}),N=W.watch("closeNavigation",()=>{setTimeout(()=>{T=!0;let{activeRoute:v}=O.get();v===M&&c.useFrame(({time:S})=>Y({time:S}))},500)});return()=>{C.destroy(),D(),G(),se(),N(),j(),g=null,_=null,k=null,C=null,x=[],w=[],T=!1}};var ad=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=id({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN0:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Bb=I({name:"caterpillar-n0",component:ad,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","fill","stroke","opacity","spacerY","intialRotation","perpetualRatio","mouseMoveRatio","disableOffcanvas"],state:{amountOfPath:17,width:Re()||ne()?30:40,height:Re()||ne()?30:40,radius:0,fill:"",stroke:"#fff",opacity:.05,spacerY:e=>e?300:-400,intialRotation:33,perpetualRatio:6,mouseMoveRatio:10,disableOffcanvas:!!(Re()||ne())}});var ld=({canvas:e,numItems:t,width:r,height:o,fill:s,opacity:n,radius:i,rotationDuration:a,rotationEach:l,centerEach:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=e.getContext(d,{alpha:!1}),g=[],w={},x={},C={},{top:P,left:M}=ie(e),{activeRoute:_}=O.get(),{offscreen:k,offScreenCtx:V}=ze({useOffscreen:m,canvas:e}),q=m?V:T,$=yt(q)&&!ne();q=null,e.width=e.clientWidth,e.height=e.clientHeight,g=[...new Array(t).keys()].map((S,R)=>{let A=R>=t/2?t/2+(t/2-R):R,B=s.includes(R)?1:A*n;return{width:A*r,height:A*o,x:0,y:0,hasFill:s.includes(R),opacity:B,radius:i,rotate:0,relativeIndex:A}}),w=Z.createTween({data:{rotate:0},stagger:{each:l,from:"center"},ease:"easeLinear",relative:!0}),[...g].forEach(S=>{w.subscribeCache(S,({rotate:R})=>{S.rotate=R})}),x=Z.createSpring({data:{x:0,y:0},stagger:{each:p,from:"end"}}),[...g].forEach(S=>{x.subscribeCache(S,({x:R,y:A})=>{S.x=R,S.y=A})});let Y=()=>{if(!T)return;m&&(k.width=e.width,k.height=e.height);let S=m?V:T;S.fillStyle="#1a1b26",S.fillRect(0,0,e.width,e.height),g.forEach(({width:R,height:A,x:B,y:J,opacity:Q,rotate:Ie,hasFill:ae},de)=>{let Me=g.length-de,De=e.width/2,Le=e.height/2,Ge=1,Je=Math.PI/180*Ie,vt=Math.cos(Je)*Ge,St=Math.sin(Je)*Ge;S.setTransform(vt,St,-St,vt,De+B+Me*B/20,Le+J+Me*J/20),$?(S.beginPath(),S.roundRect(Number.parseInt(-R/2),Number.parseInt(-A/2),R,A,[200,0])):(S.beginPath(),S.rect(Number.parseInt(-R/2),Number.parseInt(-A/2),R,A)),ae?S.fillStyle="rgba(255, 255, 255, 1)":(S.fillStyle=`rgba(26, 27, 38, ${Q})`,S.strokeStyle=`rgba(255, 255, 255, ${Q})`,S.stroke()),S.fill(),S.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:k,ctx:T})};C=Ne.createAsyncTimeline({repeat:-1,yoyo:!1}),C.goTo(w,{rotate:360},{duration:a}),C.play();let D=()=>{Y(),f&&c.useNextFrame(()=>D())};c.useFrame(()=>D());let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=ie(e).top,M=ie(e).left,Y()}),G=({x:S,y:R})=>{let A=window.innerWidth,B=window.innerHeight,J=S-e.width/2-M,Q=R-e.height/2-P;x.goTo({x:Oe(J,-A/2+400+M,A/2-400-M),y:Oe(Q,-B/2+200+P,B/2-200-P)})},se=c.useMouseMove(({client:S})=>{let{x:R,y:A}=S;G({x:R,y:A})}),j=c.useTouchMove(({client:S})=>{let{x:R,y:A}=S;G({x:R,y:A})}),N=W.watch("openNavigation",()=>{f=!1,C?.pause()}),v=W.watch("closeNavigation",()=>setTimeout(()=>{f=!0;let{activeRoute:S}=O.get();S===_&&(C?.resume(),c.useFrame(()=>D()))},500));return()=>{w.destroy(),x.destroy(),C.destroy(),L(),se(),j(),N(),v(),w=null,x=null,C=null,T=null,k=null,V=null,g=[],f=!1}};var cd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=ld({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN1:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var jb=I({name:"caterpillar-n1",component:cd,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(Re()||ne())}});var Ei=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},ud=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:T}=je({disableOffcanvas:d}),g=!0,w=e.getContext(T,{alpha:!1}),x=[],C=m,{activeRoute:P}=O.get(),{offscreen:M,offScreenCtx:_}=ze({useOffscreen:f,canvas:e}),k=f?_:w,V=yt(k)&&!ne();k=null,x=[...new Array(t).keys()].map((j,N)=>{let v=N>=t/2?t/2+(t/2-N):N,S=r+r/3*v,R=o+o/3*v,A=n.includes(N)?1:(t-N)*i;return{width:S,height:R,x:0,y:0,hasFill:n.includes(N),opacity:A,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let q=Z.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:1})},1).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:5})},5).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:9})},9);x.forEach(j=>{q.subscribeCache(j,({x:N,rotate:v})=>{let S=N/u,R=2/(3-Math.cos(2*S)),A=R*Math.cos(S)*a,B=R*Math.sin(2*S)/2*l;j.x=A,j.y=B,j.rotate=v})});let $=Ne.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(q);$.onLoopEnd(({loop:j,direction:N})=>{console.log(`loop end: ${j} , ${N}`)});let Y=()=>{if(!w)return;f&&(M.width=e.width,M.height=e.height);let j=f?_:w;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),x.forEach(({width:N,height:v,x:S,y:R,radius:A,rotate:B,hasFill:J,opacity:Q})=>{let Ie=e.width/2,ae=e.height/2,de=1,Me=Math.PI/180*B,De=Math.cos(Me)*de,Le=Math.sin(Me)*de;j.setTransform(De,Le,-Le,De,Ie+S,ae+R),V?(j.beginPath(),j.roundRect(Number.parseInt(-N/2),Number.parseInt(-v/2),N,v,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-N/2),Number.parseInt(-v/2),N,v,A)),J?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${Q})`,j.strokeStyle=`rgba(255, 255, 255, ${Q})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),He({useOffscreen:f,offscreen:M,ctx:w})},D=()=>{Y(),g&&c.useNextFrame(()=>D())};c.useFrame(()=>D()),$.play();let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,Y()}),G=W.watch("openNavigation",()=>{g=!1,$?.pause()}),se=W.watch("closeNavigation",()=>setTimeout(()=>{g=!0;let{activeRoute:j}=O.get();j===P&&($?.resume(),c.useFrame(()=>D()))},500));return{destroy:()=>{g=!1,L(),G(),se(),q.destroy(),$.destroy(),w=null,M=null,_=null,x=[]},play:()=>{$.stop(),$.play()},playReverse:()=>{$.stop(),$.playReverse()},playUseCurrent:()=>$.play({useCurrent:!0}),playReverseUseCurrent:()=>$.playReverse({useCurrent:!0}),playFromLabel:()=>{$.stop(),$.playFrom("mylabel")},plaFromLabelReverse:()=>{$.stop(),$.playFromReverse("mylabel")},stop:()=>$.stop(),pause:()=>$.pause(),resume:()=>$.resume(),reverse:()=>$.reverse(),setRotation:j=>C=j}};function zb({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return b` <li class="c-canvas__controls__item">
            ...
            </li>`}).join("")}var pd=({onMount:e,html:t,getState:r,staticProps:o})=>{let{buttons:s,rotationDefault:n}=r();e(({element:p,refs:u})=>{if(re.mq("max","desktop"))return;let{wrap:m,canvas:d,rangeValue:f,rotationButton:T}=u,g=ud({canvas:d,...r()}),{destroy:w,setRotation:x}=g;return Object.entries(s).forEach(([C,P])=>{let{method:M}=P;p.querySelector(`.${C}`).addEventListener("click",()=>g?.[M]())}),T.addEventListener("change",()=>{let C=T.value;x(C),f.textContent=C}),c.useFrame(()=>{m.classList.add("active")}),()=>{w()}});let{caterpillarN2:i}=ye(),{source:a}=i,l=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
...
`;var dd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=Z.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=Z.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=Z.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=Z.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Ne.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{l.stop(),s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var md=({refs:e})=>{let t=Z.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var Yb=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},fd=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:g,M_left:w,M_right:x,around:C}=i,{playIntro:P,playSvg:M,destroySvg:_}=dd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:g},{M_left:w},{M_right:x}],around:C}),{playText:k,destroyText:V}=md({refs:a});return Yb({playText:k,playIntro:P,playSvg:M}),()=>{_(),V()}});let{home:o}=ye(),{source:s}=o;return e`<div>
        <code-button
        ...
        <div class="l-index__logo">${hd}</div>
        <div class="l-index__top-right">${ki}</div>
    </div>`};var Xb=I({name:"home-component",component:fd});var Ri=0,Kb=({indicators:e,setState:t})=>[...e].map((r,o)=>Ut.createScrollTrigger({item:r,pin:!0,animateAtStart:!1,range:"0.1px",animatePin:!0,dynamicStart:{position:"right",value:()=>window.innerWidth+Ri-ot(r)*(o+1)},dynamicEnd:{position:"right",value:()=>{let s=e.length-(o-2);return window.innerWidth/10*9*s}},onEnter:()=>{t("currentId",-1),t("currentIdFromScroll",o)},onLeaveBack:()=>{t("currentIdFromScroll",o-1)}})),Zb=({pins:e})=>{e.forEach(t=>t.refresh())},Qb=({titles:e})=>[...e].map(t=>Ut.createParallax({item:t,propierties:"x",reverse:!0,range:9})),gd=({nav:e})=>{e.classList.add("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.add("active")})},bd=({nav:e})=>{e.classList.remove("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.remove("active")})},yd=({indicators:e,titles:t,nav:r,animatePin:o,setState:s})=>{let n=Kb({indicators:e,setState:s}),i=Qb({titles:t}),a=document.querySelector(".l-navcontainer__side");Ri=ot(a)/2;let l=c.useResize(()=>{Ri=ot(a)/2}),p=new Ro({root:".js-root",container:".js-container",row:".js-row",column:".js-column",trigger:".js-trigger",shadowClass:".shadowClass",useWillChange:!0,useDrag:!0,useSticky:!o,animateAtStart:!1,ease:!0,addCss:!0,columnHeight:70,columnWidth:100,columnAlign:"center",pin:o,animatePin:o,breakpoint:"tablet",children:[...n,...i],onEnter:()=>{gd({nav:r,indicators:e})},onEnterBack:()=>{Zb({pins:n}),gd({nav:r,indicators:e})},onLeave:()=>{bd({nav:r,indicators:e})},onLeaveBack:()=>{bd({nav:r,indicators:e})}});return p.init(),{destroy:()=>{n.forEach(u=>{u?.destroy()}),n=[],i.forEach(u=>{u?.destroy()}),i=[],p.destroy(),p=null,l()},refresh:()=>p.refresh()}};var e0=({numOfCol:e,pinIsVisible:t,staticProps:r})=>{let o=t?"":"hidden";return[...new Array(e).keys()].map((s,n)=>b`
                <horizontal-scroller-section
                    ${r({id:n,pinClass:o})}
                ></horizontal-scroller-section>
            `).join("")},t0=({numOfCol:e,setState:t,bindProps:r,staticProps:o,delegateEvents:s})=>[...new Array(e).keys()].map((n,i)=>b`
                <horizontal-scroller-button
                    ${o({id:i})}
                    ${s({click:()=>t("currentId",i)})}
                    ${r({bind:["currentId","currentIdFromScroll"],props:({currentId:a,currentIdFromScroll:l})=>({active:a===i||l===i})})}
                ></horizontal-scroller-button>
            `).join(""),vd=({onMount:e,html:t,getState:r,setState:o,watch:s,staticProps:n,bindProps:i,delegateEvents:a})=>{let{animatePin:l}=r();e(({element:m})=>{if(re.mq("max","desktop"))return;let d=m.querySelectorAll(".js-indicator"),f=m.querySelector(".js-nav"),T=m.querySelectorAll(".js-title h1"),{destroy:g}=yd({indicators:d,titles:T,nav:f,...r(),setState:o});return window.scrollTo(0,0),s("currentId",w=>{if(w===-1)return;let x=m.querySelector(`.shadowClass--section-${w} .shadowClass--in-center`),{top:C}=ie(x),P=Se(x),M=Number.parseInt(w)===0?window.innerHeight+1:C+P-window.innerHeight;lr.to(M,{duration:2e3})}),()=>{g()}});let{horizontalScroller:p}=ye(),{source:u}=p;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`<div class="l-h-scroller">
        <only-desktop></only-desktop>
    ...
    </div>`};var r0=I({name:"horizontal-scroller",component:vd,isolateOnMount:!0,isolateCreation:!0,exportState:["currentId","currentIdFromScroll","animatePin"],state:{currentId:()=>({value:0,type:Number}),currentIdFromScroll:()=>({value:0,type:Number}),animatePin:()=>({value:!1,type:Boolean})}});var Sd=({getState:e,watch:t,html:r,onMount:o})=>{let{id:s}=e();return o(({element:n})=>{let i=n.querySelector(".js-nav-button");return t("active",a=>{i.classList.toggle("active",a)}),()=>{}}),r`
        <li>
            <button
                type="button"
                data-id="${s}"
    ...
    `};var o0=I({name:"horizontal-scroller-button",component:Sd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var wd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var s0=I({name:"horizontal-scroller-section",component:wd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Td=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],g=[],w=Z.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:k}=ze({useOffscreen:m,canvas:e}),V=m?k:x,q=yt(V);V=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Qr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,g=p?T.map((v,S)=>({...v,scale:0,rotate:0,hasFill:a.includes(S)})).sort(v=>v.hasFill?-1:1):T.map((v,S)=>({...v,scale:0,rotate:0,hasFill:a.includes(S)}));let $=Z.createStaggers({items:g,stagger:l}),Y=$.map(({item:v,start:S,end:R})=>{let A=v.hasFill?1.1:1,B=Z.createSequencer({data:{scale:0}}).goTo({scale:A},{start:S,end:R,ease:"easeInOutQuad"}),J=B.subscribe(({scale:Q})=>{v.scale=Q});return w.add(B),{sequencer:B,unsubscribe:J}}),D=()=>{if(!x)return;m&&(_.width=e.width,_.height=e.height);let v=m?k:x;v.fillStyle="#1a1b26",v.fillRect(0,0,e.width,e.height),g.forEach(({x:S,y:R,centerX:A,centerY:B,width:J,height:Q,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Math.PI/180*Ie,Ge=Math.cos(Le)*ae,Je=Math.sin(Le)*ae;v.setTransform(Ge,Je,-Je,Ge,Math.round(A+Me),Math.round(B+De)),td(v,Math.round(-A+S),Math.round(-B+R),J,Q,5),q?(v.beginPath(),v.roundRect(Math.round(-A+S),Math.round(-B+R),J,Q,5)):(v.beginPath(),v.rect(Math.round(-A+S),Math.round(-B+R),J,Q)),v.fillStyle=de?P:C,v.fill(),v.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:_,ctx:x})},L=Ut.createScrollTrigger({trigger:t,propierties:"tween",tween:w,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},fromTo:!0,ease:!0,easeType:"lerp"});L.init();let G=()=>{D(),f&&c.useNextFrame(()=>G())};c.useFrame(({time:v})=>{G({time:v})});let se=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,g.forEach(v=>{let{width:S,height:R,gutter:A,numberOfColumn:B}=v;v.offsetXCenter=hr({canvasWidth:e.width,width:S,gutter:A,numberOfColumn:B}),v.offsetYCenter=dr({canvasHeight:e.height,height:R,gutter:A,numberOfRow:r})}),c.useFrame(()=>D())}),j=W.watch("openNavigation",()=>{f=!1}),N=W.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:v}=O.get();v===M&&c.useFrame(()=>G())},500));return()=>{se(),N(),j(),Y.forEach(({sequencer:v,unsubscribe:S})=>{v.destroy(),S()}),Y=[],w.destroy(),w=null,$=[],L.destroy(),L=null,x=null,_=null,k=null,T=[],g=[],f=!1}};var xd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=Td({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ye(),{source:n}=s;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
    ...
    `};var n0=I({name:"scroller-n0",component:xd,isolateOnMount:!0,isolateCreation:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[36,37,38,39,40,47,51,58,62,69,73,80,81,82,83,84],type:Array}),stagger:()=>({value:{type:"equal",each:6,from:"random"},type:"Any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||ne())}});function i0({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function a0({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var Cd=({canvas:e,canvasScroller:t,amountOfPath:r,width:o,height:s,radius:n,opacity:i,intialRotation:a,endRotation:l,disableOffcanvas:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:p}),d=!0,f=e.getContext(m,{alpha:!1}),T=[],{activeRoute:g}=O.get(),{offscreen:w,offScreenCtx:x}=ze({useOffscreen:u,canvas:e}),C=u?x:f,P=yt(C)&&!ne();C=null,e.width=e.clientWidth,e.height=e.clientHeight,T=[...new Array(r).keys()].map((D,L)=>{let G=L>=r/2?r/2+(r/2-L):L;return{width:Math.floor(i0({width:o,relativeIndex:G,amountOfPath:r})),height:Math.floor(a0({height:s,relativeIndex:G,amountOfPath:r})),opacity:G*i,rotate:0,relativeIndex:G,index:L}});let M=Z.createScrollerTween({from:{rotate:0},to:{rotate:l},stagger:{each:5,from:"center"}});[...T].forEach(D=>{M.subscribeCache(D,({rotate:L})=>{D.rotate=L})});let _=()=>{if(!f)return;u&&(w.width=e.width,w.height=e.height);let D=u?x:f,L=e.width/2,G=e.height/2;D.fillStyle="#1a1b26",D.fillRect(0,0,e.width,e.height),T.forEach(({width:se,height:j,opacity:N,rotate:v,index:S})=>{let R=T.length/2-S,A=1,B=Math.PI/180*(v-a),J=Math.cos(B)*A,Q=Math.sin(B)*A;D.setTransform(J,Q,-Q,J,L,G+R*19),P?(D.beginPath(),D.roundRect(-se/2,-j/2+R*19,se,j,150)):(D.beginPath(),D.rect(Number.parseInt(-se/2),Number.parseInt(-j/2),se,j,n)),D.strokeStyle=`rgba(255, 255, 255, ${N})`,D.fillStyle=`rgba(26, 27, 38, ${N})`,D.stroke(),D.fill(),D.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:w,ctx:f})},k=Ut.createScrollTrigger({trigger:t,propierties:"tween",tween:M,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"spring"});k.init();let V=({time:D=0})=>{_({time:D}),d&&c.useNextFrame(({time:L})=>V({time:L}))};c.useFrame(({time:D})=>{V({time:D})});let q=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,c.useFrame(()=>{_()})}),$=W.watch("openNavigation",()=>{d=!1}),Y=W.watch("closeNavigation",()=>{setTimeout(()=>{d=!0;let{activeRoute:D}=O.get();D===g&&c.useFrame(({time:L})=>V({time:L}))},500)});return()=>{M.destroy(),q(),Y(),$(),M.destroy(),M=null,k.destroy(),k=null,f=null,w=null,x=null,M=null,T=[],d=!1}};var Id=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p,canvasScroller:u}=a,m=Cd({canvas:p,canvasScroller:u,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{m()}});let{scrollerN1:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
            <div class="c-canvas c-canvas--fixed ">
                <code-button
    ...
    `};var l0=I({name:"caterpillar-n3",component:Id,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","opacity","intialRotation","endRotation","disableOffcanvas"],state:{amountOfPath:17,width:15,height:40,radius:0,opacity:.05,intialRotation:33,endRotation:720,disableOffcanvas:!!(Re()||ne())}});var Zs=[{key:"a",label:"A"},{key:"b",label:"B"},{key:"c",label:"C"},{key:"d",label:"D"}],Ed=[{key:"f",label:"F"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"c",label:"C"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"d",label:"D"},{key:"b",label:"B"}],kd=[{key:"m",label:"M"},{key:"q",label:"Q"},{key:"z",label:"Z"},{key:"i",label:"I"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"n",label:"N"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"l",label:"L"},{key:"j",label:"J"},{key:"d",label:"D"}],Rd=[{key:"h",label:"H"},{key:"f",label:"F"},{key:"a",label:"A"},{key:"d",label:"D"}];var c0=[{buttonLabel:"sample1",data:Ed},{buttonLabel:"salmple2",data:kd},{buttonLabel:"sample3",data:Rd},{buttonLabel:"Initial",data:Zs}],u0=[{label:"dynamic list with key",key:"key",clean:!1},{label:"dynamic list without key",key:"",clean:!1},{label:"dynamic list clear",key:"",clean:!0}];function p0({setState:e,staticProps:t,delegateEvents:r,bindProps:o}){return c0.map((s,n)=>{let{data:i,buttonLabel:a}=s;return b`
                <dynamic-list-button
                    ${t({label:a})}
                    ${r({click:()=>{e("data",i),e("activeSample",n)}})}
                    ${o({bind:["activeSample"],props:({activeSample:l})=>({active:n===l})})}
                ></dynamic-list-button>
            `}).join("")}function h0({bindProps:e,staticProps:t}){return u0.map((r,o)=>{let{key:s,clean:n,label:i}=r;return b`
                <dynamic-list-repeater
                    ${t({listId:o,key:s,clean:n,label:i})}
                    ${e({bind:["data","counter"],props:({data:a,counter:l})=>({data:a,counter:l})})}
                ></dynamic-list-repeater>
            `}).join("")}var Pd=async({setState:e,html:t,onMount:r,staticProps:o,bindProps:s,delegateEvents:n,watchSync:i})=>{r(({refs:p})=>{let{counterEl:u}=p;i("counter",m=>{u.textContent=m})});let{repeater:a}=ye(),{source:l}=a;return t`
        <div class="dynamic-list">
            <div class="dynamic-list__header">
                <div class="dynamic-list__top">
                    ${p0({setState:e,delegateEvents:n,staticProps:o,bindProps:s})}
                    <dynamic-list-button
    ...
    `};var m0=I({name:"dynamic-list-card",component:Ad,exportState:["isFull","label","index","counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),isFull:()=>({value:!1,type:Boolean}),label:()=>({value:"-",type:String}),index:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});function _d(e){return b`<pre>${e}</pre>`}var Od=({getState:e,html:t,onMount:r,watchSync:o})=>{let{staticFromSlot:s,staticFromComponent:n}=e();return r(({refs:i})=>{let{tEl:a,t2El:l}=i;o("parentParentState",p=>{a.textContent="",a.insertAdjacentHTML("afterbegin",_d(p))}),o("parentState",p=>{l.textContent="",l.insertAdjacentHTML("afterbegin",_d(p))})}),t`
    ...
    `};var f0=I({name:"dynamic-list-slot",component:Od,exportState:["staticFromSlot","staticFromComponent","parentParentState","parentState"],state:{staticFromSlot:()=>({value:"",type:"any"}),staticFromComponent:()=>({value:"",type:"any"}),parentParentState:()=>({value:"",type:"any"}),parentState:()=>({value:"",type:"any"})}});var Nd=async({html:e})=>e`<div class="dynamic-list-empty">
        <p>empty comp</p>
        <mobjs-slot name="empty-slot"></mobjs-slot>
    </div>`;var g0=I({name:"dynamic-list-empty",component:Nd});var Md=async({watch:e,onMount:t,html:r,getState:o})=>{let{parentListId:s,counter:n}=o();return t(({refs:i})=>{let{counterValueEl:a}=i;e("counter",l=>{a.textContent=l})}),r`<div class="dynamic-counter">
    ...
    </div>`};var b0=I({name:"dynamic-list-counter",component:Md,exportState:["counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});var Ld=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button" class="dynamic-list-button">${s}</button>
    `};var y0=I({name:"dynamic-list-button",component:Ld,exportState:["active","label"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});function v0({sync:e,staticProps:t,bindProps:r,listId:o,delegateEvents:s}){return b`
        <dynamic-list-card
            ${t({parentListId:o})}
    ...
    `}function S0(e){return`<strong>Current cards id:</strong> ${e.join(",").replaceAll(","," | ")}`}function w0({element:e,className:t,childrenId:r}){let o=e.querySelector(t);o.textContent="",o.insertAdjacentHTML("afterbegin",S0(r))}var Fd=({getState:e,html:t,repeat:r,staticProps:o,bindProps:s,delegateEvents:n})=>{let{listId:i,key:a,clean:l,label:p}=e(),u=a.length>0?a:null;return t`
        <div class="dynamic-list-repeater">
            ...
            <div class="dynamic-list-repeater__list">
                ${r({watch:"data",clean:l,key:u,afterUpdate:({childrenId:m,element:d})=>{w0({className:".js-list",childrenId:m,element:d})},render:({sync:m})=>v0({sync:m,staticProps:o,bindProps:s,delegateEvents:n,listId:i})})}
            </div>
        </div>
    `};var T0=I({name:"dynamic-list-repeater",component:Fd,exportState:["label","clean","data","listId","key","listId","counter"],state:{data:()=>({value:[],type:Array}),key:()=>({value:"",type:String}),clean:()=>({value:!1,type:Boolean}),listId:()=>({value:-1,type:Number}),counter:()=>({value:-1,type:Number}),label:()=>({value:"",type:String})}});function Dd(e){return`slotted: ${e}`}var Vd=async({html:e,onMount:t,watch:r,getState:o})=>{let{label:s}=o();return t(({refs:n})=>{let{contentEl:i}=n;r("label",a=>{i.textContent=Dd(a)})}),e`<div class="dynamic-list-slotted-label">
        <p class="content" ref="contentEl">${Dd(s)}</p>
    </div>`};var x0=I({name:"dynamic-slotted-label",component:Vd,exportState:["label"],state:{label:()=>({value:void 0,type:"Any"})}});var $d=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Wd=({groups:e,trails:t})=>{let r=180/Math.PI,o=window.innerWidth,s=window.innerHeight,n=0,i=0,a=0,l=0,p=!1,u=t.map(C=>C.querySelector("svg")),m=Z.createSpring({data:{x:0,y:0},stagger:{each:3,from:"start"}});t.forEach(C=>{m.subscribe(({x:P,y:M})=>{C.style.translate=`${P}px ${M}px`})});let d=Z.createSpring({data:{rotation:0},stagger:{each:8,from:"start"}});u.forEach(C=>{d.subscribeCache(C,({rotation:P})=>{C.style.rotate=`${P}deg`})});let f=Z.createTween({data:{opacity:0,scale:1.4}});t.forEach(C=>{f.subscribe(({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let T=c.useResize(()=>{o=window.innerWidth,s=window.innerHeight}),g=c.useMouseMove(({client:C})=>{if(!p)return;let{x:P,y:M}=C,_=M-n,k=P-i;if(Math.abs(k)>10||Math.abs(_)>10){n=M,i=P;let q=Math.atan2(_,k)*r+180,$=Math.abs(a-q);$>180&&a<q&&(l-=$),$>180&&a>q&&(l+=$);let Y=q+l+90;d.goTo({rotation:Y}),a=q}m.goTo({x:P-o/2,y:M-s/2})}),w=Z.createTween({data:{opacity:0,scale:.95},duration:2e3,ease:"easeOutQuart",stagger:{waitComplete:!0,each:5,from:"center"}});e.forEach(C=>{w.subscribeCache(C,({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let x=Ne.createAsyncTimeline({repeat:1}).createGroup().goTo(w,{opacity:1,scale:1}).goTo(f,{scale:1,opacity:1}).closeGroup();return{playIntro:async()=>x.play().then(()=>{p=!0}),destroy:()=>{w.destroy(),w=null,x.destroy(),x=null,m.destroy(),m=null,d.destroy(),d=null,f.destroy(),f=null,T(),g(),o=null,s=null,n=null,i=null,a=null,l=null,u=null}}};var I0=10,E0=async({playIntro:e})=>{await e()},k0=()=>[...new Array(I0).keys()].map((e,t)=>b`
                <div
            ...
            `).join(""),Bd=({onMount:e,html:t,getState:r,staticProps:o})=>{let s=re.mq("min","desktop"),{svg:n}=s?r():"",{child:i}=ye(),{source:a}=i;return e(({refs:l})=>{if(!s)return;let{trail0:p,trail1:u,trail2:m,trail3:d,trail4:f,trail5:T,trail6:g,trail7:w,trail8:x,trail9:C,black:P,body:M,bottom_green:_,collo:k,dark_shadow:V,gambe:q,green_top:$,head:Y,light_shadow:D,head_bg:L,body_bg:G,head_green:se,highlight:j}=l,N=Wd({groups:[P,M,_,k,V,q,$,Y,D,L,G,se,j],trails:[p,u,m,d,f,T,g,w,x,C]}),{playIntro:v,destroy:S}=N;return E0({playIntro:v}),()=>{S()}}),t`<div class="svg-child-container">
        <only-desktop></only-desktop>
    ...
    </div>`};var R0=I({name:"svg-child",component:Bd,exportState:["svg"],state:{svg:()=>({value:"",type:String})}});var Ai={};Oi(Ai,{about:()=>$0,animatedPatternN0v1:()=>A0,animatedPatternN0v2:()=>_0,animatedPatternN0v3:()=>O0,animatedPatternN0v4:()=>N0,animatedPatternN1:()=>M0,canvas_overview:()=>z0,caterpillarN0:()=>L0,caterpillarN1:()=>F0,caterpillarN2:()=>D0,child:()=>Uy,dynamic_list:()=>X0,home:()=>V0,horizontalScrollerV1:()=>B0,horizontalScrollerV2:()=>j0,mobCore_defaults:()=>My,mobCore_events:()=>Oy,mobCore_overview:()=>_y,mobCore_store:()=>Ny,mobJs_bindEvents:()=>wy,mobJs_bindProps:()=>yy,mobJs_component:()=>ey,mobJs_computed:()=>ay,mobJs_debug:()=>Ry,mobJs_delegateEvents:()=>Ty,mobJs_emit:()=>ny,mobJs_emitAsync:()=>iy,mobJs_freezeProp:()=>dy,mobJs_getChildren:()=>hy,mobJs_getParentId:()=>fy,mobJs_getState:()=>oy,mobJs_html:()=>ty,mobJs_initialization:()=>Z0,mobJs_instanceName:()=>Ay,mobJs_onMount:()=>ry,mobJs_overview:()=>K0,mobJs_refs:()=>Cy,mobJs_remove:()=>uy,mobJs_removeDom:()=>py,mobJs_repeat:()=>xy,mobJs_routing:()=>Q0,mobJs_runtime:()=>Py,mobJs_setState:()=>sy,mobJs_slot:()=>Iy,mobJs_staticProps:()=>by,mobJs_syncParent:()=>Sy,mobJs_unBind:()=>vy,mobJs_unFreezeProp:()=>my,mobJs_utils:()=>Ey,mobJs_watch:()=>ly,mobJs_watchParent:()=>gy,mobJs_watchSync:()=>cy,mobJs_web_component:()=>ky,mobMotion_async_timeline:()=>Ly,mobMotion_create_stagger:()=>Fy,mobMotion_defaults:()=>Hy,mobMotion_overview:()=>Dy,mobMotion_parallax:()=>Vy,mobMotion_scrolltrigger:()=>$y,mobMotion_sequencer:()=>Wy,mobMotion_stagger:()=>By,mobMotion_sync_timeline:()=>jy,mobMotion_tween_spring_lerp:()=>zy,pageNotFound:()=>P0,plugin_overview:()=>W0,scrollerN0v1:()=>H0,scrollerN0v2:()=>q0,scrollerN0v3:()=>U0,scrollerN0v4:()=>G0,scrollerN0v5:()=>J0,scrollerN1:()=>Y0,svg_overview:()=>qy});var P0=()=>b`
    ...
    `;var A0=()=>b`<div class="l-padding">
        ...
        ></quick-nav>
    </div>`;var L0=()=>b`<div class="l-padding">
        <animation-title
        ...
        ></quick-nav>
    </div>`;var F0=()=>b`<div class="l-padding">
        <animation-title
        ...
        ></quick-nav>
    </div>`;var D0=()=>b`<div class="l-padding">
        <animation-title
        ...
        ></quick-nav>
    </div>`;var V0=()=>b`<div class="l-index">
        <home-component></home-component>
    </div>`;var $0=async()=>{let{success:e,data:t}=await E({source:"./data/about.json"});return e?b`<doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var W0=()=>b` <doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`;var B0=()=>b`<div>
        <horizontal-scroller></horizontal-scroller>
    </div>`;var j0=()=>b`<div>
        <horizontal-scroller
            ${y({animatePin:!0})}
        ></horizontal-scroller>
    </div>`;var z0=async()=>{let{success:e,data:t}=await E({source:"./data/canvas/overview.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var H0=()=>b`<div>
        <animation-title
        ...
        ></quick-nav>
    </div>`;var Y0=()=>b`<div class="l-padding">
        <animation-title
        ...
        ></quick-nav>
    </div>`;var X0=()=>b` <dynamic-list> </dynamic-list> `;var K0=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/overview.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Z0=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/initialization.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Q0=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/routing.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ey=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/component.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ty=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/html.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ry=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/onMount.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var oy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/getState.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var sy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/setState.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ny=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/emit.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var iy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/emitAsync.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ay=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/computed.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ly=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/watch.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var cy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/watchSync.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var uy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/remove.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var py=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/removeDom.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var hy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/getChildren.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var dy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/freezeProp.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var my=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/unFreezeProp.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var fy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/getParentId.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var gy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/watchParent.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var by=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/staticProps.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var yy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/bindProps.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var vy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/unBind.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Sy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/syncParent.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var wy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/bindEvents.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ty=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/delegateEvents.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var xy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/repeat.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Cy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/refs.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Iy=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/slot.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ey=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/utils.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ky=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/webComponent.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ry=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/debug.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Py=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/runtime.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ay=async()=>{let{success:e,data:t}=await E({source:"./data/mobJs/instanceName.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var _y=async()=>{let{success:e,data:t}=await E({source:"./data/mobCore/overview.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Oy=async()=>{let{success:e,data:t}=await E({source:"./data/mobCore/events.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ny=async()=>{let{success:e,data:t}=await E({source:"./data/mobCore/store.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var My=async()=>{let{success:e,data:t}=await E({source:"./data/mobCore/defaults.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ly=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/asyncTimeline.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Fy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/createStagger.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Dy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/overview.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Vy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/parallax.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var $y=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/scrollTrigger.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Wy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/sequencer.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var By=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/stagger.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var jy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/syncTimeline.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var zy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/tweenSpringLerp.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Hy=async()=>{let{success:e,data:t}=await E({source:"./data/mobMotion/defaults.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Defaults</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var qy=async()=>{let{success:e,data:t}=await E({source:"./data/svg/overview.json"});return e?b` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Uy=async()=>{let{success:e,data:t}=await Us({source:"./asset/svg/child.svg"});return e?b`<div>
        <animation-title
            ${y({title:"Child svg"})}
        ></animation-title>
        <svg-child ${y({svg:t})}></svg-child>
    </div>`:(console.warn("fetch data fail"),[])};var jd=()=>b`
