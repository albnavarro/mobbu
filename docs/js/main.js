...
`;var Rf=({getState:e})=>{let{rawContent:t}=e();navigator.clipboard.writeText(t)};function Pf({sync:e,bindProps:t,setState:r,delegateEvents:o}){return g`
    ...
    `}var Af=async({setState:e,getState:t,codeEl:r,currentKey:o,updateScroller:s,goToTop:n,syncParent:i})=>{let{urls:a}=t(),p=a.find(({label:m})=>m===o)?.source;if(!p?.length)return;let u=g`<html-content
        ...
        ${i}
    ></html-content>`;r.insertAdjacentHTML("afterbegin",u),await po(r),e("rawContent",r.textContent),s(),n()},Pp=({codeEl:e,removeDOM:t})=>{e.textContent="";let r=e.firstElementChild;r&&t(r)},Ap=({onMount:e,setState:t,getState:r,repeat:o,html:s,bindProps:n,delegateEvents:i,staticProps:a,computed:l,watch:p,removeDOM:u,syncParent:m})=>(e(({element:d,refs:f})=>{let{screenEl:T,scrollerEl:b,codeEl:v,scrollbar:x}=f,{updateScroller:C,move:P,goToTop:M}=kp({screen:T,scroller:b,scrollbar:x});x.addEventListener("input",()=>{P(x.value)}),O.watch("beforeRouteLeave",()=>{t("urls",[])}),l("currentButtonState",["urls","activeContent"],(E,V)=>(E.length>0?(d.classList.add("active"),document.body.style.overflow="hidden"):(d.classList.remove("active"),document.body.style.overflow="",Pp({codeEl:v,removeDOM:u}),t("activeContent",""),M()),V));let _=p("activeContent",E=>{Pp({codeEl:v,removeDOM:u}),Af({setState:t,getState:r,codeEl:v,currentKey:E,updateScroller:C,goToTop:M,staticProps:a,syncParent:m})});return()=>{_()}}),s`
...
`,vh=({element:e})=>{e.textContent="",!re.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Bg))},wh=({html:e,onMount:t})=>(t(({element:r})=>{vh({element:r}),c.useResize(()=>{vh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var jg=k({name:"only-desktop",component:wh,state:{}});var Sh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=Z.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
    ...
    `;var nb=k({name:"footer-nav",component:Oh}),ib=k({name:"footer-nav-button",component:_h,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function ab({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function lb({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function cb(){let e=qe("page-transition");_e(e,"url","#home"),$.set("navigationIsOpen",!1),$.emit("closeNavigation"),$.emit("closeAllAccordion"),$.emit("goToTop")}var Nh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return $.watch("openNavigation",()=>ab({navInfo:s})),$.watch("closeNavigation",()=>lb({navInfo:s})),O.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Lh={},Fh={},Xs=()=>Lh,ye=()=>Fh,Dh=async()=>{Lh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Fh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Vh={github:Mh},pb=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=qe("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=$.get();s&&($.set("navigationIsOpen",!1),$.emit("closeNavigation"))};function hb({delegateEvents:e}){let{header:t}=Xs(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
    ...
    `;var db=()=>{let{navigationIsOpen:e}=$.get("navigationIsOpen");if($.set("navigationIsOpen",t=>!t),e){$.emit("closeNavigation");return}$.emit("openNavigation")},Wh=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{$.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),$.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var mb=k({name:"mob-header",component:Nh}),fb=k({name:"mob-header-nav",component:$h}),gb=k({name:"mob-header-toggle",component:Wh});var Ii=0,Bh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ut({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=$.get();a&&(Ii=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ii})`)}});n.init(),$.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=we(r),u=we(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),$.watch("refreshScroller",()=>n.refresh()),$.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),$.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ii})`}),$.watch("goToTop",()=>{setTimeout(()=>{n.set(0),$.set("activeSection","no-section")},s)})};function bb({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function yb({element:e,main:t}){$.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function vb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=$.get();r&&($.set("navigationIsOpen",!1),$.emit("closeNavigation"))}),t.addEventListener("click",()=>{$.emit("closeAllAccordion"),$.emit("goToTop");let{navigationIsOpen:r}=$.get();r||At.to(0)})}var jh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return $.watch("openNavigation",()=>yb({element:r,main:s})),$.watch("closeNavigation",()=>bb({element:r,main:s})),c.useResize(()=>{let p=re.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),vb({main:s,toTopBtn:i}),Bh({root:r}),()=>{}}),e`
    ...
    `);function wb({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?g`
        ...
        <nav class="l-navigation">
            <ul class="l-navigation__list">
                ${wb({data:n,staticProps:t,setState:r,bindProps:o,bindEvents:s})}
            </ul>
        </nav>
    ...
    `};function Sb({children:e,staticProps:t,callback:r}){return e.map(o=>{let{label:s,url:n,scrollToSection:i}=o;return g`
                <li class="l-navigation__submenu__item">
                    <mob-navigation-button
                        ${t({callback:r,label:s,url:n,subMenuClass:"l-navigation__link--submenu",scrollToSection:i})}
                    ></mob-navigation-button>
                </li>
            `}).join("")}var qh=({onMount:e,html:t,getState:r,setState:o,staticProps:s,bindProps:n,watch:i})=>{let{children:a,headerButton:l,callback:p}=r(),{label:u,url:m}=l;return e(({refs:d})=>{let{content:f}=d;return Io.subscribe(f),Io.reset(f),i("isOpen",async T=>{if(await Io[T?"down":"up"](f),$.emit("refreshScroller"),!T){let v=qe("main_navigation");_e(v,"currentAccordionId",-1,!1)}}),()=>{}}),t`
    ...
    `};var Tb=k({name:"mob-navigation-container",component:jh,isolateOnMount:!0,isolateCreation:!0}),xb=k({name:"mob-navigation",component:zh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),Cb=k({name:"mob-navigation-submenu",component:qh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),Ib=k({name:"mob-navigation-button",type:"button",component:Hh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),Eb=k({name:"mob-navigation-label",component:Uh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var Gh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var kb=k({name:"doc-container",component:Gh});var Jh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var Rb=k({name:"doc-title",component:Jh,state:{}});var Yh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Pb=k({name:"doc-title-small",component:Yh,state:{}});var Xh=`<?xml version="1.0" encoding="UTF-8"?>
...
`;var Qh=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
    ...
    `);var Ob=k({name:"shape-right",component:Qh}),Nb=k({name:"shape-left",component:Kh});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},ze=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},He=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},yt=e=>"roundRect"in e,ed=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Zr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:pr({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:hr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),pr=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,hr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var td=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],T=[],b={},v={},x=e.getContext(m,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Zr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,T=p?f.map((L,G)=>({...L,scale:1,rotate:0,hasFill:i.includes(G)})).sort(L=>L.hasFill?-1:1).reverse():f.map((L,G)=>{let se=i.includes(G);return{...L,scale:1,rotate:0,hasFill:se}}),b=Z.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),T.forEach(L=>{b.subscribeCache(L,({scale:G,rotate:se})=>{L.rotate=se,L.scale=G})});let V=()=>{if(!x)return;u&&(_.width=e.width,_.height=e.height);let L=u?E:x;L.fillStyle="#1a1b26",L.fillRect(0,0,e.width,e.height),T.forEach(({x:G,y:se,centerX:j,centerY:N,width:y,height:w,rotate:R,scale:A,hasFill:B,offsetXCenter:J,offsetYCenter:Q})=>{let Ie=Math.PI/180*R,ae=Math.cos(Ie)*A,de=Math.sin(Ie)*A;L.setTransform(ae,de,-de,ae,Math.round(j+J),Math.round(N+Q)),L.beginPath(),L.rect(Math.round(-j+G),Math.round(-N+se),y,w),L.fillStyle=B?P:C,L.fill(),L.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:_,ctx:x})};v=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(b,{scale:1.5,rotate:90},{duration:1e3}).goTo(b,{scale:.5},{duration:500}).goTo(b,{rotate:180,scale:1.2},{duration:500}).goTo(b,{scale:1.3},{duration:500}).goTo(b,{scale:1},{duration:1200}),v.onLoopEnd(({direction:L,loop:G})=>{console.log(`loop end: ${L}, ${G}`)}),v.play();let U=()=>{V(),d&&c.useNextFrame(()=>U())};c.useFrame(({time:L})=>{U({time:L})});let W=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,T.forEach(L=>{let{width:G,height:se,gutter:j,numberOfColumn:N}=L;L.offsetXCenter=pr({canvasWidth:e.width,width:G,gutter:j,numberOfColumn:N}),L.offsetYCenter=hr({canvasHeight:e.height,height:se,gutter:j,numberOfRow:t})}),c.useFrame(()=>V())}),Y=$.watch("openNavigation",()=>{v?.stop(),d=!1}),D=$.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:L}=O.get();L===M&&(v?.play(),c.useFrame(()=>U()))},500));return()=>{b.destroy(),v.destroy(),W(),D(),Y(),b=null,v=null,x=null,_=null,E=null,f=[],T=[],d=!1}};var rd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=td({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN0:s}=ye(),{source:n}=s;return t`
        <div>
    ...
    `};var Mb=k({name:"animatedpattern-n0",component:rd,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[16,27,38,49,60,71,82,93],type:Array}),stagger:()=>({value:{each:5,grid:{col:11,row:11,direction:"row"},waitComplete:!1},type:"any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||ne())}});var od=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a})=>{let{useOffscreen:l,context:p}=je({disableOffcanvas:a}),u=!0,m=[],d=[],f={},T={},b={},{top:v,left:x}=ie(e),C=e.getContext(p,{alpha:!1}),P="#000",M="#fff",{activeRoute:_}=O.get(),{offscreen:E,offScreenCtx:V}=ze({useOffscreen:l,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,m=Zr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,d=m.map((N,y)=>({...N,scale:0,mouseX:0,mouseY:0,hasFill:i.includes(y)})).sort(N=>N.hasFill?-1:1),f=Z.createLerp({data:{mouseX:0,mouseY:0}}),d.forEach(N=>{f.subscribeCache(N,({mouseX:y,mouseY:w})=>{N.mouseX=y,N.mouseY=w})}),T=Z.createTween({ease:"easeInOutSine",stagger:{each:5,from:"center",waitComplete:!1},data:{scale:0}}),d.forEach(N=>{T.subscribeCache(N,({scale:y})=>{N.scale=y})});let U=()=>{if(!C)return;l&&(E.width=e.width,E.height=e.height);let N=l?V:C;N.fillStyle="#1a1b26",N.fillRect(0,0,e.width,e.height),d.forEach(({x:y,y:w,centerX:R,centerY:A,width:B,height:J,mouseX:Q,mouseY:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Q-(e.width-(B+n)*r)/2,Ge=Ie-(e.height-(J+n)*t)/2,Je=(y-Le)/250,vt=(w-Ge)/250,wt=Math.sqrt(Math.pow(Math.abs(Je),2)+Math.pow(Math.abs(vt),2)),Yt=Oe(Math.abs(wt),0,2),eo=0,Ue=Math.cos(eo)*(Yt+ae),Lo=Math.sin(eo)*(Yt+ae);N.setTransform(Ue,Lo,-Lo,Ue,Math.round(R+Me),Math.round(A+De)),N.beginPath(),N.rect(Math.round(-R+y),Math.round(-A+w),B,J),N.fillStyle=de?M:P,N.fill(),N.setTransform(1,0,0,1,0,0)}),He({useOffscreen:l,offscreen:E,ctx:C})};b=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).goTo(T,{scale:.3},{duration:1e3}),b.play();let W=({x:N,y})=>{f.goTo({mouseX:N-x,mouseY:y-v})},Y=c.useMouseMove(({client:N})=>{let{x:y,y:w}=N;W({x:y,y:w})}),D=c.useTouchMove(({client:N})=>{let{x:y,y:w}=N;W({x:y,y:w})}),L=()=>{U(),u&&c.useNextFrame(()=>L())};c.useFrame(({time:N})=>{L({time:N})});let G=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,v=ie(e).top,x=ie(e).left,d.forEach(N=>{let{width:y,height:w,gutter:R,numberOfColumn:A}=N;N.offsetXCenter=pr({canvasWidth:e.width,width:y,gutter:R,numberOfColumn:A}),N.offsetYCenter=hr({canvasHeight:e.height,height:w,gutter:R,numberOfRow:t})}),c.useFrame(()=>U())}),se=$.watch("openNavigation",()=>{b?.stop(),u=!1}),j=$.watch("closeNavigation",()=>setTimeout(async()=>{u=!0;let{activeRoute:N}=O.get();N===_&&(b?.play(),c.useFrame(()=>L()))},500));return()=>{T.destroy(),b.destroy(),f.destroy(),G(),Y(),D(),j(),se(),T=null,b=null,f=null,C=null,E=null,V=null,m=[],d=[],u=!1}};var sd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=od({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN1:s}=ye(),{source:n}=s;return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Lb=k({name:"animatedpattern-n1",component:sd,isolateCreation:!0,isolateOnMount:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","disableOffcanvas"],state:{numberOfRow:7,numberOfColumn:15,cellWidth:70,cellHeight:70,gutter:10,fill:[21,22,23,24,25,25,26,37,42,53,58,69,74,85,86,87,88,89,90,44,60,65,66],disableOffcanvas:!!(Re()||ne())}});function Fb({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function Db({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var nd=({canvas:e,amountOfPath:t,width:r,height:o,fill:s,stroke:n,opacity:i,spacerY:a,intialRotation:l,perpetualRatio:p,mouseMoveRatio:u,disableOffcanvas:m})=>{let{useOffscreen:d,context:f}=je({disableOffcanvas:m}),T=!0,b=e.getContext(f,{alpha:!1}),v=[],x=[],C={},{left:P}=ie(e),{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:d,canvas:e}),V=d?E:b,U=yt(V)&&!ne();V=null,e.width=e.clientWidth,e.height=e.clientHeight,v=[...new Array(t).keys()].map((y,w)=>{let R=w,A=R<t/2?t-R:R,B=A-(t-A);return{width:Math.floor(Fb({width:r,relativeIndex:B,amountOfPath:t})),height:Math.floor(Db({height:o,relativeIndex:B,amountOfPath:t})),fill:s,stroke:n,opacity:B*i,rotate:0,y:0,relativeIndex:B,index:w}}),x=v.splice(0,v.length/2).concat(v.reverse()),C=Z.createSpring({data:{rotate:0,y:0},stagger:{each:5,from:"center"}}),[...x].forEach(y=>{C.subscribeCache(y,({rotate:w})=>{y.rotate=w})});let W=({time:y=0})=>{if(!b)return;d&&(_.width=e.width,_.height=e.height);let w=d?E:b,R=e.width/2,A=e.height/2;w.fillStyle="#1a1b26",w.fillRect(0,0,e.width,e.height),x.forEach(({width:B,height:J,opacity:Q,rotate:Ie,relativeIndex:ae,index:de})=>{let Me=Math.sin(y/1e3)*p*ae,De=de<t/2?Me+15*ae/2:-Me-15*ae/2,Le=de<t/2?-1:1,Ge=1,Je=Math.PI/180*(Ie-l),vt=Math.cos(Je)*Ge,wt=Math.sin(Je)*Ge;w.setTransform(vt,wt,-wt,vt,R,A+J/2),U?(w.beginPath(),w.roundRect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J,[200,0])):(w.beginPath(),w.rect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J)),w.strokeStyle=`rgba(255, 255, 255, ${Q})`,w.fillStyle=`rgba(26, 27, 38, ${Q})`,w.stroke(),w.fill(),w.setTransform(1,0,0,1,0,0)}),He({useOffscreen:d,offscreen:_,ctx:b})},Y=({time:y=0})=>{W({time:y}),T&&c.useNextFrame(({time:w})=>Y({time:w}))};c.useFrame(({time:y})=>{Y({time:y})});let D=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=ie(e).left,c.useFrame(({time:y})=>{W({time:y})})}),L=({x:y})=>{let w=y-e.width/2-P;C.goTo({rotate:w/u})},G=c.useMouseMove(({client:y})=>{let{x:w}=y;L({x:w})}),se=c.useTouchMove(({client:y})=>{let{x:w}=y;L({x:w})}),j=$.watch("openNavigation",()=>{T=!1}),N=$.watch("closeNavigation",()=>{setTimeout(()=>{T=!0;let{activeRoute:y}=O.get();y===M&&c.useFrame(({time:w})=>Y({time:w}))},500)});return()=>{C.destroy(),D(),G(),se(),N(),j(),b=null,_=null,E=null,C=null,x=[],v=[],T=!1}};var id=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=nd({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN0:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var $b=k({name:"caterpillar-n1",component:ld,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(Re()||ne())}});var Ei=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},cd=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:T}=je({disableOffcanvas:d}),b=!0,v=e.getContext(T,{alpha:!1}),x=[],C=m,{activeRoute:P}=O.get(),{offscreen:M,offScreenCtx:_}=ze({useOffscreen:f,canvas:e}),E=f?_:v,V=yt(E)&&!ne();E=null,x=[...new Array(t).keys()].map((j,N)=>{let y=N>=t/2?t/2+(t/2-N):N,w=r+r/3*y,R=o+o/3*y,A=n.includes(N)?1:(t-N)*i;return{width:w,height:R,x:0,y:0,hasFill:n.includes(N),opacity:A,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let U=Z.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:1})},1).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:5})},5).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:9})},9);x.forEach(j=>{U.subscribeCache(j,({x:N,rotate:y})=>{let w=N/u,R=2/(3-Math.cos(2*w)),A=R*Math.cos(w)*a,B=R*Math.sin(2*w)/2*l;j.x=A,j.y=B,j.rotate=y})});let W=Ne.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(U);W.onLoopEnd(({loop:j,direction:N})=>{console.log(`loop end: ${j} , ${N}`)});let Y=()=>{if(!v)return;f&&(M.width=e.width,M.height=e.height);let j=f?_:v;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),x.forEach(({width:N,height:y,x:w,y:R,radius:A,rotate:B,hasFill:J,opacity:Q})=>{let Ie=e.width/2,ae=e.height/2,de=1,Me=Math.PI/180*B,De=Math.cos(Me)*de,Le=Math.sin(Me)*de;j.setTransform(De,Le,-Le,De,Ie+w,ae+R),V?(j.beginPath(),j.roundRect(Number.parseInt(-N/2),Number.parseInt(-y/2),N,y,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-N/2),Number.parseInt(-y/2),N,y,A)),J?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${Q})`,j.strokeStyle=`rgba(255, 255, 255, ${Q})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),He({useOffscreen:f,offscreen:M,ctx:v})},D=()=>{Y(),b&&c.useNextFrame(()=>D())};c.useFrame(()=>D()),W.play();let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,Y()}),G=$.watch("openNavigation",()=>{b=!1,W?.pause()}),se=$.watch("closeNavigation",()=>setTimeout(()=>{b=!0;let{activeRoute:j}=O.get();j===P&&(W?.resume(),c.useFrame(()=>D()))},500));return{destroy:()=>{b=!1,L(),G(),se(),U.destroy(),W.destroy(),v=null,M=null,_=null,x=[]},play:()=>{W.stop(),W.play()},playReverse:()=>{W.stop(),W.playReverse()},playUseCurrent:()=>W.play({useCurrent:!0}),playReverseUseCurrent:()=>W.playReverse({useCurrent:!0}),playFromLabel:()=>{W.stop(),W.playFrom("mylabel")},plaFromLabelReverse:()=>{W.stop(),W.playFromReverse("mylabel")},stop:()=>W.stop(),pause:()=>W.pause(),resume:()=>W.resume(),reverse:()=>W.reverse(),setRotation:j=>C=j}};function Wb({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return g` <li class="c-canvas__controls__item">
                <button
                    type="button"
            ...
            </li>`}).join("")}var ud=({onMount:e,html:t,getState:r,staticProps:o})=>{let{buttons:s,rotationDefault:n}=r();e(({element:p,refs:u})=>{if(re.mq("max","desktop"))return;let{wrap:m,canvas:d,rangeValue:f,rotationButton:T}=u,b=cd({canvas:d,...r()}),{destroy:v,setRotation:x}=b;return Object.entries(s).forEach(([C,P])=>{let{method:M}=P;p.querySelector(`.${C}`).addEventListener("click",()=>b?.[M]())}),T.addEventListener("change",()=>{let C=T.value;x(C),f.textContent=C}),c.useFrame(()=>{m.classList.add("active")}),()=>{v()}});let{caterpillarN2:i}=ye(),{source:a}=i,l=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
    ...
    `};var Bb=10,jb={"js-CN2-play":{label:"play",method:"play"},"js-CN2-playReverse":{label:"play reverse",method:"playReverse"},"js-CN2-play-current":{label:"go forward if is backward",method:"playUseCurrent"},"js-CN2-playReverse-current":{label:"go backward if is forward",method:"playReverseUseCurrent"},"js-CN2-play-label":{label:"play from label",method:"playFromLabel"},"js-CN2-playReverse-label":{label:"play from label reverse",method:"plaFromLabelReverse"},"js-CN2-reverse":{label:"reverse",method:"reverse"},"js-CN2-stop":{label:"stop",method:"stop"},"js-CN2-pause":{label:"pause",method:"pause"},"js-CN2-resume":{label:"resume",method:"resume"}},zb=k({name:"caterpillar-n2",component:ud,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","radius","fill","opacity","xAmplitude","yAmplitude","duration","rotationDefault","friction","disableOffcanvas"],state:{numItems:Re()||ne()?20:30,width:80,height:80,radius:0,fill:[2],opacity:.02,xAmplitude:500,yAmplitude:400,duration:10,rotationDefault:360,friction:Bb/2/Math.PI,disableOffcanvas:!!(Re()||ne()),buttons:()=>({value:jb,type:"Any"})}});var pd=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Generator: Gravit.io -->
...
`;var hd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=Z.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=Z.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=Z.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=Z.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Ne.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{l.stop(),s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var dd=({refs:e})=>{let t=Z.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var qb=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},md=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:b,M_left:v,M_right:x,around:C}=i,{playIntro:P,playSvg:M,destroySvg:_}=hd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:b},{M_left:v},{M_right:x}],around:C}),{playText:E,destroyText:V}=dd({refs:a});return qb({playText:E,playIntro:P,playSvg:M}),()=>{_(),V()}});let{home:o}=ye(),{source:s}=o;return e`<div>
        <code-button
        ...
        <div class="l-index__top-right">${ki}</div>
    </div>`};var Gb=k({name:"home-component",component:md});var Ri=0,Jb=({indicators:e,setState:t})=>[...e].map((r,o)=>Gt.createScrollTrigger({item:r,pin:!0,animateAtStart:!1,range:"0.1px",animatePin:!0,dynamicStart:{position:"right",value:()=>window.innerWidth+Ri-ot(r)*(o+1)},dynamicEnd:{position:"right",value:()=>{let s=e.length-(o-2);return window.innerWidth/10*9*s}},onEnter:()=>{t("currentId",-1),t("currentIdFromScroll",o)},onLeaveBack:()=>{t("currentIdFromScroll",o-1)}})),Yb=({pins:e})=>{e.forEach(t=>t.refresh())},Xb=({titles:e})=>[...e].map(t=>Gt.createParallax({item:t,propierties:"x",reverse:!0,range:9})),fd=({nav:e})=>{e.classList.add("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.add("active")})},gd=({nav:e})=>{e.classList.remove("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.remove("active")})},bd=({indicators:e,titles:t,nav:r,animatePin:o,setState:s})=>{let n=Jb({indicators:e,setState:s}),i=Xb({titles:t}),a=document.querySelector(".l-navcontainer__side");Ri=ot(a)/2;let l=c.useResize(()=>{Ri=ot(a)/2}),p=new ko({root:".js-root",container:".js-container",row:".js-row",column:".js-column",trigger:".js-trigger",shadowClass:".shadowClass",useWillChange:!0,useDrag:!0,useSticky:!o,animateAtStart:!1,ease:!0,addCss:!0,columnHeight:70,columnWidth:100,columnAlign:"center",pin:o,animatePin:o,breakpoint:"tablet",children:[...n,...i],onEnter:()=>{fd({nav:r,indicators:e})},onEnterBack:()=>{Yb({pins:n}),fd({nav:r,indicators:e})},onLeave:()=>{gd({nav:r,indicators:e})},onLeaveBack:()=>{gd({nav:r,indicators:e})}});return p.init(),{destroy:()=>{n.forEach(u=>{u?.destroy()}),n=[],i.forEach(u=>{u?.destroy()}),i=[],p.destroy(),p=null,l()},refresh:()=>p.refresh()}};var Kb=({numOfCol:e,pinIsVisible:t,staticProps:r})=>{let o=t?"":"hidden";return[...new Array(e).keys()].map((s,n)=>g`
            ...
            `).join("")},Zb=({numOfCol:e,setState:t,bindProps:r,staticProps:o,delegateEvents:s})=>[...new Array(e).keys()].map((n,i)=>g`
                ...
                ></horizontal-scroller-button>
            `).join(""),yd=({onMount:e,html:t,getState:r,setState:o,watch:s,staticProps:n,bindProps:i,delegateEvents:a})=>{let{animatePin:l}=r();e(({element:m})=>{if(re.mq("max","desktop"))return;let d=m.querySelectorAll(".js-indicator"),f=m.querySelector(".js-nav"),T=m.querySelectorAll(".js-title h1"),{destroy:b}=bd({indicators:d,titles:T,nav:f,...r(),setState:o});return window.scrollTo(0,0),s("currentId",v=>{if(v===-1)return;let x=m.querySelector(`.shadowClass--section-${v} .shadowClass--in-center`),{top:C}=ie(x),P=we(x),M=Number.parseInt(v)===0?window.innerHeight+1:C+P-window.innerHeight;At.to(M,{duration:2e3})}),()=>{b()}});let{horizontalScroller:p}=ye(),{source:u}=p;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`<div class="l-h-scroller">
        <only-desktop></only-desktop>
        ...
        <div class="l-h-scroller__root js-root">
            <div class="l-h-scroller__container js-container">
                <div class="l-h-scroller__row js-row">
                    ${Kb({numOfCol:10,pinIsVisible:!l,staticProps:n})}
                    <section
    ...
    `};var e0=k({name:"horizontal-scroller-button",component:vd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var wd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var t0=k({name:"horizontal-scroller-section",component:wd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Ks=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Sd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],b=[],v=Z.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:m,canvas:e}),V=m?E:x,U=yt(V);V=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Zr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?T.map((y,w)=>({...y,scale:0,rotate:0,hasFill:a.includes(w)})).sort(y=>y.hasFill?-1:1):T.map((y,w)=>({...y,scale:0,rotate:0,hasFill:a.includes(w)}));let W=Z.createStaggers({items:b,stagger:l}),Y=W.map(({item:y,start:w,end:R})=>{let A=y.hasFill?1.1:1,B=Z.createSequencer({data:{scale:0}}).goTo({scale:A},{start:w,end:R,ease:"easeOutBack"}),J=B.subscribe(({scale:Q})=>{y.scale=Q});return v.add(B),{sequencer:B,unsubscribe:J}}),D=()=>{if(!x)return;m&&(_.width=e.width,_.height=e.height);let y=m?E:x;y.fillStyle="#1a1b26",y.fillRect(0,0,e.width,e.height),b.forEach(({x:w,y:R,centerX:A,centerY:B,width:J,height:Q,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Math.PI/180*Ie,Ge=Math.cos(Le)*ae,Je=Math.sin(Le)*ae;y.setTransform(Ge,Je,-Je,Ge,Math.round(A+Me),Math.round(B+De)),ed(y,Math.round(-A+w),Math.round(-B+R),J,Q,5),U?(y.beginPath(),y.roundRect(Math.round(-A+w),Math.round(-B+R),J,Q,5)):(y.beginPath(),y.rect(Math.round(-A+w),Math.round(-B+R),J,Q)),y.fillStyle=de?P:C,y.fill(),y.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:_,ctx:x})},L=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:v,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>we(t)},ease:!0,easeType:"lerp"});L.init();let G=()=>{D(),f&&c.useNextFrame(()=>G())};c.useFrame(({time:y})=>{G({time:y})});let se=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(y=>{let{width:w,height:R,gutter:A,numberOfColumn:B}=y;y.offsetXCenter=pr({canvasWidth:e.width,width:w,gutter:A,numberOfColumn:B}),y.offsetYCenter=hr({canvasHeight:e.height,height:R,gutter:A,numberOfRow:r})}),c.useFrame(()=>D())}),j=$.watch("openNavigation",()=>{f=!1}),N=$.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:y}=O.get();y===M&&c.useFrame(()=>G())},500));return()=>{se(),N(),j(),Y.forEach(({sequencer:y,unsubscribe:w})=>{y.destroy(),w()}),Y=[],v.destroy(),v=null,W=[],L.destroy(),L=null,x=null,_=null,E=null,T=[],b=[],f=!1}};var Td=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=Sd({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ye(),{source:n}=s;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
    ...
    `};var p0=k({name:"dynamic-list",component:Rd,state:{counter:()=>({value:0,type:Number}),data:()=>({value:Zs,type:Array}),activeSample:()=>({value:3,type:Number})}});function Qr(e,t){return`${e}: ${t}`}var Pd=async({getState:e,html:t,onMount:r,key:o,staticProps:s,bindProps:n,watch:i,id:a})=>{let{isFull:l,parentListId:p,index:u,label:m,counter:d}=e();return r(({element:T,refs:b})=>{let{indexEl:v,labelEl:x,counterEl:C}=b;T.addEventListener("click",()=>{T.classList.toggle("is-selected")}),i("index",P=>{v.textContent=Qr("index",P)}),i("label",P=>{x.textContent=Qr("label",P)}),i("counter",P=>{C.textContent=Qr("counter",P)}),c.useFrame(()=>{T.classList.add("active")})}),t`
...
`;var $d=({groups:e,trails:t})=>{let r=180/Math.PI,o=window.innerWidth,s=window.innerHeight,n=0,i=0,a=0,l=0,p=!1,u=t.map(C=>C.querySelector("svg")),m=Z.createSpring({data:{x:0,y:0},stagger:{each:3,from:"start"}});t.forEach(C=>{m.subscribe(({x:P,y:M})=>{C.style.translate=`${P}px ${M}px`})});let d=Z.createSpring({data:{rotation:0},stagger:{each:8,from:"start"}});u.forEach(C=>{d.subscribeCache(C,({rotation:P})=>{C.style.rotate=`${P}deg`})});let f=Z.createTween({data:{opacity:0,scale:1.4}});t.forEach(C=>{f.subscribe(({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let T=c.useResize(()=>{o=window.innerWidth,s=window.innerHeight}),b=c.useMouseMove(({client:C})=>{if(!p)return;let{x:P,y:M}=C,_=M-n,E=P-i;if(Math.abs(E)>10||Math.abs(_)>10){n=M,i=P;let U=Math.atan2(_,E)*r+180,W=Math.abs(a-U);W>180&&a<U&&(l-=360),W>180&&a>U&&(l+=360);let Y=U+l+90;d.goTo({rotation:Y}),a=U}m.goTo({x:P-o/2,y:M-s/2})}),v=Z.createTween({data:{opacity:0,scale:.95},duration:2e3,ease:"easeOutQuart",stagger:{waitComplete:!0,each:5,from:"center"}});e.forEach(C=>{v.subscribeCache(C,({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let x=Ne.createAsyncTimeline({repeat:1}).createGroup().goTo(v,{opacity:1,scale:1}).goTo(f,{scale:1,opacity:1}).closeGroup();return{playIntro:async()=>x.play().then(()=>{p=!0}),destroy:()=>{v.destroy(),v=null,x.destroy(),x=null,m.destroy(),m=null,d.destroy(),d=null,f.destroy(),f=null,T(),b(),o=null,s=null,n=null,i=null,a=null,l=null,u=null}}};var x0=10,C0=async({playIntro:e})=>{await e()},I0=()=>[...new Array(x0).keys()].map((e,t)=>g`
                <div
            ...
            `).join(""),Wd=({onMount:e,html:t,getState:r,staticProps:o})=>{let s=re.mq("min","desktop"),{svg:n}=s?r():"",{child:i}=ye(),{source:a}=i;return e(({refs:l})=>{if(!s)return;let{trail0:p,trail1:u,trail2:m,trail3:d,trail4:f,trail5:T,trail6:b,trail7:v,trail8:x,trail9:C,black:P,body:M,bottom_green:_,collo:E,dark_shadow:V,gambe:U,green_top:W,head:Y,light_shadow:D,head_bg:L,body_bg:G,head_green:se}=l,j=$d({groups:[P,M,_,E,V,U,W,Y,D,L,G,se],trails:[p,u,m,d,f,T,b,v,x,C]}),{playIntro:N,destroy:y}=j;return C0({playIntro:N}),()=>{y()}}),t`<div class="svg-child-container">
        <only-desktop></only-desktop>
    ...
    `;var R0=()=>g`<div class="l-padding">
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var U0=()=>g`<div>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Uy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Defaults</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var qy=async()=>{let{success:e,data:t}=await I({source:"./data/svg/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
