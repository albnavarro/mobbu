...
`,gh=({element:e})=>{e.textContent="",!te.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Rg))},bh=({html:e,onMount:t})=>(t(({element:r})=>{gh({element:r}),c.useResize(()=>{gh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var Pg=E({name:"only-desktop",component:bh,state:{}});var yh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=re.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
    ...
    `};var _g=E({name:"mob-loader",component:yh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var Ag=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},vh=({html:e,onMount:t})=>(t(({element:r})=>{if(te.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{Ag({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var Og=E({name:"doc-scroll",component:vh});var Sh=({html:e,delegateEvents:t})=>e`
        <div
            class="c-doc-top"
    ...
    `;var jg=E({name:"mob-footer",component:Eh});var L=c.createStore({closeAllAccordion:()=>{},refreshScroller:()=>{},openNavigation:()=>{},closeNavigation:()=>{},goToTop:()=>{},activeSection:()=>({value:"",type:String,skipEqual:!1}),navigationIsOpen:()=>({value:!1,type:Boolean})});var kh=({html:e,onMount:t,getState:r})=>{let{label:o,section:s}=r();return t(({element:n})=>{L.watch("activeSection",i=>{let a=i===s;console.log(a),n.classList.toggle("current",a)})}),e`
        <button type="button" class="footer-nav__button">${o}</button>
    `};var Bg=[{label:"canvas 2d",url:"canvas_overview",section:"canvas"},{label:"plugin",url:"plugin_overview",section:"plugin"},{label:"mobCore",url:"mobCore_overview",section:"mobCore"},{label:"mobJs",url:"mobJs_overview",section:"mobJs"},{label:"mobMotion",url:"mobMotion_overview",section:"mobMotion"}];function zg({url:e}){let t=Ue("page-transition");Pe(t,"url",e)}var Hg=({delegateEvents:e,staticProps:t})=>Bg.map(({label:r,url:o,section:s})=>g`<li class="footer-nav__item">
                <footer-nav-button
                    ${e({click:()=>{zg({url:o})}})}
                    ${t({label:r,section:s})}
                ></footer-nav-button>
    ...
    `);var _h=`<svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>

`;var Ah={},Oh={},Js=()=>Ah,ye=()=>Oh,Nh=async()=>{Ah=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Oh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Mh={github:_h},Kg=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=Ue("page-transition");Pe(o,"url",r);let{navigationIsOpen:s}=L.get();s&&(L.set("navigationIsOpen",!1),L.emit("closeNavigation"))};function Zg({delegateEvents:e}){let{header:t}=Js(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
    ...
    `;var Qg=()=>{let{navigationIsOpen:e}=L.get("navigationIsOpen");if(L.set("navigationIsOpen",t=>!t),e){L.emit("closeNavigation");return}L.emit("openNavigation")},Fh=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{L.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),L.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var eb=E({name:"mob-header",component:Ph}),tb=E({name:"mob-header-nav",component:Lh}),rb=E({name:"mob-header-toggle",component:Fh});var Ti=0,Vh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ht({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=L.get();a&&(Ti=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ti})`)}});n.init(),L.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=ve(r),u=ve(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),L.watch("refreshScroller",()=>n.refresh()),L.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),L.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ti})`}),L.watch("goToTop",()=>{setTimeout(()=>{n.set(0),L.set("activeSection","no-section")},s)})};function ob({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function sb({element:e,main:t}){L.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function nb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=L.get();r&&(L.set("navigationIsOpen",!1),L.emit("closeNavigation"))}),t.addEventListener("click",()=>{L.emit("closeAllAccordion"),L.emit("goToTop");let{navigationIsOpen:r}=L.get();r||Pt.to(0)})}var Dh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return L.watch("openNavigation",()=>sb({element:r,main:s})),L.watch("closeNavigation",()=>ob({element:r,main:s})),c.useResize(()=>{let p=te.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),nb({main:s,toTopBtn:i}),Vh({root:r}),()=>{}}),e`
    ...
    `);function ib({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?g`
                ...
                `:p?g`
                  ...
                  `}).join("")}var $h=({html:e,staticProps:t,setState:r,bindProps:o,bindEvents:s})=>{let{navigation:n}=Js();return L.watch("closeAllAccordion",()=>{r("currentAccordionId",-1)}),e`
        <nav class="l-navigation">
            <ul class="l-navigation__list">
                ${ib({data:n,staticProps:t,setState:r,bindProps:o,bindEvents:s})}
            </ul>
        </nav>
    `};var Wh=({getState:e,html:t,onMount:r,watch:o,delegateEvents:s})=>{let{label:n,url:i,arrowClass:a,subMenuClass:l,fireRoute:p,callback:u,scrollToSection:m}=e();return r(({element:d})=>(o("isOpen",f=>{c.useFrame(()=>{d.classList.toggle("active",f)})}),V.watch("activeRoute",f=>{c.useFrame(()=>{let x=f===i;d.classList.toggle("current",x),x&&p&&(u(),L.set("activeSection",m))})}),()=>{})),t`
        <button
            type="button"
            class="l-navigation__link  ${a} ${l}"
            ${s({click:()=>{if(u(),!p)return;let d=Ue("page-transition");Pe(d,"url",i),L.set("navigationIsOpen",!1),L.emit("closeNavigation")}})}
        >
            ${n}
        </button>
    ...
    `;var fb=E({name:"doc-title-small",component:Uh,state:{}});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},Be=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},ze=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},bt=e=>"roundRect"in e,qh=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Kr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:ur({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:pr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),ur=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,pr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var Gh=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],x=[],b={},S={},w=e.getContext(m,{alpha:!1}),C="#000",P="#fff",{activeRoute:$}=V.get(),{offscreen:N,offScreenCtx:I}=Be({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Kr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,x=p?f.map((O,G)=>({...O,scale:1,rotate:0,hasFill:i.includes(G)})).sort(O=>O.hasFill?-1:1).reverse():f.map((O,G)=>{let oe=i.includes(G);return{...O,scale:1,rotate:0,hasFill:oe}}),b=re.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),x.forEach(O=>{b.subscribeCache(O,({scale:G,rotate:oe})=>{O.rotate=oe,O.scale=G})});let D=()=>{if(!w)return;u&&(N.width=e.width,N.height=e.height);let O=u?I:w;O.fillStyle="#1a1b26",O.fillRect(0,0,e.width,e.height),x.forEach(({x:G,y:oe,centerX:j,centerY:_,width:y,height:v,rotate:k,scale:R,hasFill:F,offsetXCenter:q,offsetYCenter:K})=>{let Ce=Math.PI/180*k,ie=Math.cos(Ce)*R,he=Math.sin(Ce)*R;O.setTransform(ie,he,-he,ie,Math.round(j+q),Math.round(_+K)),O.beginPath(),O.rect(Math.round(-j+G),Math.round(-_+oe),y,v),O.fillStyle=F?P:C,O.fill(),O.setTransform(1,0,0,1,0,0)}),ze({useOffscreen:u,offscreen:N,ctx:w})};S=$e.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(b,{scale:1.5,rotate:90},{duration:1e3}).goTo(b,{scale:.5},{duration:500}).goTo(b,{rotate:180,scale:1.2},{duration:500}).goTo(b,{scale:1.3},{duration:500}).goTo(b,{scale:1},{duration:1200}),S.onLoopEnd(({direction:O,loop:G})=>{console.log(`loop end: ${O}, ${G}`)}),S.play();let H=()=>{D(),d&&c.useNextFrame(()=>H())};c.useFrame(({time:O})=>{H({time:O})});let W=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,x.forEach(O=>{let{width:G,height:oe,gutter:j,numberOfColumn:_}=O;O.offsetXCenter=ur({canvasWidth:e.width,width:G,gutter:j,numberOfColumn:_}),O.offsetYCenter=pr({canvasHeight:e.height,height:oe,gutter:j,numberOfRow:t})}),c.useFrame(()=>D())}),X=L.watch("openNavigation",()=>{S?.stop(),d=!1}),M=L.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:O}=V.get();O===$&&(S?.play(),c.useFrame(()=>H()))},500));return()=>{b.destroy(),S.destroy(),W(),M(),X(),b=null,S=null,w=null,N=null,I=null,f=[],x=[],d=!1}};var Jh=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(te.mq("max","desktop"))return;let{canvas:a}=i,l=Gh({canvas:a,...r()});return()=>{l()}});let{animatedPatternN0:s}=ye(),{source:n}=s;return t`
        <div>
    ...
    `};var gb=E({name:"animatedpattern-n0",component:Jh,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[16,27,38,49,60,71,82,93],type:Array}),stagger:()=>({value:{each:5,grid:{col:11,row:11,direction:"row"},waitComplete:!1},type:"any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(We()||ne())}});var Yh=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a})=>{let{useOffscreen:l,context:p}=je({disableOffcanvas:a}),u=!0,m=[],d=[],f={},x={},b={},{top:S,left:w}=se(e),C=e.getContext(p,{alpha:!1}),P="#000",$="#fff",{activeRoute:N}=V.get(),{offscreen:I,offScreenCtx:D}=Be({useOffscreen:l,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,m=Kr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,d=m.map((_,y)=>({..._,scale:0,mouseX:0,mouseY:0,hasFill:i.includes(y)})).sort(_=>_.hasFill?-1:1),f=re.createLerp({data:{mouseX:0,mouseY:0}}),d.forEach(_=>{f.subscribeCache(_,({mouseX:y,mouseY:v})=>{_.mouseX=y,_.mouseY=v})}),x=re.createTween({ease:"easeInOutSine",stagger:{each:5,from:"center",waitComplete:!1},data:{scale:0}}),d.forEach(_=>{x.subscribeCache(_,({scale:y})=>{_.scale=y})});let H=()=>{if(!C)return;l&&(I.width=e.width,I.height=e.height);let _=l?D:C;_.fillStyle="#1a1b26",_.fillRect(0,0,e.width,e.height),d.forEach(({x:y,y:v,centerX:k,centerY:R,width:F,height:q,mouseX:K,mouseY:Ce,scale:ie,hasFill:he,offsetXCenter:Ae,offsetYCenter:Me})=>{let Oe=K-(e.width-(F+n)*r)/2,qe=Ce-(e.height-(q+n)*t)/2,Ge=(y-Oe)/250,yt=(v-qe)/250,vt=Math.sqrt(Math.pow(Math.abs(Ge),2)+Math.pow(Math.abs(yt),2)),Jt=_e(Math.abs(vt),0,2),Qr=0,He=Math.cos(Qr)*(Jt+ie),Mo=Math.sin(Qr)*(Jt+ie);_.setTransform(He,Mo,-Mo,He,Math.round(k+Ae),Math.round(R+Me)),_.beginPath(),_.rect(Math.round(-k+y),Math.round(-R+v),F,q),_.fillStyle=he?$:P,_.fill(),_.setTransform(1,0,0,1,0,0)}),ze({useOffscreen:l,offscreen:I,ctx:C})};b=$e.createAsyncTimeline({repeat:-1,yoyo:!0}).goTo(x,{scale:.3},{duration:1e3}),b.play();let W=({x:_,y})=>{f.goTo({mouseX:_-w,mouseY:y-S})},X=c.useMouseMove(({client:_})=>{let{x:y,y:v}=_;W({x:y,y:v})}),M=c.useTouchMove(({client:_})=>{let{x:y,y:v}=_;W({x:y,y:v})}),O=()=>{H(),u&&c.useNextFrame(()=>O())};c.useFrame(({time:_})=>{O({time:_})});let G=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,S=se(e).top,w=se(e).left,d.forEach(_=>{let{width:y,height:v,gutter:k,numberOfColumn:R}=_;_.offsetXCenter=ur({canvasWidth:e.width,width:y,gutter:k,numberOfColumn:R}),_.offsetYCenter=pr({canvasHeight:e.height,height:v,gutter:k,numberOfRow:t})}),c.useFrame(()=>H())}),oe=L.watch("openNavigation",()=>{b?.stop(),u=!1}),j=L.watch("closeNavigation",()=>setTimeout(async()=>{u=!0;let{activeRoute:_}=V.get();_===N&&(b?.play(),c.useFrame(()=>O()))},500));return()=>{x.destroy(),b.destroy(),f.destroy(),G(),X(),M(),j(),oe(),x=null,b=null,f=null,C=null,I=null,D=null,m=[],d=[],u=!1}};var Xh=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(te.mq("max","desktop"))return;let{canvas:a}=i,l=Yh({canvas:a,...r()});return()=>{l()}});let{animatedPatternN1:s}=ye(),{source:n}=s;return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend"})}
    ...
    `};var Sb=E({name:"caterpillar-n0",component:Zh,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","fill","stroke","opacity","spacerY","intialRotation","perpetualRatio","mouseMoveRatio","disableOffcanvas"],state:{amountOfPath:17,width:40,height:40,radius:0,fill:"",stroke:"#fff",opacity:.05,spacerY:e=>e?300:-400,intialRotation:33,perpetualRatio:6,mouseMoveRatio:10,disableOffcanvas:!!(We()||ne())}});var Qh=({canvas:e,numItems:t,width:r,height:o,fill:s,opacity:n,radius:i,rotationDuration:a,rotationEach:l,centerEach:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,x=e.getContext(d,{alpha:!1}),b=[],S={},w={},C={},{top:P,left:$}=se(e),{activeRoute:N}=V.get(),{offscreen:I,offScreenCtx:D}=Be({useOffscreen:m,canvas:e}),H=m?D:x,W=bt(H)&&!ne();H=null,e.width=e.clientWidth,e.height=e.clientHeight,b=[...new Array(t).keys()].map((v,k)=>{let R=k>=t/2?t/2+(t/2-k):k,F=s.includes(k)?1:R*n;return{width:R*r,height:R*o,x:0,y:0,hasFill:s.includes(k),opacity:F,radius:i,rotate:0,relativeIndex:R}}),S=re.createTween({data:{rotate:0},stagger:{each:l,from:"center"},ease:"easeLinear",relative:!0}),[...b].forEach(v=>{S.subscribeCache(v,({rotate:k})=>{v.rotate=k})}),w=re.createSpring({data:{x:0,y:0},stagger:{each:p,from:"end"}}),[...b].forEach(v=>{w.subscribeCache(v,({x:k,y:R})=>{v.x=k,v.y=R})});let X=()=>{if(!x)return;m&&(I.width=e.width,I.height=e.height);let v=m?D:x;v.fillStyle="#1a1b26",v.fillRect(0,0,e.width,e.height),b.forEach(({width:k,height:R,x:F,y:q,opacity:K,rotate:Ce,hasFill:ie},he)=>{let Ae=b.length-he,Me=e.width/2,Oe=e.height/2,qe=1,Ge=Math.PI/180*Ce,yt=Math.cos(Ge)*qe,vt=Math.sin(Ge)*qe;v.setTransform(yt,vt,-vt,yt,Me+F+Ae*F/20,Oe+q+Ae*q/20),W?(v.beginPath(),v.roundRect(Number.parseInt(-k/2),Number.parseInt(-R/2),k,R,[200,0])):(v.beginPath(),v.rect(Number.parseInt(-k/2),Number.parseInt(-R/2),k,R)),ie?v.fillStyle="rgba(255, 255, 255, 1)":(v.fillStyle=`rgba(26, 27, 38, ${K})`,v.strokeStyle=`rgba(255, 255, 255, ${K})`,v.stroke()),v.fill(),v.setTransform(1,0,0,1,0,0)}),ze({useOffscreen:m,offscreen:I,ctx:x})};C=$e.createAsyncTimeline({repeat:-1,yoyo:!1}),C.goTo(S,{rotate:360},{duration:a}),C.play();let M=()=>{X(),f&&c.useNextFrame(()=>M())};c.useFrame(()=>M());let O=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=se(e).top,$=se(e).left,X()}),G=({x:v,y:k})=>{let R=window.innerWidth,F=window.innerHeight,q=v-e.width/2-$,K=k-e.height/2-P;w.goTo({x:_e(q,-R/2+400+$,R/2-400-$),y:_e(K,-F/2+200+P,F/2-200-P)})},oe=c.useMouseMove(({client:v})=>{let{x:k,y:R}=v;G({x:k,y:R})}),j=c.useTouchMove(({client:v})=>{let{x:k,y:R}=v;G({x:k,y:R})}),_=L.watch("openNavigation",()=>{f=!1,C?.pause()}),y=L.watch("closeNavigation",()=>setTimeout(()=>{f=!0;let{activeRoute:v}=V.get();v===N&&(C?.resume(),c.useFrame(()=>M()))},500));return()=>{S.destroy(),w.destroy(),C.destroy(),O(),oe(),j(),_(),y(),S=null,w=null,C=null,x=null,I=null,D=null,b=[],f=!1}};var ed=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(te.mq("max","desktop"))return;let{canvas:l}=a,p=Qh({canvas:l,...r()});return()=>{p()}});let{caterpillarN1:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend"})}
    ...
    `};var Tb=E({name:"caterpillar-n1",component:ed,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(We()||ne())}});var xi=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},td=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:x}=je({disableOffcanvas:d}),b=!0,S=e.getContext(x,{alpha:!1}),w=[],C=m,{activeRoute:P}=V.get(),{offscreen:$,offScreenCtx:N}=Be({useOffscreen:f,canvas:e}),I=f?N:S,D=bt(I)&&!ne();I=null,w=[...new Array(t).keys()].map((j,_)=>{let y=_>=t/2?t/2+(t/2-_):_,v=r+r/3*y,k=o+o/3*y,R=n.includes(_)?1:(t-_)*i;return{width:v,height:k,x:0,y:0,hasFill:n.includes(_),opacity:R,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let H=re.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:_})=>{xi({isForced:j,direction:_,value:1})},1).add(({isForced:j,direction:_})=>{xi({isForced:j,direction:_,value:5})},5).add(({isForced:j,direction:_})=>{xi({isForced:j,direction:_,value:9})},9);w.forEach(j=>{H.subscribeCache(j,({x:_,rotate:y})=>{let v=_/u,k=2/(3-Math.cos(2*v)),R=k*Math.cos(v)*a,F=k*Math.sin(2*v)/2*l;j.x=R,j.y=F,j.rotate=y})});let W=$e.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(H);W.onLoopEnd(({loop:j,direction:_})=>{console.log(`loop end: ${j} , ${_}`)});let X=()=>{if(!S)return;f&&($.width=e.width,$.height=e.height);let j=f?N:S;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),w.forEach(({width:_,height:y,x:v,y:k,radius:R,rotate:F,hasFill:q,opacity:K})=>{let Ce=e.width/2,ie=e.height/2,he=1,Ae=Math.PI/180*F,Me=Math.cos(Ae)*he,Oe=Math.sin(Ae)*he;j.setTransform(Me,Oe,-Oe,Me,Ce+v,ie+k),D?(j.beginPath(),j.roundRect(Number.parseInt(-_/2),Number.parseInt(-y/2),_,y,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-_/2),Number.parseInt(-y/2),_,y,R)),q?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${K})`,j.strokeStyle=`rgba(255, 255, 255, ${K})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),ze({useOffscreen:f,offscreen:$,ctx:S})},M=()=>{X(),b&&c.useNextFrame(()=>M())};c.useFrame(()=>M()),W.play();let O=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,X()}),G=L.watch("openNavigation",()=>{b=!1,W?.pause()}),oe=L.watch("closeNavigation",()=>setTimeout(()=>{b=!0;let{activeRoute:j}=V.get();j===P&&(W?.resume(),c.useFrame(()=>M()))},500));return{destroy:()=>{b=!1,O(),G(),oe(),H.destroy(),W.destroy(),S=null,$=null,N=null,w=[]},play:()=>{W.stop(),W.play()},playReverse:()=>{W.stop(),W.playReverse()},playUseCurrent:()=>W.play({useCurrent:!0}),playReverseUseCurrent:()=>W.playReverse({useCurrent:!0}),playFromLabel:()=>{W.stop(),W.playFrom("mylabel")},plaFromLabelReverse:()=>{W.stop(),W.playFromReverse("mylabel")},stop:()=>W.stop(),pause:()=>W.pause(),resume:()=>W.resume(),reverse:()=>W.reverse(),setRotation:j=>C=j}};function xb({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return g` <li class="c-canvas__controls__item">
                <button
                    type="button"
...
`;var sd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=re.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=re.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=re.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=re.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let x=p==="M_right"?-d:d;u.style.translate=`${x}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=$e.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=$e.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var nd=({refs:e})=>{let t=re.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var id=({html:e,onMount:t,staticProps:r})=>{t(async({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:x,block8:b,M_left:S,M_right:w,around:C}=i,{playIntro:P,playSvg:$,destroySvg:N}=sd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:x},{block8:b},{M_left:S},{M_right:w}],around:C}),{playText:I,destroyText:D}=nd({refs:a});return I(),await P(),$(),()=>{N(),D()}});let{home:o}=ye(),{source:s}=o;return e`<div>
    ...
    </div>`};var Rb=E({name:"home-component",component:id});var Ci=0,Pb=({indicators:e,setState:t})=>[...e].map((r,o)=>qt.createScrollTrigger({item:r,pin:!0,animateAtStart:!1,range:"0.1px",animatePin:!0,dynamicStart:{position:"right",value:()=>window.innerWidth+Ci-rt(r)*(o+1)},dynamicEnd:{position:"right",value:()=>{let s=e.length-(o-2);return window.innerWidth/10*9*s}},onEnter:()=>{t("currentId",-1),t("currentIdFromScroll",o)},onLeaveBack:()=>{t("currentIdFromScroll",o-1)}})),_b=({pins:e})=>{e.forEach(t=>t.refresh())},Ab=({titles:e})=>[...e].map(t=>qt.createParallax({item:t,propierties:"x",reverse:!0,range:9})),ad=({nav:e})=>{e.classList.add("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.add("active")})},ld=({nav:e})=>{e.classList.remove("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.remove("active")})},cd=({indicators:e,titles:t,nav:r,animatePin:o,setState:s})=>{let n=Pb({indicators:e,setState:s}),i=Ab({titles:t}),a=document.querySelector(".l-navcontainer__side");Ci=rt(a)/2;let l=c.useResize(()=>{Ci=rt(a)/2}),p=new Eo({root:".js-root",container:".js-container",row:".js-row",column:".js-column",trigger:".js-trigger",shadowClass:".shadowClass",useWillChange:!0,useDrag:!0,useSticky:!o,animateAtStart:!1,ease:!0,addCss:!0,columnHeight:70,columnWidth:100,columnAlign:"center",pin:o,animatePin:o,breakpoint:"tablet",children:[...n,...i],onEnter:()=>{ad({nav:r,indicators:e})},onEnterBack:()=>{_b({pins:n}),ad({nav:r,indicators:e})},onLeave:()=>{ld({nav:r,indicators:e})},onLeaveBack:()=>{ld({nav:r,indicators:e})}});return p.init(),{destroy:()=>{n.forEach(u=>{u?.destroy()}),n=[],i.forEach(u=>{u?.destroy()}),i=[],p.destroy(),p=null,l()},refresh:()=>p.refresh()}};var Ob=({numOfCol:e,pinIsVisible:t,staticProps:r})=>{let o=t?"":"hidden";return[...new Array(e).keys()].map((s,n)=>g`
    ...
    `};var Fb=E({name:"horizontal-scroller-section",component:hd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var dd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,x=[],b=[],S=re.createMasterSequencer(),w=e.getContext(d,{alpha:!1}),C="#000",P="#fff",{activeRoute:$}=V.get(),{offscreen:N,offScreenCtx:I}=Be({useOffscreen:m,canvas:e}),D=m?I:w,H=bt(D);D=null,e.width=e.clientWidth,e.height=e.clientHeight,x=Kr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?x.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)})).sort(y=>y.hasFill?-1:1):x.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)}));let W=re.createStaggers({items:b,stagger:l}),X=W.map(({item:y,start:v,end:k})=>{let R=y.hasFill?1.1:1,F=re.createSequencer({data:{scale:0}}).goTo({scale:R},{start:v,end:k,ease:"easeOutBack"}),q=F.subscribe(({scale:K})=>{y.scale=K});return S.add(F),{sequencer:F,unsubscribe:q}}),M=()=>{if(!w)return;m&&(N.width=e.width,N.height=e.height);let y=m?I:w;y.fillStyle="#1a1b26",y.fillRect(0,0,e.width,e.height),b.forEach(({x:v,y:k,centerX:R,centerY:F,width:q,height:K,rotate:Ce,scale:ie,hasFill:he,offsetXCenter:Ae,offsetYCenter:Me})=>{let Oe=Math.PI/180*Ce,qe=Math.cos(Oe)*ie,Ge=Math.sin(Oe)*ie;y.setTransform(qe,Ge,-Ge,qe,Math.round(R+Ae),Math.round(F+Me)),qh(y,Math.round(-R+v),Math.round(-F+k),q,K,5),H?(y.beginPath(),y.roundRect(Math.round(-R+v),Math.round(-F+k),q,K,5)):(y.beginPath(),y.rect(Math.round(-R+v),Math.round(-F+k),q,K)),y.fillStyle=he?P:C,y.fill(),y.setTransform(1,0,0,1,0,0)}),ze({useOffscreen:m,offscreen:N,ctx:w})},O=qt.createScrollTrigger({trigger:t,propierties:"tween",tween:S,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>ve(t)},ease:!0,easeType:"lerp"});O.init();let G=()=>{M(),f&&c.useNextFrame(()=>G())};c.useFrame(({time:y})=>{G({time:y})});let oe=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(y=>{let{width:v,height:k,gutter:R,numberOfColumn:F}=y;y.offsetXCenter=ur({canvasWidth:e.width,width:v,gutter:R,numberOfColumn:F}),y.offsetYCenter=pr({canvasHeight:e.height,height:k,gutter:R,numberOfRow:r})}),c.useFrame(()=>M())}),j=L.watch("openNavigation",()=>{f=!1}),_=L.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:y}=V.get();y===$&&c.useFrame(()=>G())},500));return()=>{oe(),_(),j(),X.forEach(({sequencer:y,unsubscribe:v})=>{y.destroy(),v()}),X=[],S.destroy(),S=null,W=[],O.destroy(),O=null,w=null,N=null,I=null,x=[],b=[],f=!1}};var md=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(te.mq("max","desktop"))return;let{canvas:a,canvasScroller:l}=i;window.scrollTo(0,0);let p=dd({canvas:a,canvasScroller:l,...r()});return()=>{p()}});let{scrollerN0:s}=ye(),{source:n}=s;return te.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
    ...
    </div>`;var fy=()=>g`<html-content
        ${T({source:"./data/about.json"})}
    ></html-content>`;var gy=()=>g` <doc-container>
        <html-content
            slot="docs"
