(()=>{var Hd=Object.create;var rn=Object.defineProperty;var qd=Object.getOwnPropertyDescriptor;var Ud=Object.getOwnPropertyNames;var Gd=Object.getPrototypeOf,Jd=Object.prototype.hasOwnProperty;var Yd=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),Oi=(e,t)=>{for(var r in t)rn(e,r,{get:t[r],enumerable:!0})},Xd=(e,t,r,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let s of Ud(t))!Jd.call(e,s)&&s!==r&&rn(e,s,{get:()=>t[s],enumerable:!(o=qd(t,s))||o.enumerable});return e};var Kd=(e,t,r)=>(r=e!=null?Hd(Gd(e)):{},Xd(t||!e||!e.__esModule?rn(r,"default",{value:e,enumerable:!0}):r,e));var ch=Yd((tP,lh)=>{function Xp(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(t=>{let r=e[t],o=typeof r;(o==="object"||o==="function")&&!Object.isFrozen(r)&&Xp(r)}),e}var Js=class{constructor(t){t.data===void 0&&(t.data={}),this.data=t.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}};function Kp(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function Gt(e,...t){let r=Object.create(null);for(let o in e)r[o]=e[o];return t.forEach(function(o){for(let s in o)r[s]=o[s]}),r}var qf="</span>",Hp=e=>!!e.scope,Uf=(e,{prefix:t})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){let r=e.split(".");return[`${t}${r.shift()}`,...r.map((o,s)=>`${o}${"_".repeat(s+1)}`)].join(" ")}return`${t}${e}`},bi=class{constructor(t,r){this.buffer="",this.classPrefix=r.classPrefix,t.walk(this)}addText(t){this.buffer+=Kp(t)}openNode(t){if(!Hp(t))return;let r=Uf(t.scope,{prefix:this.classPrefix});this.span(r)}closeNode(t){Hp(t)&&(this.buffer+=qf)}value(){return this.buffer}span(t){this.buffer+=`<span class="${t}">`}},qp=(e={})=>{let t={children:[]};return Object.assign(t,e),t},yi=class e{constructor(){this.rootNode=qp(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(t){this.top.children.push(t)}openNode(t){let r=qp({scope:t});this.add(r),this.stack.push(r)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(t){return this.constructor._walk(t,this.rootNode)}static _walk(t,r){return typeof r=="string"?t.addText(r):r.children&&(t.openNode(r),r.children.forEach(o=>this._walk(t,o)),t.closeNode(r)),t}static _collapse(t){typeof t!="string"&&t.children&&(t.children.every(r=>typeof r=="string")?t.children=[t.children.join("")]:t.children.forEach(r=>{e._collapse(r)}))}},vi=class extends yi{constructor(t){super(),this.options=t}addText(t){t!==""&&this.add(t)}startScope(t){this.openNode(t)}endScope(){this.closeNode()}__addSublanguage(t,r){let o=t.root;r&&(o.scope=`language:${r}`),this.add(o)}toHTML(){return new bi(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}};function Mo(e){return e?typeof e=="string"?e:e.source:null}function Zp(e){return ur("(?=",e,")")}function Gf(e){return ur("(?:",e,")*")}function Jf(e){return ur("(?:",e,")?")}function ur(...e){return e.map(r=>Mo(r)).join("")}function Yf(e){let t=e[e.length-1];return typeof t=="object"&&t.constructor===Object?(e.splice(e.length-1,1),t):{}}function Si(...e){return"("+(Yf(e).capture?"":"?:")+e.map(o=>Mo(o)).join("|")+")"}function Qp(e){return new RegExp(e.toString()+"|").exec("").length-1}function Xf(e,t){let r=e&&e.exec(t);return r&&r.index===0}var Kf=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function Ti(e,{joinWith:t}){let r=0;return e.map(o=>{r+=1;let s=r,n=Mo(o),i="";for(;n.length>0;){let a=Kf.exec(n);if(!a){i+=n;break}i+=n.substring(0,a.index),n=n.substring(a.index+a[0].length),a[0][0]==="\\"&&a[1]?i+="\\"+String(Number(a[1])+s):(i+=a[0],a[0]==="("&&r++)}return i}).map(o=>`(${o})`).join(t)}var Zf=/\b\B/,eh="[a-zA-Z]\\w*",xi="[a-zA-Z_]\\w*",th="\\b\\d+(\\.\\d+)?",rh="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",oh="\\b(0b[01]+)",Qf="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",eg=(e={})=>{let t=/^#![ ]*\//;return e.binary&&(e.begin=ur(t,/.*\b/,e.binary,/\b.*/)),Gt({scope:"meta",begin:t,end:/$/,relevance:0,"on:begin":(r,o)=>{r.index!==0&&o.ignoreMatch()}},e)},Lo={begin:"\\\\[\\s\\S]",relevance:0},tg={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[Lo]},rg={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[Lo]},og={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Xs=function(e,t,r={}){let o=Gt({scope:"comment",begin:e,end:t,contains:[]},r);o.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});let s=Si("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return o.contains.push({begin:ur(/[ ]+/,"(",s,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),o},sg=Xs("//","$"),ng=Xs("/\\*","\\*/"),ig=Xs("#","$"),ag={scope:"number",begin:th,relevance:0},lg={scope:"number",begin:rh,relevance:0},cg={scope:"number",begin:oh,relevance:0},ug={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[Lo,{begin:/\[/,end:/\]/,relevance:0,contains:[Lo]}]},pg={scope:"title",begin:eh,relevance:0},hg={scope:"title",begin:xi,relevance:0},dg={begin:"\\.\\s*"+xi,relevance:0},mg=function(e){return Object.assign(e,{"on:begin":(t,r)=>{r.data._beginMatch=t[1]},"on:end":(t,r)=>{r.data._beginMatch!==t[1]&&r.ignoreMatch()}})},Gs=Object.freeze({__proto__:null,APOS_STRING_MODE:tg,BACKSLASH_ESCAPE:Lo,BINARY_NUMBER_MODE:cg,BINARY_NUMBER_RE:oh,COMMENT:Xs,C_BLOCK_COMMENT_MODE:ng,C_LINE_COMMENT_MODE:sg,C_NUMBER_MODE:lg,C_NUMBER_RE:rh,END_SAME_AS_BEGIN:mg,HASH_COMMENT_MODE:ig,IDENT_RE:eh,MATCH_NOTHING_RE:Zf,METHOD_GUARD:dg,NUMBER_MODE:ag,NUMBER_RE:th,PHRASAL_WORDS_MODE:og,QUOTE_STRING_MODE:rg,REGEXP_MODE:ug,RE_STARTERS_RE:Qf,SHEBANG:eg,TITLE_MODE:pg,UNDERSCORE_IDENT_RE:xi,UNDERSCORE_TITLE_MODE:hg});function fg(e,t){e.input[e.index-1]==="."&&t.ignoreMatch()}function gg(e,t){e.className!==void 0&&(e.scope=e.className,delete e.className)}function bg(e,t){t&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=fg,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function yg(e,t){Array.isArray(e.illegal)&&(e.illegal=Si(...e.illegal))}function vg(e,t){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function wg(e,t){e.relevance===void 0&&(e.relevance=1)}var Sg=(e,t)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");let r=Object.assign({},e);Object.keys(e).forEach(o=>{delete e[o]}),e.keywords=r.keywords,e.begin=ur(r.beforeMatch,Zp(r.begin)),e.starts={relevance:0,contains:[Object.assign(r,{endsParent:!0})]},e.relevance=0,delete r.beforeMatch},Tg=["of","and","for","in","not","or","if","then","parent","list","value"],xg="keyword";function sh(e,t,r=xg){let o=Object.create(null);return typeof e=="string"?s(r,e.split(" ")):Array.isArray(e)?s(r,e):Object.keys(e).forEach(function(n){Object.assign(o,sh(e[n],t,n))}),o;function s(n,i){t&&(i=i.map(a=>a.toLowerCase())),i.forEach(function(a){let l=a.split("|");o[l[0]]=[n,Cg(l[0],l[1])]})}}function Cg(e,t){return t?Number(t):Ig(e)?0:1}function Ig(e){return Tg.includes(e.toLowerCase())}var Up={},cr=e=>{console.error(e)},Gp=(e,...t)=>{console.log(`WARN: ${e}`,...t)},Kr=(e,t)=>{Up[`${e}/${t}`]||(console.log(`Deprecated as of ${e}. ${t}`),Up[`${e}/${t}`]=!0)},Ys=new Error;function nh(e,t,{key:r}){let o=0,s=e[r],n={},i={};for(let a=1;a<=t.length;a++)i[a+o]=s[a],n[a+o]=!0,o+=Qp(t[a-1]);e[r]=i,e[r]._emit=n,e[r]._multi=!0}function Eg(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw cr("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ys;if(typeof e.beginScope!="object"||e.beginScope===null)throw cr("beginScope must be object"),Ys;nh(e,e.begin,{key:"beginScope"}),e.begin=Ti(e.begin,{joinWith:""})}}function kg(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw cr("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ys;if(typeof e.endScope!="object"||e.endScope===null)throw cr("endScope must be object"),Ys;nh(e,e.end,{key:"endScope"}),e.end=Ti(e.end,{joinWith:""})}}function Rg(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function Pg(e){Rg(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),Eg(e),kg(e)}function Ag(e){function t(i,a){return new RegExp(Mo(i),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(a?"g":""))}class r{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(a,l){l.position=this.position++,this.matchIndexes[this.matchAt]=l,this.regexes.push([l,a]),this.matchAt+=Qp(a)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);let a=this.regexes.map(l=>l[1]);this.matcherRe=t(Ti(a,{joinWith:"|"}),!0),this.lastIndex=0}exec(a){this.matcherRe.lastIndex=this.lastIndex;let l=this.matcherRe.exec(a);if(!l)return null;let p=l.findIndex((m,d)=>d>0&&m!==void 0),u=this.matchIndexes[p];return l.splice(0,p),Object.assign(l,u)}}class o{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(a){if(this.multiRegexes[a])return this.multiRegexes[a];let l=new r;return this.rules.slice(a).forEach(([p,u])=>l.addRule(p,u)),l.compile(),this.multiRegexes[a]=l,l}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(a,l){this.rules.push([a,l]),l.type==="begin"&&this.count++}exec(a){let l=this.getMatcher(this.regexIndex);l.lastIndex=this.lastIndex;let p=l.exec(a);if(this.resumingScanAtSamePosition()&&!(p&&p.index===this.lastIndex)){let u=this.getMatcher(0);u.lastIndex=this.lastIndex+1,p=u.exec(a)}return p&&(this.regexIndex+=p.position+1,this.regexIndex===this.count&&this.considerAll()),p}}function s(i){let a=new o;return i.contains.forEach(l=>a.addRule(l.begin,{rule:l,type:"begin"})),i.terminatorEnd&&a.addRule(i.terminatorEnd,{type:"end"}),i.illegal&&a.addRule(i.illegal,{type:"illegal"}),a}function n(i,a){let l=i;if(i.isCompiled)return l;[gg,vg,Pg,Sg].forEach(u=>u(i,a)),e.compilerExtensions.forEach(u=>u(i,a)),i.__beforeBegin=null,[bg,yg,wg].forEach(u=>u(i,a)),i.isCompiled=!0;let p=null;return typeof i.keywords=="object"&&i.keywords.$pattern&&(i.keywords=Object.assign({},i.keywords),p=i.keywords.$pattern,delete i.keywords.$pattern),p=p||/\w+/,i.keywords&&(i.keywords=sh(i.keywords,e.case_insensitive)),l.keywordPatternRe=t(p,!0),a&&(i.begin||(i.begin=/\B|\b/),l.beginRe=t(l.begin),!i.end&&!i.endsWithParent&&(i.end=/\B|\b/),i.end&&(l.endRe=t(l.end)),l.terminatorEnd=Mo(l.end)||"",i.endsWithParent&&a.terminatorEnd&&(l.terminatorEnd+=(i.end?"|":"")+a.terminatorEnd)),i.illegal&&(l.illegalRe=t(i.illegal)),i.contains||(i.contains=[]),i.contains=[].concat(...i.contains.map(function(u){return _g(u==="self"?i:u)})),i.contains.forEach(function(u){n(u,l)}),i.starts&&n(i.starts,a),l.matcher=s(l),l}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=Gt(e.classNameAliases||{}),n(e)}function ih(e){return e?e.endsWithParent||ih(e.starts):!1}function _g(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(t){return Gt(e,{variants:null},t)})),e.cachedVariants?e.cachedVariants:ih(e)?Gt(e,{starts:e.starts?Gt(e.starts):null}):Object.isFrozen(e)?Gt(e):e}var Og="11.9.0",wi=class extends Error{constructor(t,r){super(t),this.name="HTMLInjectionError",this.html=r}},gi=Kp,Jp=Gt,Yp=Symbol("nomatch"),Ng=7,ah=function(e){let t=Object.create(null),r=Object.create(null),o=[],s=!0,n="Could not find the language '{}', did you forget to load/include a language module?",i={disableAutodetect:!0,name:"Plain text",contains:[]},a={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:vi};function l(v){return a.noHighlightRe.test(v)}function p(v){let w=v.className+" ";w+=v.parentNode?v.parentNode.className:"";let R=a.languageDetectRe.exec(w);if(R){let A=W(R[1]);return A||(Gp(n.replace("{}",R[1])),Gp("Falling back to no-highlight mode for this block.",v)),A?R[1]:"no-highlight"}return w.split(/\s+/).find(A=>l(A)||W(A))}function u(v,w,R){let A="",B="";typeof w=="object"?(A=v,R=w.ignoreIllegals,B=w.language):(Kr("10.7.0","highlight(lang, code, ...args) has been deprecated."),Kr("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),B=v,A=w),R===void 0&&(R=!0);let J={code:A,language:B};j("before:highlight",J);let Q=J.result?J.result:m(J.language,J.code,R);return Q.code=J.code,j("after:highlight",Q),Q}function m(v,w,R,A){let B=Object.create(null);function J(F,z){return F.keywords[z]}function Q(){if(!U.keywords){Ee.addText(me);return}let F=0;U.keywordPatternRe.lastIndex=0;let z=U.keywordPatternRe.exec(me),X="";for(;z;){X+=me.substring(F,z.index);let ce=qe.case_insensitive?z[0].toLowerCase():z[0],Pe=J(U,ce);if(Pe){let[St,jd]=Pe;if(Ee.addText(X),X="",B[ce]=(B[ce]||0)+1,B[ce]<=Ng&&(Do+=jd),St.startsWith("_"))X+=z[0];else{let zd=qe.classNameAliases[St]||St;de(z[0],zd)}}else X+=z[0];F=U.keywordPatternRe.lastIndex,z=U.keywordPatternRe.exec(me)}X+=me.substring(F),Ee.addText(X)}function Ie(){if(me==="")return;let F=null;if(typeof U.subLanguage=="string"){if(!t[U.subLanguage]){Ee.addText(me);return}F=m(U.subLanguage,me,!0,_i[U.subLanguage]),_i[U.subLanguage]=F._top}else F=f(me,U.subLanguage.length?U.subLanguage:null);U.relevance>0&&(Do+=F.relevance),Ee.__addSublanguage(F._emitter,F.language)}function ae(){U.subLanguage!=null?Ie():Q(),me=""}function de(F,z){F!==""&&(Ee.startScope(z),Ee.addText(F),Ee.endScope())}function Me(F,z){let X=1,ce=z.length-1;for(;X<=ce;){if(!F._emit[X]){X++;continue}let Pe=qe.classNameAliases[F[X]]||F[X],St=z[X];Pe?de(St,Pe):(me=St,Q(),me=""),X++}}function De(F,z){return F.scope&&typeof F.scope=="string"&&Ee.openNode(qe.classNameAliases[F.scope]||F.scope),F.beginScope&&(F.beginScope._wrap?(de(me,qe.classNameAliases[F.beginScope._wrap]||F.beginScope._wrap),me=""):F.beginScope._multi&&(Me(F.beginScope,z),me="")),U=Object.create(F,{parent:{value:U}}),U}function Le(F,z,X){let ce=Xf(F.endRe,X);if(ce){if(F["on:end"]){let Pe=new Js(F);F["on:end"](z,Pe),Pe.isMatchIgnored&&(ce=!1)}if(ce){for(;F.endsParent&&F.parent;)F=F.parent;return F}}if(F.endsWithParent)return Le(F.parent,z,X)}function Ge(F){return U.matcher.regexIndex===0?(me+=F[0],1):(tn=!0,0)}function Je(F){let z=F[0],X=F.rule,ce=new Js(X),Pe=[X.__beforeBegin,X["on:begin"]];for(let St of Pe)if(St&&(St(F,ce),ce.isMatchIgnored))return Ge(z);return X.skip?me+=z:(X.excludeBegin&&(me+=z),ae(),!X.returnBegin&&!X.excludeBegin&&(me=z)),De(X,F),X.returnBegin?0:z.length}function vt(F){let z=F[0],X=w.substring(F.index),ce=Le(U,F,X);if(!ce)return Yp;let Pe=U;U.endScope&&U.endScope._wrap?(ae(),de(z,U.endScope._wrap)):U.endScope&&U.endScope._multi?(ae(),Me(U.endScope,F)):Pe.skip?me+=z:(Pe.returnEnd||Pe.excludeEnd||(me+=z),ae(),Pe.excludeEnd&&(me=z));do U.scope&&Ee.closeNode(),!U.skip&&!U.subLanguage&&(Do+=U.relevance),U=U.parent;while(U!==ce.parent);return ce.starts&&De(ce.starts,F),Pe.returnEnd?0:z.length}function wt(){let F=[];for(let z=U;z!==qe;z=z.parent)z.scope&&F.unshift(z.scope);F.forEach(z=>Ee.openNode(z))}let Jt={};function to(F,z){let X=z&&z[0];if(me+=F,X==null)return ae(),0;if(Jt.type==="begin"&&z.type==="end"&&Jt.index===z.index&&X===""){if(me+=w.slice(z.index,z.index+1),!s){let ce=new Error(`0 width match regex (${v})`);throw ce.languageName=v,ce.badRule=Jt.rule,ce}return 1}if(Jt=z,z.type==="begin")return Je(z);if(z.type==="illegal"&&!R){let ce=new Error('Illegal lexeme "'+X+'" for mode "'+(U.scope||"<unnamed>")+'"');throw ce.mode=U,ce}else if(z.type==="end"){let ce=vt(z);if(ce!==Yp)return ce}if(z.type==="illegal"&&X==="")return 1;if(en>1e5&&en>z.index*3)throw new Error("potential infinite loop, way more iterations than matches");return me+=X,X.length}let qe=W(v);if(!qe)throw cr(n.replace("{}",v)),new Error('Unknown language: "'+v+'"');let Fo=Ag(qe),Qs="",U=A||Fo,_i={},Ee=new a.__emitter(a);wt();let me="",Do=0,Yt=0,en=0,tn=!1;try{if(qe.__emitTokens)qe.__emitTokens(w,Ee);else{for(U.matcher.considerAll();;){en++,tn?tn=!1:U.matcher.considerAll(),U.matcher.lastIndex=Yt;let F=U.matcher.exec(w);if(!F)break;let z=w.substring(Yt,F.index),X=to(z,F);Yt=F.index+X}to(w.substring(Yt))}return Ee.finalize(),Qs=Ee.toHTML(),{language:v,value:Qs,relevance:Do,illegal:!1,_emitter:Ee,_top:U}}catch(F){if(F.message&&F.message.includes("Illegal"))return{language:v,value:gi(w),illegal:!0,relevance:0,_illegalBy:{message:F.message,index:Yt,context:w.slice(Yt-100,Yt+100),mode:F.mode,resultSoFar:Qs},_emitter:Ee};if(s)return{language:v,value:gi(w),illegal:!1,relevance:0,errorRaised:F,_emitter:Ee,_top:U};throw F}}function d(v){let w={value:gi(v),illegal:!1,relevance:0,_top:i,_emitter:new a.__emitter(a)};return w._emitter.addText(v),w}function f(v,w){w=w||a.languages||Object.keys(t);let R=d(v),A=w.filter(W).filter(D).map(ae=>m(ae,v,!1));A.unshift(R);let B=A.sort((ae,de)=>{if(ae.relevance!==de.relevance)return de.relevance-ae.relevance;if(ae.language&&de.language){if(W(ae.language).supersetOf===de.language)return 1;if(W(de.language).supersetOf===ae.language)return-1}return 0}),[J,Q]=B,Ie=J;return Ie.secondBest=Q,Ie}function T(v,w,R){let A=w&&r[w]||R;v.classList.add("hljs"),v.classList.add(`language-${A}`)}function b(v){let w=null,R=p(v);if(l(R))return;if(j("before:highlightElement",{el:v,language:R}),v.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",v);return}if(v.children.length>0&&(a.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(v)),a.throwUnescapedHTML))throw new wi("One of your code blocks includes unescaped HTML.",v.innerHTML);w=v;let A=w.textContent,B=R?u(A,{language:R,ignoreIllegals:!0}):f(A);v.innerHTML=B.value,v.dataset.highlighted="yes",T(v,R,B.language),v.result={language:B.language,re:B.relevance,relevance:B.relevance},B.secondBest&&(v.secondBest={language:B.secondBest.language,relevance:B.secondBest.relevance}),j("after:highlightElement",{el:v,result:B,text:A})}function S(v){a=Jp(a,v)}let x=()=>{M(),Kr("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function C(){M(),Kr("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let P=!1;function M(){if(document.readyState==="loading"){P=!0;return}document.querySelectorAll(a.cssSelector).forEach(b)}function _(){P&&M()}typeof window<"u"&&window.addEventListener&&window.addEventListener("DOMContentLoaded",_,!1);function E(v,w){let R=null;try{R=w(e)}catch(A){if(cr("Language definition for '{}' could not be registered.".replace("{}",v)),s)cr(A);else throw A;R=i}R.name||(R.name=v),t[v]=R,R.rawDefinition=w.bind(null,e),R.aliases&&Y(R.aliases,{languageName:v})}function V(v){delete t[v];for(let w of Object.keys(r))r[w]===v&&delete r[w]}function q(){return Object.keys(t)}function W(v){return v=(v||"").toLowerCase(),t[v]||t[r[v]]}function Y(v,{languageName:w}){typeof v=="string"&&(v=[v]),v.forEach(R=>{r[R.toLowerCase()]=w})}function D(v){let w=W(v);return w&&!w.disableAutodetect}function L(v){v["before:highlightBlock"]&&!v["before:highlightElement"]&&(v["before:highlightElement"]=w=>{v["before:highlightBlock"](Object.assign({block:w.el},w))}),v["after:highlightBlock"]&&!v["after:highlightElement"]&&(v["after:highlightElement"]=w=>{v["after:highlightBlock"](Object.assign({block:w.el},w))})}function G(v){L(v),o.push(v)}function se(v){let w=o.indexOf(v);w!==-1&&o.splice(w,1)}function j(v,w){let R=v;o.forEach(function(A){A[R]&&A[R](w)})}function N(v){return Kr("10.7.0","highlightBlock will be removed entirely in v12.0"),Kr("10.7.0","Please use highlightElement now."),b(v)}Object.assign(e,{highlight:u,highlightAuto:f,highlightAll:M,highlightElement:b,highlightBlock:N,configure:S,initHighlighting:x,initHighlightingOnLoad:C,registerLanguage:E,unregisterLanguage:V,listLanguages:q,getLanguage:W,registerAliases:Y,autoDetection:D,inherit:Jp,addPlugin:G,removePlugin:se}),e.debugMode=function(){s=!1},e.safeMode=function(){s=!0},e.versionString=Og,e.regex={concat:ur,lookahead:Zp,either:Si,optional:Jf,anyNumberOfTimes:Gf};for(let v in Gs)typeof Gs[v]=="object"&&Xp(Gs[v]);return Object.assign(e,Gs),e},Zr=ah({});Zr.newInstance=()=>ah({});lh.exports=Zr;Zr.HighlightJS=Zr;Zr.default=Zr});var Pi={};Oi(Pi,{animatedPatternN0Def:()=>Lb,animatedPatternN1Def:()=>Fb,caterpillarN0Def:()=>$b,caterpillarN1Def:()=>Wb,caterpillarN2Def:()=>Hb,codeButtonComponentDef:()=>nf,codeOverlayButtonDef:()=>Of,codeOverlayDef:()=>_f,degubButtonComponentDef:()=>Nf,docScrollDef:()=>qg,docsContainerComponentDef:()=>Rb,docsTitleComponentDef:()=>Pb,docsTitleSmallComponentDef:()=>Ab,dynamicCounterDef:()=>f0,dynamicListButtonDef:()=>g0,dynamicListCardDef:()=>h0,dynamicListDef:()=>p0,dynamicListEmptyDef:()=>m0,dynamicListLabelDef:()=>S0,dynamicListRepeaterDef:()=>w0,dynamicListSlotDef:()=>d0,footerComponentDef:()=>rb,footerNavButtonDef:()=>ab,footerNavDef:()=>ib,headerComponentDef:()=>fb,headerNavComponentDef:()=>gb,headerToggleComponentDef:()=>bb,homePageComponentDef:()=>Jb,horizontalScrollerButtonDef:()=>t0,horizontalScrollerDef:()=>e0,horizontalScrollerSectionDef:()=>r0,htmlContentDef:()=>Wf,listContentDef:()=>Hf,loaderDef:()=>zg,navigationButtonDef:()=>Eb,navigationComponentDef:()=>xb,navigationDef:()=>Cb,navigationLabelDef:()=>kb,navigationSubmenuDef:()=>Ib,onlyDesktopDef:()=>jg,pageTransitionComponentDef:()=>Ff,paragraphContentDef:()=>jf,paramsMobJsButtonDef:()=>Zg,paramsMobJsDef:()=>Kg,quickNavDef:()=>tb,routeLoaderDef:()=>Qg,scrollToButtonDef:()=>Jg,scrollToDef:()=>Gg,scrollerN0Def:()=>o0,scrollerN1Def:()=>i0,shapeLeftDef:()=>Mb,shapeRightDef:()=>Nb,snippetContentDef:()=>Vg,spacerContentDef:()=>Wg,svgChild:()=>E0,titleContentDef:()=>Bf});var on="animationStop",Ni=()=>{window.addEventListener("unhandledrejection",e=>{e.reason===on&&e.preventDefault()})};function we(e){let t=e.offsetHeight,r=getComputedStyle(e);return t+=Number.parseInt(r.marginTop)+Number.parseInt(r.marginBottom),t}function ot(e){let t=e.offsetWidth,r=getComputedStyle(e);return t+=Number.parseInt(r.marginLeft)+Number.parseInt(r.marginRight),t}function ie(e){let t=e.getBoundingClientRect();return{top:t.top+window.pageYOffset,left:t.left+window.pageXOffset}}function Ye(e){return e.getBoundingClientRect()}function ro(e,t){let r=t?.parentNode;for(;r;){if(r===e)return!0;r=r?.parentNode}return!1}function mr(e){let t=window.getComputedStyle(e),r=t.transform||t.mozTransform;if(r==="none"||r===void 0)return{x:0,y:0,z:0};let o=r.includes("3d")?"3d":"2d",s=r.match(/matrix.*\((.+)\)/)[1].split(", ");if(o==="2d")return{x:s[4],y:s[5],z:0};if(o==="3d")return{x:s[12],y:s[13],z:s[14]}}function sn(e){return typeof Node=="object"?e instanceof Node:e&&typeof e=="object"&&typeof e.nodeType=="number"&&typeof e.nodeName=="string"}var ve=()=>`_${Math.random().toString(36).slice(2,9)}`;var fr=e=>{setTimeout(()=>e())};var lt="ANY",nn="UNTYPED",Mi="STRING",Li="NUMBER",Fi="OBJECT",Di="FUNCTION",Vo="ARRAY",Vi="BOOLEAN",$i="ELEMENT",Wi="HTMLELEMENT",Bi="NODELIST",$o="SET",Wo="MAP",ue={isString:e=>Object.prototype.toString.call(e)==="[object String]",isNumber:e=>Object.prototype.toString.call(e)==="[object Number]"&&Number.isFinite(e),isObject:e=>Object.prototype.toString.call(e)==="[object Object]",isFunction:e=>Object.prototype.toString.call(e)==="[object Function]",isArray:e=>Object.prototype.toString.call(e)==="[object Array]",isBoolean:e=>Object.prototype.toString.call(e)==="[object Boolean]",isElement:e=>e instanceof Element||e instanceof Document,isHTMLElement:e=>e instanceof HTMLElement,isSet:e=>e instanceof Set,isMap:e=>e instanceof Map,isNodeList:e=>Object.prototype.isPrototypeOf.call(NodeList.prototype,e)},oo=e=>{switch(e){case String:case Mi:return"String";case Number:case Li:return"Number";case Object:case Fi:return"Object";case Function:case Di:return"Function";case Array:case Vo:return"Array";case Boolean:case Vi:return"Boolean";case Element:case $i:return"Element";case HTMLElement:case Wi:return"HTMLElement";case NodeList:case Bi:return"NodeList";case Set:case $o:return"Set";case Map:case Wo:return"Map";case lt:return lt;default:return nn}},Te=(e,t)=>{switch(e){case String:case Mi:return ue.isString(t);case Number:case Li:return ue.isNumber(t);case Object:case Fi:return ue.isObject(t);case Function:case Di:return ue.isFunction(t);case Array:case Vo:return ue.isArray(t);case Boolean:case Vi:return ue.isBoolean(t);case Element:case $i:return ue.isElement(t);case HTMLElement:case Wi:return ue.isHTMLElement(t);case NodeList:case Bi:return ue.isNodeList(t);case Set:case $o:return ue.isSet(t);case Map:case Wo:return ue.isMap(t);case lt:return!0;default:return!0}};var Zd=(e,t)=>e.size===t.size&&[...e.keys()].every(r=>e.get(r)===t.get(r)),Qd=(e,t)=>e.size===t.size&&[...e].every(r=>t.has(r)),em=(e,t)=>{if(e.length!==t.length)return!1;let r=new Set([...e,...t]);for(let o of r){let s=e.filter(i=>i===o).length,n=t.filter(i=>i===o).length;if(s!==n)return!1}return!0},ji=(e,t,r=!1)=>{if(e===null||t===null)return e===t;let s=e,n=t;if(r||(Array.isArray(e)&&(s=[...e].sort()),Array.isArray(t)&&(n=[...t].sort())),typeof s!="object"||typeof n!="object")return s===n;let i=Object.getOwnPropertyNames(s),a=Object.getOwnPropertyNames(n);if(i.length!==a.length)return!1;for(let l of i){let p=s[l],u=n[l];if(typeof p=="object"&&typeof u=="object"){if(ji(p,u,r))continue;return!1}if(p!==u)return!1}return!0},an=(e,t,r)=>{switch(e){case lt:return ji(t,r);case Vo:case Array:return em(t,r);case $o:case Set:return Qd(t,r);case Wo:case Map:return Zd(t,r);default:return t===r}};var ln=(e,t)=>{console.warn(`%c SimpleStore supports an object with a depth of up to 2 levels, set 'Any' type to use obj as value, the input object has ${e} level`,t)},zi=(e,t,r)=>{console.warn(`%c one of this key ${e} defined in computed method of prop to monitor '${t}' prop not exist`,r)},Hi=(e,t)=>{console.warn(`%c SimpleStore, trying to execute set() method: store.${e} not exist`,t)},qi=(e,t,r)=>{console.warn(`%c trying to execute setProp method on '${e}' propierties: setProp methods doesn't allow objects as value, ${JSON.stringify(t)} is an Object`,r)},Ui=(e,t)=>{console.warn(`%c trying to execute setProp method on '${e}' propierties: '${JSON.stringify(e)}' is an objects`,t)},Gi=(e,t,r,o)=>{console.warn(`%c trying to execute setProp method on '${e}' propierties: ${t} is not a ${oo(r)}`,o)},Ji=(e,t,r)=>{console.warn(`%c trying to execute setObj method on '${e}' propierties: setObj methods allow only objects as value, ${t} is not an Object`,r)},Yi=(e,t)=>{console.warn(`%c trying to execute setObj data method on '${e}' propierties: store propierties '${e}' is not an object`,t)},Xi=(e,t,r)=>{console.warn(`%c trying to execute setObj data method: one of these keys '${e}' not exist in store.${t}`,r)},Ki=(e,t,r)=>{console.warn(`%c trying to execute setObj data method on '${e}' propierties: '${JSON.stringify(t)}' have a depth > 1, nested obj is not allowed`,r)},Zi=(e,t,r,o,s)=>{console.warn(`%c trying to execute setObj data method on ${e}.${t} propierties: ${r} is not a ${oo(o)}`,s)},Qi=(e,t)=>{console.warn(`%c trying to execute get data method: store.${e} not exist`,t)},cn=(e,t)=>{console.warn(`%c trying to execute set data method: store.${e} not exist`,t)},ea=(e,t)=>{console.warn(`%c one of the keys [${e}] is already used as a computed target, or one of the keys coincides with the prop to be changed.`,t)},ta=(e,t)=>{console.warn(`%c SimpleStore error: the property ${e} to watch doesn't exist in store`,t)},ra=(e,t)=>{console.warn(`%c Validation Object error: validation function return undefined or have you used Object instead '${t}' ?`,e)};var Bo=e=>{if(!ue.isObject(e))return 0;let t=Object.values(e);return t.length===0?1:Math.max(...t.map(r=>Bo(r)))+1},oa=(e,t=!0)=>Object.entries(e).reduce((r,o)=>{let[s,n]=o,i=ue.isFunction(n)?n():{};return ue.isObject(n)&&t?{...r,[s]:oa(n,!1)}:ue.isFunction(n)&&ue.isObject(i)&&"value"in i&&("validate"in i||"type"in i||"skipEqual"in i)?{...r,[s]:i.value}:{...r,[s]:n}},{}),sa=(e,t,r,o=!0)=>Object.entries(e).reduce((s,n)=>{let[i,a]=n,l=ue.isFunction(a)?a():{};if(ue.isObject(a)&&o)return{...s,[i]:sa(a,t,r,!1)};if(ue.isFunction(a)&&ue.isObject(l)&&"value"in l&&t in l){let p=ue.isString(l[t])?l[t].toUpperCase():l[t];return{...s,[i]:p}}return{...s,[i]:r}},{}),na=({data:e,depth:t,logStyle:r})=>t>2?(ln(t,r),{}):oa(e),so=({data:e,prop:t,depth:r,logStyle:o,fallback:s})=>r>2?(ln(r,o),{}):sa(e,t,s),ia=({value:e})=>Te(Map,e)?new Map(e):Te(Set,e)?new Set(e):Te(Object,e)?{...e}:Te(Array,e)?[...e]:e;var gr=class{constructor(t={}){this.logStyle="padding: 10px;",this.callBackWatcher=new Map,this.callBackComputed=new Set,this.computedPropFired=new Set,this.computedWaitList=new Set,this.validationStatusObject={},this.dataDepth=Bo(t),this.computedRunning=!1,this.store=na({data:t,depth:this.dataDepth,logStyle:this.logStyle}),this.type=so({data:t,prop:"type",depth:this.dataDepth,logStyle:this.logStyle,fallback:nn}),this.fnValidate=so({data:t,prop:"validate",depth:this.dataDepth,logStyle:this.logStyle,fallback:()=>!0}),this.strict=so({data:t,prop:"strict",depth:this.dataDepth,logStyle:this.logStyle,fallback:!1}),this.skipEqual=so({data:t,prop:"skipEqual",depth:this.dataDepth,logStyle:this.logStyle,fallback:!0}),this.inizializeValidation()}inizializeValidation(){for(let t in this.store)ue.isObject(this.store[t])&&(this.validationStatusObject[t]={});Object.entries(this.store).forEach(t=>{let[r,o]=t;this.set(r,o,!1)})}runCallbackQueqe({prop:t,newValue:r,oldValue:o,validationValue:s}){for(let{prop:n,fn:i}of this.callBackWatcher.values())n===t&&i(r,o,s)}async runCallbackQueqeAsync({prop:t,newValue:r,oldValue:o,validationValue:s}){for(let{prop:n,fn:i}of this.callBackWatcher.values())n===t&&await i(r,o,s)}fireComputed(){this.computedWaitList.forEach(t=>{this.callBackComputed.forEach(r=>{let{prop:o,keys:s,fn:n}=r,i=Object.keys(this.store);if(!s.every(m=>i.includes(m))){zi(s,o,this.logStyle);return}if(!s.includes(t))return;let p=s.map(m=>this.store[m]);if(!this.computedPropFired.has(o)){let m=n(...p);this.set(o,m),this.computedPropFired.add(o)}})}),this.computedPropFired.clear(),this.computedWaitList.clear(),this.computedRunning=!1}addToComputedWaitLsit(t){this.callBackComputed.size!==0&&(this.computedWaitList.add(t),this.computedRunning||(this.computedRunning=!0,fr(()=>this.fireComputed())))}set(t,r,o=!0,s=!1){if(!(t in this.store)){Hi(t,this.logStyle);return}let n=s?ia({value:this.store[t]}):this.store[t],i=Te(Function,r)&&!Te(Function,n)&&this.type[t]!==Function?r(n):r,a=this.type[t]===lt;ue.isObject(n)&&!a?this.setObj(t,i,o):this.setProp(t,i,o)}setProp(t,r,o=!0){let s=this.type[t]===lt;if(ue.isObject(r)&&!s){qi(t,r,this.logStyle);return}if(ue.isObject(this.store[t])&&!s){Ui(t,this.logStyle);return}if(!Te(this.type[t],r)){Gi(t,r,this.type[t],this.logStyle);return}let i=this.store[t],a=this.fnValidate[t]?.(r,i);this.strict[t]&&!a||(this.validationStatusObject[t]=a,this.skipEqual[t]?an(this.type[t],i,r):!1)||(this.store[t]=r,o&&this.runCallbackQueqe({prop:t,newValue:r,oldValue:i,validationValue:this.validationStatusObject[t]}),this.addToComputedWaitLsit(t))}setObj(t,r,o=!0){if(!ue.isObject(r)){Ji(t,r,this.logStyle);return}if(!ue.isObject(this.store[t])){Yi(t,this.logStyle);return}let s=Object.keys(r),n=Object.keys(this.store[t]);if(!s.every(b=>n.includes(b))){Xi(s,t,this.logStyle);return}if(!Object.entries(r).map(b=>{let[S,x]=b,C=Te(this.type[t][S],x);return C||Zi(t,S,x,this.type[t][S],this.logStyle),C}).every(b=>b===!0))return;let l=Object.entries(r).map(b=>{let[S,x]=b,C=this.store[t][S];return this.strict[t][S]?{strictCheck:this.fnValidate[t][S]?.(x,C),item:b}:{strictCheck:!0,item:b}}).filter(({strictCheck:b})=>b===!0);if(l.length===0)return;let u=Object.fromEntries(l.map(({item:b})=>b).map(([b,S])=>[b,S]));Object.entries(u).forEach(b=>{let[S,x]=b,C=this.store[t][S],P=this.fnValidate[t][S]?.(x,C);P===void 0&&ra(this.logStyle,lt),this.validationStatusObject[t][S]=P});let m=this.store[t],d={...this.store[t],...u};Object.keys(u).every(b=>this.skipEqual[t][b]===!0)&&Object.entries(d).every(([b,S])=>{let x=this.type[t][b]===lt;if(Bo(S)>1&&!x){Ki(t,r,this.logStyle);return}return an(this.type[t][b],m[b],S)})||(this.store[t]=d,o&&this.runCallbackQueqe({prop:t,newValue:this.store[t],oldValue:m,validationValue:this.validationStatusObject[t]}),this.addToComputedWaitLsit(t))}quickSetProp(t,r){let o=this.store[t];this.store[t]=r,this.runCallbackQueqe({prop:t,newValue:r,oldValue:o,validationValue:!0})}get(){return this.store}getProp(t){if(t in this.store)return this.store[t];Qi(t,this.logStyle)}getValidation(){return this.validationStatusObject}watch(t,r=()=>{}){if(!(t in this.store))return ta(t,this.logStyle),()=>{};let o=ve();return this.callBackWatcher.set(o,{fn:r,prop:t}),()=>this.callBackWatcher.delete(o)}emit(t){t in this.store?this.runCallbackQueqe({prop:t,newValue:this.store[t],oldValue:this.store[t],validationValue:this.validationStatusObject[t]}):cn(t,this.logStyle)}async emitAsync(t){return t in this.store?(await this.runCallbackQueqeAsync({prop:t,newValue:this.store[t],oldValue:this.store[t],validationValue:this.validationStatusObject[t]}),{success:!0}):(cn(t,this.logStyle),{success:!1})}debugStore(){console.log(this.store)}debugValidate(){console.log(this.validationStatusObject)}setStyle(t){this.logStyle=t}computed(t,r,o){if([...this.callBackComputed,{prop:t,keys:r,fn:o}].flatMap(a=>a.prop).some(a=>r.includes(a))){ea(r,this.logStyle);return}this.callBackComputed.add({prop:t,keys:r,fn:o})}destroy(){this.callBackWatcher.clear(),this.callBackComputed.clear(),this.computedPropFired.clear(),this.computedWaitList.clear(),this.validationStatusObject={},this.store={},this.type={},this.fnValidate={},this.strict={},this.skipEqual={}}};var le=new gr({usePassive:!0,currentFrame:0,instantFps:60,requestFrame:()=>{},fpsScalePercent:()=>({value:{0:1,30:2,50:3},type:"Any"}),useScaleFps:!0,deferredNextTick:!0,throttle:60});var un=!1,no=new Map;function aa(){if(no.size===0){window.removeEventListener("DOMContentLoaded",aa),un=!1;return}for(let e of no.values())e();no.clear()}function tm(){un||(un=!0,window.addEventListener("DOMContentLoaded",aa,{passive:!1}))}var rm=e=>{let t=ve();return no.set(t,e),typeof window<"u"&&tm(),()=>no.delete(t)},la=rm;function jo(e){let t=0,r=0,o=0,s=0;return"detail"in e&&(r=e.detail),"wheelDelta"in e&&(r=-e.wheelDelta/120),"wheelDeltaY"in e&&(r=-e.wheelDeltaY/120),"wheelDeltaX"in e&&(t=-e.wheelDeltaX/120),"axis"in e&&e.axis===e.HORIZONTAL_AXIS&&(t=r,r=0),o=t*10,s=r*10,"deltaY"in e&&(s=e.deltaY),"deltaX"in e&&(o=e.deltaX),(o||s)&&e.deltaMode&&(e.deltaMode==1?(o*=40,s*=40):(o*=800,s*=800)),o&&!t&&(t=o<1?-1:1),s&&!r&&(r=s<1?-1:1),{spinX:t,spinY:r,pixelX:o,pixelY:s}}function om({type:e,e:t}){return e==="touchend"&&t.changedTouches?t.changedTouches[0]:t.touches?t.touches[0]:t}function sm({type:e,e:t}){return e==="touchend"&&t.changedTouches?t.changedTouches[0]:t.touches?t.touches[0]:t}function At(e){let t=!1,r=new Map,{usePassive:o}=le.get();le.watch("usePassive",()=>{window.removeEventListener(e,s),t=!1,n()});function s(a){if(r.size===0){window.removeEventListener(e,s),t=!1;return}let l=a.type,{pageX:p,pageY:u}=om({type:l,e:a}),{clientX:m,clientY:d}=sm({type:l,e:a}),f=a.target,T={page:{x:p,y:u},client:{x:m,y:d},target:f,type:l,preventDefault:()=>o?()=>{}:a.preventDefault()};if(l==="wheel"){let{spinX:b,spinY:S,pixelX:x,pixelY:C}=jo(a);Object.assign(T,{spinX:b,spinY:S,pixelX:x,pixelY:C})}for(let b of r.values())b(T)}function n(){t||(t=!0,o=le.getProp("usePassive"),window.addEventListener(e,s,{passive:o}))}return a=>{let l=ve();return r.set(l,a),typeof window<"u"&&n(),()=>r.delete(l)}}var ca=At("click"),ua=At("mousedown"),pa=At("touchstart"),ha=At("mousemove"),da=At("touchmove"),ma=At("mouseup"),fa=At("touchend"),ga=At("wheel");var pn=0,Xt=0,Ve={},nm=(e={},t=()=>{})=>{Ve[pn]={el:e,fn:t,data:{}};let r=pn;return pn++,{id:r,unsubscribe:()=>{if(Ve?.[r]){let o=Object.keys(Ve[r].data).length;Xt=Xt-o,delete Ve[r]}}}},im=({id:e,callBackObject:t,frame:r})=>{if(!Ve[e])return;let{currentFrame:o}=le.get(),{data:s}=Ve[e];s[r+o]||(s[r+o]=t,Xt++)},am=e=>{e in Ve&&delete Ve[e]},lm=e=>{let t=Ve?.[e];if(!t)return;let r=Object.keys(t.data).length;Xt=Xt-r,t.data={}},cm=e=>Ve?.[e]??{},um=(e,t)=>{Object.values(Ve).forEach(({data:r,fn:o,el:s})=>{let n=r?.[e];n&&(t&&o(n,s),r[e]=null,delete r[e],Xt--)})},pm=({id:e,obj:t={}})=>{if(!Ve?.[e])return;let{el:r,fn:o}=Ve[e];o(t,r)},hm=()=>Xt,dm=e=>{Object.values(Ve).forEach(({data:t})=>{Object.keys(t).forEach(r=>{delete Object.assign(t,{[`${Number.parseInt(r)-e}`]:t[r]})[r]})})},br={add:nm,get:cm,update:im,remove:am,clean:lm,fire:um,fireObject:pm,getCacheCounter:hm,updateFrameId:dm};var hn=!1,zo=new Map;function ba(){if(zo.size===0){window.removeEventListener("visibilitychange",ba),hn=!1;return}let e={visibilityState:document.visibilityState};for(let t of zo.values())t(e)}function mm(){hn||(hn=!0,window.addEventListener("visibilitychange",ba,{passive:!1}))}var fm=e=>{let t=ve();return zo.set(t,e),typeof window<"u"&&mm(),()=>zo.delete(t)},Ho=fm;var io=[],gm=(e=()=>{},t=100)=>{io.push({cb:e,priority:t})},bm=({time:e,fps:t,shouldRender:r})=>{io.length!==0&&(io.sort((o,s)=>o.priority-s.priority),io.forEach(({cb:o})=>o({time:e,fps:t,shouldRender:r})),io.length=0)},ct={add:gm,fire:bm};var dn=[],ym=e=>{dn.push(e)},vm=()=>{let e=[...dn];return dn.length=0,e},qo={add:ym,get:vm};var Tt={},Uo=0,wm=e=>{Object.keys(Tt).forEach(t=>{delete Object.assign(Tt,{[`${Number.parseInt(t)-e}`]:Tt[t]})[t]})},Sm=({currentFrame:e,time:t,fps:r,shouldRender:o})=>{let s=Tt[e];s&&(s.forEach(n=>n({time:t,fps:r,shouldRender:o})),Tt[e]=null,delete Tt[e],Uo=Uo-1)},Tm=(e,t)=>{let r=t+le.getProp("currentFrame");Tt[r]?Tt[r].push(e):(Tt[r]=[e],Uo++),le.emit("requestFrame")},xm=()=>Uo,yr={add:Tm,fire:Sm,updateKeys:wm,getAmountOfFrameToFire:xm};var ya=!1,Go=(e=30)=>{if(ya){let{instantFps:t}=le.get();return new Promise(r=>{r({averageFPS:t})})}return new Promise(t=>{let r=[],s=0,n=0,i=0,a=0,l=0,p=u=>{u*=.001;let m=u-a;a=u;let d=Number.isFinite(1/m)?1/m:60,f=Math.max(d,60);i+=f-(r[s]||0),r[s++]=f,n=Math.max(n,s),s%=25;let T=Math.round(i/n);if(l++,l>=e){le.quickSetProp("instantFps",T),ya=!0,t({averageFPS:T});return}requestAnimationFrame(p)};requestAnimationFrame(p)})};var ut=()=>typeof window>"u"?Date.now():window.performance.now(),va=16.666666666666668;Go();var mn=1e7,xa=2e3,vn=!1,_t=[],ke=ut(),wa=0,fn=0,gn=0,wn=0,bn=0,vr=!1,Ae=60,Sr=Ae,Jo=0,Yo=0,xt=0,yn=-1,wr=!0,Ca=le.getProp("fpsScalePercent"),Ia=le.getProp("useScaleFps"),Xo=!1,Ko=!1,Cm=()=>Ae<Sr/5*3,Im=()=>Ae<Sr/5*4,Em=()=>{!Cm()||Xo||(Xo=!0,setTimeout(()=>{Xo=!1},4e3))},km=()=>{!Im()||Ko||(Ko=!0,setTimeout(()=>{Ko=!1},4e3))};Ho(({visibilityState:e})=>{vr=e==="visible"});Ni();le.watch("requestFrame",()=>{Zo()});var Rm=()=>{if(!Ia)return!0;let e=Object.entries(Ca).reduce((t,[r,o])=>{let s=Math.abs(Sr-Ae);return Math.round(s*100/Sr)>Number.parseInt(r)?o:t},1);return yn=(yn+1)%e,yn===0},Sa=()=>{xt===mn&&(xt=0,le.quickSetProp("currentFrame",xt),yr.updateKeys(mn),br.updateFrameId(mn)),ct.fire({time:ke,fps:Ae,shouldRender:wr}),_t=[..._t,...qo.get()],vn=!1,_t.length>0||yr.getAmountOfFrameToFire()>0||br.getCacheCounter()>0||ke<xa?Zo():(vr=!0,xt=0,wn=ke,le.quickSetProp("currentFrame",xt))},Ta=e=>{ke=e,gn=ke-fn,vr&&(wa+=gn),fn+=gn,ke=Math.round(fn-wa);let t=Math.round(1e3/Ae);bn=Math.abs(ke-wn-t);let r=bn>100?bn:0;ke=ke-r,wn=ke,vr?(Yo=ke,Jo=0,Ae=le.getProp("instantFps")):Jo++,ke>Yo+1e3&&!vr&&(Ae=ke>xa?Math.round(Jo*1e3/(ke-Yo)):le.getProp("instantFps"),Yo=ke,Jo=0,Ae=Ae<30?le.getProp("instantFps"):Ae,Ca=le.getProp("fpsScalePercent"),Ia=le.getProp("useScaleFps")),Ae>Sr&&(Sr=Ae),wr=Rm(),Em(),km(),_t.forEach(s=>s({time:ke,fps:Ae,shouldRender:wr})),yr.fire({currentFrame:xt,time:ke,fps:Ae,shouldRender:wr}),br.fire(xt,wr),xt++,le.quickSetProp("currentFrame",xt),_t.length=0,vr=!1,le.getProp("deferredNextTick")?fr(()=>Sa()):Sa()},Zo=()=>{vn||(typeof window>"u"?setTimeout(()=>Ta(ut()),va):requestAnimationFrame(Ta),vn=!0)},Xe={add:i=>{_t.push(i),Zo()},addMultiple:(i=[])=>{_t=[..._t,...i],Zo()},getFps:()=>Ae,mustMakeSomething:()=>Xo,shouldMakeSomething:()=>Ko,getShouldRender:()=>wr};var Qo=function(t,r=200){let o;return function(){let s=()=>Reflect.apply(t,this,arguments);clearTimeout(o),o=setTimeout(s,r)}};var Sn=!1,es=new Map,Tn=()=>{},Ea=window.innerHeight,ka=window.innerWidth;function Pm(){if(es.size===0){window.removeEventListener("resize",Tn),Sn=!1;return}let e=window.innerHeight,t=window.innerWidth,r=e!==Ea,o=t!==ka;Ea=e,ka=t;let s={scrollY:window.pageYOffset,windowsHeight:e,windowsWidth:t,documentHeight:document.documentElement.scrollHeight,verticalResize:r,horizontalResize:o};for(let n of es.values())n(s)}function Am(){Sn||(Sn=!0,Tn=Qo(()=>Pm()),window.addEventListener("resize",Tn,{passive:!1}))}var _m=e=>{let t=ve();return es.set(t,e),typeof window<"u"&&Am(),()=>es.delete(t)},Ra=_m;var xn=!1,ts=new Map,Om="UP",_a="DOWN",Pa=window.pageYOffset,ao=window.pageYOffset,Cn=_a,Aa={scrollY:ao,direction:Cn};function Oa(){if(ts.size===0){window.removeEventListener("scroll",Oa),xn=!1;return}Pa=ao,ao=window.scrollY,Cn=ao>Pa?_a:Om,Aa={scrollY:ao,direction:Cn};for(let e of ts.values())e(Aa)}function Nm(){xn||(xn=!0,window.addEventListener("scroll",Oa,{passive:!0}))}var Mm=e=>{let t=ve();return ts.set(t,e),typeof window<"u"&&Nm(),()=>ts.delete(t)},Ct=Mm;var In=!1,rs=new Map,Na=()=>{};function Lm(e){if(rs.size===0){Na(),In=!1;return}Xe.add(()=>{ct.add(()=>{for(let t of rs.values())t(e)},0)})}function Fm(){In||(In=!0,Na=Ct(Lm))}var Dm=e=>{let t=ve();return rs.set(t,e),typeof window<"u"&&Fm(),()=>rs.delete(t)},Ma=Dm;var La=(e,t)=>{let r,o;return function(){let s=this,n=arguments;o?(clearTimeout(r),r=setTimeout(function(){ut()-o>=t&&(e.apply(s,n),o=ut())},t-(ut()-o))):(e.apply(s,n),o=ut())}};var En=!1,os=new Map,Fa,Da=()=>{};function Vm(e){if(os.size===0){Da(),En=!1;return}Xe.add(()=>{ct.add(()=>{for(let t of os.values())t(e)},0)})}function $m(){En||(En=!0,Fa=La(e=>Vm(e),le.getProp("throttle")),Da=Ct(Fa))}var Wm=e=>{let t=ve();return os.set(t,e),typeof window<"u"&&$m(),()=>os.delete(t)},Va=Wm;var $a=()=>{},Wa=()=>{},Ba=()=>{};function ja(e){let t=!1,r=new Map,o=!1;function s(){if(o=!1,r.size===0){Wa(),e==="START"&&$a(),t=!1;return}Xe.add(()=>{ct.add(()=>{let a={scrollY:window.pageYOffset};if(e==="END")for(let l of r.values())l(a)},0)})}function n(){t||(t=!0,Ba=Qo(()=>s()),Wa=Ct(Ba),e==="START"&&($a=Ct(({scrollY:a})=>{let l={scrollY:a};if(!o){o=!0;for(let p of r.values())p(l)}})))}return a=>{let l=ve();return r.set(l,a),typeof window<"u"&&n(),()=>r.delete(l)}}var za=ja("START"),Ha=ja("END");var c={createStore(e={}){return new gr(e)},getInstantFps(){return le.getProp("instantFps")},getFps(){return Xe.getFps()},getShouldRender(){return Xe.getShouldRender()},mustMakeSomething(){return Xe.mustMakeSomething()},shouldMakeSomething(){return Xe.shouldMakeSomething()},useFrame(e=()=>{}){return Xe.add(e)},useNextTick(e=()=>{}){return ct.add(e)},useNextFrame(e=()=>{}){return qo.add(e)},useFrameIndex(e=()=>{},t=0){return yr.add(e,t)},async useFps(e=()=>{}){let t=await Go();return e(t),t},useLoad(e=()=>{}){return la(e)},useCache:br,useResize(e=()=>{}){return Ra(e)},useVisibilityChange(e=()=>{}){return Ho(e)},useMouseClick(e=()=>{}){return ca(e)},useMouseDown(e=()=>{}){return ua(e)},useTouchStart(e=()=>{}){return pa(e)},useMouseMove(e=()=>{}){return ha(e)},useTouchMove(e=()=>{}){return da(e)},useMouseUp(e=()=>{}){return ma(e)},useTouchEnd(e=()=>{}){return fa(e)},useMouseWheel(e=()=>{}){return ga(e)},useScroll(e=()=>{}){return Ma(e)},useScrollImmediate(e=()=>{}){return Ct(e)},useScrollThrottle(e=()=>{}){return Va(e)},useScrollStart(e=()=>{}){return za(e)},useScrollEnd(e=()=>{}){return Ha(e)},checkType(e,t){return Te(e,t)},getTypeName(e){return oo(e)},getUnivoqueId(){return ve()},getTime(){return ut()},useNextLoop(e){fr(e)},store:le,normalizeWheel:jo,ANIMATION_STOP_REJECT:on};var H=new Map;var ss=({id:e="",value:t})=>{if(!e||e==="")return;let r=H.get(e);r&&H.set(e,{...r,currentRepeaterState:t,isRepeater:!0})},Tr=({id:e=""})=>!e||e===""?!1:H.get(e)?.currentRepeaterState;var qa=({id:e="",newElement:t=document.createElement("div")})=>{if(!e||e==="")return;let r=H.get(e);r&&H.set(e,{...r,element:t})},st=({id:e=""})=>!e||e===""?void 0:H.get(e)?.element,ns=({element:e})=>[...H.values()].find(r=>r?.element===e)?.id??"",is=({key:e="",parentId:t="",container:r=document.createElement("div")})=>{if(!e||e==="")return;let s=[...H.values()].find(({key:n,parentId:i,element:a})=>n===e&&i===t&&r.contains(a))?.element;if(!s){console.warn("getElementByKey failed no element found");return}return s};var as="data-mobjs",Ua="mobjs",Ot="staticprops",xr="bindprops",Ga="name",Ja="name",Ya="slot",ls="repeatid",Cr="repeaterchild",cs="key",Ir="currentlistvalue",us="bindevents",pt="weakbindevents",Nt="parentid",ps="ref";var Er={current:{},index:-1},ht="UNSET";var O=c.createStore({contentId:()=>({value:"",type:String}),rootElement:()=>({value:document.createElement("div"),type:HTMLElement}),index:()=>({value:"",type:String}),pageNotFound:()=>({value:"",type:String}),componentList:()=>({value:{},type:"any"}),routeList:()=>({value:{},type:"any"}),activeRoute:()=>({value:"",type:String,skipEqual:!1}),beforeRouteLeave:()=>({value:"",type:String,skipEqual:!1}),beforeRouteChange:()=>({value:"",type:String,skipEqual:!1}),atfterRouteChange:()=>({value:"",type:String,skipEqual:!1}),routeIsLoading:()=>({value:!1,type:Boolean}),repeaterParserRoot:()=>({value:document.createElement("div"),type:HTMLElement})});var Xa=({contentId:e=""})=>{O.set("contentId",e)},Ka=()=>{let{contentId:e}=O.get();return e},Za=()=>{let{rootElement:e}=O.get();return e},Qa=({element:e})=>{O.set("rootElement",e)};var kr=new Map,Mt=new WeakMap,kn=[],el=[],tl=(e=[])=>{let t=Te(Object,e)?[e]:e,r=c.getUnivoqueId();return kr.set(r,t),r},Bm=e=>{let t=e?.parentNode;for(;t;){if(Mt.has(t))return{target:t,data:Mt.get(t)};t=t?.parentNode}return{target:null,data:null}},jm=e=>Mt.get(e)?{target:e,data:Mt.get(e)}:Bm(e);function zm(e,t){let r=t.target,{target:o,data:s}=jm(r);if(!s||!document.contains(o))return;let n=s.find(({event:p})=>p===e);if(!n)return;let{callback:i}=n,a=ns({element:o}),l=a?Tr({id:a}):Er;Object.defineProperty(t,"target",{value:o}),i(t,l)}var rl=e=>{[...e.parentNode?.querySelectorAll(`[${pt}]`)??[]].forEach(s=>{let n=s.getAttribute(pt)??"";s.removeAttribute(pt);let i=kr.get(n);kr.delete(n);let a=i?.flatMap(l=>Object.entries(l).map(p=>{let[u,m]=p;return kn.includes(u)||kn.push(u),{event:u,callback:m}}));Mt.set(s,a)});let o=Za();kn.forEach(s=>{el.includes(s)||(el.push(s),o.addEventListener(s,zm.bind(null,s)))})};var Kt=new Map,hs=(e={})=>{let t=c.getUnivoqueId();return Kt.set(t,e),t},ds=(e="")=>{let t=Kt.get(e);return Kt.delete(e),t??{}},ol=({propsId:e})=>{e&&Kt.delete(e)},sl=()=>{Kt.clear()};var g=(e,...t)=>String.raw({raw:e},...t);var Rn={isolateCreation:!1,isolateOnMount:!1,scoped:!1,maxParseIteration:5e3,debug:!1},Pn=e=>{Rn={...Rn,...e}},Lt=()=>Rn,k=({name:e="",component:t=()=>{},state:r={},exportState:o=[],isolateCreation:s=ht,isolateOnMount:n=ht,scoped:i=ht,constructorCallback:a=()=>{},connectedCallback:l=()=>{},disconnectedCallback:p=()=>{},adoptedCallback:u=()=>{},attributeToObserve:m=[],attributeChangedCallback:d=()=>{},style:f=""})=>({[e]:{componentFunction:t,componentParams:{exportState:o,isolateCreation:s,isolateOnMount:n,scoped:i,state:r,constructorCallback:a,connectedCallback:l,disconnectedCallback:p,adoptedCallback:u,attributeToObserve:m,attributeChangedCallback:d,styleSlot:f}}});var Rr=new Map,nl=(e=[])=>{let t=Te(Object,e)?[e]:e,r=c.getUnivoqueId();return Rr.set(r,t),r},il=({element:e,componentId:t,bindEventsId:r})=>{let o=Rr.get(r);o&&(o.forEach(s=>{let[n]=Object.keys(s),[i]=Object.values(s);!n||!i||e.addEventListener(n,a=>{let l=Tr({id:t});i(a,l)})}),Rr.delete(r))},al=()=>{Rr.clear()};function*$e(e){if(e){yield e;for(let t of e.children)yield*$e(t)}}function Hm(e,t){let r=[];for(let o of $e(e)){if(r.length>0&&t)break;o?.getIsPlaceholder?.()&&r.push(o)}return r}var ms=(e,t=!0)=>{let r=[],o=e||document.body;for(let s of o.children)r=[...r,...Hm(s,t)];return r};var ll=({currentChild:e,id:t="",componentName:r=""})=>{let o=e?.[r]??[];return e[r]=[...o,t],e},cl=({currentChild:e,id:t="",componentName:r=""})=>{let o=e?.[r]??[];return e[r]=o.filter(s=>t!==s),e},ul=({props:e,store:t})=>{Object.entries(e).forEach(([r,o])=>{t.set(r,o)})};var Pr=(e="")=>{if(!e||e==="")return;let r=H.get(e)?.parentId;if(r)return r},pl=({id:e=""})=>{if(!e||e==="")return;let t=H.get(e),r=t?.parentId,o=t?.component??"";if(r)for(let[s,n]of H){let{child:i}=n;if(!i)break;s===r&&H.set(s,{...n,child:{...i,...ll({currentChild:i,id:e,componentName:o})}})}},hl=({componentId:e})=>{let t=H.get(e);if(!t)return;let{element:r,parentId:o}=t;if(o&&o.length>0)return;let n=r?.parentNode?.closest(`[${as}]`),i=n&&(!o||o==="")?{...t,parentId:n?.dataset[Ua]??""}:t;H.set(e,i)},dl=({element:e,id:t})=>{ms(e,!1).forEach(o=>{o.setParentId(t)})};var fs=({id:e="",unWatchArray:t=[]})=>{let r=H.get(e);if(!r)return;let{parentPropsWatcher:o}=r;o&&H.set(e,{...r,parentPropsWatcher:[...o,...t]})},ml=({id:e=""})=>{if(!e||e==="")return;(H.get(e)?.parentPropsWatcher??[]).forEach(o=>{o()})};var gs=({componentName:e,currentProps:t={}})=>{let{componentList:r}=O.get(),o=r?.[e]?.componentParams?.exportState??[];return Object.entries(t).filter(([s])=>o.includes(s)).reduce((s,n)=>{let[i,a]=n;return{...s,[i]:a}},{})},fl=({componentName:e,propName:t})=>{let{componentList:r}=O.get();return(r?.[e]?.componentParams?.exportState??[]).includes(t)};var bs=({id:e="",prop:t})=>{if(!e||e==="")return;let r=H.get(e);if(!r)return;let{freezedPros:o}=r;o&&H.set(e,{...r,freezedPros:[...o,t]})},lo=({id:e="",prop:t})=>{if(!e||e==="")return;let r=H.get(e);if(!r)return;let{freezedPros:o}=r;o&&H.set(e,{...r,freezedPros:o.filter(s=>s!==t)})},ys=({id:e="",prop:t})=>{if(!e||e==="")return!1;let o=H.get(e)?.freezedPros;return o?o.includes(t):!1};var An=(e="")=>!e||e===""?void 0:H.get(e)?.state?.get(),_e=(e="",t="",r,o=!0)=>{if((!e||e==="")&&(!t||t==="")&&!r||ys({id:e,prop:t}))return;let n=H.get(e),i=n?.state,a=n?.component??"";if(!fl({componentName:a,propName:t}))return console.warn(`setStateById failed ${t} in: ${a} is not exportable, maybe a slot bind state that not exist here?`),null;if(!i)return console.warn(`setStateById failed no id found on prop: ${t}`),null;i.set(t,r,o)};var co=(e="",t="",r=()=>{})=>(!e||e==="")&&(!t||t==="")?void 0:H.get(e)?.state?.watch(t,r);var Ke=new Map,bl=e=>{if(!("bind"in e&&"props"in e)){console.warn("bindProps not valid");return}let r=c.getUnivoqueId();return Ke.set(r,{...e,componentId:"",propsId:r}),r},gl=({componentId:e,bind:t,props:r,currentParentId:o,fireCallback:s})=>{if(!o)return;let n=An(o);if(!n)return;let i=Object.keys(n);t.every(d=>i.includes(d))||console.warn(`bind props error: Some prop ${JSON.stringify(t)} doesn't exist`);let l=t.map(d=>({[d]:n[d]})).reduce((d,f)=>({...d,...f}),{});if(!H.has(e))return;let u=Tr({id:e}),m=r?.({...l,_current:u.current,_index:u.index});m&&Object.entries(m).forEach(([d,f])=>{_e(e,d,f,s)})},_n=({propsId:e,componentId:t})=>{if(e){for(let[r,o]of Ke)r===e&&Ke.set(r,{...o,componentId:t});On({componentId:t,inizilizeWatcher:!1})}},yl=({componentId:e})=>{if(e)for(let[t,r]of Ke){let{componentId:o}=r;o===e&&Ke.delete(t)}},vl=({propsId:e})=>{e&&Ke.delete(e)},On=({componentId:e,inizilizeWatcher:t})=>{let r=[...Ke.values()].filter(o=>o?.componentId===e);if(r&&(r.forEach(o=>{let{bind:s,props:n,parentId:i}=o,a=i??Pr(e);if(!t){gl({componentId:e,bind:s,props:n,currentParentId:a??"",fireCallback:!0});return}let l=!1,p=s.map(u=>co(a,u,()=>{l||(l=!0,c.useNextLoop(()=>{gl({componentId:e,bind:s,props:n,currentParentId:a??"",fireCallback:!0}),l=!1}))}));fs({id:e,unWatchArray:p})}),!!t))for(let[o,s]of Ke){let{componentId:n}=s;n===e&&Ke.delete(o)}},wl=()=>{Ke.clear()};var Zt=new Map,Sl=({repeatId:e,repeaterParentId:t,targetComponent:r})=>{Zt.has(e)||Zt.set(e,{repeatId:e,repeaterParentId:t,targetComponent:r})},Nn=({id:e})=>{let t=Zt.get(e);if(t)return t?.targetComponent},Tl=({id:e})=>{for(let[t,r]of Zt){let{repeaterParentId:o}=r;o===e&&Zt.delete(t)}};var Ze=({id:e=""})=>{if(!e||e==="")return;let t=[...H.values()],{component:r,element:o}=t.find(({id:l})=>l===e)||{};if(!o||!r)return;let n=H.get(e)?.child??{};Object.values(n).flat().forEach(l=>{Ze({id:l})});let a=t.find(({child:l})=>(l?.[r]??[]).includes(e))?.id;for(let[l,p]of H){let{child:u}=p;if(!u)break;if(l===a&&H.set(l,{...p,child:{...u,...cl({currentChild:u,id:e,componentName:r})}}),l===e){let{state:m,destroy:d,parentPropsWatcher:f}=p;d(),m.destroy(),f&&f.forEach(T=>T()),Tl({id:l}),yl({componentId:l})}}H.delete(e),o?.removeCustomComponent?.(),o?.remove()},xl=()=>{[...H.values()].filter(({isCancellable:t})=>t).forEach(({id:t})=>Ze({id:t}))},Ar=()=>{[...H.values()].filter(({element:t,isCancellable:r})=>r&&!document.body.contains(t)).forEach(({id:t})=>Ze({id:t})),sl(),al(),wl()},Cl=({cb:e=()=>{},id:t=null})=>{if(!t)return;let r=H.get(t);r&&H.set(t,{...r,destroy:e})};var Mn=0,Il=()=>{Mn+=1},Ln=()=>(Mn-=1,Mn);function qm(e){let t=[];for(let r of $e(e))r?.isUserComponent&&r?.getSlotPosition?.()&&t.push(r);return t}var El=e=>{let t=[],r=e||document.body;for(let o of r.children)t=[...t,...qm(o)];return t};function Um(e){let t=[];for(let r of $e(e))r?.isSlot&&r?.getSlotName?.()&&t.push(r);return t}var kl=e=>{let t=[],r=e||document.body;for(let o of r.children)t=[...t,...Um(o)];return t};function Gm(e,t){for(let r of $e(e))if(r?.isSlot&&r?.getSlotName?.()===t)return r;return null}var Rl=(e,t)=>{let r=e||document.body;for(let o of r.children){let s=Gm(o,t);if(s)return s}return null};function Jm(e){for(let t of $e(e))if(t?.isSlot&&!t?.getSlotName?.())return t;return null}var Pl=e=>{let t=e||document.body;for(let r of t.children){let o=Jm(r);if(o)return o}return null};var Ym=({componentParsed:e,content:t})=>{if(e.parentNode)return e.insertAdjacentHTML("afterend",t),e.nextElementSibling},Xm=({element:e})=>{kl(e).forEach(r=>{let o=r.getDynamicProps();o!==""&&vl({propsId:o});let s=r.getStaticProps();s!==""&&ol({propsId:s}),r?.removeCustomComponent(),r?.remove()})},Km=({element:e})=>{let t=El(e);if(t.length===0)return;[...t].map(o=>{let s=o?.getSlotPosition(),n=Rl(e,s);if(!n)return{slot:null,elementMoved:null};n.parentNode?.insertBefore(o,n);let i=n.previousSibling;return{slot:n,elementMoved:i}}).forEach(({slot:o,elementMoved:s})=>{if(!o)return;let n=o.getStaticProps();n&&s?.setPropsFromSlotId?.(n);let i=o.getDynamicProps();i&&s?.setDynamicPropsFromSlotId?.(i),o?.removeCustomComponent(),o?.remove()})},Al=({componentParsed:e,content:t})=>{let r=e.innerHTML,o=Ym({componentParsed:e,content:t});if(o){let s=e.getId(),n=e.getDelegateEventId(),i=Pl(o);i?(i.insertAdjacentHTML("afterend",r),i.remove()):o.insertAdjacentHTML("afterbegin",r),Km({element:o}),Xm({element:o}),n&&o.setAttribute(pt,n);let{debug:a}=Lt();a&&o.setAttribute(as,s??"")}return e.remove(),o},_l=({componentParsed:e,content:t,isolateCreation:r})=>(r===ht?Lt().isolateCreation:r)?new Promise(s=>{c.useFrame(()=>{let n=Al({componentParsed:e,content:t});c.useNextTick(()=>{s({newElement:n})})})}):new Promise(s=>{let n=Al({componentParsed:e,content:t});s({newElement:n})});var Ol=()=>{customElements.define("mobjs-repeater",class extends HTMLElement{#e;constructor(){super(),this.attachShadow({mode:"open"}),this.#e="",this.isRepeater=!0;let{dataset:e}=this.shadowRoot?.host??{};e&&(this.#e=this.shadowRoot?.host.getAttribute(ls))}removeCustomComponent(){this.shadowRoot&&this.parentElement?.removeChild(this)}getRepeatId(){return this.#e}})};var Nl=()=>{customElements.define("mobjs-slot",class extends HTMLElement{#e;#t;#r;constructor(){super(),this.attachShadow({mode:"open"}),this.#e="",this.isSlot=!0;let{dataset:e}=this.shadowRoot?.host??{};e&&(this.#e=this.shadowRoot?.host.getAttribute(Ja),this.#t=this.shadowRoot?.host.getAttribute(Ot),this.#r=this.shadowRoot?.host.getAttribute(xr))}removeCustomComponent(){this.shadowRoot&&this.parentElement?.removeChild(this)}getSlotName(){return this.#e}getStaticProps(){return this.#t}getDynamicProps(){return this.#r}})};var Ml=e=>{Object.entries(e).forEach(([t,r])=>{let{constructorCallback:o,connectedCallback:s,disconnectedCallback:n,adoptedCallback:i,attributeChangedCallback:a,styleSlot:l,attributeToObserve:p}=r.componentParams;customElements.define(t,class extends HTMLElement{#e;#t;#r;#i;#o;#a;#l;#c;#u;#p;#h;#d;#m;#f;#g;#v;#w;#S;#T;#x;#C;#I;#E;#b;#k;#s;#n;#R;static get observedAttributes(){return p}constructor(){super(),this.attachShadow({mode:"open"}),this.active=!1,this.#t=c.getUnivoqueId(),this.#r=()=>{},this.#i=()=>{},this.#o=()=>{},this.#o=()=>{},this.#a=()=>{},this.#l=()=>{},this.#c=()=>{},this.#u=()=>{},this.#p=()=>{},this.#h=()=>{},this.#d=()=>{},this.#m=()=>{},this.#f=()=>{},this.#g=()=>{},this.#e=t,this.#v=!0,this.#w="",this.#S="",this.#T="",this.#x="",this.#C="",this.#I="",this.#E="",this.#b="",this.#k="",this.#s="",this.#n="",this.isUserComponent=!0;let u=this.shadowRoot.host;if(this.#w=u.getAttribute(Ga),this.#S=u.getAttribute(Ot),this.#T=u.getAttribute(xr),this.#k=u.getAttribute(cs),this.#x=u.getAttribute(us),this.#E=u.getAttribute(Ir),this.#b=u.getAttribute(Ya),this.#s=u.getAttribute(Nt)??"",this.#n=u.getAttribute(Cr),this.#R=u.getAttribute(pt),this.#b&&!this.active&&(this.style.visibility="hidden"),this.#n&&this.#n!==""&&Sl({repeatId:this.#n,repeaterParentId:this.#s,targetComponent:this.#e}),this.shadowRoot){let m=document.createElement("style");m.textContent=l,this.shadowRoot.append(m);let d=document.createElement("slot");this.shadowRoot.append(d),o({context:this})}}getComponentName(){return this.#e}setId(u){this.#t=u}getId(){return this.#t}getParentId(){return this.#s}setParentId(u){this.#s=u}getIsPlaceholder(){return this.#v}getInstanceName(){return this.#w}getStaticPropsId(){return this.#S}getDynamicPropsid(){return this.#T}getBindEventsId(){return this.#x}getCurrentKey(){return this.#k}setDynamicPropsFromSlotId(u){this.#C=u}getDynamicPropsFromSlotId(){return this.#C}setPropsFromSlotId(u){this.#I=u}getPropsFromSlotId(){return this.#I}getCurrentListValueId(){return this.#E}getSlotPosition(){return this.#b}getDelegateEventId(){return this.#R}#y(){return{componentId:this.#t,emit:this.#r,emitAsync:this.#i,freezeProp:this.#o,getChildren:this.#a,getParentId:this.#l,getState:this.#c,remove:this.#u,setState:this.#p,unBind:this.#h,unFreezeProp:this.#d,watch:this.#m,watchSync:this.#f,watchParent:this.#g}}resetData(){this.active=!1,this.#t="",this.#r=()=>{},this.#i=()=>{},this.#o=()=>{},this.#a=()=>{},this.#l=()=>{},this.#c=()=>{},this.#u=()=>{},this.#p=()=>{},this.#h=()=>{},this.#d=()=>{},this.#m=()=>{},this.#f=()=>{},this.#g=()=>{}}inizializeCustomComponent(u){this.active||(this.active=!0,this.#t=u.id,this.#r=u.emit,this.#i=u.emitAsync,this.#o=u.freezeProp,this.#a=u.getChildren,this.#l=u.getParentId,this.#c=u.getState,this.#u=u.remove,this.#p=u.setState,this.#h=u.unBind,this.#d=u.unFreezeProp,this.#m=u.watch,this.#f=u.watchSync,this.#g=u.watchParent,s({context:this,data:this.#y()}),this.#v=!1)}disconnectedCallback(){!this.shadowRoot||!this.active||(n({context:this,data:this.#y()}),this.resetData())}removeCustomComponent(){!this.shadowRoot||!this.active||this.parentElement?.removeChild(this)}adoptedCallback(){!this.shadowRoot||!this.active||i({context:this,data:this.#y()})}attributeChangedCallback(u,m,d){!this.shadowRoot||!this.active||a({name:u,oldValue:m,newValue:d,context:this,data:this.#y()})}})})};var Ll=(e={})=>{let t=Object.values(e).reduce((r,o)=>({...r,...o}),{});O.set("componentList",t),Ml(t),Ol(),Nl()},Fn=()=>{let{componentList:e}=O.get();return e};var Fl=({element:e,currentSelectors:t})=>{if(t.length>0){let r=t[0],o=t.slice(1);return{componentToParse:r,parseSourceArray:o}}else{let r=[...ms(e)],o=r?.[0],s=r.slice(1);return{componentToParse:o,parseSourceArray:s}}};var Dl=e=>[...e.querySelectorAll(`[${ps}]`)].reduce((r,o)=>{let s=o.getAttribute(ps);o.removeAttribute(ps);let n=s in r?[...r[s],o]:[o];return{...r,[s]:n}},{}),Vl=e=>Object.entries(e).map(([t,r])=>r.length===1?{[t]:r[0]}:{[t]:r}).reduce((t,r)=>({...t,...r}),{});var uo=new Map,Wl=({id:e,cb:t=()=>{}})=>{uo.set(e,t)},$l=async({id:e,element:t,refsCollection:r})=>{let s=await uo.get(e)?.({element:t,refs:Vl(r)});Cl({cb:s,id:e}),uo.delete(e)};var Dn=({isolateOnMount:e,id:t,element:r,refsCollection:o})=>(e===ht?Lt().isolateOnMount:e)?(async()=>(await $l({id:t,element:r,refsCollection:o}),new Promise(n=>{c.useNextLoop(()=>{c.useFrame(()=>{c.useNextTick(()=>{n({success:!0})})})})})))():$l({id:t,element:r,refsCollection:o});function Zm(e,t){for(let r of $e(e))if(r?.isRepeater&&r?.getRepeatId?.()===t)return r;return null}var Bl=(e,t)=>{let r=e||document.body;for(let o of r.children){let s=Zm(o,t);if(s)return s}return null};var _r=new Set,jl=({id:e,state:t,container:r})=>{_r.add({id:e,state:t,container:r})},zl=({id:e,state:t,container:r})=>{_r.forEach(o=>{e===o.id&&t===o.state&&r===o.container&&_r.delete(o)})},Hl=({id:e="",state:t="",container:r})=>[..._r].some(s=>e===s.id&&t===s.state&&r===s.container);var vs=({id:e="",component:t=""})=>{if(!e||e==="")return[];let o=H.get(e)?.child;return o?o?.[t]??[]:(console.warn("getChildIdById failed no id found"),[])},ws=({id:e,component:t,filterBy:r=[]})=>{if(!st({id:e}))return;let n=vs({id:e,component:t}).map(l=>({id:l,element:st({id:l})})).filter(({element:l})=>r.length>0?r.includes(l):!0).sort(function(l,p){let{element:u}=l,{element:m}=p;return u===m||!u||!m?0:u.compareDocumentPosition(m)&2?1:-1}).map(({id:l})=>l),i=H.get(e);if(!i)return;let{child:a}=i;H.set(e,{...i,child:{...a,[t]:n}})};var Ul=(e=[],t=[],r="")=>e.filter(o=>{let s=o?.[r];return!t.some(n=>n?.[r]===s)}),Gl=(e,t,r)=>e.map((o,s)=>{let n=o?.[r];return!t.some(a=>a?.[r]===n)?{isNewElement:!0,key:o?.[r],index:s}:{isNewElement:!1,key:o?.[r],index:s}}),ql=({arr:e=[],key:t=""})=>e.every(r=>r?.[t]),Jl=({current:e,previous:t,key:r})=>ql({arr:e,key:r})&&ql({arr:t,key:r}),Yl=({data:e=[],key:t=""})=>e.filter((r,o,s)=>s.findIndex(n=>n?.[t]===r?.[t])===o),Ft=({component:e,getChildren:t,element:r})=>{let o=t(e);return!o||!r?[]:[...o].filter(s=>{let n=st({id:s})??null;return r.contains(n)})};var po=new Map,Ss=e=>{let t=c.getUnivoqueId();return po.set(t,e),t},Xl=(e="")=>{let t=po.get(e);return po.delete(e),t??Er};var Qm="beforebegin",ef="afterend";function tf({key:e,currentUnique:t,index:r,render:o,id:s,repeatId:n}){let i=t?.[r],a=` ${cs}="${e}"
    ${Ir}="${Ss({current:i,index:r})}"
    ${Cr}="${n}" ${Nt}="${s}"`;return o({sync:a,html:(l,...p)=>g(l,...p)})}var Kl=({current:e=[],previous:t=[],containerList:r=document.createElement("div"),targetComponent:o="",getChildren:s=()=>{},key:n="",id:i="",render:a,repeatId:l})=>{let p=Yl({data:e,key:n}),m=Ul(t,p,n).map(x=>{let C=x?.[n];return is({key:C,parentId:i,container:r})}),d=Gl(p,t,n),f=d.filter(({isNewElement:x})=>!x).map(x=>is({key:x.key,parentId:i,container:r})),T=f[0]?.parentNode??r;T&&(T.innerHTML=""),f.forEach(x=>{T&&x&&T.append(x)}),ws({id:i,component:o,filterBy:f});let b=Ft({component:o,getChildren:s,element:r}),S=d.reduce((x,C)=>C.isNewElement?(x.at(-1).push(C),x):[...x,[C]],[[]]);return S?.[0].length||S.shift(),S.forEach(x=>{let C=x[0],{isNewElement:P}=C,M=P?st({id:b[0]}):is({key:x[0]?.key,parentId:i,container:r}),_=x.filter(V=>V.isNewElement).map(V=>tf({targetComponent:o,key:V.key,currentUnique:p,index:V.index,render:a,id:i,repeatId:l})).join(""),E=P?Qm:ef;M?M.insertAdjacentHTML(E,_):r.insertAdjacentHTML("afterbegin",_)}),m.forEach(x=>{let C=ns({element:x});C&&Ze({id:C})}),p};var Zl=({current:e=[],previous:t=[],containerList:r=document.createElement("div"),targetComponent:o="",getChildren:s=()=>{},render:n,id:i,repeatId:a})=>{let l=e.length,p=t.length,u=l-p;if(u>0&&[...new Array(u).keys()].map((d,f)=>{let T=e?.[f+p],b=f+p,S=`${Ir}="${Ss({current:T,index:b})}"
            ${Cr}="${a}" ${Nt}="${i}"`;return n({sync:S,html:(x,...C)=>g(x,...C)})}).forEach(d=>{r.insertAdjacentHTML("beforeend",d)}),u<0){let m=Ft({component:o,getChildren:s,element:r}),d=m.filter((T,b)=>b>=e.length),f=m.filter((T,b)=>b<e.length);r.textContent="",d.forEach(T=>{Ze({id:T})}),f.forEach(T=>{let b=st({id:T});b&&r.append(b)})}return e};var Ql=async({containerList:e=document.createElement("div"),targetComponent:t="",current:r=[],previous:o=[],getChildren:s=()=>{},key:n="",id:i,render:a,repeatId:l})=>{let m=(Jl({current:r,previous:o,key:n})?Kl:Zl)({current:r,previous:o,containerList:e,targetComponent:t,getChildren:s,key:n,id:i,render:a,repeatId:l});return O.set("repeaterParserRoot",e,!1),await O.emitAsync("repeaterParserRoot"),ws({id:i,component:t}),m};var ec=({state:e="",setState:t=()=>{},emit:r=()=>{},watch:o=()=>{},props:s={},bindEvents:n=[],clean:i=!1,dynamicProps:a,beforeUpdate:l=()=>{},afterUpdate:p=()=>{},getChildren:u=()=>{},key:m="",id:d="",containerList:f,repeatId:T="",render:b})=>{let S=Bl(f,T);S?.remove(),S?.removeCustomComponent();let x=st({id:d}),C=!0;return o(e,async(P,M)=>{if(!c.checkType(Array,P))return;if(bs({id:d,prop:e}),Hl({id:d,state:e,container:f})){lo({id:d,prop:e}),t(e,M,!1);return}let E=Nn({id:T});E&&(i||C)&&(Ft({component:E,getChildren:u,element:f}).forEach(D=>{Ze({id:D})}),f.textContent=""),jl({id:d,state:e,container:f}),l({element:x,container:f,childrenId:Ft({component:E,getChildren:u,element:f})});let V=await Ql({state:e,containerList:f,targetComponent:E,current:P,previous:i||C?[]:M,getChildren:u,key:m,props:s,dynamicProps:a,bindEvents:n,id:d,render:b,repeatId:T});C=!1;let q=Nn({id:T}),W=Ft({component:q,getChildren:u,element:f});[...W].forEach((Y,D)=>{let L=V?.[D];L&&ss({id:Y,value:{current:L,index:D}})}),c.useNextLoop(async()=>{p({element:x,container:f,childrenId:W}),zl({id:d,state:e,container:f}),lo({id:d,prop:e}),t(e,V,!1)})}),()=>r(e)};var Or=new Map,tc=({repeatId:e,obj:t})=>{Or.set(e,t)};var rc=({repeatId:e,placeholderListObj:t})=>{if(!e||!t||t.length===0)return;let r=Or.get(e);if(!r)return;let o=t.find(({id:n})=>n===e),s=ec({...r,repeatId:e,containerList:o?.parent??document.createElement("div")});return Or.delete(e),s};var oc=({componentParsed:e,instanceName:t="",props:r={},state:o={},key:s="",currentRepeaterState:n=Er,isRepeater:i=!1,parentPropsWatcher:a=[],destroy:l=()=>{},freezedPros:p=[],isCancellable:u=!0,child:m={},parentId:d="",id:f="",componentName:T=""})=>{let b=c.createStore(o);return ul({props:r,store:b}),H.set(f,{element:e,component:T,instanceName:t,destroy:l,parentPropsWatcher:a,key:s,currentRepeaterState:n,isRepeater:i,isCancellable:u,id:f,parentId:d,freezedPros:p,child:m,state:b}),{getState:()=>b.get(),setState:(S="",x={},C=!0)=>{ys({id:f,prop:S})||b.set(S,x,C)},emit:(S="")=>b.emit(S),emitAsync:async(S="")=>await b.emitAsync(S),computed:(S="",x=[],C=()=>{})=>b.computed(S,x,C),watch:(S="",x=()=>{})=>b.watch(S,x)}};var sc=({component:e})=>{let t=e.getId(),r=e.getInstanceName(),o=e.getParentId(),s=e.getStaticPropsId(),n=e.getDynamicPropsid(),i=e.getBindEventsId(),a=e.getDynamicPropsFromSlotId(),l=e.getPropsFromSlotId(),p=e.getCurrentListValueId(),u=Xl(p),m=e.getCurrentKey()??"",d=e.getComponentName(),f=s?.split(" ").join(""),T=l?.split(" ").join(""),b=ds(f),S=ds(T),x={...e.dataset};return{component:e,props:{...gs({componentName:d,currentProps:x}),...gs({componentName:d,currentProps:b}),...gs({componentName:d,currentProps:S})},id:t,componentName:d,instanceName:r,key:m,dynamicPropsId:n,dynamicPropsIdFromSlot:a,bindEventsId:i,currentListValueReal:u,parentId:o}};var nc=({component:e,state:t={},isCancellable:r=!0})=>{let{component:o,props:s,id:n,componentName:i,instanceName:a,key:l,dynamicPropsId:p,dynamicPropsIdFromSlot:u,currentListValueReal:m,bindEventsId:d,parentId:f}=sc({component:e}),{getState:T,setState:b,emit:S,emitAsync:x,computed:C,watch:P}=oc({component:e,componentParsed:o,props:s,state:t,destroy:()=>{},id:n,componentName:i,instanceName:a,key:l,isCancellable:r,parentId:f});hl({componentId:n}),pl({id:n});let M=[],_=E=>vs({id:n,component:E});return m?.index!==-1&&ss({id:n,value:m}),_n({propsId:p,componentId:n}),_n({propsId:u,componentId:n}),{bindEventsId:d,key:l,id:n,componentParsed:o,getState:T,setState:b,emit:S,emitAsync:x,computed:C,watch:P,repeatId:M,getChildren:_,watchSync:(E,V)=>{let q=P(E,V);return S(E),q},freezeProp:E=>bs({id:n,prop:E}),unFreezeProp:E=>lo({id:n,prop:E}),unBind:()=>ml({id:n}),bindProps:E=>`${xr}="${bl({...E,parentId:E?.forceParent?void 0:n})}" `,staticProps:E=>` ${Ot}="${hs(E)}" `,syncParent:` ${Nt}="${n}" `,remove:()=>{Ze({id:n}),Ar()},removeDOM:E=>{E.remove(),Ar()},getParentId:()=>Pr(n),watchParent:(E,V)=>{let q=co(Pr(n),E,V);fs({id:n,unWatchArray:[q]})},html:(E,...V)=>({id:n,content:g(E,...V),componentParsed:o}),onMount:E=>Wl({id:n,cb:E}),bindEvents:E=>`${us}="${nl(E)}"`,delegateEvents:E=>`${pt}="${tl(E)}"`,repeat:({watch:E,clean:V=!1,beforeUpdate:q=()=>{},afterUpdate:W=()=>{},key:Y,render:D})=>{let L=c.getUnivoqueId();return M.push(L),tc({repeatId:L,obj:{state:E,setState:b,emit:S,watch:P,clean:V,beforeUpdate:q,afterUpdate:W,getChildren:_,key:Y,id:n,render:D}}),`<mobjs-repeater ${ls}="${L}" style="display:none;"/>`}}};function rf(e){let t=[];for(let r of $e(e))r?.isRepeater&&r?.getRepeatId?.()&&t.push(r);return t}var ic=e=>{let t=[],r=e||document.body;for(let o of r.children)t=[...t,...rf(o)];return t};var Ts=async({element:e,functionToFireAtTheEnd:t=[],isCancellable:r=!0,currentIterationCounter:o=0,currentSelectors:s=[]})=>{if(!e)return;let n=Fn(),{componentToParse:i,parseSourceArray:a}=Fl({element:e,currentSelectors:s}),l=o===Lt().maxParseIteration;if(l&&console.warn(`dom parse reached max parse limit: ${o}`),!i||l){let D=Ln();for(let L of t.reverse()){let{onMount:G,fireDynamic:se,fireFirstRepeat:j}=L;await G(),se(),j()}t.length=0,s.length=0,rl(e);return}let p=i?.getComponentName(),u=n?.[p]?.componentFunction,m=n?.[p]?.componentParams,{isolateOnMount:d,isolateCreation:f,scoped:T}=m;if(!u){console.warn(`${p} component is not registered.`),i.remove(),await Ts({element:e,functionToFireAtTheEnd:t,isCancellable:r,currentIterationCounter:o+=1,currentSelectors:a});return}let b=nc({component:i,...m,isCancellable:r}),{content:S,componentParsed:x,id:C}=await u(b),{newElement:P}=await _l({content:S,componentParsed:x,isolateCreation:f}),M=P?Dl(P):{};if(dl({element:P,id:C}),!P){let D=Ln();return}qa({id:C,newElement:P});let E=[...ic(P)].map(D=>({parent:D.parentNode,id:D.getRepeatId()})),q=(b?.repeatId).map(D=>rc({repeatId:D,placeholderListObj:E})),W=b?.bindEventsId;W&&il({element:P,componentId:C,bindEventsId:W});let Y=T===ht?Lt().scoped:T;Y&&await Dn({isolateOnMount:d,id:C,element:P,refsCollection:M}),P?.inizializeCustomComponent?.(b),t.push({onMount:async()=>{Y||await Dn({isolateOnMount:d,id:C,element:P,refsCollection:M})},fireDynamic:()=>{On({componentId:C,inizilizeWatcher:!0})},fireFirstRepeat:q.length>0?()=>{q.forEach(D=>{D?.()})}:()=>{}}),await Ts({element:e,functionToFireAtTheEnd:t,isCancellable:r,currentIterationCounter:o+=1,currentSelectors:a})};var Nr=async({element:e,isCancellable:t=!0})=>{Il(),await Ts({element:e,isCancellable:t,currentIterationCounter:0})},ac=()=>{O.watch("repeaterParserRoot",async e=>{await Nr({element:e})})},ho=async e=>{await Nr({element:e})};var lc=e=>{let t=Object.entries(e).reduce((r,o)=>{let[s,n]=o;return{...r,[s]:n}},{});O.set("routeList",t)},xs=()=>{let{routeList:e}=O.get();return e},cc=({routeName:e=""})=>{O.set("index",e)};var uc=({routeName:e=""})=>{O.set("pageNotFound",e)};var pc=async({route:e=""})=>{O.set("routeIsLoading",!0);let t=Ka(),r=document?.querySelector(t),{activeRoute:o}=O.get();O.set("beforeRouteLeave",o),O.set("beforeRouteChange",e);let s=!1,n=O.watch("beforeRouteChange",()=>{s=!0});Ar(),O.set("activeRoute",e);let i=await xs()?.[e]?.();r.innerHTML="",scrollTo(0,0),xl(),r.insertAdjacentHTML("afterbegin",i),await Nr({element:r}),s||O.set("atfterRouteChange",e),document.body.dataset.route=e,n?.(),O.set("routeIsLoading",!1)};var hc=({url:e=""})=>{let{index:t,pageNotFound:r}=O.get();return e===""?t:e in xs()?e:r};var Vn="",dc=()=>{let e=window.location.hash.slice(1),{routeIsLoading:t}=O.get();t||pc({route:hc({url:e})})},mc=()=>{dc(),window.addEventListener("hashchange",()=>{dc()})},$n=({url:e=""})=>{window.location.hash=e,(e===Vn||Vn==="")&&window.dispatchEvent(new HashChangeEvent("hashchange")),Vn=e};var fc=()=>{O.watch("beforeRouteLeave",e=>{console.log("----------------"),console.log("before route leave",e)}),O.watch("beforeRouteChange",(e,t)=>{console.log("before route change:"),console.log("previous:",t),console.log("current:",e)}),O.watch("activeRoute",e=>{console.log("active route:",e)}),O.watch("atfterRouteChange",e=>{console.log("after route change",e),console.log("----------------")})};var Wn=async({rootId:e,wrapper:t,contentId:r,components:o={},pages:s={},afterInit:n=()=>{},index:i="home",pageNotFound:a="pageNotFound"})=>{let l=document.querySelector(e),p=t();!r||!l||(Xa({contentId:r}),Qa({element:l}),ac(),Ll(o),lc(s),cc({routeName:i}),uc({routeName:a}),l.insertAdjacentHTML("afterbegin",p),await Nr({element:l,isCancellable:!1}),c.useFrameIndex(()=>{c.useNextTick(()=>{n()})},5),fc(),mc())};var Ue=(e="")=>{if(!e)return;let r=[...H.values()].find(({instanceName:o})=>o===e)?.id;if(!r){console.warn("getIdByName failed no name");return}return r};var y=(e={})=>`${Ot}="${hs(e)}"`;var gc=`<?xml version="1.0" encoding="UTF-8"?>
...
`;var Rf=({getState:e})=>{let{rawContent:t}=e();navigator.clipboard.writeText(t)};function Pf({sync:e,bindProps:t,setState:r,delegateEvents:o}){return g`
    ...
    `}var Af=async({setState:e,getState:t,codeEl:r,currentKey:o,updateScroller:s,goToTop:n,syncParent:i})=>{let{urls:a}=t(),p=a.find(({label:m})=>m===o)?.source;if(!p?.length)return;let u=g`<html-content
        ${y({source:p,useMinHeight:!0})}
        ${i}
    ></html-content>`;r.insertAdjacentHTML("afterbegin",u),await ho(r),e("rawContent",r.textContent),s(),n()},Pp=({codeEl:e,removeDOM:t})=>{e.textContent="";let r=e.firstElementChild;r&&t(r)},Ap=({onMount:e,setState:t,getState:r,repeat:o,html:s,bindProps:n,delegateEvents:i,staticProps:a,computed:l,watch:p,removeDOM:u,syncParent:m})=>(e(({element:d,refs:f})=>{let{screenEl:T,scrollerEl:b,codeEl:S,scrollbar:x}=f,{updateScroller:C,move:P,goToTop:M}=kp({screen:T,scroller:b,scrollbar:x});x.addEventListener("input",()=>{P(x.value)}),O.watch("beforeRouteLeave",()=>{t("urls",[])}),l("currentButtonState",["urls","activeContent"],(E,V)=>(E.length>0?(d.classList.add("active"),document.body.style.overflow="hidden"):(d.classList.remove("active"),document.body.style.overflow="",Pp({codeEl:S,removeDOM:u}),t("activeContent",""),M()),V));let _=p("activeContent",E=>{Pp({codeEl:S,removeDOM:u}),Af({setState:t,getState:r,codeEl:S,currentKey:E,updateScroller:C,goToTop:M,staticProps:a,syncParent:m})});return()=>{_()}}),s`
        <div class="code-overlay js-overlay">
            ...
            <div class="code-overlay__wrap js-overlay-wrap">
                ...
                <button
                    ...
                    ${i({click:()=>{Rf({getState:r})}})}
                >
                    ${Rp}
                </button>
                <div class="code-overlay__header">
                    ${o({clean:!0,watch:"urls",render:({sync:d})=>Pf({sync:d,bindProps:n,delegateEvents:i,setState:t})})}
                </div>
                <input
                    type="range"
                    id="test"
    ...
    `};var _f=k({name:"code-overlay",component:Ap,isolateOnMount:!0,isolateCreation:!0,exportState:["urls","activeContent"],state:{urls:()=>({value:[],type:Array,skipEqual:!1}),activeContent:()=>({value:"",type:String,skipEqual:!0}),rawContent:()=>({value:"",type:String}),currentButtonState:()=>({value:String,type:"",skipEqual:!0})}}),Of=k({name:"code-overlay-button",component:_p,exportState:["key","selected","disable"],state:{key:"",selected:()=>({value:!1,type:Boolean}),disable:()=>({value:!0,type:Boolean})}});var Op=({html:e,delegateEvents:t})=>e`
        <button
            type="button"
            class="c-btn-debug"
...
Loading snippet ...</pre
    ...
    </div>`};var Vg=k({name:"mob-snippet",component:bh,exportState:["source","isFull","hasOverflow","hasBorder","numLines","loadOnMount"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number}),loadOnMount:()=>({value:!1,type:Boolean})}});function $g({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var yh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${$g({id:s,label:n})}
        class="spacer spacer--${r} ${i}"
    ></div>`};var Wg=k({name:"mob-spacer",component:yh,exportState:["style","line","id","label"],state:{style:()=>({value:"medium",type:String,validate:e=>["small","medium","big"].includes(e),strict:!0}),line:()=>({value:!1,type:Boolean}),id:()=>({value:"",type:String}),label:()=>({value:"",type:String})}});var Bg=g`
    <div class="only-desktop">
        <h3>This content is available only on desktop</h3>
        <h4>Need page reload on a screen size up to 1024px</h4>
    </div>
`,vh=({element:e})=>{e.textContent="",!re.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Bg))},wh=({html:e,onMount:t})=>(t(({element:r})=>{vh({element:r}),c.useResize(()=>{vh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var jg=k({name:"only-desktop",component:wh,state:{}});var Sh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=Z.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
        <div class="c-loader ${n}">
            <span class="c-loader__inner"></span>
        </div>
    `};var zg=k({name:"mob-loader",component:Sh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var Hg=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},Th=({html:e,onMount:t})=>(t(({element:r})=>{if(re.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{Hg({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var qg=k({name:"doc-scroll",component:Th});function Ug({targets:e,delegateEvents:t,syncParent:r,staticProps:o,setState:s,bindProps:n}){return e.map((i,a)=>{let{label:l,scroll:p}=i.dataset;return g`<li>
                <scroll-to-button
                    ${t({click:()=>{let u=p==="start"?0:ie(i).top-50;lr.to(u),s("activeId",a)}})}
                    ${n({bind:["activeId"],props:({activeId:u})=>({active:u===a})})}
                    ${o({label:l})}
                    ${r}
                >
                </scroll-to-button>
            </li> `}).join("")}var xh=({html:e,onMount:t,delegateEvents:r,syncParent:o,staticProps:s,bindProps:n,setState:i})=>(t(({refs:a})=>{if(re.mq("max","large"))return;let{list:l}=a,p=document.querySelectorAll("[data-scroll]");l.insertAdjacentHTML("beforeend",Ug({targets:[...p],delegateEvents:r,syncParent:o,staticProps:s,bindProps:n,setState:i})),ho(l);let u=c.useMouseWheel(()=>{i("activeId",-1)});return()=>{u()}}),e` <div class="c-scroll-to"><ul ref="list"></ul></div> `);var Gg=k({name:"scroll-to",component:xh,exportState:["activeId"],state:{activeId:()=>({value:0,type:Number})}});var Ch=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button">
            <span> ${s} </span>
        </button>
    `};var Jg=k({name:"scroll-to-button",component:Ch,exportState:["label","active"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});var Ih=[{label:"html",url:"mobJs_html"},{label:"onMount",url:"mobJs_onMount"},{label:"getState",url:"mobJs_getState"},{label:"setState",url:"mobJs_setState"},{label:"watch",url:"mobJs_watch"},{label:"watchSync",url:"mobJs_watchSync"},{label:"staticProps",url:"mobJs_staticProps"},{label:"bindProps",url:"mobJs_bindProps"},{label:"bindEvents",url:"mobJs_bindEvents"},{label:"delegateEvents",url:"mobJs_delegateEvents"},{label:"reactive list: (repeat)",url:"mobJs_repeat"},{label:"unBind",url:"mobJs_unBind"},{label:"emit",url:"mobJs_emit"},{label:"emitAsync",url:"mobJs_emitAsync"},{label:"computed",url:"mobJs_computed"},{label:"remove",url:"mobJs_remove"},{label:"removeDOM",url:"mobJs_removeDom"},{label:"getChildren",url:"mobJs_getChildren"},{label:"freezeProp",url:"mobJs_freezeProp"},{label:"unFreezeProp",url:"mobJs_unFreezeProp"},{label:"getParentId",url:"mobJs_getParentId"},{label:"watchParent",url:"mobJs_watchParent"},{label:"syncParent",url:"mobJs_syncParent"}];var Yg={mobjs:Ih},Xg=({data:e,staticProps:t})=>e.map(r=>{let{label:o,url:s}=r;return g`<li>
                <links-mobjs-button
                    ${t({label:o,url:s})}
                ></links-mobjs-button>
...
`;var Ph=({getState:e,html:t})=>{let{prevRoute:r,nextRoute:o}=e();return t`<div>
        ...
        <a
            ...
            >${pr}</a
        >
    </div>`};var tb=k({name:"quick-nav",component:Ph,exportState:["prevRoute","nextRoute"],state:{prevRoute:()=>({value:"",type:String}),nextRoute:()=>({value:"",type:String})}});var Ah=({html:e})=>e`
    ...
    `;var rb=k({name:"mob-footer",component:Ah});var $=c.createStore({closeAllAccordion:()=>{},refreshScroller:()=>{},openNavigation:()=>{},closeNavigation:()=>{},goToTop:()=>{},activeSection:()=>({value:"",type:String,skipEqual:!1}),navigationIsOpen:()=>({value:!1,type:Boolean})});var _h=({html:e,onMount:t,getState:r})=>{let{label:o,section:s}=r();return t(({element:n})=>{$.watch("activeSection",i=>{let a=i===s;n.classList.toggle("current",a)})}),e`
        <button type="button" class="footer-nav__button">${o}</button>
    `};var ob=[{label:"About",url:"about",section:"about"},{label:"Canvas 2d",url:"canvas_overview",section:"canvas"},{label:"Illustration",url:"svg_overview",section:"svg"},{label:"MobCore",url:"mobCore_overview",section:"mobCore"},{label:"MobJs",url:"mobJs_overview",section:"mobJs"},{label:"MobMotion",url:"mobMotion_overview",section:"mobMotion"},{label:"Plugin",url:"plugin_overview",section:"plugin"}];function sb({url:e}){let t=Ue("page-transition");_e(t,"url",e)}var nb=({delegateEvents:e,staticProps:t})=>ob.map(({label:r,url:o,section:s})=>g`<li class="footer-nav__item">
                <footer-nav-button
                    ${e({click:()=>{sb({url:o})}})}
                    ${t({label:r,section:s})}
                ></footer-nav-button>
            </li> `).join(""),Oh=({html:e,delegateEvents:t,staticProps:r})=>re.mq("max","desktop")?e` <span></span> `:e`
        <ul class="footer-nav">
            ${nb({delegateEvents:t,staticProps:r})}
        </ul>
    `;var ib=k({name:"footer-nav",component:Oh}),ab=k({name:"footer-nav-button",component:_h,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function lb({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function cb({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function ub(){let e=Ue("page-transition");_e(e,"url","#home"),$.set("navigationIsOpen",!1),$.emit("closeNavigation"),$.emit("closeAllAccordion"),$.emit("goToTop")}var Nh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return $.watch("openNavigation",()=>lb({navInfo:s})),$.watch("closeNavigation",()=>cb({navInfo:s})),O.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Lh={},Fh={},Ks=()=>Lh,ye=()=>Fh,Dh=async()=>{Lh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Fh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Vh={github:Mh},hb=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=Ue("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=$.get();s&&($.set("navigationIsOpen",!1),$.emit("closeNavigation"))};function db({delegateEvents:e}){let{header:t}=Ks(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
                              class="l-header__sidenav__link"
                              ${e({click:a=>{console.log("click"),hb({event:a})}})}
                          >
                              ${Vh[s]}
                          </button>
                      `:g`
    ...
    `;var mb=()=>{let{navigationIsOpen:e}=$.get("navigationIsOpen");if($.set("navigationIsOpen",t=>!t),e){$.emit("closeNavigation");return}$.emit("openNavigation")},Wh=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{$.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),$.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var fb=k({name:"mob-header",component:Nh}),gb=k({name:"mob-header-nav",component:$h}),bb=k({name:"mob-header-toggle",component:Wh});var Ii=0,Bh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ht({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=$.get();a&&(Ii=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ii})`)}});n.init(),$.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=we(r),u=we(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),$.watch("refreshScroller",()=>n.refresh()),$.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),$.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ii})`}),$.watch("goToTop",()=>{setTimeout(()=>{n.move(0),$.set("activeSection","no-section")},s)})};function yb({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function vb({element:e,main:t}){$.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function wb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=$.get();r&&($.set("navigationIsOpen",!1),$.emit("closeNavigation"))}),t.addEventListener("click",()=>{$.emit("closeAllAccordion"),$.emit("goToTop");let{navigationIsOpen:r}=$.get();r||lr.to(0)})}var jh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return $.watch("openNavigation",()=>vb({element:r,main:s})),$.watch("closeNavigation",()=>yb({element:r,main:s})),c.useResize(()=>{let p=re.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),wb({main:s,toTopBtn:i}),Bh({root:r}),()=>{}}),e`
    ...
    `);function Sb({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?g`
                ...
                `:p?g`
                  ...
                  `}).join("")}var zh=({html:e,staticProps:t,setState:r,bindProps:o,bindEvents:s})=>{let{navigation:n}=Ks();return $.watch("closeAllAccordion",()=>{r("currentAccordionId",-1)}),e`
    ...
    `};var Hh=({getState:e,html:t,onMount:r,watch:o,delegateEvents:s})=>{let{label:n,url:i,arrowClass:a,subMenuClass:l,fireRoute:p,callback:u,scrollToSection:m}=e();return r(({element:d})=>(o("isOpen",f=>{c.useFrame(()=>{d.classList.toggle("active",f)})}),O.watch("activeRoute",f=>{c.useFrame(()=>{let T=f===i;d.classList.toggle("current",T),T&&p&&(u(),$.set("activeSection",m))})}),()=>{})),t`
        <button
            ...
            ${s({click:()=>{if(u(),!p)return;let d=Ue("page-transition");_e(d,"url",i),$.set("navigationIsOpen",!1),$.emit("closeNavigation")}})}
        >
            ${n}
        </button>
    `};var qh=({getState:e,html:t})=>{let{label:r,sectioName:o}=e();return t`
        <div class="l-navigation__label" data-sectionname="${o}">
            ${r}
        </div>
    `};function Tb({children:e,staticProps:t,callback:r}){return e.map(o=>{let{label:s,url:n,scrollToSection:i}=o;return g`
                <li class="l-navigation__submenu__item">
                    <mob-navigation-button
                        ${t({callback:r,label:s,url:n,subMenuClass:"l-navigation__link--submenu",scrollToSection:i})}
                    ></mob-navigation-button>
                </li>
            `}).join("")}var Uh=({onMount:e,html:t,getState:r,setState:o,staticProps:s,bindProps:n,watch:i})=>{let{children:a,headerButton:l,callback:p}=r(),{label:u,url:m}=l;return e(({refs:d})=>{let{content:f}=d;return Eo.subscribe(f),Eo.reset(f),i("isOpen",async T=>{if(await Eo[T?"down":"up"](f),$.emit("refreshScroller"),!T){let S=Ue("main_navigation");_e(S,"currentAccordionId",-1,!1)}}),()=>{}}),t`
        <li class="l-navigation__item has-child">
            ...
            <ul class="l-navigation__submenu" ref="content">
                ${Tb({children:a,staticProps:s,callback:p})}
            </ul>
        </li>
    `};var xb=k({name:"mob-navigation-container",component:jh,isolateOnMount:!0,isolateCreation:!0}),Cb=k({name:"mob-navigation",component:zh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),Ib=k({name:"mob-navigation-submenu",component:Uh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),Eb=k({name:"mob-navigation-button",type:"button",component:Hh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),kb=k({name:"mob-navigation-label",component:qh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var Gh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var Rb=k({name:"doc-container",component:Gh});var Jh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var Pb=k({name:"doc-title",component:Jh,state:{}});var Yh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Ab=k({name:"doc-title-small",component:Yh,state:{}});var Xh=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Qh=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
    ...
    `);var Nb=k({name:"shape-right",component:Qh}),Mb=k({name:"shape-left",component:Kh});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},ze=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},He=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},yt=e=>"roundRect"in e,ed=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Qr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:hr({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:dr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),hr=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,dr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var td=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],T=[],b={},S={},x=e.getContext(m,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Qr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,T=p?f.map((L,G)=>({...L,scale:1,rotate:0,hasFill:i.includes(G)})).sort(L=>L.hasFill?-1:1).reverse():f.map((L,G)=>{let se=i.includes(G);return{...L,scale:1,rotate:0,hasFill:se}}),b=Z.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),T.forEach(L=>{b.subscribeCache(L,({scale:G,rotate:se})=>{L.rotate=se,L.scale=G})});let V=()=>{if(!x)return;u&&(_.width=e.width,_.height=e.height);let L=u?E:x;L.fillStyle="#1a1b26",L.fillRect(0,0,e.width,e.height),T.forEach(({x:G,y:se,centerX:j,centerY:N,width:v,height:w,rotate:R,scale:A,hasFill:B,offsetXCenter:J,offsetYCenter:Q})=>{let Ie=Math.PI/180*R,ae=Math.cos(Ie)*A,de=Math.sin(Ie)*A;L.setTransform(ae,de,-de,ae,Math.round(j+J),Math.round(N+Q)),L.beginPath(),L.rect(Math.round(-j+G),Math.round(-N+se),v,w),L.fillStyle=B?P:C,L.fill(),L.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:_,ctx:x})};S=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(b,{scale:1.5,rotate:90},{duration:1e3}).goTo(b,{scale:.5},{duration:500}).goTo(b,{rotate:180,scale:1.2},{duration:500}).goTo(b,{scale:1.3},{duration:500}).goTo(b,{scale:1},{duration:1200}),S.onLoopEnd(({direction:L,loop:G})=>{console.log(`loop end: ${L}, ${G}`)}),S.play();let q=()=>{V(),d&&c.useNextFrame(()=>q())};c.useFrame(({time:L})=>{q({time:L})});let W=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,T.forEach(L=>{let{width:G,height:se,gutter:j,numberOfColumn:N}=L;L.offsetXCenter=hr({canvasWidth:e.width,width:G,gutter:j,numberOfColumn:N}),L.offsetYCenter=dr({canvasHeight:e.height,height:se,gutter:j,numberOfRow:t})}),c.useFrame(()=>V())}),Y=$.watch("openNavigation",()=>{S?.stop(),d=!1}),D=$.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:L}=O.get();L===M&&(S?.play(),c.useFrame(()=>q()))},500));return()=>{b.destroy(),S.destroy(),W(),D(),Y(),b=null,S=null,x=null,_=null,E=null,f=[],T=[],d=!1}};var rd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=td({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN0:s}=ye(),{source:n}=s;return t`
        <div>
    ...
    `};var Lb=k({name:"animatedpattern-n0",component:rd,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[16,27,38,49,60,71,82,93],type:Array}),stagger:()=>({value:{each:5,grid:{col:11,row:11,direction:"row"},waitComplete:!1},type:"any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||ne())}});var od=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a})=>{let{useOffscreen:l,context:p}=je({disableOffcanvas:a}),u=!0,m=[],d=[],f={},T={},b={},{top:S,left:x}=ie(e),C=e.getContext(p,{alpha:!1}),P="#000",M="#fff",{activeRoute:_}=O.get(),{offscreen:E,offScreenCtx:V}=ze({useOffscreen:l,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,m=Qr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,d=m.map((N,v)=>({...N,scale:0,mouseX:0,mouseY:0,hasFill:i.includes(v)})).sort(N=>N.hasFill?-1:1),f=Z.createLerp({data:{mouseX:0,mouseY:0}}),d.forEach(N=>{f.subscribeCache(N,({mouseX:v,mouseY:w})=>{N.mouseX=v,N.mouseY=w})}),T=Z.createTween({ease:"easeInOutSine",stagger:{each:5,from:"center",waitComplete:!1},data:{scale:0}}),d.forEach(N=>{T.subscribeCache(N,({scale:v})=>{N.scale=v})});let q=()=>{if(!C)return;l&&(E.width=e.width,E.height=e.height);let N=l?V:C;N.fillStyle="#1a1b26",N.fillRect(0,0,e.width,e.height),d.forEach(({x:v,y:w,centerX:R,centerY:A,width:B,height:J,mouseX:Q,mouseY:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Q-(e.width-(B+n)*r)/2,Ge=Ie-(e.height-(J+n)*t)/2,Je=(v-Le)/250,vt=(w-Ge)/250,wt=Math.sqrt(Math.pow(Math.abs(Je),2)+Math.pow(Math.abs(vt),2)),Jt=Oe(Math.abs(wt),0,2),to=0,qe=Math.cos(to)*(Jt+ae),Fo=Math.sin(to)*(Jt+ae);N.setTransform(qe,Fo,-Fo,qe,Math.round(R+Me),Math.round(A+De)),N.beginPath(),N.rect(Math.round(-R+v),Math.round(-A+w),B,J),N.fillStyle=de?M:P,N.fill(),N.setTransform(1,0,0,1,0,0)}),He({useOffscreen:l,offscreen:E,ctx:C})};b=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).goTo(T,{scale:.3},{duration:1e3}),b.play();let W=({x:N,y:v})=>{f.goTo({mouseX:N-x,mouseY:v-S})},Y=c.useMouseMove(({client:N})=>{let{x:v,y:w}=N;W({x:v,y:w})}),D=c.useTouchMove(({client:N})=>{let{x:v,y:w}=N;W({x:v,y:w})}),L=()=>{q(),u&&c.useNextFrame(()=>L())};c.useFrame(({time:N})=>{L({time:N})});let G=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,S=ie(e).top,x=ie(e).left,d.forEach(N=>{let{width:v,height:w,gutter:R,numberOfColumn:A}=N;N.offsetXCenter=hr({canvasWidth:e.width,width:v,gutter:R,numberOfColumn:A}),N.offsetYCenter=dr({canvasHeight:e.height,height:w,gutter:R,numberOfRow:t})}),c.useFrame(()=>q())}),se=$.watch("openNavigation",()=>{b?.stop(),u=!1}),j=$.watch("closeNavigation",()=>setTimeout(async()=>{u=!0;let{activeRoute:N}=O.get();N===_&&(b?.play(),c.useFrame(()=>L()))},500));return()=>{T.destroy(),b.destroy(),f.destroy(),G(),Y(),D(),j(),se(),T=null,b=null,f=null,C=null,E=null,V=null,m=[],d=[],u=!1}};var sd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=od({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN1:s}=ye(),{source:n}=s;return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Fb=k({name:"animatedpattern-n1",component:sd,isolateCreation:!0,isolateOnMount:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","disableOffcanvas"],state:{numberOfRow:7,numberOfColumn:15,cellWidth:70,cellHeight:70,gutter:10,fill:[21,22,23,24,25,25,26,37,42,53,58,69,74,85,86,87,88,89,90,44,60,65,66],disableOffcanvas:!!(Re()||ne())}});function Db({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function Vb({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var nd=({canvas:e,amountOfPath:t,width:r,height:o,fill:s,stroke:n,opacity:i,spacerY:a,intialRotation:l,perpetualRatio:p,mouseMoveRatio:u,disableOffcanvas:m})=>{let{useOffscreen:d,context:f}=je({disableOffcanvas:m}),T=!0,b=e.getContext(f,{alpha:!1}),S=[],x=[],C={},{left:P}=ie(e),{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:d,canvas:e}),V=d?E:b,q=yt(V)&&!ne();V=null,e.width=e.clientWidth,e.height=e.clientHeight,S=[...new Array(t).keys()].map((v,w)=>{let R=w,A=R<t/2?t-R:R,B=A-(t-A);return{width:Math.floor(Db({width:r,relativeIndex:B,amountOfPath:t})),height:Math.floor(Vb({height:o,relativeIndex:B,amountOfPath:t})),fill:s,stroke:n,opacity:B*i,rotate:0,y:0,relativeIndex:B,index:w}}),x=S.splice(0,S.length/2).concat(S.reverse()),C=Z.createSpring({data:{rotate:0,y:0},stagger:{each:5,from:"center"}}),[...x].forEach(v=>{C.subscribeCache(v,({rotate:w})=>{v.rotate=w})});let W=({time:v=0})=>{if(!b)return;d&&(_.width=e.width,_.height=e.height);let w=d?E:b,R=e.width/2,A=e.height/2;w.fillStyle="#1a1b26",w.fillRect(0,0,e.width,e.height),x.forEach(({width:B,height:J,opacity:Q,rotate:Ie,relativeIndex:ae,index:de})=>{let Me=Math.sin(v/1e3)*p*ae,De=de<t/2?Me+15*ae/2:-Me-15*ae/2,Le=de<t/2?-1:1,Ge=1,Je=Math.PI/180*(Ie-l),vt=Math.cos(Je)*Ge,wt=Math.sin(Je)*Ge;w.setTransform(vt,wt,-wt,vt,R,A+J/2),q?(w.beginPath(),w.roundRect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J,[200,0])):(w.beginPath(),w.rect(-(B*Le)/2,-J/2+De+a(de<t/2),B,J)),w.strokeStyle=`rgba(255, 255, 255, ${Q})`,w.fillStyle=`rgba(26, 27, 38, ${Q})`,w.stroke(),w.fill(),w.setTransform(1,0,0,1,0,0)}),He({useOffscreen:d,offscreen:_,ctx:b})},Y=({time:v=0})=>{W({time:v}),T&&c.useNextFrame(({time:w})=>Y({time:w}))};c.useFrame(({time:v})=>{Y({time:v})});let D=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=ie(e).left,c.useFrame(({time:v})=>{W({time:v})})}),L=({x:v})=>{let w=v-e.width/2-P;C.goTo({rotate:w/u})},G=c.useMouseMove(({client:v})=>{let{x:w}=v;L({x:w})}),se=c.useTouchMove(({client:v})=>{let{x:w}=v;L({x:w})}),j=$.watch("openNavigation",()=>{T=!1}),N=$.watch("closeNavigation",()=>{setTimeout(()=>{T=!0;let{activeRoute:v}=O.get();v===M&&c.useFrame(({time:w})=>Y({time:w}))},500)});return()=>{C.destroy(),D(),G(),se(),N(),j(),b=null,_=null,E=null,C=null,x=[],S=[],T=!1}};var id=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=nd({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN0:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var $b=k({name:"caterpillar-n0",component:id,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","fill","stroke","opacity","spacerY","intialRotation","perpetualRatio","mouseMoveRatio","disableOffcanvas"],state:{amountOfPath:17,width:Re()||ne()?30:40,height:Re()||ne()?30:40,radius:0,fill:"",stroke:"#fff",opacity:.05,spacerY:e=>e?300:-400,intialRotation:33,perpetualRatio:6,mouseMoveRatio:10,disableOffcanvas:!!(Re()||ne())}});var ad=({canvas:e,numItems:t,width:r,height:o,fill:s,opacity:n,radius:i,rotationDuration:a,rotationEach:l,centerEach:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=e.getContext(d,{alpha:!1}),b=[],S={},x={},C={},{top:P,left:M}=ie(e),{activeRoute:_}=O.get(),{offscreen:E,offScreenCtx:V}=ze({useOffscreen:m,canvas:e}),q=m?V:T,W=yt(q)&&!ne();q=null,e.width=e.clientWidth,e.height=e.clientHeight,b=[...new Array(t).keys()].map((w,R)=>{let A=R>=t/2?t/2+(t/2-R):R,B=s.includes(R)?1:A*n;return{width:A*r,height:A*o,x:0,y:0,hasFill:s.includes(R),opacity:B,radius:i,rotate:0,relativeIndex:A}}),S=Z.createTween({data:{rotate:0},stagger:{each:l,from:"center"},ease:"easeLinear",relative:!0}),[...b].forEach(w=>{S.subscribeCache(w,({rotate:R})=>{w.rotate=R})}),x=Z.createSpring({data:{x:0,y:0},stagger:{each:p,from:"end"}}),[...b].forEach(w=>{x.subscribeCache(w,({x:R,y:A})=>{w.x=R,w.y=A})});let Y=()=>{if(!T)return;m&&(E.width=e.width,E.height=e.height);let w=m?V:T;w.fillStyle="#1a1b26",w.fillRect(0,0,e.width,e.height),b.forEach(({width:R,height:A,x:B,y:J,opacity:Q,rotate:Ie,hasFill:ae},de)=>{let Me=b.length-de,De=e.width/2,Le=e.height/2,Ge=1,Je=Math.PI/180*Ie,vt=Math.cos(Je)*Ge,wt=Math.sin(Je)*Ge;w.setTransform(vt,wt,-wt,vt,De+B+Me*B/20,Le+J+Me*J/20),W?(w.beginPath(),w.roundRect(Number.parseInt(-R/2),Number.parseInt(-A/2),R,A,[200,0])):(w.beginPath(),w.rect(Number.parseInt(-R/2),Number.parseInt(-A/2),R,A)),ae?w.fillStyle="rgba(255, 255, 255, 1)":(w.fillStyle=`rgba(26, 27, 38, ${Q})`,w.strokeStyle=`rgba(255, 255, 255, ${Q})`,w.stroke()),w.fill(),w.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:E,ctx:T})};C=Ne.createAsyncTimeline({repeat:-1,yoyo:!1}),C.goTo(S,{rotate:360},{duration:a}),C.play();let D=()=>{Y(),f&&c.useNextFrame(()=>D())};c.useFrame(()=>D());let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,P=ie(e).top,M=ie(e).left,Y()}),G=({x:w,y:R})=>{let A=window.innerWidth,B=window.innerHeight,J=w-e.width/2-M,Q=R-e.height/2-P;x.goTo({x:Oe(J,-A/2+400+M,A/2-400-M),y:Oe(Q,-B/2+200+P,B/2-200-P)})},se=c.useMouseMove(({client:w})=>{let{x:R,y:A}=w;G({x:R,y:A})}),j=c.useTouchMove(({client:w})=>{let{x:R,y:A}=w;G({x:R,y:A})}),N=$.watch("openNavigation",()=>{f=!1,C?.pause()}),v=$.watch("closeNavigation",()=>setTimeout(()=>{f=!0;let{activeRoute:w}=O.get();w===_&&(C?.resume(),c.useFrame(()=>D()))},500));return()=>{S.destroy(),x.destroy(),C.destroy(),L(),se(),j(),N(),v(),S=null,x=null,C=null,T=null,E=null,V=null,b=[],f=!1}};var ld=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p}=a,u=ad({canvas:p,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{u()}});let{caterpillarN1:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
                ${o({drawers:[{label:"description",source:n.description},{label:"definition",source:n.definition},{label:"component",source:n.component},{label:"animation",source:n.animation}],style:"legend",color:"green"})}
    ...
    `};var Wb=k({name:"caterpillar-n1",component:ld,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(Re()||ne())}});var Ei=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},cd=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:T}=je({disableOffcanvas:d}),b=!0,S=e.getContext(T,{alpha:!1}),x=[],C=m,{activeRoute:P}=O.get(),{offscreen:M,offScreenCtx:_}=ze({useOffscreen:f,canvas:e}),E=f?_:S,V=yt(E)&&!ne();E=null,x=[...new Array(t).keys()].map((j,N)=>{let v=N>=t/2?t/2+(t/2-N):N,w=r+r/3*v,R=o+o/3*v,A=n.includes(N)?1:(t-N)*i;return{width:w,height:R,x:0,y:0,hasFill:n.includes(N),opacity:A,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let q=Z.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:1})},1).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:5})},5).add(({isForced:j,direction:N})=>{Ei({isForced:j,direction:N,value:9})},9);x.forEach(j=>{q.subscribeCache(j,({x:N,rotate:v})=>{let w=N/u,R=2/(3-Math.cos(2*w)),A=R*Math.cos(w)*a,B=R*Math.sin(2*w)/2*l;j.x=A,j.y=B,j.rotate=v})});let W=Ne.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(q);W.onLoopEnd(({loop:j,direction:N})=>{console.log(`loop end: ${j} , ${N}`)});let Y=()=>{if(!S)return;f&&(M.width=e.width,M.height=e.height);let j=f?_:S;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),x.forEach(({width:N,height:v,x:w,y:R,radius:A,rotate:B,hasFill:J,opacity:Q})=>{let Ie=e.width/2,ae=e.height/2,de=1,Me=Math.PI/180*B,De=Math.cos(Me)*de,Le=Math.sin(Me)*de;j.setTransform(De,Le,-Le,De,Ie+w,ae+R),V?(j.beginPath(),j.roundRect(Number.parseInt(-N/2),Number.parseInt(-v/2),N,v,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-N/2),Number.parseInt(-v/2),N,v,A)),J?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${Q})`,j.strokeStyle=`rgba(255, 255, 255, ${Q})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),He({useOffscreen:f,offscreen:M,ctx:S})},D=()=>{Y(),b&&c.useNextFrame(()=>D())};c.useFrame(()=>D()),W.play();let L=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,Y()}),G=$.watch("openNavigation",()=>{b=!1,W?.pause()}),se=$.watch("closeNavigation",()=>setTimeout(()=>{b=!0;let{activeRoute:j}=O.get();j===P&&(W?.resume(),c.useFrame(()=>D()))},500));return{destroy:()=>{b=!1,L(),G(),se(),q.destroy(),W.destroy(),S=null,M=null,_=null,x=[]},play:()=>{W.stop(),W.play()},playReverse:()=>{W.stop(),W.playReverse()},playUseCurrent:()=>W.play({useCurrent:!0}),playReverseUseCurrent:()=>W.playReverse({useCurrent:!0}),playFromLabel:()=>{W.stop(),W.playFrom("mylabel")},plaFromLabelReverse:()=>{W.stop(),W.playFromReverse("mylabel")},stop:()=>W.stop(),pause:()=>W.pause(),resume:()=>W.resume(),reverse:()=>W.reverse(),setRotation:j=>C=j}};function Bb({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return g` <li class="c-canvas__controls__item">
                <button
                    type="button"
            ...
            </li>`}).join("")}var ud=({onMount:e,html:t,getState:r,staticProps:o})=>{let{buttons:s,rotationDefault:n}=r();e(({element:p,refs:u})=>{if(re.mq("max","desktop"))return;let{wrap:m,canvas:d,rangeValue:f,rotationButton:T}=u,b=cd({canvas:d,...r()}),{destroy:S,setRotation:x}=b;return Object.entries(s).forEach(([C,P])=>{let{method:M}=P;p.querySelector(`.${C}`).addEventListener("click",()=>b?.[M]())}),T.addEventListener("change",()=>{let C=T.value;x(C),f.textContent=C}),c.useFrame(()=>{m.classList.add("active")}),()=>{S()}});let{caterpillarN2:i}=ye(),{source:a}=i,l=ne()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
    ...
    `};var jb=10,zb={"js-CN2-play":{label:"play",method:"play"},"js-CN2-playReverse":{label:"play reverse",method:"playReverse"},"js-CN2-play-current":{label:"go forward if is backward",method:"playUseCurrent"},"js-CN2-playReverse-current":{label:"go backward if is forward",method:"playReverseUseCurrent"},"js-CN2-play-label":{label:"play from label",method:"playFromLabel"},"js-CN2-playReverse-label":{label:"play from label reverse",method:"plaFromLabelReverse"},"js-CN2-reverse":{label:"reverse",method:"reverse"},"js-CN2-stop":{label:"stop",method:"stop"},"js-CN2-pause":{label:"pause",method:"pause"},"js-CN2-resume":{label:"resume",method:"resume"}},Hb=k({name:"caterpillar-n2",component:ud,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","radius","fill","opacity","xAmplitude","yAmplitude","duration","rotationDefault","friction","disableOffcanvas"],state:{numItems:Re()||ne()?20:30,width:80,height:80,radius:0,fill:[2],opacity:.02,xAmplitude:500,yAmplitude:400,duration:10,rotationDefault:360,friction:jb/2/Math.PI,disableOffcanvas:!!(Re()||ne()),buttons:()=>({value:zb,type:"Any"})}});var pd=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Generator: Gravit.io -->
...
`;var hd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=Z.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=Z.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=Z.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=Z.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Ne.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Ne.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{l.stop(),s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var dd=({refs:e})=>{let t=Z.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var Gb=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},md=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:b,M_left:S,M_right:x,around:C}=i,{playIntro:P,playSvg:M,destroySvg:_}=hd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:b},{M_left:S},{M_right:x}],around:C}),{playText:E,destroyText:V}=dd({refs:a});return Gb({playText:E,playIntro:P,playSvg:M}),()=>{_(),V()}});let{home:o}=ye(),{source:s}=o;return e`<div>
        <code-button
    ...
    </div>`};var Jb=k({name:"home-component",component:md});var Ri=0,Yb=({indicators:e,setState:t})=>[...e].map((r,o)=>Ut.createScrollTrigger({item:r,pin:!0,animateAtStart:!1,range:"0.1px",animatePin:!0,dynamicStart:{position:"right",value:()=>window.innerWidth+Ri-ot(r)*(o+1)},dynamicEnd:{position:"right",value:()=>{let s=e.length-(o-2);return window.innerWidth/10*9*s}},onEnter:()=>{t("currentId",-1),t("currentIdFromScroll",o)},onLeaveBack:()=>{t("currentIdFromScroll",o-1)}})),Xb=({pins:e})=>{e.forEach(t=>t.refresh())},Kb=({titles:e})=>[...e].map(t=>Ut.createParallax({item:t,propierties:"x",reverse:!0,range:9})),fd=({nav:e})=>{e.classList.add("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.add("active")})},gd=({nav:e})=>{e.classList.remove("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.remove("active")})},bd=({indicators:e,titles:t,nav:r,animatePin:o,setState:s})=>{let n=Yb({indicators:e,setState:s}),i=Kb({titles:t}),a=document.querySelector(".l-navcontainer__side");Ri=ot(a)/2;let l=c.useResize(()=>{Ri=ot(a)/2}),p=new Ro({root:".js-root",container:".js-container",row:".js-row",column:".js-column",trigger:".js-trigger",shadowClass:".shadowClass",useWillChange:!0,useDrag:!0,useSticky:!o,animateAtStart:!1,ease:!0,addCss:!0,columnHeight:70,columnWidth:100,columnAlign:"center",pin:o,animatePin:o,breakpoint:"tablet",children:[...n,...i],onEnter:()=>{fd({nav:r,indicators:e})},onEnterBack:()=>{Xb({pins:n}),fd({nav:r,indicators:e})},onLeave:()=>{gd({nav:r,indicators:e})},onLeaveBack:()=>{gd({nav:r,indicators:e})}});return p.init(),{destroy:()=>{n.forEach(u=>{u?.destroy()}),n=[],i.forEach(u=>{u?.destroy()}),i=[],p.destroy(),p=null,l()},refresh:()=>p.refresh()}};var Zb=({numOfCol:e,pinIsVisible:t,staticProps:r})=>{let o=t?"":"hidden";return[...new Array(e).keys()].map((s,n)=>g`
                <horizontal-scroller-section
                    ${r({id:n,pinClass:o})}
                ></horizontal-scroller-section>
            `).join("")},Qb=({numOfCol:e,setState:t,bindProps:r,staticProps:o,delegateEvents:s})=>[...new Array(e).keys()].map((n,i)=>g`
                <horizontal-scroller-button
                    ${o({id:i})}
                    ${s({click:()=>t("currentId",i)})}
                    ${r({bind:["currentId","currentIdFromScroll"],props:({currentId:a,currentIdFromScroll:l})=>({active:a===i||l===i})})}
                ></horizontal-scroller-button>
            `).join(""),yd=({onMount:e,html:t,getState:r,setState:o,watch:s,staticProps:n,bindProps:i,delegateEvents:a})=>{let{animatePin:l}=r();e(({element:m})=>{if(re.mq("max","desktop"))return;let d=m.querySelectorAll(".js-indicator"),f=m.querySelector(".js-nav"),T=m.querySelectorAll(".js-title h1"),{destroy:b}=bd({indicators:d,titles:T,nav:f,...r(),setState:o});return window.scrollTo(0,0),s("currentId",S=>{if(S===-1)return;let x=m.querySelector(`.shadowClass--section-${S} .shadowClass--in-center`),{top:C}=ie(x),P=we(x),M=Number.parseInt(S)===0?window.innerHeight+1:C+P-window.innerHeight;lr.to(M,{duration:2e3})}),()=>{b()}});let{horizontalScroller:p}=ye(),{source:u}=p;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`<div class="l-h-scroller">
        <only-desktop></only-desktop>
    ...
    `};var t0=k({name:"horizontal-scroller-button",component:vd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var wd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var r0=k({name:"horizontal-scroller-section",component:wd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Sd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],b=[],S=Z.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",P="#fff",{activeRoute:M}=O.get(),{offscreen:_,offScreenCtx:E}=ze({useOffscreen:m,canvas:e}),V=m?E:x,q=yt(V);V=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Qr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?T.map((v,w)=>({...v,scale:0,rotate:0,hasFill:a.includes(w)})).sort(v=>v.hasFill?-1:1):T.map((v,w)=>({...v,scale:0,rotate:0,hasFill:a.includes(w)}));let W=Z.createStaggers({items:b,stagger:l}),Y=W.map(({item:v,start:w,end:R})=>{let A=v.hasFill?1.1:1,B=Z.createSequencer({data:{scale:0}}).goTo({scale:A},{start:w,end:R,ease:"easeOutBack"}),J=B.subscribe(({scale:Q})=>{v.scale=Q});return S.add(B),{sequencer:B,unsubscribe:J}}),D=()=>{if(!x)return;m&&(_.width=e.width,_.height=e.height);let v=m?E:x;v.fillStyle="#1a1b26",v.fillRect(0,0,e.width,e.height),b.forEach(({x:w,y:R,centerX:A,centerY:B,width:J,height:Q,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Me,offsetYCenter:De})=>{let Le=Math.PI/180*Ie,Ge=Math.cos(Le)*ae,Je=Math.sin(Le)*ae;v.setTransform(Ge,Je,-Je,Ge,Math.round(A+Me),Math.round(B+De)),ed(v,Math.round(-A+w),Math.round(-B+R),J,Q,5),q?(v.beginPath(),v.roundRect(Math.round(-A+w),Math.round(-B+R),J,Q,5)):(v.beginPath(),v.rect(Math.round(-A+w),Math.round(-B+R),J,Q)),v.fillStyle=de?P:C,v.fill(),v.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:_,ctx:x})},L=Ut.createScrollTrigger({trigger:t,propierties:"tween",tween:S,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>we(t)},ease:!0,easeType:"lerp"});L.init();let G=()=>{D(),f&&c.useNextFrame(()=>G())};c.useFrame(({time:v})=>{G({time:v})});let se=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(v=>{let{width:w,height:R,gutter:A,numberOfColumn:B}=v;v.offsetXCenter=hr({canvasWidth:e.width,width:w,gutter:A,numberOfColumn:B}),v.offsetYCenter=dr({canvasHeight:e.height,height:R,gutter:A,numberOfRow:r})}),c.useFrame(()=>D())}),j=$.watch("openNavigation",()=>{f=!1}),N=$.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:v}=O.get();v===M&&c.useFrame(()=>G())},500));return()=>{se(),N(),j(),Y.forEach(({sequencer:v,unsubscribe:w})=>{v.destroy(),w()}),Y=[],S.destroy(),S=null,W=[],L.destroy(),L=null,x=null,_=null,E=null,T=[],b=[],f=!1}};var Td=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(re.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=Sd({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ye(),{source:n}=s;return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
    ...
    `};var o0=k({name:"scroller-n0",component:Td,isolateOnMount:!0,isolateCreation:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[36,37,38,39,40,47,51,58,62,69,73,80,81,82,83,84],type:Array}),stagger:()=>({value:{type:"equal",each:6,from:"random"},type:"Any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||ne())}});function s0({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function n0({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var xd=({canvas:e,canvasScroller:t,amountOfPath:r,width:o,height:s,radius:n,opacity:i,intialRotation:a,endRotation:l,disableOffcanvas:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:p}),d=!0,f=e.getContext(m,{alpha:!1}),T=[],{activeRoute:b}=O.get(),{offscreen:S,offScreenCtx:x}=ze({useOffscreen:u,canvas:e}),C=u?x:f,P=yt(C)&&!ne();C=null,e.width=e.clientWidth,e.height=e.clientHeight,T=[...new Array(r).keys()].map((D,L)=>{let G=L>=r/2?r/2+(r/2-L):L;return{width:Math.floor(s0({width:o,relativeIndex:G,amountOfPath:r})),height:Math.floor(n0({height:s,relativeIndex:G,amountOfPath:r})),opacity:G*i,rotate:0,relativeIndex:G,index:L}});let M=Z.createScrollerTween({from:{rotate:0},to:{rotate:l},stagger:{each:5,from:"center"}});[...T].forEach(D=>{M.subscribeCache(D,({rotate:L})=>{D.rotate=L})});let _=()=>{if(!f)return;u&&(S.width=e.width,S.height=e.height);let D=u?x:f,L=e.width/2,G=e.height/2;D.fillStyle="#1a1b26",D.fillRect(0,0,e.width,e.height),T.forEach(({width:se,height:j,opacity:N,rotate:v,index:w})=>{let R=T.length/2-w,A=1,B=Math.PI/180*(v-a),J=Math.cos(B)*A,Q=Math.sin(B)*A;D.setTransform(J,Q,-Q,J,L,G+R*19),P?(D.beginPath(),D.roundRect(-se/2,-j/2+R*19,se,j,150)):(D.beginPath(),D.rect(Number.parseInt(-se/2),Number.parseInt(-j/2),se,j,n)),D.strokeStyle=`rgba(255, 255, 255, ${N})`,D.fillStyle=`rgba(26, 27, 38, ${N})`,D.stroke(),D.fill(),D.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:S,ctx:f})},E=Ut.createScrollTrigger({trigger:t,propierties:"tween",tween:M,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>we(t)},ease:!0,easeType:"spring"});E.init();let V=({time:D=0})=>{_({time:D}),d&&c.useNextFrame(({time:L})=>V({time:L}))};c.useFrame(({time:D})=>{V({time:D})});let q=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,c.useFrame(()=>{_()})}),W=$.watch("openNavigation",()=>{d=!1}),Y=$.watch("closeNavigation",()=>{setTimeout(()=>{d=!0;let{activeRoute:D}=O.get();D===b&&c.useFrame(({time:L})=>V({time:L}))},500)});return()=>{M.destroy(),q(),Y(),W(),M.destroy(),M=null,E.destroy(),E=null,f=null,S=null,x=null,M=null,T=[],d=!1}};var Cd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(re.mq("max","desktop"))return;let{wrap:l,canvas:p,canvasScroller:u}=a,m=xd({canvas:p,canvasScroller:u,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{m()}});let{scrollerN1:s}=ye(),{source:n}=s,i=ne()?"c-canvas__wrap--wrapped":"";return re.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
            <div class="c-canvas c-canvas--fixed ">
                <code-button
        ...
        <div class="dynamic-list">
            <div class="dynamic-list__header">
                <div class="dynamic-list__top">
                    ${c0({setState:e,delegateEvents:n,staticProps:o,bindProps:s})}
                    <dynamic-list-button
    ...
    `};var p0=k({name:"dynamic-list",component:Rd,state:{counter:()=>({value:0,type:Number}),data:()=>({value:Zs,type:Array}),activeSample:()=>({value:3,type:Number})}});function eo(e,t){return`${e}: ${t}`}var Pd=async({getState:e,html:t,onMount:r,key:o,staticProps:s,bindProps:n,watch:i,id:a})=>{let{isFull:l,parentListId:p,index:u,label:m,counter:d}=e();return r(({element:T,refs:b})=>{let{indexEl:S,labelEl:x,counterEl:C}=b;T.addEventListener("click",()=>{T.classList.toggle("is-selected")}),i("index",P=>{S.textContent=eo("index",P)}),i("label",P=>{x.textContent=eo("label",P)}),i("counter",P=>{C.textContent=eo("counter",P)}),c.useFrame(()=>{T.classList.add("active")})}),t`
    ...
    `};var d0=k({name:"dynamic-list-slot",component:_d,exportState:["staticFromSlot","staticFromComponent","parentParentState","parentState"],state:{staticFromSlot:()=>({value:"",type:"any"}),staticFromComponent:()=>({value:"",type:"any"}),parentParentState:()=>({value:"",type:"any"}),parentState:()=>({value:"",type:"any"})}});var Od=async({html:e})=>e`<div class="dynamic-list-empty">
        <p>empty comp</p>
        <mobjs-slot name="empty-slot"></mobjs-slot>
    </div>`;var m0=k({name:"dynamic-list-empty",component:Od});var Nd=async({watch:e,onMount:t,html:r,getState:o})=>{let{parentListId:s,counter:n}=o();return t(({refs:i})=>{let{counterValueEl:a}=i;e("counter",l=>{a.textContent=l})}),r`<div class="dynamic-counter">
    ...
    </div>`};var f0=k({name:"dynamic-list-counter",component:Nd,exportState:["counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});var Md=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button" class="dynamic-list-button">${s}</button>
    `};var g0=k({name:"dynamic-list-button",component:Md,exportState:["active","label"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});function b0({sync:e,staticProps:t,bindProps:r,listId:o,delegateEvents:s}){return g`
        <dynamic-list-card
            ${t({parentListId:o})}
    ...
    `}function y0(e){return`<strong>Current cards id:</strong> ${e.join(",").replaceAll(","," | ")}`}function v0({element:e,className:t,childrenId:r}){let o=e.querySelector(t);o.textContent="",o.insertAdjacentHTML("afterbegin",y0(r))}var Ld=({getState:e,html:t,repeat:r,staticProps:o,bindProps:s,delegateEvents:n})=>{let{listId:i,key:a,clean:l,label:p}=e(),u=a.length>0?a:null;return t`
...
`;var $d=({groups:e,trails:t})=>{let r=180/Math.PI,o=window.innerWidth,s=window.innerHeight,n=0,i=0,a=0,l=0,p=!1,u=t.map(C=>C.querySelector("svg")),m=Z.createSpring({data:{x:0,y:0},stagger:{each:3,from:"start"}});t.forEach(C=>{m.subscribe(({x:P,y:M})=>{C.style.translate=`${P}px ${M}px`})});let d=Z.createSpring({data:{rotation:0},stagger:{each:8,from:"start"}});u.forEach(C=>{d.subscribeCache(C,({rotation:P})=>{C.style.rotate=`${P}deg`})});let f=Z.createTween({data:{opacity:0,scale:1.4}});t.forEach(C=>{f.subscribe(({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let T=c.useResize(()=>{o=window.innerWidth,s=window.innerHeight}),b=c.useMouseMove(({client:C})=>{if(!p)return;let{x:P,y:M}=C,_=M-n,E=P-i;if(Math.abs(E)>10||Math.abs(_)>10){n=M,i=P;let q=Math.atan2(_,E)*r+180,W=Math.abs(a-q);W>180&&a<q&&(l-=360),W>180&&a>q&&(l+=360);let Y=q+l+90;d.goTo({rotation:Y}),a=q}m.goTo({x:P-o/2,y:M-s/2})}),S=Z.createTween({data:{opacity:0,scale:.95},duration:2e3,ease:"easeOutQuart",stagger:{waitComplete:!0,each:5,from:"center"}});e.forEach(C=>{S.subscribeCache(C,({scale:P,opacity:M})=>{C.style.scale=`${P}`,C.style.opacity=M})});let x=Ne.createAsyncTimeline({repeat:1}).createGroup().goTo(S,{opacity:1,scale:1}).goTo(f,{scale:1,opacity:1}).closeGroup();return{playIntro:async()=>x.play().then(()=>{p=!0}),destroy:()=>{S.destroy(),S=null,x.destroy(),x=null,m.destroy(),m=null,d.destroy(),d=null,f.destroy(),f=null,T(),b(),o=null,s=null,n=null,i=null,a=null,l=null,u=null}}};var x0=10,C0=async({playIntro:e})=>{await e()},I0=()=>[...new Array(x0).keys()].map((e,t)=>g`
                <div
            ...
            `).join(""),Wd=({onMount:e,html:t,getState:r,staticProps:o})=>{let s=re.mq("min","desktop"),{svg:n}=s?r():"",{child:i}=ye(),{source:a}=i;return e(({refs:l})=>{if(!s)return;let{trail0:p,trail1:u,trail2:m,trail3:d,trail4:f,trail5:T,trail6:b,trail7:S,trail8:x,trail9:C,black:P,body:M,bottom_green:_,collo:E,dark_shadow:V,gambe:q,green_top:W,head:Y,light_shadow:D,head_bg:L,body_bg:G,head_green:se,highlight:j}=l,N=$d({groups:[P,M,_,E,V,q,W,Y,D,L,G,se,j],trails:[p,u,m,d,f,T,b,S,x,C]}),{playIntro:v,destroy:w}=N;return C0({playIntro:v}),()=>{w()}}),t`<div class="svg-child-container">
        <only-desktop></only-desktop>
    ...
    </div>`};var E0=k({name:"svg-child",component:Wd,exportState:["svg"],state:{svg:()=>({value:"",type:String})}});var Ai={};Oi(Ai,{about:()=>W0,animatedPatternN0v1:()=>R0,animatedPatternN0v2:()=>P0,animatedPatternN0v3:()=>A0,animatedPatternN0v4:()=>_0,animatedPatternN0v5:()=>O0,animatedPatternN0v6:()=>N0,animatedPatternN0v7:()=>M0,animatedPatternN1:()=>L0,canvas_overview:()=>H0,caterpillarN0:()=>F0,caterpillarN1:()=>D0,caterpillarN2:()=>V0,child:()=>Gy,dynamic_list:()=>K0,home:()=>$0,horizontalScrollerV1:()=>j0,horizontalScrollerV2:()=>z0,mobCore_defaults:()=>Ly,mobCore_events:()=>Ny,mobCore_overview:()=>Oy,mobCore_store:()=>My,mobJs_bindEvents:()=>Ty,mobJs_bindProps:()=>vy,mobJs_component:()=>ty,mobJs_computed:()=>ly,mobJs_debug:()=>Py,mobJs_delegateEvents:()=>xy,mobJs_emit:()=>iy,mobJs_emitAsync:()=>ay,mobJs_freezeProp:()=>my,mobJs_getChildren:()=>dy,mobJs_getParentId:()=>gy,mobJs_getState:()=>sy,mobJs_html:()=>ry,mobJs_initialization:()=>Q0,mobJs_instanceName:()=>_y,mobJs_onMount:()=>oy,mobJs_overview:()=>Z0,mobJs_refs:()=>Iy,mobJs_remove:()=>py,mobJs_removeDom:()=>hy,mobJs_repeat:()=>Cy,mobJs_routing:()=>ey,mobJs_runtime:()=>Ay,mobJs_setState:()=>ny,mobJs_slot:()=>Ey,mobJs_staticProps:()=>yy,mobJs_syncParent:()=>Sy,mobJs_unBind:()=>wy,mobJs_unFreezeProp:()=>fy,mobJs_utils:()=>ky,mobJs_watch:()=>cy,mobJs_watchParent:()=>by,mobJs_watchSync:()=>uy,mobJs_web_component:()=>Ry,mobMotion_async_timeline:()=>Fy,mobMotion_create_stagger:()=>Dy,mobMotion_defaults:()=>qy,mobMotion_overview:()=>Vy,mobMotion_parallax:()=>$y,mobMotion_scrolltrigger:()=>Wy,mobMotion_sequencer:()=>By,mobMotion_stagger:()=>jy,mobMotion_sync_timeline:()=>zy,mobMotion_tween_spring_lerp:()=>Hy,pageNotFound:()=>k0,plugin_overview:()=>B0,scrollerN0v1:()=>q0,scrollerN0v2:()=>U0,scrollerN0v3:()=>G0,scrollerN0v4:()=>J0,scrollerN0v5:()=>Y0,scrollerN1:()=>X0,svg_overview:()=>Uy});var k0=()=>g`
    ...
    `;var R0=()=>g`<div class="l-padding">
        ...
        <animatedpattern-n0
            ${y({fill:[0,13,20,45,65,71,72,73,74,75,76,77,83,92,96,113,117,134,138,155,156,157,158,159,189,209],gutter:1,numberOfColumn:10,numberOfRow:10,cellWidth:50,cellHeight:50,stagger:{each:5,from:"start",waitComplete:!1},reorder:!1})}
        ></animatedpattern-n0>
        <quick-nav
            ${y({prevRoute:"#animatedPatternN0v3",nextRoute:"#animatedPatternN0v5"})}
        ></quick-nav>
    </div>`;var O0=()=>g`<div class="l-padding">
        <animatedpattern-n0
            ${y({fill:[0,13,20,45,65,71,72,73,74,75,76,77,83,92,96,113,117,134,138,155,156,157,158,159,189,209],gutter:1,numberOfColumn:10,numberOfRow:10,cellWidth:50,cellHeight:50,stagger:{each:5,from:"start",grid:{col:11,row:10,direction:"row"},waitComplete:!1},reorder:!1})}
        ></animatedpattern-n0>
        <quick-nav
            ${y({prevRoute:"#animatedPatternN0v4",nextRoute:"#animatedPatternN0v6"})}
        ></quick-nav>
    </div>`;var N0=()=>g`<div class="l-padding">
        <animatedpattern-n0
            ${y({fill:[0,13,20,45,65,71,72,73,74,75,76,77,83,92,96,113,117,134,138,155,156,157,158,159,189,209],gutter:1,numberOfColumn:10,numberOfRow:10,cellWidth:50,cellHeight:50,stagger:{each:5,from:"start",grid:{col:11,row:10,direction:"col"},waitComplete:!1},reorder:!1})}
        ></animatedpattern-n0>
        <quick-nav
            ${y({prevRoute:"#animatedPatternN0v5",nextRoute:"#animatedPatternN0v7"})}
        ></quick-nav>
        ...
        ></animatedpattern-n0>
        <quick-nav
            ${y({prevRoute:"#animatedPatternN0v6",nextRoute:"#animatedPatternN1"})}
        ></quick-nav>
    </div>`;var L0=()=>g`<div class="l-padding">
        <animatedpattern-n1></animatedpattern-n1>
        <quick-nav
            ${y({prevRoute:"#animatedPatternN0v7",nextRoute:"#scrollerN0v1"})}
        ></quick-nav>
        ...
        ></quick-nav>
    </div>`;var $0=()=>g`<div class="l-index">
        <home-component></home-component>
    </div>`;var W0=async()=>{let{success:e,data:t}=await I({source:"./data/about.json"});return e?g`<doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var B0=()=>g` <doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`;var j0=()=>g`<div>
        <horizontal-scroller></horizontal-scroller>
    </div>`;var z0=()=>g`<div>
        <horizontal-scroller
            ${y({animatePin:!0})}
        ></horizontal-scroller>
    </div>`;var H0=async()=>{let{success:e,data:t}=await I({source:"./data/canvas/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var q0=()=>g`<div>
        ...
        <scroller-n0
            ${y({stagger:{type:"equal",each:3,from:"end"},reorder:!1})}
        ></scroller-n0>
        <quick-nav
        ...
        ></quick-nav>
    </div>`;var K0=()=>g` <dynamic-list> </dynamic-list> `;var Z0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Q0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/initialization.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/routing.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/component.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/html.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/onMount.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/setState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emit.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emitAsync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/computed.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watch.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var uy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchSync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var py=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/remove.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var hy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/removeDom.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getChildren.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var my=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/freezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unFreezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var gy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getParentId.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var by=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var yy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/staticProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var wy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unBind.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/syncParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var xy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/delegateEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/repeat.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/refs.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/slot.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ky=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/utils.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/webComponent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Py=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/debug.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/runtime.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var _y=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/instanceName.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/events.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var My=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/store.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/asyncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/createStagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var $y=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/parallax.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Wy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/scrollTrigger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var By=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/sequencer.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var jy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/stagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var zy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/syncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Hy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/tweenSpringLerp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var qy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Defaults</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var Uy=async()=>{let{success:e,data:t}=await I({source:"./data/svg/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${y({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Gy=async()=>{let{success:e,data:t}=await Us({source:"./asset/svg/child.svg"});return e?g`<div>
        <svg-child ${y({svg:t})}></svg-child>
    </div>`:(console.warn("fetch data fail"),[])};var Bd=()=>g`
    ...
    `;c.useLoad(()=>{c.store.set("fpsScalePercent",{0:1,50:2,70:3}),re.setDefault({deferredNextTick:!0,useScaleFps:!0,usePassive:!0,mq:{desktop:1024},spring:{config:{customSpring:{friction:1,mass:1,precision:.01,tension:180,velocity:0}}}}),re.printDefault(),(async()=>{let t=document.body.querySelector(".js-main-loader"),r=document.body.querySelector(".js-main-loader-background"),o=Z.createTween({data:{opacity:1,scale:1},duration:1e3});t&&r&&[t,r].forEach(s=>{o.subscribe(({opacity:n,scale:i})=>{s.style.opacity=n,s.style.transform=`scale(${i})`})}),await Dh(),Pn({isolateCreation:!1,isolateOnMount:!1,scoped:!1,maxParseIteration:1e3,debug:!0}),Wn({rootId:"#root",contentId:"#content",wrapper:Bd,components:Pi,pages:Ai,index:"home",pageNotFound:"pageNotFound",afterInit:async()=>{await o.goTo({opacity:0,scale:.9}),t?.remove(),r?.remove(),o=null}})})()});})();
