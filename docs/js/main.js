...
`;var Cf=({getState:e})=>{let{rawContent:t}=e();navigator.clipboard.writeText(t)};function If({sync:e,bindProps:t,setState:r,delegateEvents:o}){return g`
    ...
    `}var Ef=async({setState:e,getState:t,codeEl:r,currentKey:o,updateScroller:s,goToTop:n,syncParent:i})=>{let{urls:a}=t(),p=a.find(({label:m})=>m===o)?.source;if(!p?.length)return;let u=g`<html-content
        ${S({source:p,useMinHeight:!0})}
        ${i}
    ></html-content>`;r.insertAdjacentHTML("afterbegin",u),await po(r),e("rawContent",r.textContent),s(),n()},Rp=({codeEl:e,removeDOM:t})=>{e.textContent="";let r=e.firstElementChild;r&&t(r)},Pp=({onMount:e,setState:t,getState:r,repeat:o,html:s,bindProps:n,delegateEvents:i,staticProps:a,computed:l,watch:p,removeDOM:u,syncParent:m})=>(e(({element:d,refs:f})=>{let{screenEl:T,scrollerEl:b,codeEl:w,scrollbar:x}=f,{updateScroller:C,move:A,goToTop:W}=Ep({screen:T,scroller:b,scrollbar:x});x.addEventListener("input",()=>{A(x.value)}),L.watch("beforeRouteLeave",()=>{console.log("oooo"),t("urls",[])}),l("currentButtonState",["urls","activeContent"],(k,$)=>(k.length>0?(d.classList.add("active"),document.body.style.overflow="hidden"):(d.classList.remove("active"),document.body.style.overflow="",Rp({codeEl:w,removeDOM:u}),t("activeContent",""),W()),$));let N=p("activeContent",k=>{Rp({codeEl:w,removeDOM:u}),Ef({setState:t,getState:r,codeEl:w,currentKey:k,updateScroller:C,goToTop:W,staticProps:a,syncParent:m})});return()=>{N()}}),s`
        <div class="code-overlay js-overlay">
            ...
            <div class="code-overlay__wrap js-overlay-wrap">
                ...
                <button
                    ...
                    ${i({click:()=>{Cf({getState:r})}})}
                >
                    ${kp}
                </button>
                <div class="code-overlay__header">
                    ${o({clean:!0,watch:"urls",render:({sync:d})=>If({sync:d,bindProps:n,delegateEvents:i,setState:t})})}
                </div>
                <input
                    type="range"
                    id="test"
    ...
    `};var kf=E({name:"code-overlay",component:Pp,isolateOnMount:!0,isolateCreation:!0,exportState:["urls","activeContent"],state:{urls:()=>({value:[],type:Array,skipEqual:!1}),activeContent:()=>({value:"",type:String,skipEqual:!0}),rawContent:()=>({value:"",type:String}),currentButtonState:()=>({value:String,type:"",skipEqual:!0})}}),Rf=E({name:"code-overlay-button",component:Ap,exportState:["key","selected","disable"],state:{key:"",selected:()=>({value:!1,type:Boolean}),disable:()=>({value:!0,type:Boolean})}});var _p=({html:e,delegateEvents:t})=>e`
        <button
            type="button"
            class="c-btn-debug"
...
Loading snippet ...</pre
    ...
    </div>`};var Mg=E({name:"mob-snippet",component:gh,exportState:["source","isFull","hasOverflow","hasBorder","numLines"],state:{source:()=>({value:"",type:String}),contentIsLoaded:()=>({value:!1,type:Boolean}),isFull:()=>({value:!1,type:Boolean}),hasOverflow:()=>({value:!0,type:Boolean}),hasBorder:()=>({value:!1,type:Boolean}),numLines:()=>({value:1,type:Number})}});function Lg({id:e,label:t}){return e&&e.length>0?`data-scroll=${e} data-label=${t}`:""}var bh=async({html:e,getState:t})=>{let{style:r,line:o,id:s,label:n}=t(),i=o?"spacer--line":"";return e`<div
        ${Lg({id:s,label:n})}
        class="spacer spacer--${r} ${i}"
    ></div>`};var Fg=E({name:"mob-spacer",component:bh,exportState:["style","line","id","label"],state:{style:()=>({value:"medium",type:String,validate:e=>["small","medium","big"].includes(e),strict:!0}),line:()=>({value:!1,type:Boolean}),id:()=>({value:"",type:String}),label:()=>({value:"",type:String})}});var Dg=g`
    <div class="only-desktop">
        <h3>This content is available only on desktop</h3>
        <h4>Need page reload on a screen size up to 1024px</h4>
    </div>
`,yh=({element:e})=>{e.textContent="",!oe.mq("min","desktop")&&(e.textContent="",e.insertAdjacentHTML("afterbegin",Dg))},vh=({html:e,onMount:t})=>(t(({element:r})=>{yh({element:r}),c.useResize(()=>{yh({element:r})})}),e` <div class="only-desktop-container" ref="container"></div> `);var Vg=E({name:"only-desktop",component:vh,state:{}});var Sh=({onMount:e,html:t,watch:r,remove:o,getState:s})=>{let{position:n}=s();return e(({element:i})=>{let a=re.createTween({data:{opacity:1,scale:1},duration:500});return a.subscribe(({opacity:l,scale:p})=>{i.style.opacity=l,i.style.transform=`scale(${p})`}),r("shouldRemove",async l=>{l&&(await a.goTo({opacity:0,scale:.9}),o())}),()=>{a.destroy(),a=null}}),t`
        <div class="c-loader ${n}">
            <span class="c-loader__inner"></span>
        </div>
    `};var $g=E({name:"mob-loader",component:Sh,exportState:["position","shouldRemove"],state:{shouldRemove:()=>({value:!1,type:Boolean}),position:()=>({value:"center-viewport",type:String,validate:e=>["center-viewport","center-component"].includes(e)})}});var Wg=({scrollY:e,element:t})=>{c.useNextTick(()=>{let r=e,o=document.documentElement.scrollHeight-window.innerHeight,s=Math.round(r/o*100);c.useNextFrame(()=>{t.style.setProperty("--delta",`${s}%`)})})},wh=({html:e,onMount:t})=>(t(({element:r})=>{if(oe.mq("max","large"))return;r.style.setProperty("--delta","0");let o=c.useScroll(({scrollY:s})=>{c.useFrame(()=>{Wg({scrollY:s,element:r})})});return()=>{o()}}),e` <div class="c-doc-scroll"></div> `);var Bg=E({name:"doc-scroll",component:wh});var Th=({html:e,delegateEvents:t})=>e`
        <div
            class="c-doc-top"
            ${t({click:()=>At.to(0,{duration:2e3})})}
        ></div>
    `;var jg=E({name:"doc-top",component:Th});function zg({targets:e,delegateEvents:t,syncParent:r,staticProps:o,setState:s,bindProps:n}){return e.map((i,a)=>{let{label:l,scroll:p}=i.dataset;return g`<li>
                <scroll-to-button
    ...
    `;var Kg=E({name:"mob-footer",component:Ph});var D=c.createStore({closeAllAccordion:()=>{},refreshScroller:()=>{},openNavigation:()=>{},closeNavigation:()=>{},goToTop:()=>{},activeSection:()=>({value:"",type:String,skipEqual:!1}),navigationIsOpen:()=>({value:!1,type:Boolean})});var Ah=({html:e,onMount:t,getState:r})=>{let{label:o,section:s}=r();return t(({element:n})=>{D.watch("activeSection",i=>{let a=i===s;console.log(a),n.classList.toggle("current",a)})}),e`
        <button type="button" class="footer-nav__button">${o}</button>
    `};var Zg=[{label:"about",url:"about",section:"about"},{label:"canvas 2d",url:"canvas_overview",section:"canvas"},{label:"mobCore",url:"mobCore_overview",section:"mobCore"},{label:"mobJs",url:"mobJs_overview",section:"mobJs"},{label:"mobMotion",url:"mobMotion_overview",section:"mobMotion"},{label:"plugin",url:"plugin_overview",section:"plugin"}];function Qg({url:e}){let t=qe("page-transition");_e(t,"url",e)}var eb=({delegateEvents:e,staticProps:t})=>Zg.map(({label:r,url:o,section:s})=>g`<li class="footer-nav__item">
                <footer-nav-button
                    ${e({click:()=>{Qg({url:o})}})}
                    ${t({label:r,section:s})}
                ></footer-nav-button>
            </li> `).join(""),_h=({html:e,delegateEvents:t,staticProps:r})=>oe.mq("max","desktop")?e` <span></span> `:e`
        <ul class="footer-nav">
            ${eb({delegateEvents:t,staticProps:r})}
        </ul>
    `;var tb=E({name:"footer-nav",component:_h}),rb=E({name:"footer-nav-button",component:Ah,exportState:["label","section"],state:{label:()=>({value:"",type:String}),section:()=>({value:"",type:String})}});function ob({navInfo:e}){c.useFrame(()=>{e.classList.add("open")})}function sb({navInfo:e}){c.useFrame(()=>{e.classList.remove("open")})}function nb(){let e=qe("page-transition");_e(e,"url","#home"),D.set("navigationIsOpen",!1),D.emit("closeNavigation"),D.emit("closeAllAccordion"),D.emit("goToTop")}var Oh=({html:e,onMount:t,delegateEvents:r})=>(t(({refs:o})=>{let{navInfo:s,title:n,beta:i}=o;return D.watch("openNavigation",()=>ob({navInfo:s})),D.watch("closeNavigation",()=>sb({navInfo:s})),L.watch("beforeRouteChange",a=>{n.classList.toggle("visible",a!=="home"),i.classList.toggle("visible",a!=="home")}),()=>{}}),e`
...
`;var Mh={},Lh={},Ys=()=>Mh,ve=()=>Lh,Fh=async()=>{Mh=await fetch("./data/common.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e)),Lh=await fetch("./data/legend.json").then(e=>e.json()).then(e=>e).catch(e=>console.warn("Something went wrong.",e))};var Dh={github:Nh},ab=({event:e})=>{let t=e.target;console.log(t);let{url:r}=t.dataset,o=qe("page-transition");_e(o,"url",r);let{navigationIsOpen:s}=D.get();s&&(D.set("navigationIsOpen",!1),D.emit("closeNavigation"))};function lb({delegateEvents:e}){let{header:t}=Ys(),{links:r}=t;return r.map(o=>{let{svg:s,url:n,internal:i}=o;return g`<li class="l-header__sidenav__item">
                ${i?g`
                          <button
                              type="button"
                              data-url="${n}"
                              class="l-header__sidenav__link"
                              ${e({click:a=>{console.log("click"),ab({event:a})}})}
                          >
                              ${Dh[s]}
                          </button>
                      `:g`
    ...
    `;var cb=()=>{let{navigationIsOpen:e}=D.get("navigationIsOpen");if(D.set("navigationIsOpen",t=>!t),e){D.emit("closeNavigation");return}D.emit("openNavigation")},$h=({onMount:e,html:t,delegateEvents:r})=>(e(({element:o})=>{D.watch("closeNavigation",()=>{c.useFrame(()=>{o.classList.remove("is-open")})}),D.watch("openNavigation",()=>{c.useFrame(()=>{o.classList.add("is-open")})})}),t`
        <button
    ...
    `);var ub=E({name:"mob-header",component:Oh}),pb=E({name:"mob-header-nav",component:Vh}),hb=E({name:"mob-header-toggle",component:$h});var Ci=0,Wh=({root:e})=>{let t=e.querySelector(".l-navcontainer__wrap"),r=e.querySelector(".l-navcontainer__scroll"),o=e.querySelector(".l-navcontainer__percent"),s=200,n=new Ut({screen:t,scroller:r,direction:"vertical",drag:!0,scopedEvent:!0,breakpoint:"tablet",onUpdate:({percent:i})=>{let{navigationIsOpen:a}=D.get();a&&(Ci=Number.parseInt(i)/100,o.style.transform=`translateZ(0) scaleX(${Ci})`)}});n.init(),D.watch("activeSection",i=>{let a=document.querySelector(`[data-sectionname='${i}']`);if(!a)return;let l=document.querySelector(".l-header"),p=Se(r),u=Se(l),m=100*a.offsetTop/(p-window.innerHeight+u),d=Math.min(m,100);n.move(d)}),D.watch("refreshScroller",()=>n.refresh()),D.watch("closeNavigation",()=>{o.style.transform="translateZ(0) scaleX(0)"}),D.watch("openNavigation",()=>{o.style.transform=`translateZ(0) scaleX(${Ci})`}),D.watch("goToTop",()=>{setTimeout(()=>{n.set(0),D.set("activeSection","no-section")},s)})};function db({element:e,main:t}){c.useFrame(()=>{document.body.style.overflow="",e.classList.remove("active"),t.classList.remove("shift")})}function mb({element:e,main:t}){D.emit("refreshScroller"),c.useFrame(()=>{document.body.style.overflow="hidden",e.classList.add("active"),t.classList.add("shift")})}function fb({main:e,toTopBtn:t}){e.addEventListener("click",()=>{let{navigationIsOpen:r}=D.get();r&&(D.set("navigationIsOpen",!1),D.emit("closeNavigation"))}),t.addEventListener("click",()=>{D.emit("closeAllAccordion"),D.emit("goToTop");let{navigationIsOpen:r}=D.get();r||At.to(0)})}var Bh=({html:e,onMount:t})=>(t(({element:r,refs:o})=>{let s=document.querySelector("main.main"),n="",{toTopBtn:i,wrap:a}=o;return D.watch("openNavigation",()=>mb({element:r,main:s})),D.watch("closeNavigation",()=>db({element:r,main:s})),c.useResize(()=>{let p=oe.mq("max","desktop")?"desk":"mob";p!==n&&a.scrollTo(0,0),n=p}),fb({main:s,toTopBtn:i}),Wh({root:r}),()=>{}}),e`
    ...
    `);function gb({data:e,staticProps:t,setState:r,bindProps:o,bindEvents:s}){return e.map((n,i)=>{let{label:a,url:l,children:p,section:u,sectioName:m,scrollToSection:d}=n;return u?g`
                ...
                `:p?g`
                  ...
                  `}).join("")}var jh=({html:e,staticProps:t,setState:r,bindProps:o,bindEvents:s})=>{let{navigation:n}=Ys();return D.watch("closeAllAccordion",()=>{r("currentAccordionId",-1)}),e`
        <nav class="l-navigation">
            <ul class="l-navigation__list">
                ${gb({data:n,staticProps:t,setState:r,bindProps:o,bindEvents:s})}
            </ul>
        </nav>
    ...
    `};function bb({children:e,staticProps:t,callback:r}){return e.map(o=>{let{label:s,url:n,scrollToSection:i}=o;return g`
        ...
        <li class="l-navigation__item has-child">
            ...
            <ul class="l-navigation__submenu" ref="content">
                ${bb({children:a,staticProps:s,callback:p})}
            </ul>
        </li>
    `};var yb=E({name:"mob-navigation-container",component:Bh,isolateOnMount:!0,isolateCreation:!0}),vb=E({name:"mob-navigation",component:jh,exportState:["currentAccordionId"],state:{currentAccordionId:()=>({value:-1,type:Number,skipEqual:!1})}}),Sb=E({name:"mob-navigation-submenu",component:Uh,isolateOnMount:!0,isolateCreation:!0,exportState:["children","headerButton","isOpen","callback"],state:{callback:()=>({value:()=>{},type:Function}),headerButton:()=>({value:{},type:"Any"}),children:()=>({value:[],type:Array}),isOpen:()=>({value:!1,type:Boolean})}}),wb=E({name:"mob-navigation-button",type:"button",component:zh,exportState:["label","url","arrowClass","subMenuClass","fireRoute","callback","isOpen","scrollToSection"],state:{label:()=>({value:"",type:String}),url:()=>({value:"",type:String}),scrollToSection:()=>({value:"",type:String}),arrowClass:()=>({value:"",type:String}),subMenuClass:()=>({value:"",type:String}),fireRoute:()=>({value:!0,type:Boolean}),callback:()=>({value:()=>{},type:Function}),isOpen:()=>({value:!1,type:Boolean})}}),Tb=E({name:"mob-navigation-label",component:Hh,exportState:["label","sectioName"],state:{label:()=>({value:"",type:String}),sectioName:()=>({value:"",type:String})}});var qh=({html:e,onMount:t})=>(t(({refs:r})=>{window.scrollTo(0,0);let{side:o}=r;o.classList.add("active")}),e`
    ...
    `);var xb=E({name:"doc-container",component:qh});var Gh=({html:e})=>e`
        <div class="c-doc-title">
            <h2><mobjs-slot /></h2>
        </div>
    `;var Cb=E({name:"doc-title",component:Gh,state:{}});var Jh=({html:e})=>e`
        <div class="c-doc-title-small">
            <mobjs-slot />
        </div>
    `;var Ib=E({name:"doc-title-small",component:Jh,state:{}});var Yh=`<?xml version="1.0" encoding="UTF-8"?>
...
`;var Zh=({html:e,onMount:t})=>(t(({refs:r})=>{let{shape:o}=r;c.useFrame(()=>{o.classList.add("active")})}),e`
    ...
    `);var Rb=E({name:"shape-right",component:Zh}),Pb=E({name:"shape-left",component:Xh});var je=({disableOffcanvas:e})=>{let t="OffscreenCanvas"in window&&!e;return{useOffscreen:t,context:t?"bitmaprenderer":"2d"}},ze=({useOffscreen:e,canvas:t})=>{let r=e?new OffscreenCanvas(t.width,t.height):null,o=e?r.getContext("2d"):null;return{offscreen:r,offScreenCtx:o}},He=({useOffscreen:e,offscreen:t,ctx:r})=>{if(e){let o=t.transferToImageBitmap();r.transferFromImageBitmap(o)}},yt=e=>"roundRect"in e,Qh=(e,t,r,o,s,n)=>{o<2*n&&(n=o/2),s<2*n&&(n=s/2),e.beginPath(),e.moveTo(t+n,r),e.arcTo(t+o,r,t+o,r+s,n),e.arcTo(t+o,r+s,t,r+s,n),e.arcTo(t,r+s,t,r,n),e.arcTo(t,r,t+o,r,n),e.closePath()},Zr=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n})=>[...new Array(t*r+t).keys()].reduce(i=>{let{row:a,col:l,items:p}=i,u=l<r?l+1:0,m=u===0?a+1:a,d=(o+n)*u,f=(s+n)*m;return{row:m,col:u,items:[...p,{width:o,height:s,x:d,y:f,centerX:d+o/2,centerY:f+s/2,offsetXCenter:pr({canvasWidth:e.width,width:o,gutter:n,numberOfColumn:r}),offsetYCenter:hr({canvasHeight:e.height,height:s,gutter:n,numberOfRow:t}),gutter:n,numberOfColumn:r}]}},{row:0,col:-1,items:[]}),pr=({canvasWidth:e,width:t,gutter:r,numberOfColumn:o})=>e/2-(t+r)*o/2-t/2,hr=({canvasHeight:e,height:t,gutter:r,numberOfRow:o})=>e/2-(t+r)*(o+1)/2-t/2;var ed=({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n,fill:i,disableOffcanvas:a,stagger:l,reorder:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:a}),d=!0,f=[],T=[],b={},w={},x=e.getContext(m,{alpha:!1}),C="#000",A="#fff",{activeRoute:W}=L.get(),{offscreen:N,offScreenCtx:k}=ze({useOffscreen:u,canvas:e});e.width=e.clientWidth,e.height=e.clientHeight,f=Zr({canvas:e,numberOfRow:t,numberOfColumn:r,cellWidth:o,cellHeight:s,gutter:n}).items,T=p?f.map((M,J)=>({...M,scale:1,rotate:0,hasFill:i.includes(J)})).sort(M=>M.hasFill?-1:1).reverse():f.map((M,J)=>{let ne=i.includes(J);return{...M,scale:1,rotate:0,hasFill:ne}}),b=re.createTween({ease:"easeInOutQuad",stagger:l,data:{scale:1,rotate:0}}),T.forEach(M=>{b.subscribeCache(M,({scale:J,rotate:ne})=>{M.rotate=ne,M.scale=J})});let $=()=>{if(!x)return;u&&(N.width=e.width,N.height=e.height);let M=u?k:x;M.fillStyle="#1a1b26",M.fillRect(0,0,e.width,e.height),T.forEach(({x:J,y:ne,centerX:j,centerY:_,width:y,height:v,rotate:R,scale:P,hasFill:V,offsetXCenter:G,offsetYCenter:Z})=>{let Ie=Math.PI/180*R,ae=Math.cos(Ie)*P,de=Math.sin(Ie)*P;M.setTransform(ae,de,-de,ae,Math.round(j+G),Math.round(_+Z)),M.beginPath(),M.rect(Math.round(-j+J),Math.round(-_+ne),y,v),M.fillStyle=V?A:C,M.fill(),M.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:N,ctx:x})};w=Be.createAsyncTimeline({repeat:-1,yoyo:!0}).label({name:"label1"}).goTo(b,{scale:1.5,rotate:90},{duration:1e3}).goTo(b,{scale:.5},{duration:500}).goTo(b,{rotate:180,scale:1.2},{duration:500}).goTo(b,{scale:1.3},{duration:500}).goTo(b,{scale:1},{duration:1200}),w.onLoopEnd(({direction:M,loop:J})=>{console.log(`loop end: ${M}, ${J}`)}),w.play();let U=()=>{$(),d&&c.useNextFrame(()=>U())};c.useFrame(({time:M})=>{U({time:M})});let B=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,T.forEach(M=>{let{width:J,height:ne,gutter:j,numberOfColumn:_}=M;M.offsetXCenter=pr({canvasWidth:e.width,width:J,gutter:j,numberOfColumn:_}),M.offsetYCenter=hr({canvasHeight:e.height,height:ne,gutter:j,numberOfRow:t})}),c.useFrame(()=>$())}),K=D.watch("openNavigation",()=>{w?.stop(),d=!1}),F=D.watch("closeNavigation",()=>setTimeout(async()=>{d=!0;let{activeRoute:M}=L.get();M===W&&(w?.play(),c.useFrame(()=>U()))},500));return()=>{b.destroy(),w.destroy(),B(),F(),K(),b=null,w=null,x=null,N=null,k=null,f=[],T=[],d=!1}};var td=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l}=i,p=ed({canvas:l,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{p()}});let{animatedPatternN0:s}=ve(),{source:n}=s;return t`
        <div>
    ...
    `};var Lb=E({name:"caterpillar-n1",component:ad,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","fill","opacity","radius","rotationEach","centerEach","rotationDuration","disableOffcanvas"],state:{numItems:20,width:40,height:40,fill:[14],opacity:.05,radius:0,rotationEach:15,centerEach:3,rotationDuration:5e3,disableOffcanvas:!!(Re()||se())}});var Ii=({value:e,direction:t,isForced:r})=>{r||console.log(`current: ${e}, direction: ${t}`)},ld=({canvas:e,numItems:t,width:r,height:o,radius:s,fill:n,opacity:i,xAmplitude:a,yAmplitude:l,duration:p,friction:u,rotationDefault:m,disableOffcanvas:d})=>{let{useOffscreen:f,context:T}=je({disableOffcanvas:d}),b=!0,w=e.getContext(T,{alpha:!1}),x=[],C=m,{activeRoute:A}=L.get(),{offscreen:W,offScreenCtx:N}=ze({useOffscreen:f,canvas:e}),k=f?N:w,$=yt(k)&&!se();k=null,x=[...new Array(t).keys()].map((j,_)=>{let y=_>=t/2?t/2+(t/2-_):_,v=r+r/3*y,R=o+o/3*y,P=n.includes(_)?1:(t-_)*i;return{width:v,height:R,x:0,y:0,hasFill:n.includes(_),opacity:P,radius:s,rotate:0}}),e.width=e.clientWidth,e.height=e.clientHeight;let U=re.createSequencer({stagger:{each:6},data:{x:p/4,rotate:0},duration:p}).goTo({x:p+p/4},{start:0,end:p,ease:"easeLinear"}).goTo({rotate:()=>-C},{start:0,end:5,ease:"easeInOutBack"}).goTo({rotate:0},{start:5,end:p,ease:"easeInOutBack"}).label("mylabel",2).add(({isForced:j,direction:_})=>{Ii({isForced:j,direction:_,value:1})},1).add(({isForced:j,direction:_})=>{Ii({isForced:j,direction:_,value:5})},5).add(({isForced:j,direction:_})=>{Ii({isForced:j,direction:_,value:9})},9);x.forEach(j=>{U.subscribeCache(j,({x:_,rotate:y})=>{let v=_/u,R=2/(3-Math.cos(2*v)),P=R*Math.cos(v)*a,V=R*Math.sin(2*v)/2*l;j.x=P,j.y=V,j.rotate=y})});let B=Be.createSyncTimeline({repeat:-1,yoyo:!1,duration:4e3}).add(U);B.onLoopEnd(({loop:j,direction:_})=>{console.log(`loop end: ${j} , ${_}`)});let K=()=>{if(!w)return;f&&(W.width=e.width,W.height=e.height);let j=f?N:w;j.fillStyle="#1a1b26",j.fillRect(0,0,e.width,e.height),x.forEach(({width:_,height:y,x:v,y:R,radius:P,rotate:V,hasFill:G,opacity:Z})=>{let Ie=e.width/2,ae=e.height/2,de=1,Ne=Math.PI/180*V,Fe=Math.cos(Ne)*de,Me=Math.sin(Ne)*de;j.setTransform(Fe,Me,-Me,Fe,Ie+v,ae+R),$?(j.beginPath(),j.roundRect(Number.parseInt(-_/2),Number.parseInt(-y/2),_,y,[150,0])):(j.beginPath(),j.rect(Number.parseInt(-_/2),Number.parseInt(-y/2),_,y,P)),G?j.fillStyle="rgba(255, 255, 255, 1)":(j.fillStyle=`rgba(26, 27, 38, ${Z})`,j.strokeStyle=`rgba(255, 255, 255, ${Z})`,j.stroke()),j.fill(),j.setTransform(1,0,0,1,0,0)}),He({useOffscreen:f,offscreen:W,ctx:w})},F=()=>{K(),b&&c.useNextFrame(()=>F())};c.useFrame(()=>F()),B.play();let M=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,K()}),J=D.watch("openNavigation",()=>{b=!1,B?.pause()}),ne=D.watch("closeNavigation",()=>setTimeout(()=>{b=!0;let{activeRoute:j}=L.get();j===A&&(B?.resume(),c.useFrame(()=>F()))},500));return{destroy:()=>{b=!1,M(),J(),ne(),U.destroy(),B.destroy(),w=null,W=null,N=null,x=[]},play:()=>{B.stop(),B.play()},playReverse:()=>{B.stop(),B.playReverse()},playUseCurrent:()=>B.play({useCurrent:!0}),playReverseUseCurrent:()=>B.playReverse({useCurrent:!0}),playFromLabel:()=>{B.stop(),B.playFrom("mylabel")},plaFromLabelReverse:()=>{B.stop(),B.playFromReverse("mylabel")},stop:()=>B.stop(),pause:()=>B.pause(),resume:()=>B.resume(),reverse:()=>B.reverse(),setRotation:j=>C=j}};function Fb({buttons:e}){return Object.entries(e).map(([t,r])=>{let{label:o}=r;return g` <li class="c-canvas__controls__item">
            ...
            </li>`}).join("")}var cd=({onMount:e,html:t,getState:r,staticProps:o})=>{let{buttons:s,rotationDefault:n}=r();e(({element:p,refs:u})=>{if(oe.mq("max","desktop"))return;let{wrap:m,canvas:d,rangeValue:f,rotationButton:T}=u,b=ld({canvas:d,...r()}),{destroy:w,setRotation:x}=b;return Object.entries(s).forEach(([C,A])=>{let{method:W}=A;p.querySelector(`.${C}`).addEventListener("click",()=>b?.[W]())}),T.addEventListener("change",()=>{let C=T.value;x(C),f.textContent=C}),c.useFrame(()=>{m.classList.add("active")}),()=>{w()}});let{caterpillarN2:i}=ve(),{source:a}=i,l=se()?"c-canvas__wrap--wrapped":"";return t`
        <div>
            <only-desktop></only-desktop>
            <code-button
    ...
    `};var Db=10,Vb={"js-CN2-play":{label:"play",method:"play"},"js-CN2-playReverse":{label:"play reverse",method:"playReverse"},"js-CN2-play-current":{label:"go forward if is backward",method:"playUseCurrent"},"js-CN2-playReverse-current":{label:"go backward if is forward",method:"playReverseUseCurrent"},"js-CN2-play-label":{label:"play from label",method:"playFromLabel"},"js-CN2-playReverse-label":{label:"play from label reverse",method:"plaFromLabelReverse"},"js-CN2-reverse":{label:"reverse",method:"reverse"},"js-CN2-stop":{label:"stop",method:"stop"},"js-CN2-pause":{label:"pause",method:"pause"},"js-CN2-resume":{label:"resume",method:"resume"}},$b=E({name:"caterpillar-n2",component:cd,isolateCreation:!0,isolateOnMount:!0,exportState:["numItems","width","height","radius","fill","opacity","xAmplitude","yAmplitude","duration","rotationDefault","friction","disableOffcanvas"],state:{numItems:Re()||se()?20:30,width:80,height:80,radius:0,fill:[2],opacity:.02,xAmplitude:500,yAmplitude:400,duration:10,rotationDefault:360,friction:Db/2/Math.PI,disableOffcanvas:!!(Re()||se()),buttons:()=>({value:Vb,type:"Any"})}});var ud=`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!-- Generator: Gravit.io -->
...
`;var pd=({logoRefs:e,around:t})=>{let r=e.map(p=>{let[u,m]=Object.entries(p)[0];return{key:u,item:m}}),o=re.createTween({data:{opacity:0,scale:.5,x:-10},duration:2e3,ease:"easeOutQuart",stagger:{each:8,from:"end"}}),s=re.createTween({data:{scale:1,x:0},duration:4e3,ease:"easeInOutQuad",stagger:{each:40,from:"end"}}),n=re.createTween({data:{scale:.5,opacity:0},duration:1e3,ease:"easeInOutQuad",stagger:{each:4}}),i=re.createTween({data:{scale:1},duration:4e3,ease:"easeInOutQuad",stagger:{each:20}});r.forEach(({key:p,item:u})=>{s.subscribe(({scale:m,x:d})=>{if(u.style.scale=`${m}`,p!=="M_right"&&p!=="M_left")return;let f=p==="M_right"?-d:d;u.style.translate=`${f}px 0px`})}),r.forEach(({key:p,item:u})=>{o.subscribe(({scale:m,x:d,opacity:f})=>{if(u.style.scale=`${m}`,u.style.opacity=f,p!=="M_right"&&p!=="M_left")return;let T=p==="M_right"?-d:d;u.style.translate=`${T}px 0px`})}),t.forEach(p=>{n.subscribe(({scale:u,opacity:m})=>{p.style.scale=`${u}`,p.style.opacity=m})}),t.forEach(p=>{i.subscribe(({scale:u})=>{p.style.scale=`${u}`})});let a=Be.createAsyncTimeline({repeat:1}).createGroup({waitComplete:!0}).goTo(o,{opacity:1,scale:1,x:0}).goTo(n,{opacity:1,scale:1}).closeGroup(),l=Be.createAsyncTimeline({repeat:-1,yoyo:!0}).createGroup({waitComplete:!1}).goTo(s,{scale:.95,x:.5}).goTo(i,{scale:.95}).closeGroup().createGroup({waitComplete:!1}).goTo(s,{scale:1.05,x:-.5}).goTo(i,{scale:1.05}).closeGroup();return{playIntro:async()=>a.play(),playSvg:()=>l.play(),destroySvg:()=>{s.destroy(),l.destroy(),a.destroy(),n.destroy(),s=null,o=null,i=null,n=null,l=null,a=null}}};var hd=({refs:e})=>{let t=re.createTween({data:{y:100},duration:500,ease:"easeOutCubic",stagger:{each:10}});return e.forEach(r=>{t.subscribe(({y:o})=>{r.style.translate=`0px ${o}%`})}),{playText:()=>t.goTo({y:0}),destroyText:()=>{t.destroy(),t=null}}};var jb=async({playText:e,playIntro:t,playSvg:r})=>{e(),await t(),r()},dd=({html:e,onMount:t,staticProps:r})=>{t(({element:n,refs:i})=>{let{textStagger:a,block1:l,block2:p,block3:u,block4:m,block5:d,block6:f,block7:T,block8:b,M_left:w,M_right:x,around:C}=i,{playIntro:A,playSvg:W,destroySvg:N}=pd({element:n,logoRefs:[{block1:l},{block2:p},{block3:u},{block4:m},{block5:d},{block6:f},{block7:T},{block8:b},{M_left:w},{M_right:x}],around:C}),{playText:k,destroyText:$}=hd({refs:a});return jb({playText:k,playIntro:A,playSvg:W}),()=>{N(),$()}});let{home:o}=ve(),{source:s}=o;return e`<div>
        <code-button
    ...
    </div>`};var zb=E({name:"home-component",component:dd});var ki=0,Hb=({indicators:e,setState:t})=>[...e].map((r,o)=>Gt.createScrollTrigger({item:r,pin:!0,animateAtStart:!1,range:"0.1px",animatePin:!0,dynamicStart:{position:"right",value:()=>window.innerWidth+ki-ot(r)*(o+1)},dynamicEnd:{position:"right",value:()=>{let s=e.length-(o-2);return window.innerWidth/10*9*s}},onEnter:()=>{t("currentId",-1),t("currentIdFromScroll",o)},onLeaveBack:()=>{t("currentIdFromScroll",o-1)}})),Ub=({pins:e})=>{e.forEach(t=>t.refresh())},qb=({titles:e})=>[...e].map(t=>Gt.createParallax({item:t,propierties:"x",reverse:!0,range:9})),md=({nav:e})=>{e.classList.add("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.add("active")})},fd=({nav:e})=>{e.classList.remove("active"),[...document.querySelectorAll(".js-indicator")].forEach(r=>{r.classList.remove("active")})},gd=({indicators:e,titles:t,nav:r,animatePin:o,setState:s})=>{let n=Hb({indicators:e,setState:s}),i=qb({titles:t}),a=document.querySelector(".l-navcontainer__side");ki=ot(a)/2;let l=c.useResize(()=>{ki=ot(a)/2}),p=new ko({root:".js-root",container:".js-container",row:".js-row",column:".js-column",trigger:".js-trigger",shadowClass:".shadowClass",useWillChange:!0,useDrag:!0,useSticky:!o,animateAtStart:!1,ease:!0,addCss:!0,columnHeight:70,columnWidth:100,columnAlign:"center",pin:o,animatePin:o,breakpoint:"tablet",children:[...n,...i],onEnter:()=>{md({nav:r,indicators:e})},onEnterBack:()=>{Ub({pins:n}),md({nav:r,indicators:e})},onLeave:()=>{fd({nav:r,indicators:e})},onLeaveBack:()=>{fd({nav:r,indicators:e})}});return p.init(),{destroy:()=>{n.forEach(u=>{u?.destroy()}),n=[],i.forEach(u=>{u?.destroy()}),i=[],p.destroy(),p=null,l()},refresh:()=>p.refresh()}};var Gb=({numOfCol:e,pinIsVisible:t,staticProps:r})=>{let o=t?"":"hidden";return[...new Array(e).keys()].map((s,n)=>g`
                <horizontal-scroller-section
                    ${r({id:n,pinClass:o})}
                ></horizontal-scroller-section>
            `).join("")},Jb=({numOfCol:e,setState:t,bindProps:r,staticProps:o,delegateEvents:s})=>[...new Array(e).keys()].map((n,i)=>g`
                <horizontal-scroller-button
                    ${o({id:i})}
                    ${s({click:()=>t("currentId",i)})}
                    ${r({bind:["currentId","currentIdFromScroll"],props:({currentId:a,currentIdFromScroll:l})=>({active:a===i||l===i})})}
                ></horizontal-scroller-button>
            `).join(""),bd=({onMount:e,html:t,getState:r,setState:o,watch:s,staticProps:n,bindProps:i,delegateEvents:a})=>{let{animatePin:l}=r();e(({element:m})=>{if(oe.mq("max","desktop"))return;let d=m.querySelectorAll(".js-indicator"),f=m.querySelector(".js-nav"),T=m.querySelectorAll(".js-title h1"),{destroy:b}=gd({indicators:d,titles:T,nav:f,...r(),setState:o});return window.scrollTo(0,0),s("currentId",w=>{if(w===-1)return;let x=m.querySelector(`.shadowClass--section-${w} .shadowClass--in-center`),{top:C}=ie(x),A=Se(x),W=Number.parseInt(w)===0?window.innerHeight+1:C+A-window.innerHeight;At.to(W,{duration:2e3})}),()=>{b()}});let{horizontalScroller:p}=ve(),{source:u}=p;return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`<div class="l-h-scroller">
        <only-desktop></only-desktop>
    ...
    `};var Xb=E({name:"horizontal-scroller-button",component:yd,exportState:["id","active"],state:{id:()=>({value:-1,type:Number}),active:()=>({value:!1,type:Boolean})}});var vd=({html:e,getState:t})=>{let{id:r,pinClass:o}=t();return e`
        <section
    ...
    `};var Kb=E({name:"horizontal-scroller-section",component:vd,exportState:["id","pinClass"],state:{id:()=>({id:-1,type:Number}),pinClass:()=>({id:"",type:String})}});var Xs=`<?xml version="1.0" encoding="UTF-8"?>
<!-- Created with Inkscape (http://www.inkscape.org/) -->
...
`;var Sd=({canvas:e,canvasScroller:t,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i,fill:a,stagger:l,reorder:p,disableOffcanvas:u})=>{let{useOffscreen:m,context:d}=je({disableOffcanvas:u}),f=!0,T=[],b=[],w=re.createMasterSequencer(),x=e.getContext(d,{alpha:!1}),C="#000",A="#fff",{activeRoute:W}=L.get(),{offscreen:N,offScreenCtx:k}=ze({useOffscreen:m,canvas:e}),$=m?k:x,U=yt($);$=null,e.width=e.clientWidth,e.height=e.clientHeight,T=Zr({canvas:e,numberOfRow:r,numberOfColumn:o,cellWidth:s,cellHeight:n,gutter:i}).items,b=p?T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)})).sort(y=>y.hasFill?-1:1):T.map((y,v)=>({...y,scale:0,rotate:0,hasFill:a.includes(v)}));let B=re.createStaggers({items:b,stagger:l}),K=B.map(({item:y,start:v,end:R})=>{let P=y.hasFill?1.1:1,V=re.createSequencer({data:{scale:0}}).goTo({scale:P},{start:v,end:R,ease:"easeOutBack"}),G=V.subscribe(({scale:Z})=>{y.scale=Z});return w.add(V),{sequencer:V,unsubscribe:G}}),F=()=>{if(!x)return;m&&(N.width=e.width,N.height=e.height);let y=m?k:x;y.fillStyle="#1a1b26",y.fillRect(0,0,e.width,e.height),b.forEach(({x:v,y:R,centerX:P,centerY:V,width:G,height:Z,rotate:Ie,scale:ae,hasFill:de,offsetXCenter:Ne,offsetYCenter:Fe})=>{let Me=Math.PI/180*Ie,Ge=Math.cos(Me)*ae,Je=Math.sin(Me)*ae;y.setTransform(Ge,Je,-Je,Ge,Math.round(P+Ne),Math.round(V+Fe)),Qh(y,Math.round(-P+v),Math.round(-V+R),G,Z,5),U?(y.beginPath(),y.roundRect(Math.round(-P+v),Math.round(-V+R),G,Z,5)):(y.beginPath(),y.rect(Math.round(-P+v),Math.round(-V+R),G,Z)),y.fillStyle=de?A:C,y.fill(),y.setTransform(1,0,0,1,0,0)}),He({useOffscreen:m,offscreen:N,ctx:x})},M=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:w,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"lerp"});M.init();let J=()=>{F(),f&&c.useNextFrame(()=>J())};c.useFrame(({time:y})=>{J({time:y})});let ne=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,b.forEach(y=>{let{width:v,height:R,gutter:P,numberOfColumn:V}=y;y.offsetXCenter=pr({canvasWidth:e.width,width:v,gutter:P,numberOfColumn:V}),y.offsetYCenter=hr({canvasHeight:e.height,height:R,gutter:P,numberOfRow:r})}),c.useFrame(()=>F())}),j=D.watch("openNavigation",()=>{f=!1}),_=D.watch("closeNavigation",()=>setTimeout(async()=>{f=!0;let{activeRoute:y}=L.get();y===W&&c.useFrame(()=>J())},500));return()=>{ne(),_(),j(),K.forEach(({sequencer:y,unsubscribe:v})=>{y.destroy(),v()}),K=[],w.destroy(),w=null,B=[],M.destroy(),M=null,x=null,N=null,k=null,T=[],b=[],f=!1}};var wd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:i})=>{if(oe.mq("max","desktop"))return;let{wrap:a,canvas:l,canvasScroller:p}=i;window.scrollTo(0,0);let u=Sd({canvas:l,canvasScroller:p,...r()});return c.useFrame(()=>{a.classList.add("active")}),()=>{u()}});let{scrollerN0:s}=ve(),{source:n}=s;return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
    ...
    `};var Qb=E({name:"scroller-n0",component:wd,isolateOnMount:!0,isolateCreation:!0,exportState:["numberOfRow","numberOfColumn","cellWidth","cellHeight","gutter","fill","stagger","reorder","disableOffcanvas"],state:{numberOfRow:()=>({value:10,type:Number}),numberOfColumn:()=>({value:10,type:Number}),cellWidth:()=>({value:65,type:Number}),cellHeight:()=>({value:65,type:Number}),gutter:()=>({value:1,type:Number}),fill:()=>({value:[36,37,38,39,40,47,51,58,62,69,73,80,81,82,83,84],type:Array}),stagger:()=>({value:{type:"equal",each:6,from:"random"},type:"Any"}),reorder:()=>({value:!0,type:Boolean}),disableOffcanvas:!!(Re()||se())}});function e0({width:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}function t0({height:e,relativeIndex:t,amountOfPath:r}){return Math.sqrt(Math.pow(e*t,2)-Math.pow(e*t/r*t,2))*2}var Td=({canvas:e,canvasScroller:t,amountOfPath:r,width:o,height:s,radius:n,opacity:i,intialRotation:a,endRotation:l,disableOffcanvas:p})=>{let{useOffscreen:u,context:m}=je({disableOffcanvas:p}),d=!0,f=e.getContext(m,{alpha:!1}),T=[],{activeRoute:b}=L.get(),{offscreen:w,offScreenCtx:x}=ze({useOffscreen:u,canvas:e}),C=u?x:f,A=yt(C)&&!se();C=null,e.width=e.clientWidth,e.height=e.clientHeight,T=[...new Array(r).keys()].map((F,M)=>{let J=M>=r/2?r/2+(r/2-M):M;return{width:Math.floor(e0({width:o,relativeIndex:J,amountOfPath:r})),height:Math.floor(t0({height:s,relativeIndex:J,amountOfPath:r})),opacity:J*i,rotate:0,relativeIndex:J,index:M}});let W=re.createScrollerTween({from:{rotate:0},to:{rotate:l},stagger:{each:5,from:"center"}});[...T].forEach(F=>{W.subscribeCache(F,({rotate:M})=>{F.rotate=M})});let N=()=>{if(!f)return;u&&(w.width=e.width,w.height=e.height);let F=u?x:f,M=e.width/2,J=e.height/2;F.fillStyle="#1a1b26",F.fillRect(0,0,e.width,e.height),T.forEach(({width:ne,height:j,opacity:_,rotate:y,index:v})=>{let R=T.length/2-v,P=1,V=Math.PI/180*(y-a),G=Math.cos(V)*P,Z=Math.sin(V)*P;F.setTransform(G,Z,-Z,G,M,J+R*19),A?(F.beginPath(),F.roundRect(-ne/2,-j/2+R*19,ne,j,150)):(F.beginPath(),F.rect(Number.parseInt(-ne/2),Number.parseInt(-j/2),ne,j,n)),F.strokeStyle=`rgba(255, 255, 255, ${_})`,F.fillStyle=`rgba(26, 27, 38, ${_})`,F.stroke(),F.fill(),F.setTransform(1,0,0,1,0,0)}),He({useOffscreen:u,offscreen:w,ctx:f})},k=Gt.createScrollTrigger({trigger:t,propierties:"tween",tween:W,dynamicStart:{position:"bottom",value:()=>window.innerHeight},dynamicEnd:{position:"bottom",value:()=>Se(t)},ease:!0,easeType:"spring"});k.init();let $=({time:F=0})=>{N({time:F}),d&&c.useNextFrame(({time:M})=>$({time:M}))};c.useFrame(({time:F})=>{$({time:F})});let U=c.useResize(()=>{e.width=e.clientWidth,e.height=e.clientHeight,c.useFrame(()=>{N()})}),B=D.watch("openNavigation",()=>{d=!1}),K=D.watch("closeNavigation",()=>{setTimeout(()=>{d=!0;let{activeRoute:F}=L.get();F===b&&c.useFrame(({time:M})=>$({time:M}))},500)});return()=>{W.destroy(),U(),K(),B(),W.destroy(),W=null,k.destroy(),k=null,f=null,w=null,x=null,W=null,T=[],d=!1}};var xd=({onMount:e,html:t,getState:r,staticProps:o})=>{e(({refs:a})=>{if(oe.mq("max","desktop"))return;let{wrap:l,canvas:p,canvasScroller:u}=a,m=Td({canvas:p,canvasScroller:u,...r()});return c.useFrame(()=>{l.classList.add("active")}),()=>{m()}});let{scrollerN1:s}=ve(),{source:n}=s,i=se()?"c-canvas__wrap--wrapped":"";return oe.mq("max","desktop")?t`<div><only-desktop></only-desktop></div>`:t`
        <div>
            <only-desktop></only-desktop>
            <div class="c-canvas c-canvas--fixed ">
                <code-button
    ...
    `};var r0=E({name:"caterpillar-n3",component:xd,isolateOnMount:!0,isolateCreation:!0,exportState:["amountOfPath","width","height","radius","opacity","intialRotation","endRotation","disableOffcanvas"],state:{amountOfPath:17,width:15,height:40,radius:0,opacity:.05,intialRotation:33,endRotation:720,disableOffcanvas:!!(Re()||se())}});var Ks=[{key:"a",label:"A"},{key:"b",label:"B"},{key:"c",label:"C"},{key:"d",label:"D"}],Cd=[{key:"f",label:"F"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"c",label:"C"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"d",label:"D"},{key:"b",label:"B"}],Id=[{key:"m",label:"M"},{key:"q",label:"Q"},{key:"z",label:"Z"},{key:"i",label:"I"},{key:"b",label:"B"},{key:"e",label:"E"},{key:"n",label:"N"},{key:"a",label:"A"},{key:"g",label:"G"},{key:"h",label:"H"},{key:"l",label:"L"},{key:"j",label:"J"},{key:"d",label:"D"}],Ed=[{key:"h",label:"H"},{key:"f",label:"F"},{key:"a",label:"A"},{key:"d",label:"D"}];var o0=[{buttonLabel:"sample1",data:Cd},{buttonLabel:"salmple2",data:Id},{buttonLabel:"sample3",data:Ed},{buttonLabel:"Initial",data:Ks}],s0=[{label:"dynamic list with key",key:"key",clean:!1},{label:"dynamic list without key",key:"",clean:!1},{label:"dynamic list clear",key:"",clean:!0}];function n0({setState:e,staticProps:t,delegateEvents:r,bindProps:o}){return o0.map((s,n)=>{let{data:i,buttonLabel:a}=s;return g`
                <dynamic-list-button
                    ${t({label:a})}
                    ${r({click:()=>{e("data",i),e("activeSample",n)}})}
                    ${o({bind:["activeSample"],props:({activeSample:l})=>({active:n===l})})}
                ></dynamic-list-button>
            `}).join("")}function i0({bindProps:e,staticProps:t}){return s0.map((r,o)=>{let{key:s,clean:n,label:i}=r;return g`
                <dynamic-list-repeater
                    ${t({listId:o,key:s,clean:n,label:i})}
                    ${e({bind:["data","counter"],props:({data:a,counter:l})=>({data:a,counter:l})})}
                ></dynamic-list-repeater>
            `}).join("")}var kd=async({setState:e,html:t,onMount:r,staticProps:o,bindProps:s,delegateEvents:n,watchSync:i})=>{r(({refs:p})=>{let{counterEl:u}=p;i("counter",m=>{u.textContent=m})});let{repeater:a}=ve(),{source:l}=a;return t`
        <div class="dynamic-list">
            <div class="dynamic-list__header">
                <div class="dynamic-list__top">
                    ${n0({setState:e,delegateEvents:n,staticProps:o,bindProps:s})}
                    <dynamic-list-button
    ...
    `};var a0=E({name:"dynamic-list",component:kd,state:{counter:()=>({value:0,type:Number}),data:()=>({value:Ks,type:Array}),activeSample:()=>({value:3,type:Number})}});function Qr(e,t){return`${e}: ${t}`}var Rd=async({getState:e,html:t,onMount:r,key:o,staticProps:s,bindProps:n,watch:i,id:a})=>{let{isFull:l,parentListId:p,index:u,label:m,counter:d}=e();return r(({element:T,refs:b})=>{let{indexEl:w,labelEl:x,counterEl:C}=b;T.addEventListener("click",()=>{T.classList.toggle("is-selected")}),i("index",A=>{w.textContent=Qr("index",A)}),i("label",A=>{x.textContent=Qr("label",A)}),i("counter",A=>{C.textContent=Qr("counter",A)}),c.useFrame(()=>{T.classList.add("active")})}),t`
    ...
    `};var c0=E({name:"dynamic-list-slot",component:Ad,exportState:["staticFromSlot","staticFromComponent","parentParentState","parentState"],state:{staticFromSlot:()=>({value:"",type:"any"}),staticFromComponent:()=>({value:"",type:"any"}),parentParentState:()=>({value:"",type:"any"}),parentState:()=>({value:"",type:"any"})}});var _d=async({html:e})=>e`<div class="dynamic-list-empty">
        <p>empty comp</p>
        <mobjs-slot name="empty-slot"></mobjs-slot>
    </div>`;var u0=E({name:"dynamic-list-empty",component:_d});var Od=async({watch:e,onMount:t,html:r,getState:o})=>{let{parentListId:s,counter:n}=o();return t(({refs:i})=>{let{counterValueEl:a}=i;e("counter",l=>{a.textContent=l})}),r`<div class="dynamic-counter">
    ...
    </div>`};var p0=E({name:"dynamic-list-counter",component:Od,exportState:["counter","parentListId"],state:{parentListId:()=>({value:-1,type:Number}),counter:()=>({value:0,type:Number})}});var Nd=({html:e,getState:t,onMount:r,watchSync:o})=>{let{label:s}=t();return r(({element:n})=>{o("active",i=>{n.classList.toggle("active",i)})}),e`
        <button type="button" class="dynamic-list-button">${s}</button>
    `};var h0=E({name:"dynamic-list-button",component:Nd,exportState:["active","label"],state:{label:()=>({value:"",type:String}),active:()=>({value:!1,type:Boolean})}});function d0({sync:e,staticProps:t,bindProps:r,listId:o,delegateEvents:s}){return g`
        <dynamic-list-card
            ${t({parentListId:o})}
    ...
    `}function m0(e){return`<strong>Current cards id:</strong> ${e.join(",").replaceAll(","," | ")}`}function f0({element:e,className:t,childrenId:r}){let o=e.querySelector(t);o.textContent="",o.insertAdjacentHTML("afterbegin",m0(r))}var Md=({getState:e,html:t,repeat:r,staticProps:o,bindProps:s,delegateEvents:n})=>{let{listId:i,key:a,clean:l,label:p}=e(),u=a.length>0?a:null;return t`
        <div class="dynamic-list-repeater">
            ...
            <div class="dynamic-list-repeater__list">
                ${r({watch:"data",clean:l,key:u,afterUpdate:({childrenId:m,element:d})=>{f0({className:".js-list",childrenId:m,element:d})},render:({sync:m})=>d0({sync:m,staticProps:o,bindProps:s,delegateEvents:n,listId:i})})}
            </div>
        </div>
    `};var g0=E({name:"dynamic-list-repeater",component:Md,exportState:["label","clean","data","listId","key","listId","counter"],state:{data:()=>({value:[],type:Array}),key:()=>({value:"",type:String}),clean:()=>({value:!1,type:Boolean}),listId:()=>({value:-1,type:Number}),counter:()=>({value:-1,type:Number}),label:()=>({value:"",type:String})}});function Ld(e){return`slotted: ${e}`}var Fd=async({html:e,onMount:t,watch:r,getState:o})=>{let{label:s}=o();return t(({refs:n})=>{let{contentEl:i}=n;r("label",a=>{i.textContent=Ld(a)})}),e`<div class="dynamic-list-slotted-label">
        <p class="content" ref="contentEl">${Ld(s)}</p>
    </div>`};var b0=E({name:"dynamic-slotted-label",component:Fd,exportState:["label"],state:{label:()=>({value:void 0,type:"Any"})}});var Pi={};_i(Pi,{about:()=>_0,animatedPatternN0v1:()=>v0,animatedPatternN0v2:()=>S0,animatedPatternN0v3:()=>w0,animatedPatternN0v4:()=>T0,animatedPatternN0v5:()=>x0,animatedPatternN0v6:()=>C0,animatedPatternN0v7:()=>I0,animatedPatternN1:()=>E0,canvas_overview:()=>L0,caterpillarN0:()=>k0,caterpillarN1:()=>R0,caterpillarN2:()=>P0,dynamic_list:()=>j0,home:()=>A0,horizontalScrollerV1:()=>N0,horizontalScrollerV2:()=>M0,mobCore_defaults:()=>Ey,mobCore_events:()=>Cy,mobCore_overview:()=>xy,mobCore_store:()=>Iy,mobJs_bindEvents:()=>dy,mobJs_bindProps:()=>uy,mobJs_component:()=>q0,mobJs_computed:()=>Q0,mobJs_debug:()=>Sy,mobJs_delegateEvents:()=>my,mobJs_emit:()=>K0,mobJs_emitAsync:()=>Z0,mobJs_freezeProp:()=>ny,mobJs_getChildren:()=>sy,mobJs_getParentId:()=>ay,mobJs_getState:()=>Y0,mobJs_html:()=>G0,mobJs_initialization:()=>H0,mobJs_instanceName:()=>Ty,mobJs_onMount:()=>J0,mobJs_overview:()=>z0,mobJs_refs:()=>gy,mobJs_remove:()=>ry,mobJs_removeDom:()=>oy,mobJs_repeat:()=>fy,mobJs_routing:()=>U0,mobJs_runtime:()=>wy,mobJs_setState:()=>X0,mobJs_slot:()=>by,mobJs_staticProps:()=>cy,mobJs_syncParent:()=>hy,mobJs_unBind:()=>py,mobJs_unFreezeProp:()=>iy,mobJs_utils:()=>yy,mobJs_watch:()=>ey,mobJs_watchParent:()=>ly,mobJs_watchSync:()=>ty,mobJs_web_component:()=>vy,mobMotion_async_timeline:()=>ky,mobMotion_create_stagger:()=>Ry,mobMotion_defaults:()=>Dy,mobMotion_overview:()=>Py,mobMotion_parallax:()=>Ay,mobMotion_plugin:()=>Fy,mobMotion_scrolltrigger:()=>_y,mobMotion_sequencer:()=>Oy,mobMotion_stagger:()=>Ny,mobMotion_sync_timeline:()=>My,mobMotion_tween_spring_lerp:()=>Ly,pageNotFound:()=>y0,plugin_overview:()=>O0,scrollerN0v1:()=>F0,scrollerN0v2:()=>D0,scrollerN0v3:()=>V0,scrollerN0v4:()=>$0,scrollerN0v5:()=>W0,scrollerN1:()=>B0});var y0=()=>g`
    ...
    `;var v0=()=>g`<div class="l-padding">
        <animatedpattern-n0></animatedpattern-n0>
    </div>`;var S0=()=>g`<div class="l-padding">
        <animatedpattern-n0
    ...
    </div>`;var A0=()=>g`<div class="l-index">
        <home-component></home-component>
    </div>`;var _0=async()=>{let{success:e,data:t}=await I({source:"./data/about.json"});return e?g`<doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var O0=()=>g` <doc-container>
        <html-content
            slot="docs"
    ...
    </doc-container>`;var N0=()=>g`<div>
        <horizontal-scroller></horizontal-scroller>
    </div>`;var M0=()=>g`<div>
        <horizontal-scroller
            ${S({animatePin:!0})}
        ></horizontal-scroller>
    </div>`;var L0=async()=>{let{success:e,data:t}=await I({source:"./data/canvas/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var F0=()=>g`<div>
        ...
        ></scroller-n0>
    </div>`;var B0=()=>g`<div class="l-padding">
        <caterpillar-n3></caterpillar-n3>
    </div>`;var j0=()=>g` <dynamic-list> </dynamic-list> `;var z0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var H0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/initialization.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var U0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/routing.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var G0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/html.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var J0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/onMount.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Y0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var X0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/setState.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var K0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emit.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Z0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/emitAsync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Q0=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/computed.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watch.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchSync.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/remove.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/removeDom.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getChildren.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/freezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unFreezeProp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/getParentId.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/watchParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/staticProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var uy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindProps.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var py=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/unBind.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var hy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/syncParent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var dy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/bindEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var my=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/delegateEvents.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/repeat.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var gy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/refs.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var by=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/slot.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var yy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/utils.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var vy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/webComponent.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Sy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/debug.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var wy=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/runtime.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ty=async()=>{let{success:e,data:t}=await I({source:"./data/mobJs/instanceName.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var xy=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Cy=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/events.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Iy=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/store.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ey=async()=>{let{success:e,data:t}=await I({source:"./data/mobCore/defaults.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var ky=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/asyncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ry=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/createStagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Py=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/overview.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ay=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/parallax.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var _y=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/scrollTrigger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Oy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/sequencer.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ny=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/stagger.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var My=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/syncTimeline.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Ly=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/tweenSpringLerp.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
    ...
    </doc-container>`:(console.warn("fetch data fail"),[])};var Fy=async()=>{let{success:e,data:t}=await I({source:"./data/mobMotion/plugin.json"});return e?g` <doc-container>
        <html-content
            slot="docs"
            ${S({data:t.data,useMaxWidth:!0})}
        ></html-content>
        ...
        <scroll-to slot="section-links"></scroll-to>
        <doc-title slot="section-title">Defaults</doc-title>
    </doc-container>`:(console.warn("fetch data fail"),[])};var Dd=()=>g`
    ...
    `;c.useLoad(()=>{c.store.set("fpsScalePercent",{0:1,50:2,70:3}),oe.setDefault({deferredNextTick:!0,useScaleFps:!0,usePassive:!0,mq:{desktop:1024},spring:{config:{customSpring:{friction:1,mass:1,precision:.01,tension:180,velocity:0}}}}),oe.printDefault(),(async()=>{let t=document.body.querySelector(".js-main-loader"),r=document.body.querySelector(".js-main-loader-background"),o=re.createTween({data:{opacity:1,scale:1},duration:1e3});t&&r&&[t,r].forEach(s=>{o.subscribe(({opacity:n,scale:i})=>{s.style.opacity=n,s.style.transform=`scale(${i})`})}),await Fh(),Rn({isolateCreation:!1,isolateOnMount:!1,scoped:!1,maxParseIteration:1e3,debug:!0}),$n({rootId:"#root",contentId:"#content",wrapper:Dd,components:Ri,pages:Pi,index:"home",pageNotFound:"pageNotFound",afterInit:async()=>{await o.goTo({opacity:0,scale:.9}),t?.remove(),r?.remove(),o=null}})})()});})();
